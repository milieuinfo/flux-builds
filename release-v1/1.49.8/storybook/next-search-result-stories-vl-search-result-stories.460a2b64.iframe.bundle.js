...
`;v.storyName="vl-search-result-next - group",x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:'() => html`\n    <vl-search-result-next>\n        <vl-search-result-title-next>\n            <a href="#">Vlaanderenkiest.be</a>\n        </vl-search-result-title-next>\n        <vl-search-result-text-next>\n            <time>Maandag 22 oktober 2018</time>\n        </vl-search-result-text-next>\n        <vl-search-result-properties-next>\n            <label>Vlaanderenkiest.be</label>\n            <data>Verkiezingsresultaten op Vlaanderenkiest.be...</data>\n            <label>Vlaanderen intern</label>\n            <data>Werkt u bij de Vlaamse overheid...</data>\n        </vl-search-result-properties-next>\n    </vl-search-result-next>\n`',...x.parameters?.docs?.source}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:'() => html`\n    <div class="vl-group-next vl-group-next--column vl-group-next--stretch-children vl-group-next--no-gap">\n        <vl-search-result-next>\n            <vl-search-result-title-next>\n                <a href="#">Vlaanderenkiest.be</a>\n            </vl-search-result-title-next>\n            <vl-search-result-text-next>\n                <time>Maandag 22 oktober 2018</time>\n            </vl-search-result-text-next>\n            <vl-search-result-properties-next>\n                <label>Vlaanderenkiest.be</label>\n                <data>Verkiezingsresultaten op Vlaanderenkiest.be...</data>\n                <label>Vlaanderen intern</label>\n                <data>Werkt u bij de Vlaamse overheid...</data>\n            </vl-search-result-properties-next>\n        </vl-search-result-next>\n        <vl-search-result-next>\n            <vl-search-result-title-next>\n                <a href="#">Vlaanderenkiest.be</a>\n            </vl-search-result-title-next>\n            <vl-search-result-text-next>\n                <time>Maandag 22 oktober 2018</time>\n            </vl-search-result-text-next>\n            <vl-search-result-properties-next>\n                <label>Vlaanderenkiest.be</label>\n                <data>Verkiezingsresultaten op Vlaanderenkiest.be...</data>\n                <label>Vlaanderen intern</label>\n                <data>Werkt u bij de Vlaamse overheid...</data>\n            </vl-search-result-properties-next>\n        </vl-search-result-next>\n    </div>\n`',...v.parameters?.docs?.source}}};let g=["SearchResultDefault","SearchResultGroup"]},"../../node_modules/react-dom/client.js":(e,t,r)=>{var s=r("../../node_modules/react-dom/index.js");t.createRoot=s.createRoot,t.hydrateRoot=s.hydrateRoot},"../../libs/components/src/next/properties/index.ts":(e,t,r)=>{r.d(t,{L:()=>s.L});var s=r("../../libs/components/src/next/properties/vl-properties.component.ts")},"../../libs/components/src/next/properties/vl-properties.component.ts":(e,t,r)=>{r.d(t,{L:()=>v});var s=r("../../libs/common/utilities/src/index.ts"),n=r("../../libs/elements/src/index.ts"),l=r("../../node_modules/lit/index.js");let a=(e,t)=>t?e.map(e=>e.cloneNode(!0)):e,o=(e,t)=>{let r=[],s=[],n=[];return e.forEach(e=>{switch(e.localName){case"label":s.length&&n.length&&(r.push({labels:s,data:n}),s=[],n=[]),s.push(e.children.length>0?a([...e.childNodes],t):e.innerHTML);break;case"data":n.push(e.children.length>0?a([...e.childNodes],t):e.innerHTML)}}),s.length&&r.push({labels:s,data:n}),r},i=(e,t)=>null==e||0==e.length?[]:e[0]?.localName==="div"?e.map(e=>({class:e.className,items:o([...e.children],t)})):[{items:o(e,t)}];var c=r("../../libs/common/utilities/src/css/index.ts");let d=e=>(0,l.AH)`
        width: calc(${e}% - 1rem);
    `,h=()=>(0,l.AH)`
        font-size: 1.6rem;
    `,u=()=>(0,l.AH)`
...
`;var x=r("../../libs/components/src/next/properties/vl-properties.defaults.ts");class v extends s.jW{static get styles(){return[n.hF,b]}static get properties(){return{props:{type:Array},aggregatedProps:{type:Array,state:!0},labelWidth:{type:Number,attribute:"label-width"},noClone:{type:Boolean,attribute:"no-clone"}}}set props(e){this.attributeProps=e,this.buildInternalProperties()}get props(){return this.attributeProps}connectedCallback(){super.connectedCallback(),this.buildInternalProperties(),this.observeLightPropertiesChange()}firstUpdated(e){super.firstUpdated(e),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.labelWidthSheet,m.styleSheet])}updated(e){super.updated(e),e.has("labelWidth")&&this.labelWidth&&this.labelWidthSheet.replace(p(this.labelWidth).toString())}disconnectedCallback(){super.disconnectedCallback(),this.disconnectMutationObservers()}render(){return(0,l.qy)` <dl>${this.aggregatedProps.map(e=>this.renderColumn(e))}</dl> `}renderColumn(e){return e.class?(0,l.qy)` <div class="${e.class}">${e.items.map(e=>this.renderItem(e))}</div>`:(0,l.qy)` ${e.items.map(e=>this.renderItem(e))}`}renderItem(e){return(0,l.qy)` <div class="item">${this.renderLabels(e.labels)} ${this.renderData(e.data)}</div>`}renderLabels(e){return e.map(e=>(0,l.qy)` <dt>${e}</dt>`)}renderData(e){return e.map(e=>(0,l.qy)` <dd>${e}</dd>`)}buildInternalProperties(){this.aggregatedProps=[...this.attributeProps,...i([...this.children],!this.noClone)]}disconnectMutationObservers(){this.mutationObserverList.forEach(e=>e.disconnect()),this.mutationObserverList=[]}observeLightPropertiesChange(){this.disconnectMutationObservers(),this.mutationObserverList=[...this.mutationObserverList,(0,s.U_)(this,e=>{this.buildInternalProperties(),this.observeLightPropertiesChange()})],this.children.length>0&&"div"===this.children[0].localName&&[...this.children].forEach(e=>this.mutationObserverList=[...this.mutationObserverList,(0,s.U_)(e,e=>{this.buildInternalProperties()})])}constructor(...e){super(...e),this.attributeProps=x.g.props,this.aggregatedProps=x.g.props,this.labelWidth=x.g.labelWidth,this.labelWidthSheet=new CSSStyleSheet,this.noClone=!1,this.mutationObserverList=[]}}v=function(e,t,r,s){var n,l=arguments.length,a=l<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,s);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(a=(l<3?n(a):l>3?n(t,r,a):n(t,r))||a);return l>3&&a&&Object.defineProperty(t,r,a),a}([(0,s.M1)("vl-properties-next")],v)},"../../libs/components/src/next/properties/vl-properties.defaults.ts":(e,t,r)=>{r.d(t,{g:()=>s});let s={labelWidth:25,noClone:!1,props:[]}},"../../libs/components/src/next/search-result/vl-search-result-properties.component.ts":(e,t,r)=>{r.d(t,{y:()=>o});var s=r("../../libs/common/utilities/src/index.ts"),n=r("../../libs/components/src/next/properties/index.ts"),l=r("../../node_modules/lit/index.js");let a=(0,l.AH)`
    dl {
        margin: initial;
    }
