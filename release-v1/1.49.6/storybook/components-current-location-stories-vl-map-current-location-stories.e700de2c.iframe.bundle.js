...
`,...c.hF];class m extends r.jW{static get styles(){return[(0,n.AH)`
                ${(0,n.iz)(p)}
            `,a.mU]}static get properties(){return{zoom:{type:Number,attribute:"data-vl-zoom",reflect:!0},tooltip:{type:String,attribute:"data-vl-tooltip",reflect:!0}}}constructor(){super(),this.zoom=s.a,this.tooltip=s.K}connectedCallback(){super.connectedCallback(),this._mapElement=this.closest("vl-map")}_currentLocation(){navigator.geolocation.getCurrentPosition(e=>{let t=i.A.Proj("EPSG:4326"),o=i.A.Proj(this._mapElement.map.projection.getCode()),r=i.A.Point(e.coords.longitude,e.coords.latitude),a=i.A.transform(t,o,r);this._mapElement.map.getView().setCenter([a.x,a.y]),this._mapElement.map.getView().setZoom(this.zoom)})}render(){return(0,n.qy)` <div class="uig-map-current-location">
            <button @click=${()=>this._currentLocation()} type="button" title="${this.tooltip}">
                <span class="vl-icon vl-icon--location-gps"></span>
            </button>
        </div>`}}m=function(e,t,o,r){var a,n=arguments.length,l=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,o,r);else for(var i=e.length-1;i>=0;i--)(a=e[i])&&(l=(n<3?a(l):n>3?a(t,o,l):a(t,o))||l);return n>3&&l&&Object.defineProperty(t,o,l),l}([(0,l.EM)("vl-map-current-location")],m)}}]);