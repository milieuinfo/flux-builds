"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[834],{"../../libs/components/src/next/paragraph/index.ts":(e,n,t)=>{t.d(n,{Q:()=>i.Q});var i=t("../../libs/components/src/next/paragraph/vl-paragraph.component.ts")},"../../libs/components/src/next/paragraph/vl-paragraph.component.ts":(e,n,t)=>{t.d(n,{Q:()=>s});var i=t("../../libs/common/utilities/src/index.ts"),r=t("../../libs/common/utilities/src/css/index.ts"),a=t("../../node_modules/lit/index.js"),o=t("../../node_modules/lit/directives/class-map.js"),l=t("../../libs/components/src/next/paragraph/vl-paragraph.defaults.ts");class s extends i.jW{static get styles(){return[r.N]}static get properties(){return{bold:{type:Boolean},introduction:{type:Boolean}}}render(){let e={bold:this.bold,introduction:this.introduction};return(0,a.qy)`
            <p class=${(0,o.H)(e)}>
                <slot></slot>
            </p>
        `}constructor(...e){super(...e),this.bold=l.J.bold,this.introduction=l.J.introduction}}s=function(e,n,t,i){var r,a=arguments.length,o=a<3?n:null===i?i=Object.getOwnPropertyDescriptor(n,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,t,i);else for(var l=e.length-1;l>=0;l--)(r=e[l])&&(o=(a<3?r(o):a>3?r(n,t,o):r(n,t))||o);return a>3&&o&&Object.defineProperty(n,t,o),o}([(0,i.M1)("vl-paragraph-next")],s)},"../../libs/components/src/next/paragraph/vl-paragraph.defaults.ts":(e,n,t)=>{t.d(n,{J:()=>i});let i={bold:!1,introduction:!1}},"../../libs/components/src/next/properties/index.ts":(e,n,t)=>{t.d(n,{L:()=>i.L});var i=t("../../libs/components/src/next/properties/vl-properties.component.ts")},"../../libs/components/src/next/properties/vl-properties.component.ts":(e,n,t)=>{t.d(n,{L:()=>u});var i=t("../../libs/common/utilities/src/index.ts"),r=t("../../libs/elements/src/index.ts"),a=t("../../node_modules/lit/index.js");let o=e=>{let n=[],t=[],i=[];return e.forEach(e=>{switch(e.localName){case"label":t.length&&i.length&&(n.push({labels:t,data:i}),t=[],i=[]),t.push(Array.from(e.childNodes).map(e=>e.cloneNode(!0)));break;case"data":i.push(Array.from(e.childNodes).map(e=>e.cloneNode(!0)))}}),t.length&&n.push({labels:t,data:i}),n},l=e=>null==e||0==e.length?(console.warn("vl-properties - geen props opgegeven"),[]):e[0]?.localName==="div"?e.map(e=>({class:e.className,items:o([...e.children])})):[{items:o(e)}];var s=t("../../libs/common/utilities/src/css/index.ts");let v=e=>(0,a.AH)`
        width: calc(${e}% - 1rem);
    `,d=()=>(0,a.AH)`
        font-size: 1.6rem;
    `,g=()=>(0,a.AH)`
...
`;var h=t("../../libs/components/src/next/properties/vl-properties.defaults.ts");class u extends i.jW{static get styles(){return[r.hF,m]}static get properties(){return{props:{type:Array},aggregatedProps:{type:Array,state:!0},labelWidth:{type:Number,attribute:"label-width"}}}set props(e){this.attributeProps=e,this.buildInternalProperties()}get props(){return this.attributeProps}connectedCallback(){super.connectedCallback(),this.buildInternalProperties(),this.observeLightPropertiesChange()}firstUpdated(e){super.firstUpdated(e),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.labelWidthSheet,p.styleSheet])}updated(e){super.updated(e),e.has("labelWidth")&&this.labelWidth&&this.labelWidthSheet.replace(c(this.labelWidth).toString())}disconnectedCallback(){super.disconnectedCallback(),this.disconnectMutationObservers()}render(){return(0,a.qy)` <dl>${this.aggregatedProps.map(e=>this.renderColumn(e))}</dl> `}renderColumn(e){return e.class?(0,a.qy)` <div class="${e.class}">${e.items.map(e=>this.renderItem(e))}</div>`:(0,a.qy)` ${e.items.map(e=>this.renderItem(e))}`}renderItem(e){return(0,a.qy)` <div class="item">${this.renderLabels(e.labels)} ${this.renderData(e.data)}</div>`}renderLabels(e){return e.map(e=>(0,a.qy)` <dt>${e}</dt>`)}renderData(e){return e.map(e=>(0,a.qy)` <dd>${e}</dd>`)}buildInternalProperties(){this.aggregatedProps=[...this.attributeProps,...l([...this.children])]}disconnectMutationObservers(){this.mutationObserverList.forEach(e=>e.disconnect()),this.mutationObserverList=[]}observeLightPropertiesChange(){this.disconnectMutationObservers(),this.mutationObserverList=[...this.mutationObserverList,(0,i.U_)(this,e=>{this.buildInternalProperties(),this.observeLightPropertiesChange()})],this.children.length>0&&"div"===this.children[0].localName&&[...this.children].forEach(e=>this.mutationObserverList=[...this.mutationObserverList,(0,i.U_)(e,e=>{this.buildInternalProperties()})])}constructor(...e){super(...e),this.attributeProps=h.g.props,this.aggregatedProps=h.g.props,this.mutationObserverList=[],this.labelWidth=h.g.labelWidth,this.labelWidthSheet=new CSSStyleSheet}}u=function(e,n,t,i){var r,a=arguments.length,o=a<3?n:null===i?i=Object.getOwnPropertyDescriptor(n,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,t,i);else for(var l=e.length-1;l>=0;l--)(r=e[l])&&(o=(a<3?r(o):a>3?r(n,t,o):r(n,t))||o);return a>3&&o&&Object.defineProperty(n,t,o),o}([(0,i.M1)("vl-properties-next")],u)},"../../libs/components/src/next/properties/vl-properties.defaults.ts":(e,n,t)=>{t.d(n,{g:()=>i});let i={labelWidth:25,props:[]}},"../../libs/components/src/next/title/index.ts":(e,n,t)=>{t.d(n,{I:()=>i.I});var i=t("../../libs/components/src/next/title/vl-title.component.ts")},"../../libs/components/src/next/title/vl-title.component.ts":(e,n,t)=>{t.d(n,{I:()=>v});var i=t("../../libs/common/utilities/src/index.ts");t("../../node_modules/@lit/reactive-element/reactive-element.js");var r=t("../../node_modules/lit-html/lit-html.js");t("../../node_modules/lit-element/lit-element.js");/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var a=(e,n,t)=>{for(var i of n)if(i[0]===e)return(0,i[1])();return null==t?void 0:t()},o=t("../../node_modules/lit/directives/class-map.js"),l=t("../../libs/components/src/next/title/vl-title.css.ts"),s=t("../../libs/components/src/next/title/vl-title.defaults.ts");class v extends i.jW{static get styles(){return[l.Z]}static get properties(){return{type:{type:String},underline:{type:Boolean},noSpaceBottom:{type:Boolean,attribute:"no-space-bottom"},alt:{type:Boolean}}}render(){let e={underline:this.underline,"no-space-bottom":this.noSpaceBottom,alt:this.alt};return(0,r.qy)`
            ${a(this.type,[["h1",()=>(0,r.qy)` <h1 class=${(0,o.H)(e)} part="h1">
                            <slot></slot>
                        </h1>`],["h2",()=>(0,r.qy)` <h2 class=${(0,o.H)(e)} part="h2">
                            <slot></slot>
                        </h2>`],["h3",()=>(0,r.qy)` <h3 class=${(0,o.H)(e)} part="h3">
                            <slot></slot>
                        </h3>`],["h4",()=>(0,r.qy)` <h4 class=${(0,o.H)(e)} part="h4">
                            <slot></slot>
                        </h4>`],["h5",()=>(0,r.qy)` <h5 class=${(0,o.H)(e)} part="h5">
                            <slot></slot>
                        </h5>`],["h6",()=>(0,r.qy)` <h6 class=${(0,o.H)(e)} part="h6">
                            <slot></slot>
                        </h6>`]],()=>(0,r.qy)` <h1 class=${(0,o.H)(e)} part="h1">
                    <slot></slot>
                </h1>`)}
        `}constructor(...e){super(...e),this.type=s.D.type,this.underline=s.D.underline,this.noSpaceBottom=s.D.noSpaceBottom,this.alt=s.D.alt}}v=function(e,n,t,i){var r,a=arguments.length,o=a<3?n:null===i?i=Object.getOwnPropertyDescriptor(n,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,t,i);else for(var l=e.length-1;l>=0;l--)(r=e[l])&&(o=(a<3?r(o):a>3?r(n,t,o):r(n,t))||o);return a>3&&o&&Object.defineProperty(n,t,o),o}([(0,i.M1)("vl-title-next")],v)},"../../libs/components/src/next/title/vl-title.defaults.ts":(e,n,t)=>{t.d(n,{D:()=>i});let i={type:"h1",underline:!1,alt:!1,noSpaceBottom:!1}},"../../libs/sections/src/privacy/vl-privacy.defaults.ts":(e,n,t)=>{t.d(n,{z:()=>i});let i={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",headerSlot:"",versionSlot:"",contentSlot:"",bottomSlot:""}},"../../libs/sections/src/privacy/vl-privacy.section.ts":(e,n,t)=>{var i=t("../../libs/common/utilities/src/index.ts"),r=t("../../libs/common/utilities/src/css/index.ts"),a=t("../../libs/components/src/index.ts"),o=t("../../libs/components/src/next/paragraph/index.ts"),l=t("../../libs/components/src/next/properties/index.ts"),s=t("../../libs/components/src/next/side-navigation/index.ts"),v=t("../../libs/components/src/next/title/index.ts"),d=t("../../libs/elements/src/index.ts"),g=t("../../node_modules/lit/index.js"),c=t("../../node_modules/lit/decorators.js"),p=t("../../node_modules/lit-html/lit-html.js");let m=()=>(0,p.qy)`
...
`,u=()=>[a.a7],b=({disableBackLink:e,hideBackLink:n})=>(0,g.qy)`
...
`;var w=t("../../libs/sections/src/privacy/vl-privacy.defaults.ts");class x extends i.jW{static{(0,i.gy)([a.Y4,a.FQ,a.Pq,a.Ic,v.I,s.N8,l.L,o.Q,...u()])}static get styles(){return[d.hF,r.B2,r.DE,r.as,r.Ei]}static get properties(){return{date:{type:String,attribute:"data-vl-date"},disableBackLink:{type:Boolean,attribute:"data-vl-disable-back-link"},hideBackLink:{type:Boolean,attribute:"data-vl-hide-back-link"},version:{type:String,attribute:"data-vl-version"}}}constructor(){super(),this.date=w.z.date,this.version=w.z.version,this.disableBackLink=w.z.disableBackLink,this.hideBackLink=w.z.hideBackLink,this.allowCustomCSS=!1}render(){return(0,g.qy)`
            <slot name="header"
