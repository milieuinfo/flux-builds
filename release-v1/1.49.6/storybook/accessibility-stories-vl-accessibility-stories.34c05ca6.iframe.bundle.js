 ...
 */class l extends n.WL{constructor(e){if(super(e),this.et=a.s6,e.type!==n.OA.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===a.s6||null==e)return this.vt=void 0,this.et=e;if(e===a.c0)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.vt;this.et=e;var t=[e];return t.raw=t,this.vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}l.directiveName="unsafeHTML",l.resultType=1;var s=(0,n.u$)(l)},"../../node_modules/lit/directives/unsafe-html.js":(e,t,i)=>{i.d(t,{_:()=>a._});var a=i("../../node_modules/lit-html/directives/unsafe-html.js")},"../../libs/components/src/next/properties/index.ts":(e,t,i)=>{i.d(t,{L:()=>a.L});var a=i("../../libs/components/src/next/properties/vl-properties.component.ts")},"../../libs/components/src/next/properties/vl-properties.component.ts":(e,t,i)=>{i.d(t,{L:()=>b});var a=i("../../libs/common/utilities/src/index.ts"),n=i("../../libs/elements/src/index.ts"),l=i("../../node_modules/lit/index.js");let s=e=>{let t=[],i=[],a=[];return e.forEach(e=>{switch(e.localName){case"label":i.length&&a.length&&(t.push({labels:i,data:a}),i=[],a=[]),i.push(Array.from(e.childNodes).map(e=>e.cloneNode(!0)));break;case"data":a.push(Array.from(e.childNodes).map(e=>e.cloneNode(!0)))}}),i.length&&t.push({labels:i,data:a}),t},o=e=>null==e||0==e.length?(console.warn("vl-properties - geen props opgegeven"),[]):e[0]?.localName==="div"?e.map(e=>({class:e.className,items:s([...e.children])})):[{items:s(e)}];var r=i("../../libs/common/utilities/src/css/index.ts");let d=e=>(0,l.AH)`
        width: calc(${e}% - 1rem);
    `,c=()=>(0,l.AH)`
        font-size: 1.6rem;
    `,m=()=>(0,l.AH)`
