"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[8565],{"../../libs/form/src/next/select-rich/vl-select-rich.component.ts":(e,t,l)=>{l.d(t,{A:()=>b});var i=l("../../libs/common/utilities/src/index.ts"),s=l("../../node_modules/@domg/govflanders-style/common/index.js"),o=l("../../node_modules/@domg/govflanders-style/component/index.js"),r=l("../../node_modules/choices.js/public/assets/scripts/choices.mjs"),c=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),n=l("../../libs/form/src/next/form-control/form-control.ts"),d=l("../../libs/form/src/next/input-field/vl-input-field.css.ts");let u=(0,c.AH)`
    .vl-pill {
        display: inline-flex;
        max-width: 100%;
        align-items: center;
...
`;var p=l("../../libs/common/utilities/src/css/index.ts");let h=(0,c.AH)`
...
`;var v=l("../../libs/form/src/next/select-rich/vl-select-rich.defaults.ts"),_=l("../../libs/form/src/next/select-rich/vl-select-rich.search-matchers.ts");class b extends n.M{constructor(){super(),this.options=v.X.options,this.initialOptions=v.X.initialOptions,this.placeholder=v.X.placeholder,this.search=v.X.search,this.searchPlaceholder=v.X.searchPlaceholder,this.choices=null,this.notDeletable=v.X.notDeletable,this.multiple=v.X.multiple,this.position=v.X.position,this.resultLimit=v.X.resultLimit,this.noResultsText=v.X.noResultsText,this.noChoicesText=v.X.noChoicesText,this.searchStrategy=v.X.searchStrategy,this.searchMatcher=null,this.nativeSearchMethod=null,this.value=null,this.dropdownInitialised=!1,this.initialised=!1,this.isDropdownOpen=!1,this.dispatchInput=!1,this.callbackOnInit=()=>{this.getChoicesElement()?.addEventListener("click",this.onClickChoices),this.internals.labels[0]?.addEventListener("click",this.onClickChoices),this.getChoicesElement()?.addEventListener("showDropdown",()=>{let e=this.getChoicesElement()?.querySelector(".vl-select__list--dropdown");e&&!this.dropdownInitialised&&(e.setAttribute("role","group"),e.setAttribute("id","vl-select__list"),this.dropdownInitialised=!0),this.isDropdownOpen=!0}),this.getChoicesElement()?.addEventListener("hideDropdown",()=>{this.isDropdownOpen=!1}),this.setChoicesInputAttributes(),setTimeout(()=>{this.value||this.setValue(null),this.choices?.input?.element?.addEventListener("input",this.onSearchInput),this.installSearchWrapper()},0),this.initialised=!0},this.onClickChoices=()=>{this.disabled||this.choices?.showDropdown()},this.onSearchInput=e=>{let t=e?.target?.value;this.dispatchEvent(new CustomEvent("vl-select-search",{bubbles:!0,composed:!0,detail:{value:t}}))},this.submitFormOnEnter=!1}static get styles(){return[s.h8,s.BI,d.N,m,u,o.py,h]}static get properties(){return{initialOptions:{type:Array,attribute:"initial-options",hasChanged:this.compareValue},options:{type:Array,hasChanged:this.compareValue},placeholder:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},multiple:{type:Boolean},search:{type:Boolean},position:{type:String},resultLimit:{type:Number,attribute:"result-limit"},noResultsText:{type:String,attribute:"no-results-text"},noChoicesText:{type:String,attribute:"no-choices-text"},searchPlaceholder:{type:String,attribute:"search-placeholder"},searchStrategy:{type:String,attribute:"search-strategy"},value:{type:FormData,state:!0,hasChanged:this.compareValue}}}static{this.compareValue=(e,t)=>{let l=e instanceof FormData?[...e.entries()]:e,i=t instanceof FormData?[...t.entries()]:t;return l instanceof Array&&i instanceof Array?JSON.stringify(l)!==JSON.stringify(i):e!==t}}connectedCallback(){super.connectedCallback(),this.initialised&&(this.choices=new r.A(this.validationTarget,this.getChoicesConfig()),this.initialOptions=structuredClone(this.options))}firstUpdated(e){super.firstUpdated(e),this.choices=new r.A(this.validationTarget,this.getChoicesConfig()),this.initialOptions=structuredClone(this.options)}updated(e){if(super.updated(e),this.choices){if(e.has("options")&&(this.choices.initialised&&(this.choices.clearStore(),this.choices.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.options)),b.compareValue(this.value,e.has("value"))&&(this.value=this.collectFormData())),e.has("value")){let e={value:this.getSelected()};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{bubbles:!0,composed:!0,detail:e})),this.validity.valid&&this.dispatchEventIfValid(e)}e.has("disabled")&&(this.disabled?this.choices.disable():this.choices.enable()),e.has("error")&&this.internals.setValidity({customError:this.error},"custom-error"),e.has("resultLimit")&&(this.choices.config.searchResultLimit=this.resultLimit),e.has("searchStrategy")&&(this.searchMatcher=(0,_.NL)(this.searchStrategy))}}disconnectedCallback(){super.disconnectedCallback(),this.getChoicesElement()?.removeEventListener("click",this.onClickChoices),this.internals.labels[0]?.removeEventListener("click",this.onClickChoices),this.choices?.input?.element?.removeEventListener("input",this.onSearchInput),this.choices?.destroy()}render(){let e={"vl-select":!this.multiple,"vl-multiselect":this.multiple,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success};return(0,c.qy)`
            <select
                id=${this.id||c.s6}
                name=${this.name||c.s6}
                class=${(0,a.H)(e)}
                aria-label=${this.label||c.s6}
                aria-invalid=${this.isInvalid||c.s6}
            ...
            ></select>
        `}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){super.resetFormControl(),this.choices?.clearStore(),this.choices?.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.initialOptions),this.value=this.collectFormData()}setOptions(e){e&&e.length&&(this.options=structuredClone(e))}setSearchMatcher(e){this.searchMatcher=e}updateSelectedOptions(e){let t=e.filter(e=>e.selected).map(e=>e.value),l=e.filter(e=>!e.selected).map(e=>e.value);this.removeSelectionByValue(l),this.selectByValue(t)}setSelectedValues(e){this.removeAllSelections(),this.selectByValue(e)}getSelected(){return this.multiple?this.getSelectedValues():this.getSelectedValues()[0]||null}selectByValue(e){this.choices&&(this.choices.setChoiceByValue(e),this.setValue(this.collectFormData()))}removeSelectionByValue(e){this.choices&&(Array.isArray(e)?e.forEach(e=>this.choices.removeActiveItemsByValue(e)):this.choices.removeActiveItemsByValue(e),this.setValue(this.collectFormData()))}removeAllSelections(){this.choices&&(this.choices.removeActiveItems(),this.setValue(this.collectFormData()))}onKeydown(e){e.stopPropagation(),super.onKeydown(e)}setChoicesInputAttributes(){if(this.choices?.input?.element){let e=this.choices.input.element;e.setAttribute("type","text"),e.classList.add("vl-input-field","vl-input-field-cloned"),e.setAttribute("autocomplete","off"),e.setAttribute("autocapitalize","off"),e.setAttribute("spellcheck","false"),e.setAttribute("role","textbox"),e.setAttribute("aria-autocomplete","list"),e.setAttribute("aria-label","zoek item")}}getSelectedValues(){return Array.from(this.validationTarget.selectedOptions).filter(e=>e.value&&e.hasAttribute("selected")).map(e=>e.value)}collectFormData(){let e=this.name||this.id,t=this.getSelectedValues();return t?.length?t.reduce((t,l,i)=>(i?t.append(e,l):t.set(e,l),t),new FormData):null}getChoicesElement(){return this.shadowRoot?.querySelector(".js-vl-select")}getChoicesConfig(){return{callbackOnInit:this.callbackOnInit,shouldSort:!1,removeItemButton:!this.notDeletable,removeItems:!this.notDeletable,searchEnabled:this.search,placeholder:!!this.placeholder,placeholderValue:this.placeholder,position:this.position,noResultsText:this.noResultsText,searchResultLimit:this.resultLimit,noChoicesText:this.noChoicesText,shadowRoot:this.shadowRoot,searchPlaceholderValue:this.searchPlaceholder,classNames:{...r.A.defaults.allOptions.classNames,containerOuter:"js-vl-select",containerInner:"vl-select__inner",input:"vl-input-field",inputCloned:"vl-input-field-cloned",list:"vl-select__list",listItems:"vl-select__list--multiple",listSingle:"vl-select__list--single",listDropdown:["vl-select__list","vl-select__list--dropdown"],item:"vl-select__item",itemSelectable:"vl-select__item--selectable",itemDisabled:"vl-select__item--disabled",itemChoice:"vl-select__item--choice",placeholder:"vl-select__placeholder",group:"vl-select__group",groupHeading:"vl-select__heading",button:"vl-select__button"},callbackOnCreateTemplates:e=>({containerOuter:()=>e(`
                            <div
                            ...
                            ></div>
                            `),item:(t,l)=>{let i=!0===l.placeholder;return this.notDeletable?e(`
                        ...
                        `):e(`<div class="
                                ...
                                >
                                    ...
                                    <button type="button"
                                    ${i?"":'role="option"'}
                                     class="vl-pill__close ${this.multiple?"":"vl-vi vl-vi-close"}" data-button aria-label="verwijder ${l.label}">
                                        ${this.multiple?'<span class="vl-pill__close__icon vl-vi vl-vi-close" aria-hidden="true"></span>':""}
                                    </button>
                                </div>`)},itemList:()=>e(`<div class="vl-input-field ${this.multiple?"vl-select__list--multiple":""}" role="listbox"></div>`),choiceList:()=>e('<div class="vl-select__list" role="listbox" aria-label="item lijst" tabindex="0"></div>')})}}onChange(){this.value=this.collectFormData()}onInput(){this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:{value:this.getSelected()}}))}installSearchWrapper(){if(!this.choices)return;let e=Object.getPrototypeOf(this.choices)._searchChoices??this.choices._searchChoices;this.nativeSearchMethod=e.bind(this.choices),this.choices._searchChoices=e=>this.searchMatcher?this.searchMatcher(this.choices,e):this.nativeSearchMethod(e)}}b=function(e,t,l,i){var s,o=arguments.length,r=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,l):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,l,i);else for(var c=e.length-1;c>=0;c--)(s=e[c])&&(r=(o<3?s(r):o>3?s(t,l,r):s(t,l))||r);return o>3&&r&&Object.defineProperty(t,l,r),r}([(0,i.M1)("vl-select-rich-next")],b)},"../../libs/form/src/next/select-rich/vl-select-rich.defaults.ts":(e,t,l)=>{l.d(t,{X:()=>o});var i=l("../../libs/form/src/next/form-control/form-control.defaults.ts"),s=l("../../libs/form/src/next/select-rich/vl-select-rich.model.ts");let o={...i.i,initialOptions:[],options:[],placeholder:"",notDeletable:!1,multiple:!1,search:!1,position:s.u.AUTO,resultLimit:4,noResultsText:"Geen resultaten gevonden",noChoicesText:"Geen resterende opties gevonden",searchPlaceholder:"Zoek item",searchStrategy:s._.DEFAULT}},"../../libs/form/src/next/select-rich/vl-select-rich.model.ts":(e,t,l)=>{l.d(t,{_:()=>s,u:()=>i});let i={AUTO:"auto",TOP:"top",BOTTOM:"bottom"},s={DEFAULT:"default",EXACT_AND:"exact-and",EXACT_OR:"exact-or"}},"../../libs/form/src/next/select-rich/vl-select-rich.search-matchers.ts":(e,t,l)=>{l.d(t,{NL:()=>a});var i=l("../../libs/form/src/next/select-rich/vl-select-rich.model.ts");let s=e=>(t,l)=>{let i=l.trim().replace(/\s{2,}/g," ");if(!i.length||i===t._currentValue)return null;let s=t._searcher,o=t._store.choices.filter(e=>!e.placeholder);s.isEmptyIndex()&&s.index(o);let r=i.toLowerCase().split(/\s+/).filter(e=>e.length>0),c=o.filter(t=>{if(t.disabled)return!1;let l=t.label?.toLowerCase()||"",i=t.value?.toLowerCase()||"";return e(r,`${l} ${i}`)}).map((e,t)=>({item:e,score:0,rank:t+1}));t._currentValue=i,t._highlightPosition=0,t._isSearching=!0;let a=t._notice;return"addChoice"!==(a&&a.type)&&(c.length?t._clearNotice():t._displayNotice(t.config.noResultsText,"no-results")),t._store.dispatch({type:"FILTER_CHOICES",results:c}),c.length},o=s((e,t)=>e.every(e=>t.includes(e))),r=s((e,t)=>e.some(e=>t.includes(e))),c={[i._.EXACT_AND]:o,[i._.EXACT_OR]:r},a=e=>e===i._.DEFAULT?null:c[e]||null}}]);