 ...
 */class l extends n.WL{constructor(e){if(super(e),this.et=a.s6,e.type!==n.OA.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===a.s6||null==e)return this.vt=void 0,this.et=e;if(e===a.c0)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.vt;this.et=e;var t=[e];return t.raw=t,this.vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}l.directiveName="unsafeHTML",l.resultType=1;var s=(0,n.u$)(l)},"../../node_modules/lit/directives/unsafe-html.js":(e,t,i)=>{i.d(t,{_:()=>a._});var a=i("../../node_modules/lit-html/directives/unsafe-html.js")},"../../libs/components/src/next/properties/index.ts":(e,t,i)=>{i.d(t,{L:()=>a.L});var a=i("../../libs/components/src/next/properties/vl-properties.component.ts")},"../../libs/components/src/next/properties/vl-properties.component.ts":(e,t,i)=>{i.d(t,{L:()=>g});var a=i("../../libs/common/utilities/src/index.ts"),n=i("../../libs/elements/src/index.ts"),l=i("../../node_modules/lit/index.js");let s=(e,t)=>t?e.map(e=>e.cloneNode(!0)):e,o=(e,t)=>{let i=[],a=[],n=[];return e.forEach(e=>{switch(e.localName){case"label":a.length&&n.length&&(i.push({labels:a,data:n}),a=[],n=[]),a.push(e.children.length>0?s([...e.childNodes],t):e.innerHTML);break;case"data":n.push(e.children.length>0?s([...e.childNodes],t):e.innerHTML)}}),a.length&&i.push({labels:a,data:n}),i},r=(e,t)=>null==e||0==e.length?[]:e[0]?.localName==="div"?e.map(e=>({class:e.className,items:o([...e.children],t)})):[{items:o(e,t)}];var d=i("../../libs/common/utilities/src/css/index.ts");let c=e=>(0,l.AH)`
        width: calc(${e}% - 1rem);
    `,m=()=>(0,l.AH)`
        font-size: 1.6rem;
    `,p=()=>(0,l.AH)`
...
`;var b=i("../../libs/components/src/next/properties/vl-properties.defaults.ts");class g extends a.jW{static get styles(){return[n.hF,v]}static get properties(){return{props:{type:Array},aggregatedProps:{type:Array,state:!0},labelWidth:{type:Number,attribute:"label-width"},noClone:{type:Boolean,attribute:"no-clone"}}}set props(e){this.attributeProps=e,this.buildInternalProperties()}get props(){return this.attributeProps}connectedCallback(){super.connectedCallback(),this.buildInternalProperties(),this.observeLightPropertiesChange()}firstUpdated(e){super.firstUpdated(e),this.shadowRoot&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.labelWidthSheet,h.styleSheet])}updated(e){super.updated(e),e.has("labelWidth")&&this.labelWidth&&this.labelWidthSheet.replace(u(this.labelWidth).toString())}disconnectedCallback(){super.disconnectedCallback(),this.disconnectMutationObservers()}render(){return(0,l.qy)` <dl>${this.aggregatedProps.map(e=>this.renderColumn(e))}</dl> `}renderColumn(e){return e.class?(0,l.qy)` <div class="${e.class}">${e.items.map(e=>this.renderItem(e))}</div>`:(0,l.qy)` ${e.items.map(e=>this.renderItem(e))}`}renderItem(e){return(0,l.qy)` <div class="item">${this.renderLabels(e.labels)} ${this.renderData(e.data)}</div>`}renderLabels(e){return e.map(e=>(0,l.qy)` <dt>${e}</dt>`)}renderData(e){return e.map(e=>(0,l.qy)` <dd>${e}</dd>`)}buildInternalProperties(){this.aggregatedProps=[...this.attributeProps,...r([...this.children],!this.noClone)]}disconnectMutationObservers(){this.mutationObserverList.forEach(e=>e.disconnect()),this.mutationObserverList=[]}observeLightPropertiesChange(){this.disconnectMutationObservers(),this.mutationObserverList=[...this.mutationObserverList,(0,a.U_)(this,e=>{this.buildInternalProperties(),this.observeLightPropertiesChange()})],this.children.length>0&&"div"===this.children[0].localName&&[...this.children].forEach(e=>this.mutationObserverList=[...this.mutationObserverList,(0,a.U_)(e,e=>{this.buildInternalProperties()})])}constructor(...e){super(...e),this.attributeProps=b.g.props,this.aggregatedProps=b.g.props,this.labelWidth=b.g.labelWidth,this.labelWidthSheet=new CSSStyleSheet,this.noClone=!1,this.mutationObserverList=[]}}g=function(e,t,i,a){var n,l=arguments.length,s=l<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(s=(l<3?n(s):l>3?n(t,i,s):n(t,i))||s);return l>3&&s&&Object.defineProperty(t,i,s),s}([(0,a.M1)("vl-properties-next")],g)},"../../libs/components/src/next/properties/vl-properties.defaults.ts":(e,t,i)=>{i.d(t,{g:()=>a});let a={labelWidth:25,noClone:!1,props:[]}},"../../libs/components/src/next/title/index.ts":(e,t,i)=>{i.d(t,{I:()=>a.I});var a=i("../../libs/components/src/next/title/vl-title.component.ts")},"../../libs/components/src/next/title/vl-title.component.ts":(e,t,i)=>{i.d(t,{I:()=>d});var a=i("../../libs/common/utilities/src/index.ts");i("../../node_modules/@lit/reactive-element/reactive-element.js");var n=i("../../node_modules/lit-html/lit-html.js");i("../../node_modules/lit-element/lit-element.js");/**
 * @license
