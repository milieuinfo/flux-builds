...
`},"../../libs/form/src/next/radio-group/vl-radio.defaults.ts":(e,t,s)=>{s.d(t,{Q:()=>l});let l={id:"radio",name:"",value:null,label:"",block:!1,readonly:!1,disabled:!1,error:!1,success:!1,checked:!1}},"../../libs/form/src/next/select-rich/index.ts":(e,t,s)=>{s.d(t,{Al:()=>l.A});var l=s("../../libs/form/src/next/select-rich/vl-select-rich.component.ts");s("../../libs/form/src/next/select-rich/vl-select-rich.model.ts"),s("../../libs/form/src/next/select-rich/vl-select-rich.search-matchers.ts")},"../../libs/form/src/next/select/index.ts":(e,t,s)=>{s.d(t,{Y:()=>l.Y});var l=s("../../libs/form/src/next/select/vl-select.component.ts")},"../../libs/form/src/next/select/vl-select.component.ts":(e,t,s)=>{s.d(t,{Y:()=>p});var l=s("../../libs/common/utilities/src/index.ts"),i=s("../../node_modules/@domg/govflanders-style/common/index.js"),r=s("../../node_modules/@domg/govflanders-style/component/index.js"),o=s("../../node_modules/lit/index.js"),a=s("../../node_modules/lit/directives/class-map.js"),n=s("../../node_modules/lit/directives/live.js"),c=s("../../libs/form/src/next/form-control/form-control.ts");let d=(0,o.AH)`
    .vl-select {
        background-color: #fff;
        appearance: none;
