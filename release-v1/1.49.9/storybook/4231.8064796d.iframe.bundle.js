...
`;var r=i("../../node_modules/@domg/govflanders-style/common/index.js"),o=i("../../node_modules/@domg/govflanders-style/component/index.js"),d=i("../../node_modules/cleave.js/dist/cleave-esm.js"),u=i("../../node_modules/flatpickr/dist/esm/index.js"),p=i("../../node_modules/flatpickr/dist/l10n/nl.js"),c=i.n(p),h=i("../../node_modules/lit/directives/class-map.js"),m=i("../../node_modules/lit/directives/live.js"),v=i("../../libs/form/src/next/form-control/form-control.ts"),f=i("../../libs/form/src/next/input-field/vl-input-field.css.ts");let b=(t,e,i)=>{if(!t)return null;let a=null,n=t.split(/[dmyY]/).filter(t=>t),s=t.split(/[.*+-/_:]/);if(s.filter(t=>!["d","m","Y","y"].includes(t)).length)return null;let l=s.reduce((t,e)=>"Y"===e?t+4:t+2,0);if(a={date:!0,datePattern:s,delimiters:n,regex:RegExp(`^[0-9]{${l}}$`)},e){let i=u.A?.parseDate(e,t);a={...a,dateMin:i?u.A?.formatDate(i,"Y-M-D"):void 0}}if(i){let e=u.A?.parseDate(i,t);a={...a,dateMax:e?u.A?.formatDate(e,"Y-M-D"):void 0}}return a},g=t=>{if(!t)return null;let e=t.split(/[HhiS]/).filter(t=>t),i=!0,a=t.split(/[.*+-/_:]/).map(t=>{switch(t){case"H":return"h";case"h":return i=!1,"h";case"i":return"m";case"S":return"s";default:return t}});return a.filter(t=>!["h","m","s"].includes(t)).length?null:{time:!0,timePattern:a,timeFormat:i?"24":"12",delimiters:e,regex:RegExp(`^[0-9]{${2*a.length}}$`)}},y={key:"patternMismatch",message:"Value does not meet the given pattern.",isValid(t,e){let{disableMaskValidation:i,cleaveInstance:a,inputValue:n}=t,s=t.regex||t.pattern;if(!e||!s&&(!a||i))return!0;if(!(a&&!i&&t.maskOptions?.regex))return new RegExp(s).test(n);{let e=a.getRawValue();return new RegExp(t.maskOptions.regex).test(e)}}};var k=i("../../libs/form/src/next/datepicker/vl-datepicker.defaults.ts");let x=(0,s.AH)`
    :host {
        position: relative;
    }
