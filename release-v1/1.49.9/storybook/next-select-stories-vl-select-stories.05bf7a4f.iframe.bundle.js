"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[9369],{"../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs":(e,t,l)=>{l.d(t,{f:()=>b});var n=l("../../node_modules/react/index.js"),o=l("../../node_modules/react-dom/client.js"),r=new Map,s=({callback:e,children:t})=>{let l=(0,n.useRef)();return(0,n.useLayoutEffect)(()=>{l.current!==e&&(l.current=e,e())},[e]),t},a=async(e,t)=>{let l=await d(t);return new Promise(t=>{l.render(n.createElement(s,{callback:()=>t(null)},e))})},i=(e,t)=>{let l=r.get(e);l&&(l.unmount(),r.delete(e))},d=async e=>{let t=r.get(e);return t||(t=o.createRoot(e),r.set(e,t)),t},c=l("../../node_modules/@storybook/blocks/dist/index.mjs"),u={code:c.XA,a:c.zE,...c.Sw},p=class extends n.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e){let{showException:t}=this.props;t(e)}render(){let{hasError:e}=this.state,{children:t}=this.props;return e?null:n.createElement(n.Fragment,null,t)}},b=class{constructor(){this.render=async(e,t,o)=>{let r={...u,...t?.components},s=c.kQ;return new Promise((i,d)=>{l.e(814).then(l.bind(l,"../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/index.js")).then(({MDXProvider:l})=>a(n.createElement(p,{showException:d,key:Math.random()},n.createElement(l,{components:r},n.createElement(s,{context:e,docsParameter:t}))),o)).then(()=>i())})},this.unmount=e=>{i(e)}}}},"../../node_modules/@storybook/addon-docs/dist/index.mjs":(e,t,l)=>{l.d(t,{Hl:()=>n.Hl,W8:()=>n.W8,kL:()=>n.kL,ov:()=>n.ov}),l("../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var n=l("../../node_modules/@storybook/blocks/dist/index.mjs")},"../../libs/form/src/next/select/stories/vl-select.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{SelectDeclarativeOptions:()=>V,SelectDefault:()=>j,SelectDisabledOption:()=>$,SelectGroups:()=>f,SelectNotDeletable:()=>k,SelectReadOnly:()=>w,SelectSelectedOption:()=>y,__namedExportsOrder:()=>R,default:()=>g});var n=l("../../libs/common/storybook/src/index.ts"),o=l("../../libs/form/src/next/form-control/stories/form-control.stories-arg.ts"),r=l("../../libs/form/src/next/select/vl-select.defaults.ts"),s=l("../../node_modules/@storybook/addon-actions/dist/index.mjs");let a={...o.Z,...r.p,onVlChange:(0,s.XI)("vl-change"),onVlInput:(0,s.XI)("vl-input"),onVlValid:(0,s.XI)("vl-valid")},i={...o.x,block:{name:"block",description:"Duidt aan dat de component de volledige breedte van zijn parent mag innemen.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:a.block}}},placeholder:{name:"placeholder",description:"De placeholder tekst van het veld.",table:{type:{summary:n.QE.STRING},category:n.R6.ATTRIBUTES,defaultValue:{summary:a.placeholder}}},autocomplete:{name:"autocomplete",description:"De autocomplete van het veld. Dit moet een waarde zijn die door de browser ondersteund wordt.<br>Een lijst van waarden kan je vinden op [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete#values).",table:{type:{summary:n.QE.STRING},category:n.R6.ATTRIBUTES,defaultValue:{summary:a.autocomplete}}},notDeletable:{name:"not-deletable",description:"Duidt aan dat de selectie niet verwijderbaar is.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:a.notDeletable}}},initialOptions:{name:"initial-options",description:"De opties die geselecteerd worden bij reset van de form.<br>Zie de documentatie pagina voor meer info.",table:{type:{summary:"SelectOption"},category:n.R6.PROPERTIES,defaultValue:{summary:a.options}}},options:{name:"options",description:"De opties die geselecteerd kunnen worden.<br>Zie de documentatie pagina voor meer info.",table:{type:{summary:"SelectOption"},category:n.R6.PROPERTIES,defaultValue:{summary:a.options}}},onVlChange:{name:"vl-change",description:"Event dat afgevuurd wordt als er een optie selecteerd of verwijderd wordt (zowel programmatorisch als door een gebruiker).<br>Het detail object van het event bevat de waarde van de geselecteerde optie.",table:{type:{summary:"{ value: string }"},category:n.R6.EVENTS}},onVlInput:{name:"vl-input",description:"Event dat alleen afgevuurd wordt als de gebruiker een optie selecteert of verwijdert.<br>Het detail object van het event bevat de waarde van de geselecteerde optie.",table:{type:{summary:"{ value: string }"},category:n.R6.EVENTS}},onVlValid:{name:"vl-valid",description:"Event dat afgevuurd wordt als de select valid is.<br>Het detail object van het event bevat de waarde van de geselecteerde optie.",table:{type:{summary:"{ value: string }"},category:n.R6.EVENTS}}};var d=l("../../node_modules/lit/index.js");l("../../node_modules/react/index.js");var c=l("../../node_modules/react/jsx-runtime.js"),u=l("../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),p=l("../../node_modules/@storybook/addon-docs/dist/index.mjs"),b=l("../../libs/form/src/next/form-control/stories/form-control.public-methods-doc.mdx");function h(e){let t=Object.assign({h1:"h1",p:"p",code:"code",a:"a",h2:"h2",pre:"pre",h3:"h3",ol:"ol",li:"li",strong:"strong",ul:"ul"},(0,u.RP)(),e.components),{VluxMetaData:l}=t;return l||function(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("VluxMetaData",!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h1,{id:"select---next",children:"Select - next"}),"\n",(0,c.jsx)(l,{id:"form-next-select"}),"\n",(0,c.jsxs)(t.p,{children:["Gebruik de ",(0,c.jsx)(t.code,{children:"select-next"})," component om een select veld toe te voegen aan een pagina.",(0,c.jsx)("br",{}),"\nZie het ",(0,c.jsx)(t.a,{href:"/docs/ontwerp-form-demo--documentatie",children:"form demo"})," voorbeeld voor het gebruik binnen een form."]}),"\n",(0,c.jsx)(t.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:"language-js",children:"import { VlSelectComponent } from '@domg-wc/form/next/select';\n"})}),"\n",(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:"language-html",children:"<vl-select-next></vl-select-next>\n"})}),"\n",(0,c.jsx)(p.Hl,{of:j}),"\n",(0,c.jsxs)("details",{children:[(0,c.jsx)("summary",{children:"options"}),(0,c.jsx)(p.kL,{code:`
    [
    ...
    [
...
]`,language:"ts",dark:!0})]}),"\n",(0,c.jsx)(t.h3,{id:"declaratieve-opties",children:"Declaratieve opties"}),"\n",(0,c.jsxs)(t.p,{children:["In plaats van de ",(0,c.jsx)(t.code,{children:"options"})," property te gebruiken, kan je ook gebruik maken van standaard HTML ",(0,c.jsx)(t.code,{children:"<option>"})," elementen\nbinnen de ",(0,c.jsx)(t.code,{children:"<vl-select-next>"})," component."]}),"\n",(0,c.jsx)(p.Hl,{of:V}),"\n",(0,c.jsx)(t.p,{children:(0,c.jsx)(t.strong,{children:"Ondersteunde option attributen:"})}),"\n",(0,c.jsxs)(t.ul,{children:["\n",(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:"value"}),": De waarde van de optie"]}),"\n",(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:"selected"}),": Markeert de optie als geselecteerd"]}),"\n",(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:"disabled"}),": Schakelt de optie uit"]}),"\n"]}),"\n",(0,c.jsx)(t.h2,{id:"validatie",children:"Validatie"}),"\n",(0,c.jsxs)(t.p,{children:["Meer info over validatie binnen onze form componenten vind je hier: ",(0,c.jsx)(t.a,{href:"/docs/ontwerp-form-validation--documentatie",children:"Form - Validatie"})]}),"\n",(0,c.jsx)(t.h2,{id:"referenties",children:"Referenties"}),"\n",(0,c.jsx)(t.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),"\n",(0,c.jsx)(t.p,{children:(0,c.jsx)(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-select",target:"_blank",rel:"nofollow noopener noreferrer",children:"Documentatie Digitaal Vlaanderen - Select"})})]})}var m=l("../../libs/common/utilities/src/index.ts"),v=l("../../libs/form/src/next/select/vl-select.component.ts");(0,m.gy)([v.Y]);let g={id:"form-next-select",title:"Form-next/select",tags:["autodocs"],args:a,argTypes:i,parameters:{docs:{page:function(e={}){let{wrapper:t}=Object.assign({},(0,u.RP)(),e.components);return t?(0,c.jsx)(t,Object.assign({},e,{children:(0,c.jsx)(h,e)})):h(e)}}}},x=(0,n._7)(a,({id:e,name:t,label:l,required:n,disabled:o,error:r,success:s,options:a,placeholder:i,notDeletable:c,autocomplete:u,block:p,onVlChange:b,onVlInput:h,onVlValid:m,onVlReset:v})=>(0,d.qy)` <vl-select-next
            id=${e}
            name=${t}
            label=${l}
            ?required=${n}
        ...
        </vl-select-next>`).bind({});V.storyName="vl-select-next - declarative options",V.args={id:"woonplaats",name:"woonplaats",label:"Kies je woonplaats",placeholder:"Kies je woonplaats"},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...j.parameters?.docs?.source}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...k.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...f.parameters?.docs?.source}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...y.parameters?.docs?.source}}},$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...$.parameters?.docs?.source}}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:"story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  options,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            .options=${options}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        ></vl-select-next>`;\n})",...w.parameters?.docs?.source}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:'story(selectArgs, ({\n  id,\n  name,\n  label,\n  required,\n  disabled,\n  error,\n  success,\n  placeholder,\n  notDeletable,\n  autocomplete,\n  block,\n  onVlChange,\n  onVlInput,\n  onVlValid,\n  onVlReset\n}) => {\n  return html` <vl-select-next\n            id=${id}\n            name=${name}\n            label=${label}\n            ?required=${required}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?success=${success}\n            placeholder=${placeholder}\n            ?not-deletable=${notDeletable}\n            ?block=${block}\n            autocomplete=${autocomplete}\n            @vl-change=${onVlChange}\n            @vl-input=${onVlInput}\n            @vl-valid=${onVlValid}\n            @vl-reset=${onVlReset}\n        >\n            <option value="antwerpen">Antwerpen</option>\n            <option value="brussel" selected>Brussel</option>\n            <option value="gent">gent</option>\n            <option value="hasselt" disabled>Hasselt (niet beschikbaar)</option>\n            <option value="waregem">Waregem</option>\n            <option value="lier">Lier</option>\n            <option value="rio-piedras">Rio Piedras</option>\n        </vl-select-next>`;\n})',...V.parameters?.docs?.source}}};let R=["SelectDefault","SelectNotDeletable","SelectGroups","SelectSelectedOption","SelectDisabledOption","SelectReadOnly","SelectDeclarativeOptions"]},"../../libs/form/src/next/form-control/stories/form-control.public-methods-doc.mdx":(e,t,l)=>{l.d(t,{A:()=>s}),l("../../node_modules/react/index.js");var n=l("../../node_modules/react/jsx-runtime.js"),o=l("../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js");function r(e){let t=Object.assign({h3:"h3",p:"p",blockquote:"blockquote"},(0,o.RP)(),e.components);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h3,{id:"resetformcontrol",children:"resetFormControl()"}),"\n",(0,n.jsxs)(t.p,{children:["Reset de form control.",(0,n.jsx)("br",{}),"\nDe value van de control wordt teruggezet op de initiële value. Deze methode wordt ook aangeroepen als de form zelf\ngereset wordt."]}),"\n",(0,n.jsxs)(t.blockquote,{children:["\n",(0,n.jsx)(t.p,{children:"Opgelet: het is belangrijk de initiële waarde in te stellen op de form control vóór de form control gerenderd wordt.\nAnders wordt een lege value ingesteld als initiële waarde."}),"\n"]})]})}let s=function(e={}){let{wrapper:t}=Object.assign({},(0,o.RP)(),e.components);return t?(0,n.jsx)(t,Object.assign({},e,{children:(0,n.jsx)(r,e)})):r(e)}},"../../node_modules/react-dom/client.js":(e,t,l)=>{var n=l("../../node_modules/react-dom/index.js");t.createRoot=n.createRoot,t.hydrateRoot=n.hydrateRoot},"../../libs/form/src/next/form-control/stories/form-control.stories-arg.ts":(e,t,l)=>{l.d(t,{Z:()=>s,x:()=>a});var n=l("../../libs/common/storybook/src/index.ts"),o=l("../../libs/form/src/next/form-control/form-control.defaults.ts"),r=l("../../node_modules/@storybook/addon-actions/dist/index.mjs");let s={...n.D8,...o.i,onVlReset:(0,r.XI)("vl-reset")},a={...(0,n.RN)(!0),id:{name:"id",description:"Het id van het veld.",table:{type:{summary:n.QE.STRING},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.id}}},name:{name:"name",description:"De naam van het veld.",table:{type:{summary:n.QE.STRING},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.name}}},label:{name:"label",description:"Vult het aria-label attribuut van het veld in.<br/>Kan gebruikt worden als er geen bijhorend label element of vl-form-label component is.",table:{type:{summary:n.QE.STRING},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.label}}},required:{name:"required",description:"Duidt aan dat het veld verplicht is.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.required}}},disabled:{name:"disabled",description:"Beeldt de component in een disabled state af.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.disabled}}},error:{name:"error",description:"Beeldt de component in een error state af.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.error}}},success:{name:"success",description:"Beeldt de component in een success state af.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:s.success}}},onVlReset:{name:"vl-reset",description:"Event dat afgevuurd wordt wanneer het veld gereset wordt.",table:{category:n.R6.EVENTS}}}},"../../libs/form/src/next/select/vl-select.component.ts":(e,t,l)=>{l.d(t,{Y:()=>b});var n=l("../../libs/common/utilities/src/index.ts"),o=l("../../node_modules/@domg/govflanders-style/common/index.js"),r=l("../../node_modules/@domg/govflanders-style/component/index.js"),s=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),i=l("../../node_modules/lit/directives/live.js"),d=l("../../libs/form/src/next/form-control/form-control.ts");let c=(0,s.AH)`
    .vl-select {
...
`;var p=l("../../libs/form/src/next/select/vl-select.defaults.ts");class b extends d.M{static get styles(){return[o.h8,o.BI,c,r.py,u]}static get properties(){return{options:{type:Array,attribute:!1},initialOptions:{type:Array,attribute:"initial-options"},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String}}}get validationTarget(){return this.shadowRoot?.querySelector("select")}connectedCallback(){super.connectedCallback(),this.parseSlottedOptions();let e=this.getSelectedOption();this.value=e?.value||"",this.initialOptions=structuredClone(this.getAllOptions()),this.setupSlotObserver()}disconnectedCallback(){super.disconnectedCallback(),this.slotObserver?.disconnect()}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value||""}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:e})),this.dispatchInput=!1),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=!!this.value,n=this.getAllOptions().some(e=>e.group);return(0,s.qy)`
            <div class=${(0,a.H)(e)}>
                ...
                >
                    ...
                    ${n?this.renderGroupedOptions():this.renderSelectOptions(this.getAllOptions())}
                </select>
        ...
        `}renderGroupedOptions(){return Object.entries(this.getGroupedOptions()).map(([e,t])=>(0,s.qy)` <optgroup label=${e}>${this.renderSelectOptions(t)}</optgroup>`)}renderSelectOptions(e){return e.map(e=>(0,s.qy)` <option
            ...
            >
                ${e.label||e.value}
            </option>`)}resetFormControl(){super.resetFormControl(),this.options.length>0?this.options=structuredClone(this.initialOptions):this.parseSlottedOptions();let e=this.getSelectedOption();this.value=e?.value||""}onChange(e){this.value=e?.target?.value}onSelect(){this.dispatchInput=!0}clearValue(){this.dispatchInput=!0,this.value=""}onSlotChange(){this.parseSlottedOptions(),this.requestUpdate()}getSelectedOption(){return[...this.getAllOptions()].reverse().find(e=>e.selected)}getGroupedOptions(){return this.getAllOptions().reduce((e,t)=>{let l=t.group||this.DEFAULT_GROUP_LABEL;return e[l]?e[l].push(t):e[l]=[t],e},{})}setupSlotObserver(){this.slotObserver=new MutationObserver(()=>{this.parseSlottedOptions(),this.requestUpdate()}),this.slotObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","label","selected","disabled"]})}parseSlottedOptions(){let e=Array.from(this.children);this.parsedOptions=e.reduce((e,t)=>{if("option"===t.tagName.toLowerCase())e.push(this.parseOptionElement(t));else if("optgroup"===t.tagName.toLowerCase()){let l=t.label||this.DEFAULT_GROUP_LABEL,n=Array.from(t.querySelectorAll("option")).map(e=>{let t=this.parseOptionElement(e);return t.group=l,t});e.push(...n)}return e},[])}parseOptionElement(e){return{value:e.value||e.textContent?.trim()||"",label:e.textContent?.trim()||e.value||"",selected:e.selected,disabled:e.disabled}}getAllOptions(){return this.options.length>0?this.options:this.parsedOptions}constructor(...e){super(...e),this.options=p.p.options,this.initialOptions=p.p.initialOptions,this.value="",this.block=p.p.block,this.placeholder=p.p.placeholder,this.autocomplete=p.p.autocomplete,this.notDeletable=p.p.notDeletable,this.DEFAULT_GROUP_LABEL="Overig",this.dispatchInput=!1,this.parsedOptions=[]}}b=function(e,t,l,n){var o,r=arguments.length,s=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,l):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,n);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(r<3?o(s):r>3?o(t,l,s):o(t,l))||s);return r>3&&s&&Object.defineProperty(t,l,s),s}([(0,n.M1)("vl-select-next")],b)},"../../libs/form/src/next/select/vl-select.defaults.ts":(e,t,l)=>{l.d(t,{p:()=>n});let n={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,options:[],initialOptions:[],block:!1,placeholder:"",autocomplete:"",notDeletable:!1}}}]);