...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-doormat",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Doormat"})})]})}function H(r={}){const{wrapper:t}={...f(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(u,{...r})}):u(r)}function N(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}M([R]);const I={id:"components-block-doormat",title:"Components - Block/doormat",tags:["autodocs"],args:a,argTypes:k,parameters:{docs:{page:H}}},c=B(a,({href:r,external:t,alt:d,imageSrc:x,imageAlt:S,imageHeight:y,imageWidth:v,graphic:b,textSlot:$,titleSlot:T})=>E`
  ...
  titleSlot
        ...
        \`)`,...m.parameters?.docs?.source}}};const O=["DoormatDefault","DoormatAlt","DoormatImage","DoormatGraphic"];export{s as DoormatAlt,n as DoormatDefault,m as DoormatGraphic,l as DoormatImage,O as __namedExportsOrder,I as default};
