...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-info-tile.html",rel:"nofollow",children:"Legacy Demo - Info Tile"})})]})}function ee(s={}){const{wrapper:n}={...D(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(A,{...s})}):A(s)}function ne(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const ie={id:"components-block-info-tile",title:"Components - Block/info-tile",tags:["autodocs"],args:l,argTypes:Q,parameters:{docs:{page:ee}}},o=q({...l,classes:""},({autoOpen:s,toggleable:n,center:H,clickable:x,clickableLabel:O,contentSlot:w,subtitleSlot:V,titleSlot:C,footerSlot:E,menuSlot:N,badgeSlot:U,size:R,icon:_,iconAsBadge:F,type:G,fullHeight:W=!1,classes:Z="",onVlClickInfoTile:Y})=>j`
        <vl-info-tile
            ?auto-open=${s}
            ?center=${H}
            ?icon-as-badge=${F}
