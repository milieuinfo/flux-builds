...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-link",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Link"})})]})}function z(r={}){const{wrapper:n}={...$(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(x,{...r})}):x(r)}function H(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}M([R]);const W={id:"components-atom-link",title:"Components - Atom/link",tags:["autodocs"],args:l,argTypes:G,parameters:{docs:{page:z}}},o=N(l,({href:r,bold:n,small:g,large:v,error:j,external:y,buttonAsLink:S,icon:L,iconPlacement:A,defaultSlot:T,label:w})=>D`
            <vl-link
                href=${r}
                ?bold=${n}
                ?small=${g}
