import{u as t,j as e,M as o,C as r,b5 as l,b6 as g,b7 as c,b8 as h,b9 as v,ba as m,x as b,bb as p}from"./iframe-iHJvAyUB.js";import"./preload-helper-D9Z9MdNV.js";function s(i){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...t(),...i.components},{FluxComponentMetaData:d}=n;return d||x("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Components - Atom/heading-style"}),`
`,e.jsx(n.h1,{id:"heading-style",children:"Heading Style"}),`
`,e.jsx(d,{id:"components-atom-heading-style"}),`
...
`,e.jsx(r,{of:a})]})}function H(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function x(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const y={id:"components-atom-heading-style",title:"Components - Atom/heading-style (intern)",tags:["autodocs"],parameters:{docs:{page:H}}},a=({})=>b`
    <style>
        .sb-heading-1 {
            ${l}
        }
...
`;a.storyName="heading-style - default";a.parameters=p;a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`({}) => html\`
    <style>
        .sb-heading-1 {
            \${vlHeading1}
        }
    ...
    <div class="sb-heading-5">Heading van grootte 5</div>
    <div class="sb-heading-6">Heading van grootte 6</div>
\``,...a.parameters?.docs?.source}}};const f=["HeadingStyleDefault"];export{a as HeadingStyleDefault,f as __namedExportsOrder,y as default};
