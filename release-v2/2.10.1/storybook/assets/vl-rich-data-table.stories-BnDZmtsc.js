...
`,a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data-table.html",rel:"nofollow",children:"Legacy Demo - Rich Data Table"})]})]})}function oe(t={}){const{wrapper:e}={...E(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(M,{...t})}):M(t)}function de(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}A([q,O,F,L,H,J,W,G,K]);const Be={id:"components-block-rich-data-table",title:"Components - Block/rich-data-table",tags:["autodocs"],args:p,argTypes:ae,parameters:{docs:{page:oe}}},ce=D(p,({collapsedM:t,collapsedS:e,collapsedXS:d,zebra:s,fluxZebra:r})=>T`
        <vl-rich-data-table
  ...
  return html\`
    ...
    \`;
})`,...k.parameters?.docs?.source}}};const Ce=["RichDataTableDefault","RichDataTableSorting","RichDataTableFilter","RichDataTableFilterAndPagination","RichDataTableSelectable"];export{b as RichDataTableDefault,v as RichDataTableFilter,N as RichDataTableFilterAndPagination,k as RichDataTableSelectable,g as RichDataTableSorting,Ce as __namedExportsOrder,Be as default};
