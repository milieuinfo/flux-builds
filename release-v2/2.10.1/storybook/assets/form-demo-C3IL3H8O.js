...
`;function t(o){const l={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...r(),...o.components},{FluxAlert:n}=l;return n||c("FluxAlert"),e.jsxs(e.Fragment,{children:[e.jsx(a,{of:m}),`
...
`,e.jsxs("details",{open:!0,children:[e.jsx("summary",{children:"Code"}),e.jsx(i,{code:v,language:"ts",dark:!0})]})]})}function y(o={}){const{wrapper:l}={...r(),...o.components};return l?e.jsx(l,{...o,children:e.jsx(t,{...o})}):t(o)}function c(o,l){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
