...
\`;
`;function g(e){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...p(),...e.components},{FluxComponentMetaData:d}=n;return d||G("FluxComponentMetaData"),l.jsxs(l.Fragment,{children:[l.jsx(h,{title:"Styles/Layout (afnemers)/grid"}),`
...
`})}),`
`,l.jsx(m,{of:i})]})}function D(e={}){const{wrapper:n}={...p(),...e.components};return n?l.jsx(n,{...e,children:l.jsx(g,{...e})}):g(e)}function G(e,n){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}const _=f`
    .vl-grid {
...
`;b([j,y,k]);const P={id:"styles-layout-grid",title:"Styles/Layout (afnemers)/grid",tags:["autodocs"],parameters:{docs:{page:D}}},c=()=>r`
    <style>
