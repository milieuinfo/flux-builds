import{x as i,u,j as e,C as s,S as n,bh as d,s as y}from"./iframe-iHJvAyUB.js";import"./vl-map-base-layer-Ds3vxb_U.js";import"./vl-map-base-layer-grb-gray-CGABEvMh.js";import"./vl-map-layer-circle-style-D2Cy4zz2.js";import"./vl-map-features-layer-922S3FZt.js";import"./vl-map-select-actions-BoHnlSce.js";import{m as f,a as c}from"./vl-map-select-actions.stories-arg-urOgEv6-.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-CSngL2Zd.js";import"./select-action-1FZKXXYz.js";import"./vl-map-layer-action-DwQtFJbn.js";import"./vl-map-select-action-BGaWXPUG.js";import"./vl-map-select-action.stories-arg-DkdqLHKD.js";import"./vl-map-action.stories-arg-Cdh564ny.js";const v={type:"FeatureCollection",features:[{type:"Feature",id:1,geometry:{type:"Point",coordinates:[146055,196908]}}]},g={type:"FeatureCollection",features:[{type:"Feature",id:2,geometry:{type:"Point",coordinates:[149055,199908]}},{type:"Feature",id:3,geometry:{type:"Point",coordinates:[152055,202908]}}]},b=["layer-1","layer-2"],h=(a,t)=>i`
    <vl-map lambert2008>
...
`,j={type:"FeatureCollection",features:[{type:"Feature",id:1,geometry:{type:"Point",coordinates:[146055,196908]}}]},x={type:"FeatureCollection",features:[{type:"Feature",id:2,geometry:{type:"Point",coordinates:[149055,199908]}},{type:"Feature",id:3,geometry:{type:"Point",coordinates:[152055,202908]}}]},S=["layer-1","layer-2"],$=(a,t)=>i`
    <vl-map lambert2008>
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
        <vl-map-features-layer .features=${j} name="layer-1" projection-code="EPSG:31370">
            <vl-map-layer-circle-style border-color="#000000"></vl-map-layer-circle-style>
        </vl-map-features-layer>
        <vl-map-features-layer .features=${x} name="layer-2" projection-code="EPSG:31370">
...
`,e.jsx(s,{of:o}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"Toon code"}),e.jsx(n,{code:M,language:"ts",dark:!0})]})]})}function G(a={}){const{wrapper:t}={...u(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(m,{...a})}):m(a)}function D(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const J={id:"map-action-layer-action-select-action-select-actions",title:"map/action/layer-action/select-action/select-actions",tags:["autodocs"],args:c,argTypes:f,parameters:{docs:{page:G}}},r=y(c,({active:a,defaultActive:t})=>C(a,t));r.storyName="vl-map-select-actions - default";r.args={active:!0};const l=y(c,({active:a,defaultActive:t})=>$(a,t));l.storyName="vl-map-select-actions - custom style";l.args={active:!0};const o=y(c,({active:a,defaultActive:t})=>h(a,t));o.storyName="vl-map-select-actions - clustering";o.args={active:!0};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(mapSelectActionsArgs, ({
  active,
  defaultActive
}) => {
