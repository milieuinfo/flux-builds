...
`,e.jsx(r.p,{children:e.jsx(r.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-http-error-message--default",rel:"nofollow",children:"Legacy Storybook - Http Error Message"})})]})}function _(s={}){const{wrapper:r}={...j(),...s.components};return r?e.jsx(r,{...s,children:e.jsx(N,{...s})}):N(s)}function q(s,r){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}B([O]);const W={id:"components-block-http-error-message",title:"Components - Block/http-error-message",tags:["autodocs"],args:a,argTypes:U,parameters:{docs:{page:_}}},t=V(a,({title:s,image:r,alt:b,errorCode:R,textSlot:k,actionsSlot:D})=>P`
        <vl-http-error-message title=${s} image=${r} image-alt=${b} error-code=${R}>
            ${H(k)} ${H(D)}
