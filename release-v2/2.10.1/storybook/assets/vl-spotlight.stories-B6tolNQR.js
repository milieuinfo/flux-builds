import{R as s,U as n,Z as f,Y as $,O as N,be as c,P as A,s as b,x as e,r as I,bf as O}from"./iframe-iHJvAyUB.js";import"./preload-helper-D9Z9MdNV.js";const t={...A,link:"",external:!1,alt:!1,noBorder:!1,size:c.S,imgSrc:"",imgAlt:"",title:"",subtitle:"",text:"",content:""},E={...N,link:{name:"link",description:"De component wordt een link. Door te klikken op de component wordt de gebruiker doorgestuurd naar de link die gezet is in dit attribuut.",table:{type:{summary:n.STRING},defaultValue:{summary:t.link},category:s.ATTRIBUTES}},external:{name:"external",description:"Opent de link in een nieuw tabblad. Dit attribuut wordt enkel gebruikt als het attribuut `link` gezet is.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.external)},category:s.ATTRIBUTES}},alt:{name:"alt",description:"Geeft de component een alternatieve stijl. De achtergrond wordt grijs.",table:{type:{summary:n.BOOLEAN},defaultValue:{summary:String(t.alt)},category:s.ATTRIBUTES}},noBorder:{name:"no-border",description:"Geeft de component weer zonder border.",table:{type:{summary:n.BOOLEAN},defaultValue:{summary:String(t.noBorder)},category:s.ATTRIBUTES}},size:{name:"size",description:"Dit attribuut bepaalt de grootte van de component.",type:{name:n.STRING,required:!1},control:{type:$.SELECT},options:Object.values(c),table:{type:{summary:f(Object.values(c))},category:s.ATTRIBUTES,defaultValue:{summary:String(t.size)}}},imgSrc:{name:"img-src",description:"Het path van de image dat getoond moet worden in de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.imgSrc)},category:s.ATTRIBUTES}},imgAlt:{name:"img-alt",description:"De alternatieve tekst van de image dat getoond moet worden in de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.imgAlt)},category:s.ATTRIBUTES}},title:{name:"title",description:"Titel van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.title)},category:s.SLOTS}},subtitle:{name:"subtitle",description:"Subtitle van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.subtitle)},category:s.SLOTS}},text:{name:"text",description:"Text van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.text)},category:s.SLOTS}},content:{name:"content",description:"Content van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.content)},category:s.SLOTS}}};I([O]);const G={id:"components-block-spotlight",title:"Components - Block/spotlight",tags:["autodocs"],args:t,argTypes:E},R=b(t,({link:o,alt:S,size:y,imgSrc:T,imgAlt:k,title:u,subtitle:v,text:d,content:h,external:w,noBorder:x})=>e`
        <vl-spotlight
            link=${o}
            ?alt=${S}
            ?no-border=${x}
    ...
    `),l=R.bind({});l.storyName="vl-spotlight - default";l.args={title:"Premies voor renovatie"};const a=b(t,({external:o})=>e`
    ...
    `);a.storyName="vl-spotlight - with link";a.parameters={controls:{include:["external"]}};const r=()=>e`
    <vl-spotlight>
...
`;m.storyName="vl-spotlight - with subtitle";l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:'story(spotlightArgs, ({\n  link,\n  alt,\n  size,\n  imgSrc,\n  imgAlt,\n  title,\n  subtitle,\n  text,\n  content,\n  external,\n  noBorder\n}: typeof spotlightArgs) => html`\n        <vl-spotlight\n            link=${link}\n            ?alt=${alt}\n            ?no-border=${noBorder}\n            ?external=${external}\n            size=${size}\n            img-src=${imgSrc}\n            img-alt=${imgAlt}\n        >\n            ${title ? html`<span slot="title"> ${title} </span>` : ``}\n            ${subtitle ? html`<span slot="subtitle"> ${subtitle} </span>` : ``}\n            ${text ? html`<span slot="text"> ${text} </span>` : ``}\n            ${content ? html`<span slot="content"> ${content} </span>` : ``}\n        </vl-spotlight>\n    `)',...l.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`story(spotlightArgs, ({
  external
}: typeof spotlightArgs) => html\`
    ...
    \`)`,...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => html\`
    <vl-spotlight>
        <span slot="title"> Premies voor renovatie </span>
    </vl-spotlight>
