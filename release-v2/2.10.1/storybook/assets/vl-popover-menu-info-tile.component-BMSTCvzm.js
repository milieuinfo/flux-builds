import{r as c,bC as p,h as v,aV as s,x as d,H as u,bD as x,E as h,K as f,bE as w}from"./iframe-iHJvAyUB.js";var _=Object.getOwnPropertyDescriptor,q=(i,n,r,a)=>{for(var o=a>1?void 0:a?_(n,r):n,e=i.length-1,l;e>=0;e--)(l=i[e])&&(o=l(o)||o);return o};let m=class extends s{render(){return d`
            <div>
                <vl-button
                    ghost
        ...
        `}createRenderRoot(){return this}};c([p,v]);m=q([u("vl-popover-menu")],m);var k=Object.getOwnPropertyDescriptor,A=(i,n,r,a)=>{for(var o=a>1?void 0:a?k(n,r):n,e=i.length-1,l;e>=0;e--)(l=i[e])&&(o=l(o)||o);return o};const V=`
...
`;let b=class extends s{static get styles(){const i=h`
        ...
        `;return[f,i]}render(){return d`
            <div class="panel">
                <vl-accordion toggle-text="Stedelijk woongebied" custom-css=${V} heading-level="2">
                    <span class="laaginfo">
        ...
        `}createRenderRoot(){return this}};c([x,p,v]);b=A([u("vl-popover-menu-accordion")],b);var j=Object.getOwnPropertyDescriptor,$=(i,n,r,a)=>{for(var o=a>1?void 0:a?j(n,r):n,e=i.length-1,l;e>=0;e--)(l=i[e])&&(o=l(o)||o);return o};let g=class extends s{static get styles(){return[f,h``]}render(){return d`
