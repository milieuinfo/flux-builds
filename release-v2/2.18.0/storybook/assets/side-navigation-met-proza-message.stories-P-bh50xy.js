import{O as t,P as i,x as s,r as o,Q as n}from"./iframe-COmpMQdF.js";import"./vl-side-navigation.component-CBOSry5K.js";import{V as l}from"./vl-side-navigation-layout.component-BpuzxATb.js";import"./vl-tabs.component-DrlJllZ6.js";const r={title:"Patronen/Navigatie/Side Navigation/met proza message",parameters:{layout:"fullscreen",docs:{story:{inline:!1,iframeHeight:860}}}};o([l,t,i,n]);const a="side-navigation-layout-proza-message",u=s`
...
`,m=()=>{t.__setPreloadedMessagesCacheForDomain(a,Promise.resolve({"page-title":"Side Navigation - met Proza Message","section-1-title":"Ontwerpprincipes","section-1-sub-1":"Consistente headings","section-1-sub-2":"Scanbare content","section-1-sub-3":"Toegankelijkheid","section-2-title":"Implementatie","section-2-sub-1":"Preloaden van berichten","section-2-sub-2":"Vullen van titels","section-2-sub-3":"Validatie","section-3-title":"Resultaat","section-3-sub-1":"Wat je in de side navigation ziet","section-3-sub-2":"Samenvatting"})),i.__setToegelatenOperatiesCacheForDomain(a,Promise.resolve({update:!1}))},e=()=>(m(),u);e.storyName="side-navigation - met proza message";e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  preloadProzaMessages();
  return sideNavigationLayoutWithProzaMessageHTML;
}`,...e.parameters?.docs?.source}}};const p=["SideNavigationMetProzaMessage"],z=Object.freeze(Object.defineProperty({__proto__:null,SideNavigationMetProzaMessage:e,__namedExportsOrder:p,default:r},Symbol.toStringTag,{value:"Module"}));export{e as S,z as s};
