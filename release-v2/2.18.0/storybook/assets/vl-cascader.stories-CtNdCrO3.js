import{Z as i,_ as s,cV as B,X as V,bS as b,W as P,u as S,j as e,C as h,b8 as C,S as g,x as v,T as j,s as k,r as M,bt as $,bH as L}from"./iframe-COmpMQdF.js";import{o as x}from"./unsafe-html-DkF6qbYn.js";import"./preload-helper-D9Z9MdNV.js";const{action:N}=__STORYBOOK_MODULE_ACTIONS__,r={...V,...B,homeSlot:"",headerSlot:"",onVlClickBreadcrumb:N("vl-click-breadcrumb")},A={...P,headerText:{name:"header-text",description:"Hiermee kan je de tekst instellen voor de header.",table:{type:{summary:s.STRING},category:i.ATTRIBUTES,defaultValue:{summary:r.headerText}}},headerSlot:{name:b.HEADER,description:"Hiermee kan je de standaard header vervangen door een header naar keuze.",table:{type:{summary:s.HTML},category:i.SLOTS,defaultValue:{summary:r.headerSlot}}},breadcrumbPlaceholder:{name:b.BREADCRUMB_PLACEHOLDER,description:"Hiermee kan je een breadcrumb placeholder instellen. Zichtbaar wanneer breadcrumb niet zichtbaar is.",table:{type:{summary:s.HTML},category:i.SLOTS,defaultValue:{summary:r.breadcrumbPlaceholder}}},level:{name:"level",description:`Huidige niveau in de hiërarchie.

Dit attribuut kan je aanpassen om terug te gaan naar een lager niveau.`,table:{type:{summary:s.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(r.level)}}},homeSlot:{name:b.HOME,description:"Hiermee kan je het `"+b.HOME+"`-slot instellen.",table:{type:{summary:s.HTML},category:i.SLOTS,defaultValue:{summary:r.homeSlot}}},hideBreadcrumb:{name:"hide-breadcrumb",description:"Verbergt breadcrumb navigatie.",table:{type:{summary:s.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.hideBreadcrumb)}}},loading:{name:"loading",description:"Geeft weer dat data wordt geladen. Is reactief.",table:{type:{summary:s.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.loading)}}},itemListFn:{name:"itemListFn",description:"Laat toe om een promise mee te geven wanneer dynamisch data moet opgehaald. Dit werkt enkel in combinatie met de `nodes`-property waarbij `requestParams` ingesteld staan.\n\nKan niet aangepast worden in Storybook. \n\n Raadpleeg de [documentatie](?path=/docs/components-cascader--cascader-default#cascader-met-dynamisch-ophalen-van-kind-elementen) voor meer info.",control:!1,table:{disable:!0,type:{summary:s.FUNCTION},category:i.PROPERTIES,defaultValue:{summary:String(r.itemListFn)}}},items:{name:"nodes",description:`Om de data-structuur van de cascader programmatorisch in te stellen.

 Raadpleeg [documentatie](?path=/docs/components-cascader--cascader-property-binding#cascader-met-property-binding) voor meer info.`,table:{disable:!0,type:{summary:s.ARRAY},category:i.PROPERTIES,defaultValue:{summary:String(r.items)}}},loadingMessage:{name:"loading-message",description:"De boodschap die getoond wordt wanneer items aan het laden zijn.",table:{type:{summary:s.STRING},category:i.ATTRIBUTES,defaultValue:{summary:r.loadingMessage}}},templates:{name:"templates",description:`Laat toe om alternatieve templates voor de cascader-items in te stellen.

Kan niet aangepast worden in Storybook.

 Raadpleeg de documentatie voor meer informatie.`,control:!1,table:{disable:!0,type:{summary:s.MAP},category:i.PROPERTIES,defaultValue:{summary:String(r.templates)}}},onVlClickBreadcrumb:{name:"vl-click-breadcrumb",description:"Event dat afgevuurd wordt als op een breadcrumb item wordt geklikt.<br>Het detail object van het event bevat het gekozen niveau en het label van de breadcrumb.",table:{type:{summary:"{ index: number, label?: string }"},category:i.EVENTS}}},I=`import { TemplateFn } from '../vl-cascader.model';
...
`,G=`import { CascaderItem } from '../vl-cascader.model';
...
`,O=`import { ItemListFn, CascaderItem } from '../vl-cascader.model';
...
`;function D(n){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...S(),...n.components},{FluxAlert:t,FluxComponentMetaData:l}=a;return t||f("FluxAlert"),l||f("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"cascader",children:"Cascader"}),`
`,e.jsx(l,{id:"components-block-cascader-cascader"}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld CascaderItem-array opzet"}),e.jsx(g,{code:G,language:"ts",dark:!0,format:!0})]}),`
`,e.jsx(h,{of:c}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld itemListFn opzet"}),e.jsx(g,{code:O,language:"ts",dark:!0,format:!0})]}),`
...
`,e.jsx(h,{of:m}),`
`,e.jsx(a.h2,{id:"gekende-beperkingen",children:"Gekende beperkingen"}),`
`,e.jsx(a.p,{children:`De cascader zal het huidige niveau van de meegegeven boomstructuur in zijn eigen shadow DOM renderen.
Dit heeft als gevolg dat eigen CSS en klasses, die toegepast zijn op die boomstructuur, niet door de shadow DOM
zullen penetreren.`}),`
`,e.jsxs(a.p,{children:[`Om dit op te lossen, dien je Custom CSS toe te voegen (die dan wel zal werken op de styles binnen de shadow DOM van
de cascader). `,e.jsx(a.a,{href:"/docs/recepten-css-styling--documentatie#custom-css",children:"Hier vind je meer uitleg over Custom CSS toevoegen"})]}),`
`,e.jsx(a.h2,{id:"toegankelijkheid",children:"Toegankelijkheid"}),`
`,e.jsx(t,{type:"info",children:"\n  Plaats deze component binnen een `<main>`, `<section>`, `<article>` of `<aside>`, zodat\n  de interne `<header>` geen impliciete banner-role krijgt. De banner-role is voorbehouden voor\n  de globale `<vl-header>` en moet uniek zijn per pagina.\n"}),`
`,e.jsx(a.h2,{id:"referenties",children:"Referenties"}),`
`,e.jsx(a.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),`
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/vue-documentation/?path=/story/components-vl-sidebar--sidebar-advanced",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - vl-sidebar-advanced"})})]})}function R(n={}){const{wrapper:a}={...S(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(D,{...n})}):D(n)}function f(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const H=[{label:"Vlaanderen",children:[{label:"Antwerpen",templateType:"provincie",children:[{label:"Niveau 2 - A",children:[{label:"Niveau 3 - A",children:[{label:"Niveau 4 - A"},{label:"Niveau 4 - B"}]},{label:"Niveau 3 - B"}]},{label:"Niveau 2 - B"},{label:"Berchem"}]},{label:"Brussel",templateType:"provincie",narrowDown:!0,data:{requestParams:"Niveau-id"}},{label:"Limburg",templateType:"provincie",children:[{label:"Hasselt"},{label:"Zonhoven"},{label:"Lummen"},{label:"Halen"},{label:"Tongeren"}]},{label:"Vlaams-Brabant",templateType:"provincie",narrowDown:!0,data:{requestParams:"Niveau-id"}}]},{label:"Wallonië"}],E=async n=>{const{data:a}=n,t=a?.requestParams;return await new Promise(l=>setTimeout(l,3e3)),[{label:t+" "+new Date().getHours(),children:[{label:t+" "+new Date().getMinutes(),children:[{label:t+" "+new Date().getMilliseconds(),narrowDown:!0,data:{requestParams:"Niveau-deeper"}},{label:"[- "+t+" -]",templateType:"provincie"}]},{label:t+" "+new Date().getMinutes()}]},{label:t+" "+new Date().getMinutes(),children:[{label:t+" "+new Date().getMilliseconds(),narrowDown:!0,data:{requestParams:"Niveau-deeper"}},{label:"[- "+t+" -]",templateType:"provincie"}]},{label:t+" "+new Date().getMinutes()}]},T=new Map([["provincie",(n,a)=>{const t=n.children||n.narrowDown,l=v`Bekijk deelgemeentes
            ${n.children?.length?v` <vl-text annotation>( ${n.children.length} )</vl-text> `:"Bekijk deelgemeentes "}`;return v`
                <div class="vl-cascader-item">
                    ...
                    <vl-link
                        bold
                        button-as-link
                        icon="${t?"arrow-right-fat":j}"
                        icon-placement="after"
                        class="vl-cascader-link"
                        @click=${()=>a(n)}
                    >
                        <span>
                            ${n.children?l:n.narrowDown?"Haal deelgemeentes op":"Actie"}
                        </span>
                    </vl-link>
                </div>
            `}]]),F={id:"components-block-cascader-cascader",title:"Components - Block/cascader/cascader",tags:["autodocs"],args:r,argTypes:A,parameters:{docs:{page:R}}};M([$,L]);const w=n=>v` <div style="width: 600px;margin: auto auto;">${n()}</div>`,o=k(r,({level:n,loadingMessage:a,loading:t,hideBreadcrumb:l,headerSlot:p,headerText:u,onVlClickBreadcrumb:y})=>v`
            <vl-cascader
                level="${n}"
                hide-breadcrumb="${l}"
                loading="${t}"
        ...
        `);o.storyName="vl-cascader - default";o.decorators=[w];o.parameters={controls:{exclude:["content","label","labelSlot"]}};const m=k(r,({breadcrumbPlaceholder:n,level:a,loadingMessage:t,loading:l,hideBreadcrumb:p,homeSlot:u,onVlClickBreadcrumb:y})=>v`
            <vl-side-sheet
                left
        ...
        `);m.storyName="vl-cascader - side-sheet";m.args={breadcrumbPlaceholder:'<vl-autocomplete placeholder="Zoek..." slot="breadcrumb-placeholder"></vl-autocomplete>'};m.parameters={controls:{exclude:["content","label","labelSlot"]}};const d=k(r,({level:n,loadingMessage:a,loading:t,hideBreadcrumb:l,templates:p,onVlClickBreadcrumb:u})=>v`
            <vl-cascader
                level="${n}"
                hide-breadcrumb="${l}"
                loading="${t}"
        ...
        `);d.storyName="vl-cascader - dynamic templating";d.decorators=[w];d.argTypes={templates:{table:{disable:!1}}};d.args={templates:T};d.parameters={controls:{exclude:["content","label","labelSlot"]}};const c=k(r,({items:n})=>v`
        <vl-cascader .items=${n} .itemListFn=${E} .templates=${T}></vl-cascader>
    `);c.storyName="vl-cascader - property binding";c.decorators=[w];c.parameters={controls:{include:["itemListFn","items","templates"]}};c.argTypes={itemListFn:{table:{disable:!1}},items:{table:{disable:!1}},templates:{table:{disable:!1}}};c.args={items:H};c.parameters={controls:{exclude:["content","label","labelSlot"]}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(cascaderArgs, ({
  level,
  loadingMessage,
  loading,
  hideBreadcrumb,
  ...
  return html\`
        ...
        \`;
})`,...m.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story(cascaderArgs, ({
  level,
  loadingMessage,
  loading,
  hideBreadcrumb,
  ...
  return html\`
        ...
        \`;
})`,...d.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`story(cascaderArgs, ({
  items
}) => {
  return html\`
        <vl-cascader .items=\${items} .itemListFn=\${getItemList} .templates=\${cascaderItemTemplates}></vl-cascader>
    \`;
})`,...c.parameters?.docs?.source}}};const Z=["CascaderDefault","CascaderSideSheet","CascaderDynamicTemplating","CascaderPropertyBinding"];export{o as CascaderDefault,d as CascaderDynamicTemplating,c as CascaderPropertyBinding,m as CascaderSideSheet,Z as __namedExportsOrder,F as default};
