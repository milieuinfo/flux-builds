import{bx as h,i as p,$ as b,br as g,bs as m,aV as O,F as u,T as r,ch as f,x as a,w as S}from"./iframe-COmpMQdF.js";const C=`:host {
...
`,i={...b,options:[],initialOptions:[],block:!1,placeholder:"",autocomplete:"",notDeletable:!1};var _=Object.getOwnPropertyDescriptor,$=(e,t,l,s)=>{for(var o=s>1?void 0:s?_(t,l):t,n=e.length-1,c;n>=0;n--)(c=e[n])&&(o=c(o)||o);return o};let v=class extends g{constructor(){super(...arguments),this.options=i.options,this.initialOptions=i.initialOptions,this.value="",this.block=i.block,this.placeholder=i.placeholder,this.autocomplete=i.autocomplete,this.notDeletable=i.notDeletable,this.DEFAULT_GROUP_LABEL="Overig",this.dispatchInput=!1,this.parsedOptions=[]}static get styles(){return[m,O,y]}static get properties(){return{options:{type:Array,attribute:!1},initialOptions:{type:Array,attribute:"initial-options"},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String}}}get validationTarget(){return this.shadowRoot?.querySelector("select")}connectedCallback(){super.connectedCallback(),this.parseSlottedOptions();const e=this.getSelectedOption();this.value=e?.value||"",this.initialOptions=structuredClone(this.getAllOptions()),this.setupSlotObserver()}disconnectedCallback(){super.disconnectedCallback(),this.slotObserver?.disconnect()}updated(e){if(super.updated(e),e.has("options")){const t=this.getSelectedOption();this.value=t?.value||""}if(e.has("value")){const t={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:t})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:t})),this.dispatchInput=!1),this.dispatchEventIfValid(t)}}render(){const e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=!!this.value,s=this.getAllOptions().some(o=>o.group);return a`
            <div class=${u(e)}>
                ...
                >
                    ...
                    ${s?this.renderGroupedOptions():this.renderSelectOptions(this.getAllOptions())}
                </select>
        ...
        `}renderGroupedOptions(){const e=this.getGroupedOptions();return Object.entries(e).map(([t,l])=>a` <optgroup label=${t}>${this.renderSelectOptions(l)}</optgroup>`)}renderSelectOptions(e){return e.map(t=>a` <option
            ...
            >
                ${t.label||t.value}
            </option>`)}resetFormControl(){super.resetFormControl(),this.options.length>0?this.options=structuredClone(this.initialOptions):this.parseSlottedOptions();const e=this.getSelectedOption();this.value=e?.value||""}onChange(e){this.value=e?.target?.value}onSelect(){this.dispatchInput=!0}clearValue(){this.dispatchInput=!0,this.value=""}onSlotChange(){this.parseSlottedOptions(),this.syncValueWithOptions(),this.requestUpdate()}syncValueWithOptions(){this.getAllOptions().length>0&&(this.value=this.getSelectedOption()?.value||"")}getSelectedOption(){return[...this.getAllOptions()].reverse().find(e=>e.selected)}getGroupedOptions(){return this.getAllOptions().reduce((t,l)=>{const s=l.group||this.DEFAULT_GROUP_LABEL;return t[s]?t[s].push(l):t[s]=[l],t},{})}setupSlotObserver(){this.slotObserver=new MutationObserver(e=>{e.some(l=>l.type==="childList"||l.target!==this)&&(this.parseSlottedOptions(),this.syncValueWithOptions(),this.requestUpdate())}),this.slotObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","label","selected","disabled"]})}parseSlottedOptions(){const e=Array.from(this.children);this.parsedOptions=e.reduce((t,l)=>{if(l.tagName.toLowerCase()==="option")t.push(this.parseOptionElement(l));else if(l.tagName.toLowerCase()==="optgroup"){const s=l.label||this.DEFAULT_GROUP_LABEL,n=Array.from(l.querySelectorAll("option")).map(c=>{const d=this.parseOptionElement(c);return d.group=s,d});t.push(...n)}return t},[])}parseOptionElement(e){return{value:e.value||e.textContent?.trim()||"",label:e.textContent?.trim()||e.value||"",selected:e.selected,disabled:e.disabled}}getAllOptions(){return this.options.length>0?this.options:this.parsedOptions}};v=$([S("vl-select")],v);export{v as V,i as s};
