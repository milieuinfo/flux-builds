import{Z as u,_ as d,W as h,X as v,u as p,j as e,C as n,b8 as m,x as i,r as y,c4 as x,c5 as g,c6 as k}from"./iframe-BgD7f6Cn.js";import"./preload-helper-D9Z9MdNV.js";const c={...v,defaultSlot:""},V={...h,defaultSlot:{name:"[default]",description:"De inhoud van het zoekresultaat",table:{type:{summary:d.HTML},category:u.SLOTS,defaultValue:{summary:c.defaultSlot}}}};function o(t){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...t.components},{FluxComponentMetaData:s}=r;return s||j("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"search-result",children:"Search Result"}),`
...
`,e.jsx(n,{of:a})]})}function b(t={}){const{wrapper:r}={...p(),...t.components};return r?e.jsx(r,{...t,children:e.jsx(o,{...t})}):o(t)}function j(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const R={id:"components-block-search-result",title:"Components - Block/search-result",tags:["autodocs"],args:c,argTypes:V,parameters:{docs:{page:b}}};y([x,g,k]);const l=()=>i`
    <vl-search-result>
...
`;l.storyName="vl-search-result - default";const a=()=>i`
...
`;a.storyName="vl-search-result - group";l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`() => html\`
    <vl-search-result>
        <vl-search-result-title>
            <a href="#">Vlaanderenkiest.be</a>
        </vl-search-result-title>
...
\``,...l.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => html\`
    <div class="vl-group vl-group--column vl-group--stretch-children vl-group--no-gap">
        <vl-search-result>
            <vl-search-result-title>
                <a href="#">Vlaanderenkiest.be</a>
...
\``,...a.parameters?.docs?.source}}};const C=["SearchResultDefault","SearchResultGroup"];export{l as SearchResultDefault,a as SearchResultGroup,C as __namedExportsOrder,R as default};
