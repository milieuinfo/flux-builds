import{u as v,j as e,M as p,C as b,S as m,x as c,i as u,b6 as i}from"./iframe-BgD7f6Cn.js";import"./preload-helper-D9Z9MdNV.js";const h=""+new URL("section-overlap-BFjLB5_G.png",import.meta.url).href;function d(n){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",...v(),...n.components},{FluxComponentMetaData:a}=s;return a||x("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"Styles/Layout (afnemers)/section"}),`
`,e.jsx(s.h1,{id:"section",children:"Section"}),`
`,e.jsx(a,{id:"styles-layout-section"}),`
`,e.jsx(s.h2,{id:"doel",children:"Doel"}),`
`,e.jsxs(s.p,{children:["De ",e.jsx(s.code,{children:"vl-section"})," verdeelt de toepassing in delen en zorgt voor consistente witruimte."]}),`
...
krijgt. Om minder (dan de standaard) witruimte te krijgen zijn er de optionele classes `,e.jsx(s.code,{children:"vl-section--small"}),`
...
`,e.jsx("br",{}),`
`,e.jsx("br",{}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"section overlap - code"}),e.jsx(m,{code:o.toString(),language:"html",dark:!0,format:!0})]})]})}function g(n={}){const{wrapper:s}={...v(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(d,{...n})}):d(n)}function x(n,s){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const f={id:"styles-layout-section",title:"Styles/Layout (afnemers)/section",tags:["autodocs"],parameters:{docs:{page:g}}},r=u`
    .vl-section {
        p {
            display: flex;
