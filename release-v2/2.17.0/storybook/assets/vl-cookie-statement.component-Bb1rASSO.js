import{n as h,x as D,i as A,r as b,Y as y,Q as v,w as s,f as w,v as f,cF as j,cG as V,cH as z,bH as G,aY as x,bs as E,A as P,z as I,D as M,cO as $}from"./iframe-BgD7f6Cn.js";import"./vl-side-navigation.component-BNTw7VxO.js";import{V as H}from"./vl-side-navigation-layout.component-DpDANmP8.js";const T=()=>[h],L=()=>D`
...
`;var B=Object.getOwnPropertyDescriptor,F=(t,o,r,i)=>{for(var e=i>1?void 0:i?B(o,r):o,n=t.length-1,a;n>=0;n--)(a=t[n])&&(e=a(e)||e);return e};let l=class extends w{constructor({title:t,name:o,purpose:r,domain:i,processor:e,validity:n}={}){const a="<div></div>",S=[...f.map(d=>d.styleSheet),O.styleSheet];super(a,S);const C=()=>{const d=o||this.getAttribute("name");return Array.isArray(d)?`
                    <vl-typography>
                        <ul>
        ...
        `,o=[E.styleSheet,...f.map(i=>i.styleSheet),O.styleSheet,P.styleSheet,I.styleSheet,M.styleSheet];super(t,o);const r=this.shadowRoot?.querySelector('slot[name="header"]');r&&$(L(),r),this.allowCustomCSS=!1,this._element.insertAdjacentHTML("afterend",`
