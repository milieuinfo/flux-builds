import{u as t,j as e,M as d}from"./iframe-BgD7f6Cn.js";import"./preload-helper-D9Z9MdNV.js";function o(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Planning/Aanpak v2, v3, ..."}),`
...
`,e.jsxs(n.p,{children:["Componenten zoals de DV ",e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/button",rel:"nofollow",children:"vl-ui-button"}),`
moeten als een uitbreiding op een native button geïmplementeerd worden. De Flux web-component moet dus extenden van
HTMLButtonElement. De reden is dat de scss van DV enkel werkt op een `,e.jsx(n.code,{children:"button"}),` tag, een custom component maken met als
