import{u as l,j as e,M as u,C as a,bc as m,x as d,bd as x,b6 as c}from"./iframe-BgD7f6Cn.js";import"./preload-helper-D9Z9MdNV.js";function r(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",...l(),...i.components},{FluxComponentMetaData:o}=n;return o||p("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Styles/Base (intern)/mixin"}),`
...
\``,...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`({}) => html\` <style>
    ...
    <div class="sb-focus-outline">outline bij focus</div>\``,...s.parameters?.docs?.source}}};const g=["WaveAnimationMixinDefault","FocusOutlineMixinDefault"];export{s as FocusOutlineMixinDefault,t as WaveAnimationMixinDefault,g as __namedExportsOrder,j as default};
