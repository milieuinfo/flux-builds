...
<vl-functional-header
    ...
    hide-back-link
    custom-css=".vl-functional-header__sub-actions, .vl-functional-header__sub__action { width: 100% } ::slotted(.vl-group) { width: 100% } ${a?"":":host .vl-content-block { min-width: 900px}"}"
>
...
`,s=e("<vl-button>Actie knop</vl-button>"),u=e(`<form role="search" aria-label="Zoeken op deze site">
    ...
    </form>`),l=e("<vl-button>Actie knop</vl-button>",!0),n=e(`<form role="search" aria-label="Zoeken op deze site">
        <div class="vl-group vl-group--input-group">
            <vl-input-field input-group block type="search" name="zoekterm" label="Zoekterm"></vl-input-field>
            <vl-button input-group icon="search" type="submit" label="Zoeken" tertiary></vl-button>
        </div>
    </form>`,!0),t=(i=!1)=>` <vl-functional-header
        title="School- en studietoelagen"
        custom-css="${`
                ...
                ${i?"":":host .vl-content-block { min-width: 900px}"}
            `}"
    >
        <vl-tabs-next
            slot="sub-title"
    ...
    </vl-functional-header>`,r=t(),o=t(!0),c=` <vl-functional-header
        title="School- en studietoelagen"
    >
...
`;export{s as a,n as b,u as c,o as d,r as e,l as f,c as g,m as h};
