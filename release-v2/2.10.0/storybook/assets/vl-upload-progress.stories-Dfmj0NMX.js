...
`})})]})}function C(o={}){const{wrapper:r}={...b(),...o.components};return r?e.jsx(r,{...o,children:e.jsx(y,{...o})}):y(o)}function I(o,r){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}k([N]);const _={id:"components-block-upload-progress",title:"Components - Block/upload-progress",tags:["autodocs"],args:h,argTypes:z,parameters:{docs:{page:C}}},u=A(h,({filename:o,filesize:r,progress:g,indeterminate:v,label:$,cancellable:P,retryable:j,error:x,success:T,message:U,hideProgress:E,onVlUploadProgressRetry:V,onVlUploadProgressCancel:D})=>R`
        <vl-upload-progress
            filename=${c(o)}
            filesize=${c(r)}
            progress=${c(g)}
