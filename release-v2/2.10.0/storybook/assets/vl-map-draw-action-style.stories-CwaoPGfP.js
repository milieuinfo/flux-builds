...
`,r.jsx(v,{of:c})]})}function h(a={}){const{wrapper:e}={...d(),...a.components};return e?r.jsx(e,{...a,children:r.jsx(i,{...a})}):i(a)}function w(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const I={id:"map-action-draw-action-draw-action-style",title:"map/action/draw-action/draw-action-style",tags:["autodocs"],args:o,argTypes:f,parameters:{docs:{page:h}}},c=S(o,({color:a,borderColor:e,borderSize:n,circleColor:s,circleBorderColor:m,circleBorderSize:p,circleSize:y})=>T`
        <vl-map lambert2008>
