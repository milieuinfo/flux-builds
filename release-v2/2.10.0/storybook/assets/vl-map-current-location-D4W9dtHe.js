import{E as l,K as p,I as u,B as d,aZ as m,bB as g,x as b}from"./iframe-FlvNZLqI.js";import{ag as n}from"./vl-map-base-layer-CnkWBJRC.js";const f=10,h="Huidige locatie",v=l`
...
`,x=[v,...p];var y=Object.getOwnPropertyDescriptor,_=(o,e,i,r)=>{for(var t=r>1?void 0:r?y(e,i):e,a=o.length-1,s;a>=0;a--)(s=o[a])&&(t=s(t)||t);return t};let c=class extends d{constructor(){super(),this.zoom=f,this.tooltip=h}static get styles(){return[l`
                ${g(x)}
        ...
        </div>`}};c=_([u("vl-map-current-location")],c);export{h as D,f as a};
