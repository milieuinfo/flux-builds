import{R as r,U as m,P as k,O as f,u as q,j as i,bh as j,C as c,s as p,x as u,r as L,b0 as U,bJ as y,h as w,ch as S}from"./iframe-FlvNZLqI.js";import{t as v}from"./vl-side-navigation.component-Daoa2h3U.js";import"./preload-helper-D9Z9MdNV.js";const C=Object.freeze(Object.defineProperty({__proto__:null,get SideNavigationCompact(){return d},get SideNavigationDefault(){return a},get SideNavigationWithCustomToc(){return l},get __namedExportsOrder(){return z},get default(){return $}},Symbol.toStringTag,{value:"Module"})),T={closed:!1,compact:!1,headingRootSelector:"",maxDepth:void 0,navigationTitle:"Op deze pagina"},o={...k,...T,defaultSlot:""},D={...f,closed:{name:"closed",description:"Wanneer aanwezig wordt de inhoudstafel standaard verborgen. Heeft enkel effect wanneer het attribuut `compact` is gezet of bij mobiele weergave (viewport < 768px). Op desktop zonder compact wordt de navigatie altijd getoond.",table:{type:{summary:m.BOOLEAN},category:r.ATTRIBUTES,defaultValue:{summary:String(o.closed)}}},compact:{name:"compact",description:"Forceert de compacte weergave (toggle knop, verborgen navigatie standaard) ongeacht de viewport grootte.",table:{type:{summary:m.BOOLEAN},category:r.ATTRIBUTES,defaultValue:{summary:String(o.compact)}}},headingRootSelector:{name:"heading-root-selector",description:'CSS selector om het root container element te vinden waarbinnen naar headings gezocht wordt. Indien niet opgegeven, wordt het volledige document/shadow root doorzocht. Voorbeeld: "#section-1" om enkel headings binnen die sectie te scannen.',table:{type:{summary:m.STRING},category:r.ATTRIBUTES,defaultValue:{summary:o.headingRootSelector}}},maxDepth:{name:"max-depth",description:"Optionele maximum diepte voor shadow DOM traversal (bij scannen van headings én bij zoeken van scroll-target). Biedt fijnmazige controle over performantie vs compatibiliteit. 0 = enkel light DOM, 1 = light DOM + eerste niveau shadow DOM, undefined = onbeperkt (standaard).",table:{type:{summary:m.NUMBER},category:r.ATTRIBUTES,defaultValue:{summary:o.maxDepth!==void 0?String(o.maxDepth):"undefined"}}},navigationTitle:{name:"navigation-title",description:"Tekst die getoond wordt als titel boven de inhoudstafel.",table:{type:{summary:m.STRING},category:r.ATTRIBUTES,defaultValue:{summary:o.navigationTitle}}},defaultSlot:{name:"[default]",description:'Custom inhoudsopgave. Wanneer je hier content plaatst (bijv. een ul/li-structuur met vl-link elementen met href="#..."), wordt die gebruikt in plaats van de automatisch gegenereerde inhoudsopgave. De links moeten verwijzen naar heading-ids in de content.',table:{type:{summary:m.HTML},category:r.SLOTS,defaultValue:{summary:String(o.defaultSlot)}}}};function g(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...q(),...t.components},{FluxAlert:n,FluxComponentMetaData:s}=e;return n||h("FluxAlert"),s||h("FluxComponentMetaData"),i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"side-navigation-next",children:"Side Navigation Next"}),`
`,i.jsx(s,{id:"components-block-next-side-navigation-next"}),`
...
`,i.jsxs("details",{children:[i.jsx("summary",{children:"Compact (navigatie standaard gesloten)"}),i.jsxs(e.p,{children:["Met het attribuut ",i.jsx(e.code,{children:"compact"})," wordt de compacte weergave geforceerd: de navigatie staat standaard gesloten en kan via de toggle knop worden opengeklapt."]}),i.jsx(c,{of:d,inline:!1})]}),`
...
`]}),`
`,i.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function N(t={}){const{wrapper:e}={...q(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(g,{...t})}):g(t)}function h(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const $={id:"components-block-next-side-navigation-next",title:"Components - Block/next/side-navigation-next",tags:["autodocs"],args:o,argTypes:D,parameters:{docs:{page:N,story:{inline:!1,iframeHeight:500}}}};L([U,y,w,S]);const x=u`
...
`,a=p(o,({closed:t,compact:e,headingRootSelector:n,maxDepth:s,navigationTitle:b})=>u`
        ...
        `);a.storyName="vl-side-navigation-next - default";a.args={headingRootSelector:"#story-content-container"};const d=p(o,({closed:t,headingRootSelector:e,maxDepth:n,navigationTitle:s})=>u`
            <div class="vl-grid vl-content-block">
                <vl-side-navigation-next
        ...
        `);d.storyName="vl-side-navigation-next - compact";d.args={compact:!0,headingRootSelector:"#story-content-container"};const l=p(o,({closed:t,compact:e,maxDepth:n})=>u`
        <div class="vl-grid vl-content-block">
            <vl-side-navigation-next
                class="vl-column vl-column--3 vl-column--start-10 vl-column--m-3  vl-column--s-12  vl-side-navigation--order-1"
                ?closed=${t}
    ...
    `);l.storyName="vl-side-navigation-next - custom table of contents";a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`story(sideNavigationArgs, ({
  closed,
  compact,
  headingRootSelector,
  maxDepth,
  ...
  return html\`
        ...
        \`;
})`,...a.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story(sideNavigationArgs, ({
  closed,
  headingRootSelector,
  maxDepth,
  navigationTitle
  ...
  return html\`
        ...
        \`;
})`,...d.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`story(sideNavigationArgs, ({
  closed,
  compact,
  maxDepth
}) => {
  return html\`
    ...
    \`;
})`,...l.parameters?.docs?.source}}};const z=["SideNavigationDefault","SideNavigationCompact","SideNavigationWithCustomToc"];export{d as SideNavigationCompact,a as SideNavigationDefault,l as SideNavigationWithCustomToc,z as __namedExportsOrder,$ as default};
