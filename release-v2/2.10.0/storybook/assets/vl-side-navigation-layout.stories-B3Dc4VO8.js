import{R as l,U as r,P as k,O as f,u as x,j as n,bh as j,C as m,s as g,x as v,r as $,b0 as S,ch as w,bJ as q,h as I}from"./iframe-FlvNZLqI.js";import"./vl-side-navigation-layout.component-CNRZTDKB.js";import{t as h}from"./vl-side-navigation.component-Daoa2h3U.js";import"./preload-helper-D9Z9MdNV.js";const P=Object.freeze(Object.defineProperty({__proto__:null,get SideNavigationLayoutDefault(){return c},get SideNavigationLayoutTwoLayouts(){return d},get SideNavigationLayoutWithCustomToc(){return u},get SideNavigationLayoutWithSteps(){return s},get __namedExportsOrder(){return O},get default(){return D}},Symbol.toStringTag,{value:"Module"})),T={compact:!1,headingRootSelector:"",contentBlock:!1,maxDepth:void 0,navigationTitle:"",excludeSelectors:""},a={...k,...T,contentSlot:"",navigationSlot:""},L={...f,compact:{name:"compact",description:"Forceert de compacte weergave (toggle knop, verborgen navigatie standaard) ongeacht de viewport grootte.",table:{type:{summary:r.BOOLEAN},category:l.ATTRIBUTES,defaultValue:{summary:String(a.compact)}}},headingRootSelector:{name:"heading-root-selector",description:'CSS selector om het root container element te vinden waarbinnen naar headings gezocht wordt. Indien niet opgegeven, wordt het volledige document/shadow root doorzocht. Voorbeeld: "#section-1" om enkel headings binnen die sectie te scannen.',table:{type:{summary:r.STRING},category:l.ATTRIBUTES,defaultValue:{summary:a.headingRootSelector}}},contentBlock:{name:"content-block",description:"Past de vl-content-block class toe op de layout container voor correcte spacing.",table:{type:{summary:r.BOOLEAN},category:l.ATTRIBUTES,defaultValue:{summary:String(a.contentBlock)}}},maxDepth:{name:"max-depth",description:"Optionele maximum diepte voor shadow DOM traversal (bij scannen van headings én bij zoeken van scroll-target). Biedt fijnmazige controle over performantie vs compatibiliteit. 0 = enkel light DOM, 1 = light DOM + eerste niveau shadow DOM, undefined = onbeperkt (standaard).",table:{type:{summary:r.NUMBER},category:l.ATTRIBUTES,defaultValue:{summary:a.maxDepth!==void 0?String(a.maxDepth):"undefined"}}},navigationTitle:{name:"navigation-title",description:"Tekst die getoond wordt als titel boven de inhoudstafel in de side navigation. Wordt doorgegeven aan vl-side-navigation-next.",table:{type:{summary:r.STRING},category:l.ATTRIBUTES,defaultValue:{summary:a.navigationTitle}}},excludeSelectors:{name:"exclude-selectors",description:'Comma-separated CSS selectors van elementen om uit te sluiten tijdens het scannen van headings. Wordt doorgegeven aan vl-side-navigation-next. Voorbeeld: "iframe, table.large-data, .skip-headings".',table:{type:{summary:r.STRING},category:l.ATTRIBUTES,defaultValue:{summary:a.excludeSelectors}}},contentSlot:{name:"content",description:"De hoofdinhoud van de pagina. Plaats hier het element (bijv. een div) met de secties en headings waarop de inhoudsopgave gebaseerd wordt. Moet een element zijn dat overeenkomt met heading-root-selector of een kind daarvan bevat.",table:{type:{summary:r.HTML},category:l.SLOTS,defaultValue:{summary:String(a.contentSlot)}}},navigationSlot:{name:"navigation",description:"Optioneel. Custom navigatie-component. Dit slot verwacht de [vl-side-navigation-next](/docs/components-next-side-navigation-side-navigation--documentatie). Indien niet gezet, wordt automatisch een `vl-side-navigation-next` gegenereerd op basis van de headings in de content slot.",table:{type:{summary:r.HTML},category:l.SLOTS,defaultValue:{summary:String(a.navigationSlot)}}}};function y(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...x(),...i.components},{FluxAlert:o,FluxComponentMetaData:p}=e;return o||b("FluxAlert"),p||b("FluxComponentMetaData"),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"side-navigation-layout",children:"Side Navigation Layout"}),`
`,n.jsx(p,{id:"components-block-next-side-navigation-layout"}),`
...
`})}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-html",children:`<vl-side-navigation-layout>
    <div slot="content">
...
`]}),`
`,n.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function C(i={}){const{wrapper:e}={...x(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(y,{...i})}):y(i)}function b(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const D={id:"components-block-next-side-navigation-layout",title:"Components - Block/next/side-navigation-layout",tags:["autodocs"],args:a,argTypes:L,parameters:{docs:{page:C,story:{inline:!1,iframeHeight:500}}}};$([S,w,q,I]);const t=v`
    <vl-paragraph>
...
`,c=g(a,({compact:i,contentBlock:e,navigationTitle:o,excludeSelectors:p})=>v`
            <vl-side-navigation-layout
                ?compact=${i}
                ?content-block=${e}
        ...
        `);c.storyName="vl-side-navigation-layout - default";const s=g(a,({compact:i,contentBlock:e,maxDepth:o,excludeSelectors:p})=>v`
            <vl-side-navigation-layout
                ?compact=${i}
                ?content-block=${e}
                max-depth=${o}
        ...
        `);s.storyName="vl-side-navigation-layout - met steps";s.parameters={docs:{story:{inline:!1,iframeHeight:800}}};const d=g(a,({compact:i,contentBlock:e,excludeSelectors:o})=>v`
            <vl-side-navigation-layout
                ?compact=${i}
                ?content-block=${e}
        ...
        `);d.storyName="vl-side-navigation-layout - twee layouts met eigen content";d.parameters={docs:{story:{inline:!1,iframeHeight:900}}};const u=g(a,({compact:i,contentBlock:e,excludeSelectors:o})=>v`
            <vl-side-navigation-layout
                ?compact=${i}
                ?content-block=${e}
        ...
        `);u.storyName="vl-side-navigation-layout - custom table of contents";c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  navigationTitle,
  excludeSelectors
  ...
  return html\`
        ...
        \`;
})`,...c.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  maxDepth,
  excludeSelectors
  ...
  return html\`
        ...
        \`;
})`,...s.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  excludeSelectors
}) => {
  return html\`
        ...
        \`;
})`,...d.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  excludeSelectors
}) => {
  return html\`
        ...
        \`;
})`,...u.parameters?.docs?.source}}};const O=["SideNavigationLayoutDefault","SideNavigationLayoutWithSteps","SideNavigationLayoutTwoLayouts","SideNavigationLayoutWithCustomToc"];export{c as SideNavigationLayoutDefault,d as SideNavigationLayoutTwoLayouts,u as SideNavigationLayoutWithCustomToc,s as SideNavigationLayoutWithSteps,O as __namedExportsOrder,D as default};
