...
`;var u=s("../../libs/components/src/form/select/vl-select.defaults.ts");class p extends c.M{static get styles(){return[i.h8,i.BI,d,r.py,h]}static get properties(){return{options:{type:Array},initialOptions:{type:Array,attribute:"initial-options"},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String}}}get validationTarget(){return this.shadowRoot?.querySelector("select")}connectedCallback(){super.connectedCallback();let e=this.getSelectedOption();this.value=e?.value||"",this.initialOptions=structuredClone(this.options)}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value||""}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:e})),this.dispatchInput=!1),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},s=!!this.value,o=this.options.some(e=>e.group);return(0,l.qy)`
        ...
        `}renderGroupedOptions(){return Object.entries(this.getGroupedOptions()).map(([e,t])=>(0,l.qy)` <optgroup label=${e}>${this.renderSelectOptions(t)}</optgroup>`)}renderSelectOptions(e){return e.map(e=>(0,l.qy)` <option
            ...
            >
                ${e.label||e.value}
            </option>`)}resetFormControl(){super.resetFormControl(),this.options=structuredClone(this.initialOptions);let e=this.getSelectedOption();this.value=e?.value||""}onChange(e){this.value=e?.target?.value}onSelect(){this.dispatchInput=!0}clearValue(){this.dispatchInput=!0,this.value=""}getSelectedOption(){return[...this.options].reverse().find(e=>e.selected)}getGroupedOptions(){return this.options.reduce((e,t)=>{let s=t.group||this.DEFAULT_GROUP_LABEL;return e[s]?e[s].push(t):e[s]=[t],e},{})}constructor(...e){super(...e),this.options=u.p.options,this.initialOptions=u.p.initialOptions,this.value="",this.block=u.p.block,this.placeholder=u.p.placeholder,this.autocomplete=u.p.autocomplete,this.notDeletable=u.p.notDeletable,this.DEFAULT_GROUP_LABEL="Overig",this.dispatchInput=!1}}p=function(e,t,s,o){var i,r=arguments.length,l=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,s):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,s,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(l=(r<3?i(l):r>3?i(t,s,l):i(t,s))||l);return r>3&&l&&Object.defineProperty(t,s,l),l}([(0,o.M1)("vl-select")],p)},"../../libs/components/src/form/select/vl-select.defaults.ts":(e,t,s)=>{s.d(t,{p:()=>o});let o={...s("../../libs/components/src/form/form-control/form-control.defaults.ts").i,options:[],initialOptions:[],block:!1,placeholder:"",autocomplete:"",notDeletable:!1}},"../../libs/components/src/form/textarea-rich/vl-textarea-rich.component.ts":(e,t,s)=>{s.d(t,{I:()=>d});var o=s("../../libs/common/src/index.ts"),i=s("../../node_modules/tinymce/tinymce.js"),r=s.n(i),l=s("../../libs/components/src/form/textarea/vl-textarea.component.ts"),a=s("../../node_modules/lit/index.js");let n=(0,a.AH)`
    .tox-tinymce {
        border-radius: 0.3rem;
