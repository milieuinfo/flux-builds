"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[3662],{"../../libs/components/src/compliance/privacy/vl-privacy.component.ts":(e,n,i)=>{var r=i("../../libs/common/src/index.ts"),a=i("../../libs/styles/src/index.ts"),t=i("../../node_modules/lit/index.js"),o=i("../../node_modules/lit/decorators.js"),l=i("../../libs/components/src/atom/index.ts"),v=i("../../libs/components/src/atom/paragraph/index.ts"),s=i("../../libs/components/src/block/contact-card/index.ts"),d=i("../../libs/components/src/block/document/index.ts"),g=i("../../libs/components/src/block/infoblock/index.ts"),c=i("../../libs/components/src/block/properties/index.ts"),m=i("../../libs/components/src/block/side-navigation/index.ts"),p=i("../../libs/components/src/block/typography/index.ts"),k=i("../../node_modules/lit-html/lit-html.js");let h=()=>(0,k.qy)`
...
`;var b=i("../../libs/components/src/block/functional-header/index.ts");let w=()=>[b.a],f=({disableBackLink:e,hideBackLink:n})=>(0,t.qy)`
...
`;var j=i("../../libs/components/src/compliance/privacy/vl-privacy.defaults.ts");class z extends r.jW{static{(0,r.gy)([s.Y,d.F,g.P,p.I,l.IM,m.N8,c.L,v.Q,...w()])}constructor(){super(),this.date=j.z.date,this.version=j.z.version,this.disableBackLink=j.z.disableBackLink,this.hideBackLink=j.z.hideBackLink,this.allowCustomCSS=!1}static get styles(){return[a.qO,a.oi,a.B2,a.DE,a.as,a.Ei]}static get properties(){return{date:{type:String,attribute:"date"},disableBackLink:{type:Boolean,attribute:"disable-back-link"},hideBackLink:{type:Boolean,attribute:"hide-back-link"},version:{type:String,attribute:"version"}}}render(){return(0,t.qy)`
            <slot name="header"
        ...
        `}handleContentSlotChanged(e){let n=this.shadowRoot?.querySelector("#content"),i=this.querySelector('[slot="content"]');n&&i&&(n.textContent="",n.appendChild(i))}}z=function(e,n,i,r){var a,t=arguments.length,o=t<3?n:null===r?r=Object.getOwnPropertyDescriptor(n,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,i,r);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(o=(t<3?a(o):t>3?a(n,i,o):a(n,i))||o);return t>3&&o&&Object.defineProperty(n,i,o),o}([(0,o.EM)("vl-privacy")],z)},"../../libs/components/src/compliance/privacy/vl-privacy.defaults.ts":(e,n,i)=>{i.d(n,{z:()=>r});let r={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",headerSlot:"",versionSlot:"",contentSlot:"",bottomSlot:""}}}]);