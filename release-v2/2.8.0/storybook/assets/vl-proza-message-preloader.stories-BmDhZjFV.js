import{K as t,L as l,H as c,I as m,u as i,j as e,C as p,bd as v,s as g,c0 as u,x as h}from"./iframe-BQb9mjVp.js";import{p as z}from"./vl-proza-message.stories-msw-CAqD3i-N.js";import"./preload-helper-D9Z9MdNV.js";const r={...m,baseUrl:"",domain:""},b={...c,baseUrl:{name:"base-url",description:"Optionele baseUrl waarvan de Proza berichten opgehaald worden.<br>Indien deze baseUrl niet meegegeven wordt, worden de Proza berichten opgehaald relatief tov de huidige url op het pad 'proza/domein/{domain}'.<br>Dit attribuut is niet reactief.",control:!1,table:{type:{summary:l.URL},category:t.ATTRIBUTES,defaultValue:{summary:r.baseUrl}}},domain:{name:"domain",description:"Het Proza domein waarin de Proza berichten zit.",type:{name:l.STRING,required:!0},control:!1,table:{type:{summary:l.STRING},category:t.ATTRIBUTES,defaultValue:{summary:r.domain}}}};function d(a){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...a.components},{FluxComponentMetaData:s}=o;return s||j("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"proza-message-preloader",children:"Proza Message Preloader"}),`
...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlProzaMessagePreloader.html",rel:"nofollow",children:"Legacy Documentatie - Proza Message Preloader"})})]})}function x(a={}){const{wrapper:o}={...i(),...a.components};return o?e.jsx(o,{...a,children:e.jsx(d,{...a})}):d(a)}function j(a,o){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const P={id:"components-block-proza-message-proza-message-preloader",title:"Components - Block/proza-message/proza-message-preloader",tags:["autodocs"],args:r,argTypes:b,parameters:{docs:{page:x},controls:{hideNoControlsWarning:!0},msw:{handlers:z}}},n=g(r,()=>(u.clearCache(),h`
        <div>
