...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-proza-message.html",rel:"nofollow",children:"Legacy Demo - Proza Message"})})]})}function x(o={}){const{wrapper:a}={...m(),...o.components};return a?e.jsx(a,{...o,children:e.jsx(c,{...o})}):c(o)}function f(o,a){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}const M={id:"components-block-proza-message-proza-message",title:"Components - Block/proza-message/proza-message",tags:["autodocs"],args:n,argTypes:y,parameters:{docs:{page:x},controls:{hideNoControlsWarning:!0},msw:{handlers:[...z,...k]}}},t=v(n,()=>(p.clearCache(),g`
  ...
  return html\`
    ...
    \`;
})`,...s.parameters?.docs?.source}}};const T=["ProzaMessageDefault","ProzaMessageEditable"];export{t as ProzaMessageDefault,s as ProzaMessageEditable,T as __namedExportsOrder,M as default};
