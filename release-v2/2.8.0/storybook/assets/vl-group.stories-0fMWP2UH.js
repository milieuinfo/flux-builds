...
voor meer informatie en voorbeelden.`]})]})}function B(l={}){const{wrapper:e}={...b(),...l.components};return e?o.jsx(e,{...l,children:o.jsx(x,{...l})}):x(l)}function G(l,e){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}const N={id:"styles-layout-group",title:"Styles/Layout (afnemers)/group",tags:["autodocs"],args:O,argTypes:M,parameters:{docs:{page:B}}};S([A,C,L,E]);const v=({group:l,collapseL:e,collapseM:n,collapseS:t,collapseXS:s,column:a,justifyCenter:c,justifyEnd:i,separatorColumn:p,separatorRow:u,spaceBetween:d})=>y` <div
    class=${f({"vl-group":l,"vl-group--collapse-l":e,"vl-group--collapse-m":n,"vl-group--collapse-s":t,"vl-group--collapse-xs":s,"vl-group--column":a,"vl-group--justify-center":c,"vl-group--justify-end":i,"vl-group--separator-column":p,"vl-group--separator-row":u,"vl-group--space-between":d})}
>
    <vl-button>Aanvraag starten</vl-button>
    <vl-button secondary>Annuleren</vl-button>
</div>`;v.storyName="vl-group - buttons";const m=({group:l,collapseL:e,collapseM:n,collapseS:t,collapseXS:s,column:a,justifyCenter:c,justifyEnd:i,separatorColumn:p,separatorRow:u,spaceBetween:d})=>y` <div
    class=${f({"vl-group":l,"vl-group--collapse-l":e,"vl-group--collapse-m":n,"vl-group--collapse-s":t,"vl-group--collapse-xs":s,"vl-group--column":a,"vl-group--justify-center":c,"vl-group--justify-end":i,"vl-group--separator-column":p,"vl-group--separator-row":u,"vl-group--space-between":d})}
    style="height: 140px"
>
...
</div>`;m.storyName="vl-group - links";m.args={separatorRow:!0};const g=({group:l,collapseL:e,collapseM:n,collapseS:t,collapseXS:s,column:a,justifyCenter:c,justifyEnd:i,separatorColumn:p,separatorRow:u,spaceBetween:d,stretchChildren:w})=>y` <div
    class=${f({"vl-group":l,"vl-group--collapse-l":e,"vl-group--collapse-m":n,"vl-group--collapse-s":t,"vl-group--collapse-xs":s,"vl-group--column":a,"vl-group--justify-center":c,"vl-group--justify-end":i,"vl-group--separator-column":p,"vl-group--separator-row":u,"vl-group--space-between":d,"vl-group--stretch-children":w})}
>
...
</div>`;g.storyName="vl-group - accordions";g.args={column:!0,separatorColumn:!0,stretchChildren:!0};const h=({group:l,collapseL:e,collapseM:n,collapseS:t,collapseXS:s,column:a,justifyCenter:c,justifyEnd:i,separatorColumn:p,separatorRow:u,spaceBetween:d})=>y` <div
    class=${f({"vl-group":l,"vl-group--collapse-l":e,"vl-group--collapse-m":n,"vl-group--collapse-s":t,"vl-group--collapse-xs":s,"vl-group--column":a,"vl-group--justify-center":c,"vl-group--justify-end":i,"vl-group--separator-column":p,"vl-group--separator-row":u,"vl-group--space-between":d})}
    style="height: 140px"
>
