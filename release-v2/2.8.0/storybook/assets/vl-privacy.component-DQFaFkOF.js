import{x as i,g as d,r as g,cD as m,bb as c,cE as p,cF as k,aX as h,m as u,J as b,aY as w,A as f,B as y,aH as j,E as z,bx as D,cG as O,cH as V,cA as A}from"./iframe-BQb9mjVp.js";const G=()=>i`
...
`,t={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",headerSlot:"",versionSlot:"",contentSlot:"",bottomSlot:""};var P=Object.getOwnPropertyDescriptor,T=(n,e,a,l)=>{for(var r=l>1?void 0:l?P(e,a):e,o=n.length-1,v;o>=0;o--)(v=n[o])&&(r=v(r)||r);return r};let s=class extends y{constructor(){super(),this.date=t.date,this.version=t.version,this.disableBackLink=t.disableBackLink,this.hideBackLink=t.hideBackLink,this.allowCustomCSS=!1}static get styles(){return[j,z,D,O,V,A]}static get properties(){return{date:{type:String,attribute:"date"},disableBackLink:{type:Boolean,attribute:"disable-back-link"},hideBackLink:{type:Boolean,attribute:"hide-back-link"},version:{type:String,attribute:"version"}}}render(){return i`
        ...
        `}handleContentSlotChanged(n){const e=this.shadowRoot?.querySelector("#content"),a=this.querySelector('[slot="content"]');e&&a&&(e.textContent="",e.appendChild(a))}};g([m,c,p,k,h,u,b,w,...S()]);s=T([f("vl-privacy")],s);export{t as p};
