import{Z as i,_ as h,a2 as l,a1 as m,W as p,c7 as s,X as b,u,j as e,C as f,b8 as x,x as g}from"./iframe-BAEsER5t.js";import"./preload-helper-D9Z9MdNV.js";const j={...b,href:"#",medium:s.FACEBOOK},v={...p,medium:{name:"medium",control:{type:m.SELECT},options:Object.values(s),description:"This attribute is used to pass the medium.",table:{type:{summary:l(Object.values(s))},category:i.ATTRIBUTES}},href:{name:"href",description:"The href attribute specifies the link's destination.",table:{type:{summary:h.STRING},category:i.ATTRIBUTES}}};function c(n){const t={code:"code",h1:"h1",h2:"h2",p:"p",...u(),...n.components},{FluxAlert:r,FluxComponentMetaData:a}=t;return r||d("FluxAlert"),a||d("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"share-button",children:"Share Button"}),`
