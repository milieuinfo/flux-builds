import{Z as i,_ as r,W as c,X as p,u as x,j as e,C as m,b8 as h,s as w,x as b}from"./iframe-BAEsER5t.js";import"./preload-helper-D9Z9MdNV.js";const a={...p,image:"",contextLink:"",titleLink:""},u={...c,image:{name:"image (slot)",description:"",table:{type:{summary:r.HTML},category:i.SLOTS}},contextLink:{name:"context-link (slot)",description:"Link voor de context.",table:{type:{summary:r.STRING},category:i.ATTRIBUTES,defaultValue:{summary:a.contextLink}}},titleLink:{name:"title-link (slot)",description:"Link voor de titel",table:{type:{summary:r.STRING},category:i.ATTRIBUTES,defaultValue:{summary:a.titleLink}}}};function d(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...x(),...n.components},{FluxAlert:s,FluxComponentMetaData:l}=t;return s||f("FluxAlert"),l||f("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"content-header",children:"Content Header"}),`
`,e.jsx(l,{id:"components-block-content-header"}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/content-header",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Content Header"})})]})}function H(n={}){const{wrapper:t}={...x(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(d,{...n})}):d(n)}function f(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const j={id:"components-block-content-header",title:"Components - Block/content-header",tags:["autodocs"],args:a,argTypes:u,parameters:{docs:{page:H}}},M=w(a,({contextLink:n,titleLink:t})=>b`
        <vl-content-header>
            <img
                slot="image"
                sizes="100vw"
    ...
    `),o=M.bind({});o.storyName="vl-content-header - default";o.args={contextLink:"Context",titleLink:"Vlaanderen"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(contentHeaderArgs, ({
  contextLink,
  titleLink
}) => html\`
        <vl-content-header>
    ...
    \`)`,...o.parameters?.docs?.source}}};const y=["ContentHeaderDefault"];export{o as ContentHeaderDefault,y as __namedExportsOrder,j as default};
