...
`]})]})}function E(l={}){const{wrapper:o}={...h(),...l.components};return o?e.jsx(o,{...l,children:e.jsx(f,{...l})}):f(l)}function N(l,o){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}L([V,D,T]);const W={id:"components-block-modal",title:"Components - Block/modal",tags:["autodocs"],args:p,argTypes:B,parameters:{docs:{page:E}}},n=S({...p,id:""},({title:l,label:o,open:b,closable:y,notCancellable:w,notAutoClosable:k,allowOverflow:j,size:O,position:x,id:v,focusOnModal:A})=>$`
        <div>
            <vl-button
