import{Y as i,Z as l,a0 as p,U as m,W as d,u as s,j as e,C as u,bb as g,s as h,x}from"./iframe-BJy2lIHs.js";import"./vl-map-base-layer-Bhd069p5.js";import"./vl-map-base-layer-grb-gray-CiePMeON.js";import{D as y,a as f}from"./vl-map-current-location-C1mlLYUt.js";import"./preload-helper-D9Z9MdNV.js";const n={...d,tooltip:y,zoom:f},b={...m,tooltip:{name:"tooltip",description:"Bepaalt de tekst van de tooltip van de huidige locatie knop.",table:{type:{summary:l.STRING},category:i.ATTRIBUTES,defaultValue:{summary:n.tooltip}}},zoom:{name:"zoom",description:"Bepaalt hoever er ingezoomd wordt bij het klikken op de huidige locatie knop.",control:{type:p.RANGE,min:1,max:13,step:1},table:{type:{summary:l.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(n.zoom)}}}};function c(t){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...t.components},{FluxComponentMetaData:r}=o;return r||j("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"map-current-location",children:"Map Current Location"}),`
...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-map-vl-map-current-location--default",rel:"nofollow",children:"Legacy Storybook - Map Current Location"})})]})}function v(t={}){const{wrapper:o}={...s(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(c,{...t})}):c(t)}function j(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const E={id:"map-current-location",title:"map/current-location",tags:["autodocs"],args:n,argTypes:b,parameters:{docs:{page:v}}},a=h(n,({tooltip:t,zoom:o})=>x`
        <vl-map lambert2008>
