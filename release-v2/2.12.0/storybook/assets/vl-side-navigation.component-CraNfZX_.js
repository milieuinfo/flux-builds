import{cJ as Q,cK as V,i as w,bd as C,J as S,cL as F,x as v,T as m,r as P,d as _,bD as j,P as W,B as G,bs as J,aV as K,aU as X,w as Y}from"./iframe-BJy2lIHs.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Z={attribute:!0,type:String,converter:V,reflect:!1,hasChanged:Q},ee=(e=Z,t,i)=>{const{kind:n,metadata:s}=i;let o=globalThis.litPropertyMetadata.get(s);if(o===void 0&&globalThis.litPropertyMetadata.set(s,o=new Map),o.set(i.name,e),n==="accessor"){const{name:a}=i;return{set(r){const c=t.get.call(this);t.set.call(this,r),this.requestUpdate(a,c,e)},init(r){return r!==void 0&&this.C(a,void 0,e),r}}}if(n==="setter"){const{name:a}=i;return function(r){const c=this[a];t.call(this,r),this.requestUpdate(a,c,e)}}throw Error("Unsupported decorator location: "+n)};function u(e){return(t,i)=>typeof i=="object"?ee(e,t,i):((n,s,o)=>{const a=s.hasOwnProperty(o);return s.constructor.createProperty(o,a?{...n,wrapped:!0}:n),a?Object.getOwnPropertyDescriptor(s,o):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function T(e){return u({...e,state:!0,attribute:!1})}const k=w`
...
`,oe=(e,{selector:t="vl-title, h1, h2, h3, h4, h5, h6",minLevel:i=1,maxLevel:n=6,maxDepth:s,excludeSelectors:o})=>{if(!e)return{elements:[],headings:[]};const a=Math.max(1,Math.min(6,Number(i)||1)),r=Math.max(1,Math.min(6,Number(n)||6)),b=F(e,t,s,0,o).filter(d=>{if(!(d instanceof HTMLElement))return!1;const y=d.getRootNode();return!(y instanceof ShadowRoot&&y.host&&y.host.tagName.toLowerCase()==="vl-title")}).map(d=>({element:d,level:le(d)})).filter(({level:d})=>d!==null&&d>=a&&d<=r),f=new Map;b.forEach(({element:d,level:y})=>{const I=ae(d),x=d.getAttribute("id")?.trim()??"";x&&(f.has(x)||f.set(x,{element:d,level:y,text:I,id:x}))});const g=Array.from(f.values());return re(g),{elements:g.map(({element:d})=>d),headings:g}},ae=e=>A(e),H=e=>(e??"").replace(/\s+/g," ").trim(),A=(e,t=new Set)=>{if(t.has(e))return"";if(t.add(e),e.nodeType===Node.TEXT_NODE)return H(e.textContent);if(!(e instanceof Element||e instanceof ShadowRoot))return"";const i=[];if(e instanceof Element&&e.shadowRoot){const s=A(e.shadowRoot,t);return H(s)}return(e instanceof HTMLSlotElement?e.assignedNodes({flatten:!0}):Array.from(e.childNodes)).forEach(s=>{const o=A(s,t);o&&i.push(o)}),H(i.join(" "))};function re(e){e.sort((t,i)=>{const n=t.element.compareDocumentPosition(i.element);if(n&Node.DOCUMENT_POSITION_DISCONNECTED){const s=t.element.getBoundingClientRect(),o=i.element.getBoundingClientRect();return s.top-o.top}return n&Node.DOCUMENT_POSITION_FOLLOWING?-1:n&Node.DOCUMENT_POSITION_PRECEDING?1:0})}const le=e=>{const t=e.tagName.toLowerCase(),i=t.match(/^h([1-6])$/);if(i)return parseInt(i[1],10);if(t==="vl-title"){const s=e.getAttribute("type"),o=e.type,r=(s||o||"h1").toLowerCase().match(/^h([1-6])$/);if(r)return parseInt(r[1],10)}const n=e.getAttribute("aria-level");if(n){const s=parseInt(n,10);if(!Number.isNaN(s))return s}return null},D=(e,t)=>{const i=e.querySelectorAll("slot");for(const n of Array.from(i))if(n instanceof HTMLSlotElement){const s=n.assignedElements({flatten:!0});for(const o of s){if("querySelector"in o){const a=o.querySelector(t);if(a)return a}if(o.matches&&o.matches(t))return o}}return null},ce=(e,t,i)=>{if(e&&t){const n=e.querySelector?.(t);if(n)return n;if(e!==document){const s=D(e,t);if(s)return s}return console.warn(`[vl-side-navigation-next] selector "${t}" not found within headingRoot. Using headingRoot as-is. Headings will be scanned from the entire headingRoot scope.`),e}if(e)return e;if(t){const n=i.querySelector(t);return n||(console.warn(`[vl-side-navigation-next] selector "${t}" not found in fallbackRoot. Using fallbackRoot as-is.`),i)}return i},de=e=>{const t=[];return e.forEach(i=>{[...i.querySelectorAll('a[href^="#"], vl-link[href^="#"]')].forEach(s=>{const o=s.getAttribute("href");if(o){const a=o.substring(1);a&&!t.includes(a)&&t.push(a)}})}),t},he=(e,t)=>{const i=t.querySelector(`#${e}`);if(i)return i;if(t!==document){const n=document.querySelector(`#${e}`);if(n)return n}return null};function ue(e,t){const i=de(e);return i.length===0?[]:i.map(n=>he(n,t)).filter(n=>n!==null)}function Ce(e){const t=e.currentTarget,n=t.closest("li")?.querySelector(":scope > ul");if(!n)return;n.hasAttribute("hidden")?(n.removeAttribute("hidden"),t.setAttribute("aria-expanded","true"),t.setAttribute("aria-label","Inklappen"),t.classList.add("showing-children")):(n.setAttribute("hidden",""),t.setAttribute("aria-expanded","false"),t.setAttribute("aria-label","Uitklappen"),t.classList.remove("showing-children"))}function q(e,t="smooth"){const n=e.currentTarget.getAttribute("href");if(!n||!n.startsWith("#"))return;const s=n.substring(1);if(!s)return;const o=document.getElementById(s);o&&(e.preventDefault(),history.pushState(null,"",n),o.scrollIntoView({behavior:t,block:"start"}))}function fe(e,t="smooth"){e.forEach(i=>{i.querySelectorAll('a[href^="#"], vl-link[href^="#"]').forEach(s=>{if(s.tagName.toLowerCase()==="vl-link"){const o=s.shadowRoot?.querySelector("a");o&&o.addEventListener("click",a=>q(a,t))}else s.addEventListener("click",o=>q(o,t))})})}function pe(e){e.forEach(t=>{t.querySelectorAll("li > ul").forEach(s=>{s.setAttribute("hidden","")}),t.querySelectorAll(".toggle-button").forEach(s=>{s.setAttribute("aria-expanded","false"),s.setAttribute("aria-label","Uitklappen"),s.classList.remove("showing-children")})})}function ge(e,t){e.forEach(i=>{i.querySelectorAll('a[href^="#"], vl-link[href^="#"]').forEach(s=>{const o=s.getAttribute("href");o&&(o.substring(1)===t?(s.classList.add("active"),s.setAttribute("aria-current","location")):(s.classList.remove("active"),s.removeAttribute("aria-current")))})})}function me(e,t){for(const i of e){const n=i.querySelectorAll('a[href^="#"], vl-link[href^="#"]');for(const s of Array.from(n)){const o=s.getAttribute("href");if(o&&o.substring(1)===t)return s}}return null}function ve(e){const t=new Set;let i=e.closest("li");for(;i;){const n=i.parentElement;if(n&&n.tagName==="UL")t.add(n),i=n.parentElement?.closest("li")??null;else break}return t}function be(e,t){const i=me(e,t),n=i?ve(i):new Set;if(i){const o=i.closest("li")?.querySelector(":scope > ul");o&&n.add(o)}for(const s of e)s.querySelectorAll("li > ul").forEach(a=>{const r=n.has(a),c=typeof document<"u"&&document.activeElement?a.contains(document.activeElement):!1,p=r||c;p?a.removeAttribute("hidden"):a.setAttribute("hidden","");const f=a.parentElement?.querySelector(":scope > .nav-item-wrapper > .toggle-button");f&&(f.setAttribute("aria-expanded",String(p)),f.setAttribute("aria-label",p?"Inklappen":"Uitklappen"),p?f.classList.add("showing-children"):f.classList.remove("showing-children"))})}const ye=(e,t={scroll:{},state:{},callbacks:{}})=>{const i="headings"in e?B(e.headings):e;return i.length>0?U(i,t):v``},B=e=>{const t=[],i=[];return e.forEach(n=>{const s={item:n,children:[]};for(;i.length>0&&n.level<=i[i.length-1].item.level;)i.pop();i.length===0?t.push(s):i[i.length-1].children.push(s),i.push(s)}),t},U=(e,t,i,n)=>e.length?v`
        <ul id=${i??m} ?hidden=${n??!1}>
            ${e.map(s=>we(s,t))}
        </ul>
    `:v``,we=(e,t)=>{const{activeHeadingId:i,expandedHeadingIds:n}=t.state,{onActiveHeadingChange:s}=t.callbacks,{scrollRoot:o,scrollBehavior:a}=t.scroll,r=i===e.item.id,c=e.children.length>0,p=c&&O(e.children,i),b=n?.has(e.item.id)??!1,f=n?.has(`-${e.item.id}`)??!1,g=b||(r||p)&&!f,d=e.item.text||e.item.id,y=E=>{E.preventDefault();const R=e.item.element??xe(e.item.id,o,t.scroll.maxDepth);R&&R.scrollIntoView({behavior:a??"smooth",block:"start"})},I=E=>{E.preventDefault(),E.stopPropagation(),s?.(e.item.id,!0)},x=v`<a
        href=${`#${e.item.id}`}
        class=${r?"active":""}
    ...
    >
        ${d}
    </a>`,N=c?`toc-section-${e.item.id}`:void 0,z=c?v`<button
              type="button"
              class="toggle-button"
    ...
    `},O=(e,t)=>{if(!t)return!1;for(const i of e)if(i.item.id===t||i.children.length>0&&O(i.children,t))return!0;return!1},M=(e,t)=>{for(const i of e){if(i.item.id===t)return i;if(i.children.length>0){const n=M(i.children,t);if(n)return n}}return null},xe=(e,t,i)=>{const n=t??document,s=`#${e}`,o=n.querySelector(s);if(o)return o;if(n instanceof Element||n instanceof ShadowRoot){const r=D(n,s);if(r instanceof HTMLElement)return r}const a=r=>{const c=F(r,s,i);return c.length>0&&c[0]instanceof HTMLElement?c[0]:null};if(n===document){const r=a(document);if(r)return r}if(n!==document){const r=a(document);if(r)return r}return null};var Se=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,h=(e,t,i,n)=>{for(var s=n>1?void 0:n?Te(t,i):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(n?a(t,i,s):a(s))||s);return n&&s&&Se(t,i,s),s};P([_,j,W]);let l=class extends G{constructor(){super(...arguments),this.compact=!1,this.childSpacing="small",this.headingElements=[],this.minLevel=2,this.maxLevel=3,this.isTableOfContentsHidden=!1,this.navigationTitle="Op deze pagina",this.activeHeadingId="",this.tocTemplate=v``,this.hasCustomToc=!1,this.expandedHeadingIds=new Set,this.isMobileView=!1,this.headingObserverMap=new Map,this.isTableOfContentsInitialized=!1,this.mediaQueryHandler=e=>this.handleMediaQueryChange(e),this.previousTocEffectivelyHidden=!1,this.closeSideNavigation=()=>{this.isTableOfContentsHidden=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector("#show-toc-button")?.shadowRoot?.querySelector("button")?.focus()})},this.showSideNavigation=()=>{this.isTableOfContentsHidden=!1,this.updateComplete.then(()=>{this.shadowRoot?.querySelector("#side-navigation-toc")?.focus()})}}static get styles(){return[J,se,K(),X]}firstUpdated(){this.setupMediaQueryListener();const t=this.shadowRoot?.querySelector("slot")?.assignedElements()??[];t.length>0?this.initializeCustomToc(t):this.closest?.("vl-side-navigation-layout-next")?(this.buildTableOfContents(),this.setupIntersectionObserver()):requestAnimationFrame(()=>{this.isTableOfContentsInitialized||(this.buildTableOfContents(),this.setupIntersectionObserver())})}updated(e){if(e.has("headingRoot")&&this.hasCustomToc){const n=this.shadowRoot?.querySelector("slot")?.assignedElements()??[];n.length>0&&this.headingRoot&&this.extractHeadingIdsFromManualToc(n);return}if(e.has("headingRoot")&&!this.isTableOfContentsInitialized){const i=this.shadowRoot?.querySelector("slot");if(i){const n=i.assignedElements();n.length>0&&this.headingRoot?this.extractHeadingIdsFromManualToc(n):this.refreshTableOfContents()}else this.refreshTableOfContents()}(e.has("minLevel")||e.has("maxLevel")||e.has("headingRootSelector")||e.has("excludeSelectors"))&&this.isTableOfContentsInitialized&&this.refreshTableOfContents();const t=this.isTocEffectivelyHidden;if(t&&!this.previousTocEffectivelyHidden&&this.updateComplete.then(()=>this.handleTocVisibilityFocusRecovery()),this.previousTocEffectivelyHidden=t,(e.has("expandedHeadingIds")||e.has("activeHeadingId"))&&this.isFocusInsideNav()){const i=this.getDeepActiveElement();if(i&&(i.offsetParent===null||i.hasAttribute("hidden")||i.getAttribute("aria-hidden")==="true")){const s=i;this.updateComplete.then(()=>this.moveFocusToLogicalNeighbor(s))}}}connectedCallback(){super.connectedCallback(),this.isTableOfContentsInitialized&&!this.intersectionObserver&&this.setupIntersectionObserver(),this.setupMediaQueryListener(),this.updateComplete.then(()=>this.setupFocusRecoveryObserver())}disconnectedCallback(){super.disconnectedCallback(),this.cleanupIntersectionObserver(),this.cleanupMediaQueryListener(),this.cleanupFocusRecoveryObserver()}setupMediaQueryListener(){this.mediaQueryList||(this.mediaQueryList=window.matchMedia(`(min-width: ${S+1}px)`),this.isMobileView=!this.mediaQueryList.matches,this.mediaQueryList.addEventListener("change",this.mediaQueryHandler))}cleanupMediaQueryListener(){this.mediaQueryList&&(this.mediaQueryList.removeEventListener("change",this.mediaQueryHandler),this.mediaQueryList=void 0)}handleTocVisibilityFocusRecovery(){if(!this.isTocEffectivelyHidden||!this.isFocusInsideNav())return;this.shadowRoot?.querySelector("#show-toc-button")?.shadowRoot?.querySelector("button")?.focus()}getFocusableElementsInNav(){const e=this.shadowRoot?.querySelector("nav");if(!e)return[];const t=[],i=e.querySelector("slot");if(i&&i instanceof HTMLSlotElement){const s=i.assignedElements({flatten:!0});for(const o of s)this.collectFocusablesInTreeOrder(o,t)}return e.querySelectorAll("a[href], button").forEach(s=>{s instanceof HTMLElement&&t.push(s)}),t}collectFocusablesInTreeOrder(e,t){e instanceof HTMLElement&&(e.matches?.("a[href]")||e.matches?.("button"))&&t.push(e);const i=[];e instanceof HTMLSlotElement?i.push(...e.assignedElements({flatten:!0})):e.shadowRoot&&i.push(...Array.from(e.shadowRoot.children)),i.push(...Array.from(e.children));for(const n of i)this.collectFocusablesInTreeOrder(n,t)}getDeepActiveElement(){if(typeof document>"u")return null;let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}isFocusInsideNav(){const e=this.shadowRoot?.querySelector("nav");if(!e)return!1;const t=this.getDeepActiveElement();if(!t)return!1;if(e.contains(t))return!0;const i=e.querySelector("slot");return(i instanceof HTMLSlotElement?i.assignedElements({flatten:!0}):[]).some(s=>s===t||s.contains(t))}moveFocusToLogicalNeighbor(e){const t=this.getFocusableElementsInNav(),i=t.filter(s=>s.offsetParent!==null&&!s.hasAttribute("hidden")&&s.getAttribute("aria-hidden")!=="true");if(i.length===0){this.shadowRoot?.querySelector("#show-toc-button")?.shadowRoot?.querySelector("button")?.focus();return}const n=s=>{s.tagName.toLowerCase()==="vl-link"?s.shadowRoot?.querySelector("a")?.focus():s.focus()};if(this.activeHeadingId){const s=i.find(o=>(o.getAttribute("href")||o.closest("vl-link")?.getAttribute("href"))===`#${this.activeHeadingId}`);if(s){n(s);return}}if(e){const s=t.indexOf(e);if(s!==-1){const o=t.slice(0,s).reverse().find(r=>i.includes(r));if(o){n(o);return}const a=t.slice(s+1).find(r=>i.includes(r));if(a){n(a);return}}}n(i[0])}setupFocusRecoveryObserver(){if(this.focusRecoveryMutationObserver)return;const e=()=>{if(this.isFocusInsideNav()){const i=this.getDeepActiveElement();this.lastFocusedNavElement=i?new WeakRef(i):void 0}};this.shadowRoot?.addEventListener("focusin",e),this.addEventListener("focusin",e),this.focusRecoveryMutationObserver=new MutationObserver(i=>{if(typeof document>"u"||this.getDeepActiveElement()!==document.body)return;const s=this.lastFocusedNavElement?.deref();if(!s)return;i.some(a=>Array.from(a.removedNodes).some(r=>r===s||r.contains(s)))&&(this.lastFocusedNavElement=void 0,this.moveFocusToLogicalNeighbor(s))});const t=this.shadowRoot?.querySelector("nav");t&&this.focusRecoveryMutationObserver.observe(t,{childList:!0,subtree:!0}),this.focusRecoveryMutationObserver.observe(this,{childList:!0,subtree:!0})}cleanupFocusRecoveryObserver(){this.focusRecoveryMutationObserver&&(this.focusRecoveryMutationObserver.disconnect(),this.focusRecoveryMutationObserver=void 0)}handleMediaQueryChange(e){this.isMobileView=!e.matches,e.matches&&this.isTableOfContentsHidden&&!this.compact&&(this.isTableOfContentsHidden=!1)}get isTocEffectivelyHidden(){return(this.compact||this.isMobileView)&&this.isTableOfContentsHidden}get effectiveScrollBehavior(){return typeof window>"u"?"smooth":window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"}setupIntersectionObserver(){this.cleanupIntersectionObserver();const e={root:null,rootMargin:"0px 0px -70% 0px",threshold:0};this.intersectionObserver=new IntersectionObserver(t=>this.handleIntersection(t),e),this.headingElements.forEach(t=>{const i=t.getAttribute("id");i&&(this.headingObserverMap.set(i,t),this.intersectionObserver?.observe(t))})}handleIntersection(e){const t=e.filter(i=>i.isIntersecting);if(t.length>0){const n=t.reduce((s,o)=>o.boundingClientRect.top<s.boundingClientRect.top?o:s).target.getAttribute("id");n&&n!==this.activeHeadingId&&(this.activeHeadingId=n,this.updateActiveLinks())}}updateActiveLinks(){this.hasCustomToc?this.updateManualTocActiveStates():this.updateTableOfContents(),this.dispatchEvent(new CustomEvent("active-heading-changed",{detail:{activeHeadingId:this.activeHeadingId},bubbles:!0}))}cleanupIntersectionObserver(){this.intersectionObserver&&(this.intersectionObserver.disconnect(),this.intersectionObserver=void 0),this.headingObserverMap.clear()}updateObservedElements(e){this.headingElements=e,this.setupIntersectionObserver()}render(){const e=this.compact||this.isMobileView;return v`
            ...
            ></vl-button>
        `}handleTocSlotChange(e){const i=e.target.assignedElements();i.length>0?this.initializeCustomToc(i):(this.hasCustomToc=!1,this.refreshTableOfContents())}initializeCustomToc(e){this.hasCustomToc=!0,this.extractHeadingIdsFromManualToc(e),this.adoptLightDomStyles(),pe(e),fe(e,this.effectiveScrollBehavior),this.setupIntersectionObserver()}adoptLightDomStyles(){l.lightDomStyleSheet||(l.lightDomStyleSheet=new CSSStyleSheet,l.lightDomStyleSheet.replaceSync(ne.toString())),document.adoptedStyleSheets.includes(l.lightDomStyleSheet)||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,l.lightDomStyleSheet])}extractHeadingIdsFromManualToc(e){const t=this.headingRoot??this.getRootNode(),i=ue(e,t);i.length>0&&(this.headingElements=i,this.setupIntersectionObserver())}updateManualTocActiveStates(){const e=this.shadowRoot?.querySelector("slot");if(!e)return;const t=e.assignedElements();ge(t,this.activeHeadingId),be(t,this.activeHeadingId)}get tableOfContents(){return this.shadowRoot?.querySelector("table-of-contents")}buildTableOfContents(){const e=ce(this.headingRoot,this.headingRootSelector,this.getRootNode());this.tableOfContentsStructure=oe(e,{minLevel:this.minLevel,maxLevel:this.maxLevel,maxDepth:this.maxDepth,excludeSelectors:this.excludeSelectors}),this.headingElements=this.tableOfContentsStructure.elements,this.updateObservedElements(this.headingElements),this.updateTableOfContents(),this.isTableOfContentsInitialized=!0}updateTableOfContents(){if(!this.tableOfContentsStructure)return;const e=this.headingRoot??this.getRootNode(),t=B(this.tableOfContentsStructure.headings),i=Array.from(this.expandedHeadingIds).filter(n=>{if(!n.startsWith("-"))return!0;const s=n.substring(1),o=M(t,s),a=this.activeHeadingId===s,r=o?O(o.children,this.activeHeadingId):!1;return a||r});i.length!==this.expandedHeadingIds.size&&(this.expandedHeadingIds=new Set(i)),this.tocTemplate=ye(t,{scroll:{scrollRoot:e,scrollBehavior:this.effectiveScrollBehavior,maxDepth:this.maxDepth},state:{activeHeadingId:this.activeHeadingId,expandedHeadingIds:this.expandedHeadingIds},callbacks:{onActiveHeadingChange:(n,s)=>{if(s&&this.tableOfContentsStructure){const o=this.expandedHeadingIds.has(n),a=this.expandedHeadingIds.has(`-${n}`),r=this.activeHeadingId===n,c=M(t,n),p=c?O(c.children,this.activeHeadingId):!1,b=r||p;o?(this.expandedHeadingIds.delete(n),b&&this.expandedHeadingIds.add(`-${n}`)):a?(this.expandedHeadingIds.delete(`-${n}`),this.expandedHeadingIds.add(n)):b?this.expandedHeadingIds.add(`-${n}`):this.expandedHeadingIds.add(n),this.expandedHeadingIds=new Set(this.expandedHeadingIds),this.updateTableOfContents()}}}})}refreshTableOfContents(){this.tableOfContentsStructure=void 0,this.isTableOfContentsInitialized=!1,this.buildTableOfContents()}};h([u({type:Boolean,reflect:!0})],l.prototype,"compact",2);h([u({type:String,reflect:!0,attribute:"child-spacing"})],l.prototype,"childSpacing",2);h([u({type:Array})],l.prototype,"headingElements",2);h([u({attribute:!1})],l.prototype,"headingRoot",2);h([u({type:String,attribute:"heading-root-selector"})],l.prototype,"headingRootSelector",2);h([u({type:Number,attribute:"min-level"})],l.prototype,"minLevel",2);h([u({type:Number,attribute:"max-level"})],l.prototype,"maxLevel",2);h([u({type:Boolean,attribute:"closed",reflect:!0})],l.prototype,"isTableOfContentsHidden",2);h([u({type:Number,attribute:"max-depth"})],l.prototype,"maxDepth",2);h([u({type:String,attribute:"exclude-selectors"})],l.prototype,"excludeSelectors",2);h([u({type:String,attribute:"navigation-title"})],l.prototype,"navigationTitle",2);h([T()],l.prototype,"activeHeadingId",2);h([T()],l.prototype,"tocTemplate",2);h([T()],l.prototype,"hasCustomToc",2);h([T()],l.prototype,"expandedHeadingIds",2);h([T()],l.prototype,"isMobileView",2);l=h([Y("vl-side-navigation-next")],l);export{l as V,u as n,Ce as t};
