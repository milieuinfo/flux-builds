...
`,a.jsx(d,{of:i})]})}function j(n={}){const{wrapper:o}={...u(),...n.components};return o?a.jsx(o,{...n,children:a.jsx(v,{...n})}):v(n)}function w(n,o){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const H={id:"map-controls-action-control",title:"map/controls/action-control",tags:["autodocs"],args:r,argTypes:A,parameters:{docs:{page:j},controls:{hideNoControlsWarning:!0}}},s=y(r,({actionId:n,icon:o,label:c,defaultActive:b})=>g`
        <vl-map lambert2008>
  ...
  defaultActive
    ...
    \`)`,...i.parameters?.docs?.source}}};const O=["MapActionControlDefault","MapActionControlDefaultActive","MapActionControlIcon","MapActionControlMultiple"];export{t as MapActionControlDefault,e as MapActionControlDefaultActive,l as MapActionControlIcon,i as MapActionControlMultiple,O as __namedExportsOrder,H as default};
