...
`;function D(n){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...f(),...n.components},{FluxComponentMetaData:t}=a;return t||R("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"cascader",children:"Cascader"}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"CascaderItem-model"}),e.jsx(h,{code:`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld CascaderItem-array opzet"}),e.jsx(h,{code:G,language:"ts",dark:!0,format:!0})]}),`
`,e.jsx(g,{of:i}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld itemListFn opzet"}),e.jsx(h,{code:O,language:"ts",dark:!0,format:!0})]}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld templates opzet"}),e.jsx(h,{code:I,language:"ts",dark:!0,format:!0})]}),`
...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/vue-documentation/?path=/story/components-vl-sidebar--sidebar-advanced",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - vl-sidebar-advanced"})})]})}function A(n={}){const{wrapper:a}={...f(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(D,{...n})}):D(n)}function R(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const H=[{label:"Vlaanderen",children:[{label:"Antwerpen",templateType:"provincie",children:[{label:"Niveau 2 - A",children:[{label:"Niveau 3 - A",children:[{label:"Niveau 4 - A"},{label:"Niveau 4 - B"}]},{label:"Niveau 3 - B"}]},{label:"Niveau 2 - B"},{label:"Berchem"}]},{label:"Brussel",templateType:"provincie",narrowDown:!0,data:{requestParams:"Niveau-id"}},{label:"Limburg",templateType:"provincie",children:[{label:"Hasselt"},{label:"Zonhoven"},{label:"Lummen"},{label:"Halen"},{label:"Tongeren"}]},{label:"Vlaams-Brabant",templateType:"provincie",narrowDown:!0,data:{requestParams:"Niveau-id"}}]},{label:"Wallonië"}],E=async n=>{const{data:a}=n,t=a?.requestParams;return await new Promise(d=>setTimeout(d,3e3)),[{label:t+" "+new Date().getHours(),children:[{label:t+" "+new Date().getMinutes(),children:[{label:t+" "+new Date().getMilliseconds(),narrowDown:!0,data:{requestParams:"Niveau-deeper"}},{label:"[- "+t+" -]",templateType:"provincie"}]},{label:t+" "+new Date().getMinutes()}]},{label:t+" "+new Date().getMinutes(),children:[{label:t+" "+new Date().getMilliseconds(),narrowDown:!0,data:{requestParams:"Niveau-deeper"}},{label:"[- "+t+" -]",templateType:"provincie"}]},{label:t+" "+new Date().getMinutes()}]},S=new Map([["provincie",(n,a)=>{const t=n.children||n.narrowDown,d=v`Bekijk deelgemeentes
        ...
        `);o.storyName="vl-cascader - default";o.decorators=[w];o.parameters={controls:{exclude:["content","label","labelSlot"]}};const m=k(r,({breadcrumbPlaceholder:n,level:a,loadingMessage:t,loading:d,hideBreadcrumb:p,homeSlot:u,onVlClickBreadcrumb:y})=>v`
            <vl-side-sheet
                left
        ...
        `);m.storyName="vl-cascader - side-sheet";m.args={breadcrumbPlaceholder:'<vl-autocomplete placeholder="Zoek..." slot="breadcrumb-placeholder"></vl-autocomplete>'};m.parameters={controls:{exclude:["content","label","labelSlot"]}};const c=k(r,({level:n,loadingMessage:a,loading:t,hideBreadcrumb:d,templates:p,onVlClickBreadcrumb:u})=>v`
            <vl-cascader
                level="${n}"
                hide-breadcrumb="${d}"
                loading="${t}"
        ...
        `);c.storyName="vl-cascader - dynamic templating";c.decorators=[w];c.argTypes={templates:{table:{disable:!1}}};c.args={templates:S};c.parameters={controls:{exclude:["content","label","labelSlot"]}};const i=k(r,({items:n})=>v`
  ...
  return html\`
    ...
    \`;
})`,...i.parameters?.docs?.source}}};const Z=["CascaderDefault","CascaderSideSheet","CascaderDynamicTemplating","CascaderPropertyBinding"];export{o as CascaderDefault,c as CascaderDynamicTemplating,i as CascaderPropertyBinding,m as CascaderSideSheet,Z as __namedExportsOrder,F as default};
