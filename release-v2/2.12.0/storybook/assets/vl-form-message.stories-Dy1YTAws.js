import{Y as a,Z as i,U as g,c7 as u,W as f,u as l,j as e,C as h,bb as p,s as v,x as j,r as x,c as b}from"./iframe-BJy2lIHs.js";import"./preload-helper-D9Z9MdNV.js";const s={...f,...u,defaultSlot:""},y={...g,for:{name:"for",description:"De id van het input element waarvoor de message getoond moet worden.",table:{category:a.ATTRIBUTES,type:{summary:i.STRING},defaultValue:{summary:String(s.for)}}},state:{name:"state",description:"De state van het input element waarvoor de message getoond moet worden.",table:{category:a.ATTRIBUTES,type:{summary:"ValidityState"},defaultValue:{summary:String(s.state)}}},show:{name:"show",description:"Duidt aan of de message getoond moet worden.<br>Dit kan gebruikt worden om de message manueel te tonen of te verbergen.",table:{category:a.ATTRIBUTES,type:{summary:i.BOOLEAN},defaultValue:{summary:String(s.show)}}},preLine:{name:"preLine",description:"Duidt aan of de nieuwe lijnen (`\n`) in de message behouden worden.",table:{category:a.ATTRIBUTES,type:{summary:i.BOOLEAN},defaultValue:{summary:String(s.preLine)}}},defaultSlot:{name:"[default]",description:"De inhoud van de message.",table:{type:{summary:i.HTML},category:a.SLOTS,defaultValue:{summary:s.defaultSlot}}}};function d(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...l(),...o.components},{FluxComponentMetaData:t}=n;return t||k("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"form-message",children:"Form Message"}),`
...
de DOM. Een voorbeeld hiervan kan je vinden in onze `,e.jsx(n.a,{href:"/docs/patronen-formulier-demo--documentatie",children:"form demo"}),"."]}),`
