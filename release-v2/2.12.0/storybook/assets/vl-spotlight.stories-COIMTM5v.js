import{Y as e,Z as n,a1 as f,a0 as A,U as N,b8 as u,W as I,s as S,x as s,r as L,b9 as E}from"./iframe-BJy2lIHs.js";import"./preload-helper-D9Z9MdNV.js";const t={...I,link:"",linkLabel:"",external:!1,alt:!1,noBorder:!1,size:u.S,imgSrc:"",imgAlt:"",title:"",subtitle:"",text:"",content:""},O={...N,link:{name:"link",description:"De component wordt een link. Door te klikken op de component wordt de gebruiker doorgestuurd naar de link die gezet is in dit attribuut.",table:{type:{summary:n.STRING},defaultValue:{summary:t.link},category:e.ATTRIBUTES}},linkLabel:{name:"link-label",description:'Aria-label voor de link. Aanbevolen voor toegankelijkheid. Let op: `aria-label` vervangt de volledige linktekst, bv. "Premies voor renovatie - opent in nieuw venster" bij external links.',table:{type:{summary:n.STRING},defaultValue:{summary:t.linkLabel},category:e.ATTRIBUTES}},external:{name:"external",description:"Opent de link in een nieuw tabblad. Dit attribuut wordt enkel gebruikt als het attribuut `link` gezet is.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.external)},category:e.ATTRIBUTES}},alt:{name:"alt",description:"Geeft de component een alternatieve stijl. De achtergrond wordt grijs.",table:{type:{summary:n.BOOLEAN},defaultValue:{summary:String(t.alt)},category:e.ATTRIBUTES}},noBorder:{name:"no-border",description:"Geeft de component weer zonder border.",table:{type:{summary:n.BOOLEAN},defaultValue:{summary:String(t.noBorder)},category:e.ATTRIBUTES}},size:{name:"size",description:"Dit attribuut bepaalt de grootte van de component.",type:{name:n.STRING,required:!1},control:{type:A.SELECT},options:Object.values(u),table:{type:{summary:f(Object.values(u))},category:e.ATTRIBUTES,defaultValue:{summary:String(t.size)}}},imgSrc:{name:"img-src",description:"Het path van de image dat getoond moet worden in de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.imgSrc)},category:e.ATTRIBUTES}},imgAlt:{name:"img-alt",description:"De alternatieve tekst van de image dat getoond moet worden in de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.imgAlt)},category:e.ATTRIBUTES}},title:{name:"title",description:"Titel van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.title)},category:e.SLOTS}},subtitle:{name:"subtitle",description:"Subtitle van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.subtitle)},category:e.SLOTS}},text:{name:"text",description:"Text van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.text)},category:e.SLOTS}},content:{name:"content",description:"Content van de spotlight.",table:{type:{summary:n.STRING},defaultValue:{summary:String(t.content)},category:e.SLOTS}}};L([E]);const P={id:"components-block-spotlight",title:"Components - Block/spotlight",tags:["autodocs"],args:t,argTypes:O},R=S(t,({link:l,linkLabel:c,alt:y,size:k,imgSrc:T,imgAlt:w,title:d,subtitle:v,text:h,content:b,external:$,noBorder:x})=>s`
    ...
    `),a=R.bind({});a.storyName="vl-spotlight - default";a.args={title:"Premies voor renovatie"};const o=S(t,({external:l,linkLabel:c})=>s`
        <vl-spotlight
            link="http://www.google.com"
            link-label=${c||(l?"Premies voor renovatie - opent in nieuw venster":"Premies voor renovatie")}
            ?external=${l}
        >
...
`;i.storyName="vl-spotlight - with image";i.decorators=[l=>s` <div style="width: 600px;">${l()}</div>`];const g=()=>s`
...
`;g.storyName="vl-spotlight - with subtitle";a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:'story(spotlightArgs, ({\n  link,\n  linkLabel,\n  alt,\n  size,\n  imgSrc,\n  imgAlt,\n  title,\n  subtitle,\n  text,\n  content,\n  external,\n  noBorder\n}: typeof spotlightArgs) => html`\n        <vl-spotlight\n            link=${link}\n            link-label=${linkLabel}\n            ?alt=${alt}\n            ?no-border=${noBorder}\n            ?external=${external}\n            size=${size}\n            img-src=${imgSrc}\n            img-alt=${imgAlt}\n        >\n            ${title ? html`<span slot="title"> ${title} </span>` : ``}\n            ${subtitle ? html`<span slot="subtitle"> ${subtitle} </span>` : ``}\n            ${text ? html`<span slot="text"> ${text} </span>` : ``}\n            ${content ? html`<span slot="content"> ${content} </span>` : ``}\n        </vl-spotlight>\n    `)',...a.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(spotlightArgs, ({
  external,
  linkLabel
}: typeof spotlightArgs) => html\`
        <vl-spotlight
