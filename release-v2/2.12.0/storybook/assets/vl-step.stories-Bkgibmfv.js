import{Y as t,Z as s,U as c,W as u,s as d,x as a}from"./iframe-BJy2lIHs.js";import"./preload-helper-D9Z9MdNV.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,e={...u,defaultOpen:!1,toggleable:!1,type:null,onToggle:g("vl-on-toggle"),contentRenderer:void 0,iconSlot:"",subIconSlot:"",titleSlot:"",titleAnnotationSlot:"",subtitleSlot:"",contentSlot:""},m={...c,toggleable:{name:"toggleable",description:"Beeldt een stap af als een accordion.",control:!1,table:{type:{summary:s.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(e.toggleable)}}},type:{name:"type",description:"Beeldt een stap af in een bepaalde staat.",control:!1,table:{type:{summary:"highlighted | disabled | success | warning | error"},category:t.ATTRIBUTES,defaultValue:{summary:String(e.type)}}},defaultOpen:{name:"default-open",description:"Indien gezet zal de step standaard geopend zijn. Werkt enkel in combinatie met het `toggleable` attribuut. <br>Dit attribuut is niet reactief.",table:{type:{summary:s.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(e.defaultOpen)}}},onToggle:{name:"vl-on-toggle",description:"Afgevuurd bij het openen of sluiten van de toggleable step.<br>Het event bevat of de step geopend of gesloten is.<br>Werkt enkel in combinatie met het `toggleable` attribuut.",table:{type:{summary:"{ open: boolean }"},category:t.EVENTS}},contentRenderer:{name:"contentRenderer",description:"Functie die aangeroepen wordt om dynamische content te renderen op basis van de open/closed state.<br>Signatuur: `(open: boolean) => TemplateResult`<br>Werkt enkel in combinatie met het `toggleable` attribuut.<br>Wanneer deze property is ingesteld, wordt het `content` slot genegeerd.",control:!1,table:{type:{summary:"(open: boolean) => TemplateResult"},category:t.PROPERTIES,defaultValue:{summary:"undefined"}}},iconSlot:{name:"icon",description:"Element voor het hoofd-icoon van de step.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.iconSlot}}},subIconSlot:{name:"sub-icon",description:"Element voor het sub-icoon van de step.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.subIconSlot}}},titleSlot:{name:"title",description:"Element voor de titel van de step.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.titleSlot}}},titleAnnotationSlot:{name:"title-annotation",description:"Element voor een annotatie bij de titel van de step.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.titleAnnotationSlot}}},subtitleSlot:{name:"subtitle",description:"Element voor de subtitel van de step.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.subtitleSlot}}},contentSlot:{name:"content",description:"Element voor de hoofdcontent van de step.<br>Wordt genegeerd wanneer de `contentRenderer` property is ingesteld.",table:{type:{summary:s.HTML},category:t.SLOTS,defaultValue:{summary:e.contentSlot}}}},S={id:"components-block-steps-step",title:"Components - Block/steps/step",tags:["autodocs"],args:e,argTypes:m,parameters:{controls:{hideNoControlsWarning:!0}}},i=d(e,({defaultOpen:l,onToggle:n})=>a`
        <vl-steps>
            <vl-step toggleable ?default-open=${l} @vl-on-toggle=${p=>n(p.detail)}>
    ...
    `);i.storyName="vl-step - toggleable";const r=d(e,({defaultOpen:l})=>a`
        <vl-steps>
            <vl-step
                toggleable
                ?default-open=${l}
                .contentRenderer=${n=>n?a`<p><strong>Open:</strong> Dit is de uitgebreide content die alleen zichtbaar is wanneer de step geopend is.</p>`:a`<p><em>Gesloten:</em> Klik om meer te zien...</p>`}
            >
                <span slot="icon">1</span>
