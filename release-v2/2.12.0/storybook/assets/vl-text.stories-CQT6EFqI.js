...
`,n.jsx(s,{of:$})]})}function I(t={}){const{wrapper:e}={...b(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(S,{...t})}):S(t)}function U(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}O([M]);const _={id:"components-atom-text",title:"Components - Atom/text",tags:["autodocs"],args:T,argTypes:V,parameters:{docs:{page:I}}},l=B(T,({bold:t,success:e,warning:f,error:y,italic:h,underline:j,annotation:w,small:v,defaultSlot:A})=>N`
        <vl-text
            ?bold=${t}
            ?success=${e}
            ?warning=${f}
