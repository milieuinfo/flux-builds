"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[2063],{"../../libs/components/src/form/select-rich/vl-select-rich.component.ts":(e,l,t)=>{t.d(l,{A:()=>_});var i=t("../../libs/common/src/index.ts"),s=t("../../node_modules/@domg/govflanders-style/common/index.js"),o=t("../../node_modules/@domg/govflanders-style/component/index.js"),r=t("../../node_modules/choices.js/public/assets/scripts/choices.mjs"),c=t("../../node_modules/lit/index.js"),a=t("../../node_modules/lit/directives/class-map.js"),n=t("../../libs/components/src/form/form-control/index.ts"),d=t("../../libs/components/src/form/input-field/index.ts");let u=(0,c.AH)`
    .vl-pill {
        display: inline-flex;
        max-width: 100%;
        align-items: center;
...
`;var p=t("../../libs/styles/src/index.ts");let m=(0,c.AH)`
...
`;var h=t("../../libs/components/src/form/select-rich/vl-select-rich.defaults.ts");class _ extends n.M{constructor(){super(),this.options=h.X.options,this.initialOptions=h.X.initialOptions,this.placeholder=h.X.placeholder,this.search=h.X.search,this.searchPlaceholder=h.X.searchPlaceholder,this.choices=null,this.notDeletable=h.X.notDeletable,this.multiple=h.X.multiple,this.position=h.X.position,this.resultLimit=h.X.resultLimit,this.noResultsText=h.X.noResultsText,this.noChoicesText=h.X.noChoicesText,this.value=null,this.dropdownInitialised=!1,this.isDropdownOpen=!1,this.dispatchInput=!1,this.initialised=!1,this.callbackOnInit=async()=>{this.getChoicesElement()?.addEventListener("click",this.onClickChoices),this.internals.labels[0]?.addEventListener("click",this.onClickChoices),this.getChoicesElement()?.addEventListener("showDropdown",()=>{let e=this.getChoicesElement()?.querySelector(".vl-select__list--dropdown");e&&!this.dropdownInitialised&&(e.setAttribute("role","group"),e.setAttribute("id","vl-select__list"),this.dropdownInitialised=!0),this.isDropdownOpen=!0}),this.getChoicesElement()?.addEventListener("hideDropdown",()=>{this.isDropdownOpen=!1}),this.setChoicesInputAttributes(),await Promise.resolve(),this.value||this.setValue(null),this.choices?.input?.element?.addEventListener("input",this.onSearchInput),this.initialised=!0},this.onClickChoices=()=>{this.disabled||this.choices?.showDropdown()},this.onSearchInput=e=>{let l=e?.target?.value;this.dispatchEvent(new CustomEvent("vl-select-search",{bubbles:!0,composed:!0,detail:{value:l}}))},this.submitFormOnEnter=!1}static get styles(){return[s.h8,s.BI,d.N,v,u,o.py,m]}static get properties(){return{initialOptions:{type:Array,attribute:"initial-options"},options:{type:Array,hasChanged:(e,l)=>e instanceof Array&&l instanceof Array?JSON.stringify([...e])!==JSON.stringify([...l]):e!==l},placeholder:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},multiple:{type:Boolean},search:{type:Boolean},position:{type:String},resultLimit:{type:Number,attribute:"result-limit"},noResultsText:{type:String,attribute:"no-results-text"},noChoicesText:{type:String,attribute:"no-choices-text"},searchPlaceholder:{type:String,attribute:"search-placeholder"},value:{type:FormData,state:!0,hasChanged:(e,l)=>this.compareValue(l,e)}}}static{this.compareValue=(e,l)=>e instanceof FormData&&l instanceof FormData?JSON.stringify([...e.entries()])!==JSON.stringify([...l.entries()]):e!==l}connectedCallback(){super.connectedCallback(),this.initialised&&(this.choices=new r.A(this.validationTarget,this.getChoicesConfig()),this.initialOptions=structuredClone(this.options))}async firstUpdated(e){super.firstUpdated(e),this.choices=new r.A(this.validationTarget,this.getChoicesConfig()),this.initialOptions=structuredClone(this.options)}updated(e){if(super.updated(e),this.choices){if(e.has("options")&&(this.choices.initialised&&(this.choices.clearStore(),this.choices.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.options)),_.compareValue(this.value,e.has("value"))&&(this.value=this.collectFormData())),e.has("value")){let e={value:this.getSelected()};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{bubbles:!0,composed:!0,detail:e})),this.validity.valid&&this.dispatchEventIfValid(e)}e.has("disabled")&&(this.disabled?this.choices.disable():this.choices.enable()),e.has("error")&&this.internals.setValidity({customError:this.error},"custom-error"),e.has("resultLimit")&&(this.choices.config.searchResultLimit=this.resultLimit)}}disconnectedCallback(){super.disconnectedCallback(),this.getChoicesElement()?.removeEventListener("click",this.onClickChoices),this.internals.labels[0]?.removeEventListener("click",this.onClickChoices),this.choices?.input?.element?.removeEventListener("input",this.onSearchInput),this.choices?.destroy()}render(){let e={"vl-select":!this.multiple,"vl-multiselect":this.multiple,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success};return(0,c.qy)`
            <select
                id=${this.id||c.s6}
                name=${this.name||c.s6}
                class=${(0,a.H)(e)}
            ...
            ></select>
        `}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){super.resetFormControl(),this.choices?.clearStore(),this.choices?.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.initialOptions),this.value=this.collectFormData()}setOptions(e){e&&e.length&&(this.options=structuredClone(e))}updateSelectedOptions(e){let l=e.filter(e=>e.selected).map(e=>e.value),t=e.filter(e=>!e.selected).map(e=>e.value);this.removeSelectionByValue(t),this.selectByValue(l)}setSelectedValues(e){this.removeAllSelections(),this.selectByValue(e)}getSelected(){return this.multiple?this.getSelectedValues():this.getSelectedValues()[0]||null}selectByValue(e){this.choices&&(this.choices.setChoiceByValue(e),this.setValue(this.collectFormData()))}removeSelectionByValue(e){this.choices&&(Array.isArray(e)?e.forEach(e=>this.choices.removeActiveItemsByValue(e)):this.choices.removeActiveItemsByValue(e),this.setValue(this.collectFormData()))}removeAllSelections(){this.choices&&(this.choices.removeActiveItems(),this.setValue(this.collectFormData()))}onKeydown(e){e.stopPropagation(),super.onKeydown(e)}setChoicesInputAttributes(){if(this.choices?.input?.element){let e=this.choices.input.element;e.setAttribute("type","text"),e.classList.add("vl-input-field","vl-input-field-cloned"),e.setAttribute("autocomplete","off"),e.setAttribute("autocapitalize","off"),e.setAttribute("spellcheck","false"),e.setAttribute("role","textbox"),e.setAttribute("aria-autocomplete","list"),e.setAttribute("aria-label","zoek item")}}getSelectedValues(){return Array.from(this.validationTarget.selectedOptions).filter(e=>e.value&&e.hasAttribute("selected")).map(e=>e.value)}collectFormData(){let e=this.name||this.id,l=this.getSelectedValues();return l?.length?l.reduce((l,t,i)=>(i?l.append(e,t):l.set(e,t),l),new FormData):null}getChoicesElement(){return this.shadowRoot?.querySelector(".js-vl-select")}getChoicesConfig(){return{callbackOnInit:this.callbackOnInit,shouldSort:!1,removeItemButton:!this.notDeletable,removeItems:!this.notDeletable,searchEnabled:this.search,placeholder:!!this.placeholder,placeholderValue:this.placeholder,position:this.position,noResultsText:this.noResultsText,searchResultLimit:this.resultLimit,noChoicesText:this.noChoicesText,searchPlaceholderValue:this.searchPlaceholder,classNames:{...r.A.defaults.allOptions.classNames,containerOuter:"js-vl-select",containerInner:"vl-select__inner",input:"vl-input-field",inputCloned:"vl-input-field-cloned",list:"vl-select__list",listItems:"vl-select__list--multiple",listSingle:"vl-select__list--single",listDropdown:["vl-select__list","vl-select__list--dropdown"],item:"vl-select__item",itemSelectable:"vl-select__item--selectable",itemDisabled:"vl-select__item--disabled",itemChoice:"vl-select__item--choice",placeholder:"vl-select__placeholder",group:"vl-select__group",groupHeading:"vl-select__heading",button:"vl-select__button"},callbackOnCreateTemplates:e=>({containerOuter:()=>e(`
                            <div
                            ...
                            ></div>
                            `),item:(l,t)=>{let i=!0===t.placeholder;return this.notDeletable?e(`
                        ...
                        `):e(`<div class="
                                ...
                                </div>`)},itemList:()=>e(`<div class="vl-input-field ${this.multiple?"vl-select__list--multiple":""}" role="listbox"></div>`),choiceList:()=>e('<div class="vl-select__list" role="listbox" aria-label="item lijst" tabindex="0"></div>')})}}onChange(){this.value=this.collectFormData()}onInput(){this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:{value:this.getSelected()}}))}}_=function(e,l,t,i){var s,o=arguments.length,r=o<3?l:null===i?i=Object.getOwnPropertyDescriptor(l,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,l,t,i);else for(var c=e.length-1;c>=0;c--)(s=e[c])&&(r=(o<3?s(r):o>3?s(l,t,r):s(l,t))||r);return o>3&&r&&Object.defineProperty(l,t,r),r}([(0,i.M1)("vl-select-rich")],_)},"../../libs/components/src/form/select-rich/vl-select-rich.defaults.ts":(e,l,t)=>{t.d(l,{X:()=>o});var i=t("../../libs/components/src/form/form-control/form-control.defaults.ts"),s=t("../../libs/components/src/form/select-rich/vl-select-rich.model.ts");let o={...i.i,initialOptions:[],options:[],placeholder:"",notDeletable:!1,multiple:!1,search:!1,position:s.u.AUTO,resultLimit:4,noResultsText:"Geen resultaten gevonden",noChoicesText:"Geen resterende opties gevonden",searchPlaceholder:"Zoek item"}},"../../libs/components/src/form/select-rich/vl-select-rich.model.ts":(e,l,t)=>{t.d(l,{u:()=>i});let i={AUTO:"auto",TOP:"top",BOTTOM:"bottom"}}}]);