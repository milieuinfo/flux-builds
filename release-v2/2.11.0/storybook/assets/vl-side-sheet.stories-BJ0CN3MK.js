...
`;function f(t){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...x(),...t.components},{FluxComponentMetaData:a}=i;return a||M("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(i.h1,{id:"side-sheet",children:"Side sheet"}),`
...
`,e.jsx(b,{of:l}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld code om side-sheet te openen en te sluiten van buitenaf"}),e.jsx($,{code:T,language:"ts",dark:!0})]}),`
...
`,e.jsx(i.p,{children:e.jsx(i.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-side-sheet.html",rel:"nofollow",children:"Legacy Demo - Side Sheet"})})]})}function A(t={}){const{wrapper:i}={...x(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(f,{...t})}):f(t)}function M(t,i){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const C=()=>{let t;return customElements.whenDefined("vl-side-sheet").then(()=>{t=document.querySelector("#side-sheet-toggle"),document.querySelector("#vl-side-sheet-open-button-with-close-listener")}),{toggleSideSheet:()=>t?.toggle(),openSideSheet:()=>t?.open(),closeSideSheet:()=>t?.close()}},P={id:"components-block-side-sheet",title:"Components - Block/side-sheet",tags:["autodocs"],args:n,argTypes:V,parameters:{docs:{page:A}},decorators:[t=>g` <div style="height: 150px;">${t()}</div>`]},u=S(n,({enableSwipe:t,absolute:i,left:a,toggleText:r,tooltipText:o,right:d,customIcon:c,hideToggleButton:m,iconPlacement:p,open:h})=>g`
        <vl-side-sheet
            ?enable-swipe=${t}
            ?absolute=${i}
            ?left=${a}
    ...
    `);u.storyName="vl-side-sheet - default";const l=S(n,({enableSwipe:t,absolute:i,left:a,toggleText:r,tooltipText:o,right:d,customIcon:c,hideToggleButton:m,iconPlacement:p,open:h})=>{const{toggleSideSheet:j,openSideSheet:q,closeSideSheet:v}=C();return g`
            <style>
                :root {
  ...
  return html\`
    ...
    closeSideSheet();
        ...
        \`;
})`,...l.parameters?.docs?.source}}};const L=["SideSheetDefault","SideSheetToggle"];export{u as SideSheetDefault,l as SideSheetToggle,L as __namedExportsOrder,P as default};
