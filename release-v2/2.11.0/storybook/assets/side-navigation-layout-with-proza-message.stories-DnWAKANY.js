import{N as t,O as i,x as s,r as o,P as n}from"./iframe-BWsn3Pr7.js";import"./vl-side-navigation.component-tsPCsyiV.js";import{V as l}from"./vl-side-navigation-layout.component-auw8UJss.js";o([l,t,i,n]);const a="side-navigation-layout-proza-message",r=s`
...
`,u=()=>{t.__setPreloadedMessagesCacheForDomain(a,Promise.resolve({"page-title":"Side navigation layout met proza message","section-1-title":"Ontwerpprincipes","section-1-sub-1":"Consistente headings","section-1-sub-2":"Scanbare content","section-1-sub-3":"Toegankelijkheid","section-2-title":"Implementatie","section-2-sub-1":"Preloaden van berichten","section-2-sub-2":"Vullen van titels","section-2-sub-3":"Validatie","section-3-title":"Resultaat","section-3-sub-1":"Wat je in de side navigation ziet","section-3-sub-2":"Samenvatting"})),i.__setToegelatenOperatiesCacheForDomain(a,Promise.resolve({update:!1}))},m={title:"Patronen/Pagina Opbouw/Side Navigation Met Proza Message",parameters:{layout:"fullscreen",docs:{story:{inline:!1,iframeHeight:860}}}},e=()=>(u(),r);e.storyName="vl-side-navigation-layout-next - met proza message";e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  preloadProzaMessages();
  return sideNavigationLayoutWithProzaMessageHTML;
}`,...e.parameters?.docs?.source}}};const p=["LayoutMetProzaMessage"],g=Object.freeze(Object.defineProperty({__proto__:null,LayoutMetProzaMessage:e,__namedExportsOrder:p,default:m},Symbol.toStringTag,{value:"Module"}));export{e as L,g as s};
