...
`]}),`
`,n.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function C(i={}){const{wrapper:e}={...b(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(x,{...i})}):x(i)}function y(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const A={id:"components-block-next-side-navigation-layout",title:"Components - Block/next/side-navigation-layout",tags:["autodocs"],args:a,argTypes:T,parameters:{docs:{page:C,story:{inline:!1,iframeHeight:500}}}};$([S,w,q,I]);const t=v`
    <vl-paragraph>
...
`,r=g(a,({compact:i,contentBlock:e,navigationTitle:o,excludeSelectors:p})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
        ...
        `);r.storyName="vl-side-navigation-layout-next - default";const d=g(a,({compact:i,contentBlock:e,maxDepth:o,excludeSelectors:p})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
                max-depth=${o}
        ...
        `);d.storyName="vl-side-navigation-layout-next - met steps";d.parameters={docs:{story:{inline:!1,iframeHeight:800}}};const c=g(a,({compact:i,contentBlock:e,excludeSelectors:o})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
        ...
        `);c.storyName="vl-side-navigation-layout-next - twee layouts met eigen content";c.parameters={docs:{story:{inline:!1,iframeHeight:900}}};const u=g(a,({compact:i,contentBlock:e,excludeSelectors:o})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
        ...
        `);u.storyName="vl-side-navigation-layout-next - custom table of contents";r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  navigationTitle,
  excludeSelectors
