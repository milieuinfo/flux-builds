import{Y as i,Z as c,a0 as M,u as S,j as e,C as j,bk as B,s as F,x as P}from"./iframe-BWsn3Pr7.js";import"./vl-map-base-layer-GzsTO7HG.js";import"./vl-map-base-layer-grb-gray-DkR4pSJA.js";import"./vl-map-features-layer-DbA6_kY7.js";import"./vl-map-layer-circle-style-Tr5dao-V.js";import{m as k,a as A}from"./vl-map-layer-style.stories-arg-B3U42Z8Q.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-OiGP_esM.js";const o={...A,borderColor:"rgba(0, 0, 0, 0)",clusterColor:"rgba(2, 85, 204, 1)",clusterTextColor:"#FFF",clusterMultiplier:1,size:5},E={...k,borderColor:{name:"border-color",description:"De kleur van de rand van de kaartlaagstijl.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.borderColor}}},clusterColor:{name:"cluster-color",description:"De kleur bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterColor}}},clusterMultiplier:{name:"cluster-multiplier",description:"Bepaalt de verhouding van de vergroting voor clusters tegenover ingestelde `size`.",control:{type:M.NUMBER,step:.1},table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.clusterMultiplier)}}},clusterTextColor:{name:"cluster-text-color",description:"De kleur van de tekst bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterTextColor}}},size:{name:"size",description:"De grootte van de cirkels.",table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.size)}}}};function z(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...S(),...r.components},{FluxComponentMetaData:s}=t;return s||N("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"map-layer-circle-style",children:"Map Layer Circle Style"}),`
