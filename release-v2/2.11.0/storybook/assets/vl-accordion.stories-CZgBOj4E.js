...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accordion.html",rel:"nofollow",children:"Legacy Demo - Accordion"})})]})}function K(a={}){const{wrapper:n}={...S(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(x,{...a})}):x(a)}function F(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}R([B,_]);const Z={id:"components-block-accordion",title:"Components - Block/accordion",tags:["autodocs"],args:o,argTypes:G,parameters:{docs:{page:K}}},s=P(o,({bold:a,closeToggleText:n,contentPadding:T,disabled:$,defaultOpen:j,icon:k,openToggleText:y,toggleText:w,defaultSlot:L,titleSlot:A,subtitleSlot:O,menuSlot:H,headingLevel:M,onToggle:z})=>N`
        <vl-accordion
            ?bold=${a}
            content-padding=${T}
            close-toggle-text=${n}
