...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-toasters",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Toaster"})})]})}function z(n={}){const{wrapper:t}={...w(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(j,{...n})}):j(n)}function b(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}var x=Object.freeze,N=Object.defineProperty,v=(n,t)=>x(N(n,"raw",{value:x(n.slice())})),y,k,T;D([L,q,C]);const R={id:"components-block-toaster",title:"Components - Block/toaster",tags:["autodocs"],args:i,argTypes:M,parameters:{contentPadding:"large",docs:{page:z,story:{inline:!0}},controls:{hideNoControlsWarning:!0}},decorators:[n=>d` <div style="height: 400px;">${n()}</div>`]},o=u(i,({placement:n,fadeOut:t,defaultSlot:r})=>d(y||(y=v([`
        <script>
    ...
    `);a.storyName="vl-toaster - default slot";a.args={placement:"bottom-right",defaultSlot:`<vl-alert
                ...
                </vl-alert>`};const l=u(i,({placement:n,fadeOut:t})=>d(k||(k=v([`
        <script>
    ...
    `])),t,n));l.storyName="vl-toaster - show alert";l.parameters={controls:{exclude:["defaultSlot"]}};const s=u(i,({placement:n,fadeOut:t,defaultSlot:r})=>d(T||(T=v([`
        <script>
