import{u as p,j as l,M as h,S as u,cY as x,C as m,cZ as t,J as a,c_ as v,i as f,x as r,r as b,b as j,V as y,d as k}from"./iframe-BWsn3Pr7.js";import"./vl-checkbox.component-CvVVUNDF.js";import"./vl-datepicker.component-CGTacbZy.js";import"./vl-fieldset.component-CEX40_0t.js";import"./vl-input-field-masked.component-JDC2nPd7.js";import"./vl-radio.component-CHlVTLth.js";import"./vl-radio-group.component-CE7zrAt5.js";import"./vl-select.component-BeclDyWK.js";import"./vl-select-rich.component-6VfhK8u2.js";import"./vl-textarea.component-DAqVE4Ft.js";import"./vl-textarea-rich.component-Bl1Wf8Pb.js";import"./vl-upload.component-CmniMp_T.js";import"./preload-helper-D9Z9MdNV.js";import"./cleave-esm-DfUhcNrv.js";import"./vl-upload-progress.component-By6VmyDp.js";const S=""+new URL("grid-large-uKz8Dn73.png",import.meta.url).href,w=""+new URL("grid-medium-DzNcUqr3.png",import.meta.url).href,z=""+new URL("grid-small-C8fouyyk.png",import.meta.url).href,M=""+new URL("grid-extra-small-CfB2bL1s.png",import.meta.url).href,C=""+new URL("css-large-BCbHcJ27.png",import.meta.url).href,$=""+new URL("css-medium-B1Gfoyhz.png",import.meta.url).href,L=""+new URL("css-small-DRqYjDPH.png",import.meta.url).href,R=""+new URL("css-extra-small-DJX17tHm.png",import.meta.url).href,E=`import gridRawCss from './vl-grid.raw.css?raw';
...
\`;
`;function g(e){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...p(),...e.components},{FluxComponentMetaData:d}=n;return d||_("FluxComponentMetaData"),l.jsxs(l.Fragment,{children:[l.jsx(h,{title:"Styles/Layout (afnemers)/grid"}),`
...
`})}),`
`,l.jsx(m,{of:i})]})}function G(e={}){const{wrapper:n}={...p(),...e.components};return n?l.jsx(n,{...e,children:l.jsx(g,{...e})}):g(e)}function _(e,n){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}const D=f`
    .vl-grid {
...
`;b([j,y,k]);const P={id:"styles-layout-grid",title:"Styles/Layout (afnemers)/grid",tags:["autodocs"],parameters:{docs:{page:G}}},c=()=>r`
    <style>
...
\``,...i.parameters?.docs?.source}}};const T=["GridResponsive","GridColumnStart","GridJustifyAlign","GridWithForm"];export{s as GridColumnStart,o as GridJustifyAlign,c as GridResponsive,i as GridWithForm,T as __namedExportsOrder,P as default};
