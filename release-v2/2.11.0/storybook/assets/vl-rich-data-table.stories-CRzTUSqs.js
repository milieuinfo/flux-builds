...
`,a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data-table.html",rel:"nofollow",children:"Legacy Demo - Rich Data Table"})]})]})}function oe(t={}){const{wrapper:e}={...M(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(A,{...t})}):A(t)}function de(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}I([q,O,F,L,H,J,W,K,G]);const Be={id:"components-block-rich-data-table",title:"Components - Block/rich-data-table",tags:["autodocs"],args:p,argTypes:ae,parameters:{docs:{page:oe}}},ce=D(p,({collapsedM:t,collapsedS:e,collapsedXS:m,zebra:s,fluxZebra:i,label:o,caption:n})=>T`
            <vl-rich-data-table
        ...
        `),v=ce.bind({});v.storyName="vl-rich-data-table - default";v.args={collapsedM:!1,collapsedS:!1,collapsedXS:!1,caption:"Tabel met projectgegevens"};const me=D(p,({collapsedM:t,collapsedS:e,collapsedXS:m,zebra:s,fluxZebra:i,multiSort:o,label:n,caption:l})=>{const d='{"data": [{ "id" : 0, "name" : "Water" , "owner" : "Kevin Jansens" }, { "id" : 1, "name" : "Vuur" , "owner" : "Anton Vanherrewege" }, { "id" : 2, "name" : "Aarde" , "owner" : "Hedwig Jansens" }]}';return ee(),T`
            <vl-rich-data-table
        ...
        `}),N=me.bind({});N.storyName="vl-rich-data-table - sorting";N.args={collapsedM:!1,collapsedS:!1,collapsedXS:!1,multiSort:!1,caption:"Sorteerbare tabel"};const fe=D(p,({collapsedM:t,collapsedS:e,collapsedXS:m,filterClosable:s,filterClosed:i,filterMaxWidth:o,zebra:n,fluxZebra:l,label:d,caption:c})=>(_(),T`
            <vl-rich-data-table
        ...
        `)),k=fe.bind({});k.storyName="vl-rich-data-table - filter";k.args={filterClosable:!0,caption:"Tabel met filter"};const pe=D(p,({collapsedM:t,collapsedS:e,collapsedXS:m,filterClosable:s,filterClosed:i,filterMaxWidth:o,zebra:n,fluxZebra:l,label:d,caption:c})=>(Y(),T`
            <vl-rich-data-table
        ...
        `)),x=pe.bind({});x.storyName="vl-rich-data-table - filter and pagination";x.args={filterClosable:!0,filterClosed:!0,caption:"Tabel met filter en paginatie"};const he=D(p,({collapsedM:t,collapsedS:e,collapsedXS:m,zebra:s,fluxZebra:i,label:o,caption:n})=>{const l={data:[{selected:!0,name:"document.pdf",extension:"pdf",filesize:"123 MB"},{selected:!1,name:"bestand.docx",extension:"docx",filesize:"2 GB"},{selected:!1,name:"Een bestand met een lange naam.pptx",extension:"pptx",filesize:"10 KB"}]},{checkActions:d,headerTemplate:c,dataFieldRenderer:r,applySelectionToAllRows:f}=Q();return T`
            <style>
                vl-title::part(h1) {
