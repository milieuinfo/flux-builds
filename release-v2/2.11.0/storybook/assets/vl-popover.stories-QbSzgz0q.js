...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/js-components/vl-ui-popover",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Popover"})})]})}function U(t={}){const{wrapper:o}={...V(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(C,{...t})}):C(t)}function S(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:x}=__STORYBOOK_MODULE_ACTIONS__;_([N,I,q,M]);const X={id:"components-block-popover",title:"Components - Block/popover",tags:["autodocs"],args:r,argTypes:Z,parameters:{docs:{page:U}}},z=t=>h` <div style="position: relative;min-height: 150px;">${t()}</div>`,R=g(r,({trigger:t,contentPadding:o,open:c,placement:n,hideArrow:b,hideOnClick:l,distance:O,strategy:L})=>h`
            ...
            <vl-popover
                ...
                content-padding=${o}
            >
                <vl-popover-action-list @click=${D=>{const u=D.target;x("click")("vl-popover-action clicked > "+u.action),Array.from(u.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(y=>{y!==u&&y.removeAttribute("selected")}),u.setAttribute("selected","")}}>
        ...
        <vl-popover-action-list @click=${c=>{const n=c.target;x("click")("vl-popover-action clicked > "+n.action,n),Array.from(n.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(l=>{l!==n&&l.removeAttribute("selected")}),n.setAttribute("selected","")}}>
    ...
    `);s.storyName="vl-popover - actions";s.parameters={controls:{include:["selected"]}};const v=g(f,({selected:t})=>h`
        <vl-popover-action-list @click=${c=>{const n=c.target;x("click")("vl-popover-action clicked > "+n.action),Array.from(n.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(l=>{l!==n&&l.removeAttribute("selected")}),n.setAttribute("selected","")}}>
            <vl-popover-action ?selected=${t} icon="search" action="zoeken">Zoeken</vl-popover-action>
            <vl-popover-action icon="bell" action="rapporten-tonen">Rapportenoverzicht</vl-popover-action>
            <vl-popover-action icon="pin" action="locatie-vinden">Vind locatie</vl-popover-action>
            <hr class="vl-separator" />
  ...
  return html\`
    ...
    \`;
})`,...m.parameters?.docs?.source}}};const W=["PopoverDefault","PopoverHover","PopoverActions","PopoverActionsDivider","PopoverActionsLinks"];export{s as PopoverActions,v as PopoverActionsDivider,m as PopoverActionsLinks,a as PopoverDefault,p as PopoverHover,W as __namedExportsOrder,X as default};
