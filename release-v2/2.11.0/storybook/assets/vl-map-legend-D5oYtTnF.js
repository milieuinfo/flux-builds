import{i as c,v as b,t as m,B as u,x as n,bB as h}from"./iframe-BWsn3Pr7.js";import{V as f}from"./vl-map-layer-circle-style-Tr5dao-V.js";import{V as x}from"./vl-map-vector-layer-OiGP_esM.js";import{bl as v}from"./vl-map-base-layer-GzsTO7HG.js";const y=c`
    .ol-box {
...
`,g=[w,...b,y,v],L=c`
    :host {
        display: flex;
        align-items: center;
`;var I=Object.getOwnPropertyDescriptor,T=(e,t,o,l)=>{for(var i=l>1?void 0:l?I(t,o):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(i=s(i)||i);return i};let p=class extends u{constructor(){super(...arguments),this.icon=null,this.label="",this.layer="",this.iconText="",this.iconTextColor=""}static get styles(){return[g,L]}static get properties(){return{layer:{type:String,attribute:"layer"},iconText:{type:String,attribute:"icon-text"},iconTextColor:{type:String,attribute:"icon-text-color",reflect:!0}}}render(){return n`
        ...
        `}};p=T([m("vl-map-legend-item")],p);const a={TOP_LEFT:"top_left",TOP_RIGHT:"top_right",BOTTOM_LEFT:"bottom_left",BOTTOM_RIGHT:"bottom_right"};var z=Object.getOwnPropertyDescriptor,k=(e,t,o,l)=>{for(var i=l>1?void 0:l?z(t,o):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(i=s(i)||i);return i};let d=class extends u{constructor(){super(),this.items=[],this.styledItems=[],this.urlItems=[],this.customItems=[],this.placement=a.BOTTOM_RIGHT}static get styles(){return[c`
                ${h(g)}
