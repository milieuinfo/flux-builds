import{Y as s,Z as r,W as k,U as f,u as q,j as i,bk as j,C as c,s as p,x as u,r as L,P as U,bL as y,d as w,ci as S}from"./iframe-BWsn3Pr7.js";import{t as v}from"./vl-side-navigation.component-tsPCsyiV.js";import"./preload-helper-D9Z9MdNV.js";const C={closed:!1,compact:!1,headingRootSelector:"",maxDepth:void 0,navigationTitle:"Op deze pagina"},t={...k,...C,defaultSlot:""},T={...f,closed:{name:"closed",description:"Wanneer aanwezig wordt de inhoudstafel standaard verborgen. Heeft enkel effect wanneer het attribuut `compact` is gezet of bij mobiele weergave (viewport < 768px). Op desktop zonder compact wordt de navigatie altijd getoond.",table:{type:{summary:r.BOOLEAN},category:s.ATTRIBUTES,defaultValue:{summary:String(t.closed)}}},compact:{name:"compact",description:"Forceert de compacte weergave (toggle knop, verborgen navigatie standaard) ongeacht de viewport grootte.",table:{type:{summary:r.BOOLEAN},category:s.ATTRIBUTES,defaultValue:{summary:String(t.compact)}}},headingRootSelector:{name:"heading-root-selector",description:'CSS selector om het root container element te vinden waarbinnen naar headings gezocht wordt. Indien niet opgegeven, wordt het volledige document/shadow root doorzocht. Voorbeeld: "#section-1" om enkel headings binnen die sectie te scannen.',table:{type:{summary:r.STRING},category:s.ATTRIBUTES,defaultValue:{summary:t.headingRootSelector}}},maxDepth:{name:"max-depth",description:"Optionele maximum diepte voor shadow DOM traversal (bij scannen van headings én bij zoeken van scroll-target). Biedt fijnmazige controle over performantie vs compatibiliteit. 0 = enkel light DOM, 1 = light DOM + eerste niveau shadow DOM, undefined = onbeperkt (standaard).",table:{type:{summary:r.NUMBER},category:s.ATTRIBUTES,defaultValue:{summary:t.maxDepth!==void 0?String(t.maxDepth):"undefined"}}},navigationTitle:{name:"navigation-title",description:"Tekst die getoond wordt als titel boven de inhoudstafel.",table:{type:{summary:r.STRING},category:s.ATTRIBUTES,defaultValue:{summary:t.navigationTitle}}},defaultSlot:{name:"[default]",description:'Custom inhoudsopgave. Wanneer je hier content plaatst (bijv. een ul/li-structuur met vl-link elementen met href="#..."), wordt die gebruikt in plaats van de automatisch gegenereerde inhoudsopgave. De links moeten verwijzen naar heading-ids in de content.',table:{type:{summary:r.HTML},category:s.SLOTS,defaultValue:{summary:String(t.defaultSlot)}}}};function g(o){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...q(),...o.components},{FluxAlert:n,FluxComponentMetaData:d}=e;return n||h("FluxAlert"),d||h("FluxComponentMetaData"),i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"side-navigation-next",children:"Side Navigation Next"}),`
`,i.jsx(d,{id:"components-block-next-side-navigation"}),`
...
`]}),`
`,i.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function D(o={}){const{wrapper:e}={...q(),...o.components};return e?i.jsx(e,{...o,children:i.jsx(g,{...o})}):g(o)}function h(o,e){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}const A={id:"components-block-next-side-navigation",title:"Components - Block/next/side-navigation",tags:["autodocs"],args:t,argTypes:T,parameters:{docs:{page:D,story:{inline:!1,iframeHeight:500}}}};L([U,y,w,S]);const x=u`
...
`,a=p(t,({closed:o,compact:e,headingRootSelector:n,maxDepth:d,navigationTitle:b})=>u`
        ...
        `);a.storyName="vl-side-navigation-next - default";a.args={headingRootSelector:"#story-content-container"};const l=p(t,({closed:o,headingRootSelector:e,maxDepth:n,navigationTitle:d})=>u`
            <div class="vl-grid vl-content-block">
                <vl-side-navigation-next
        ...
        `);l.storyName="vl-side-navigation-next - compact";l.args={compact:!0,headingRootSelector:"#story-content-container"};const m=p(t,({closed:o,compact:e,maxDepth:n})=>u`
        <div class="vl-grid vl-content-block">
            <vl-side-navigation-next
                class="vl-column vl-column--3 vl-column--start-10 vl-column--m-3  vl-column--s-12  vl-side-navigation--order-1"
                ?closed=${o}
