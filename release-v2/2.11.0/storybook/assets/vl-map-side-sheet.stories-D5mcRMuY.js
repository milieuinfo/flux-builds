...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-side-sheet.html",rel:"nofollow",children:"Legacy Demo - Map Side Sheet"})})]})}function E(a={}){const{wrapper:e}={...c(),...a.components};return e?t.jsx(e,{...a,children:t.jsx(m,{...a})}):m(a)}function A(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const k={id:"map-side-sheet-side-sheet",title:"map/side-sheet/side-sheet",tags:["autodocs"],args:n,argTypes:M,parameters:{docs:{page:E}}},i=h(n,({right:a,open:e,enableSwipe:r,defaultSlot:u,toggleText:b,tooltipText:f,customIcon:y,iconPlacement:S,hideToggleButton:v})=>g`
  ...
  open
    ...
    \`)`,...l.parameters?.docs?.source}}};const C=["MapSideSheetDefault","MapSideSheetDual"];export{i as MapSideSheetDefault,l as MapSideSheetDual,C as __namedExportsOrder,k as default};
