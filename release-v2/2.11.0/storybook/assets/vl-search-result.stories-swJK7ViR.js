import{Y as u,Z as h,U as p,W as v,u as i,j as e,C as n,bk as m,x as c,r as b,c8 as x,c9 as g,ca as k}from"./iframe-BWsn3Pr7.js";import"./preload-helper-D9Z9MdNV.js";const d={...v,defaultSlot:""},V={...p,defaultSlot:{name:"[default]",description:"De inhoud van het zoekresultaat",table:{type:{summary:h.HTML},category:u.SLOTS,defaultValue:{summary:d.defaultSlot}}}};function o(a){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...a.components},{FluxComponentMetaData:s}=r;return s||f("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"search-result",children:"Search Result"}),`
...
`,e.jsx(r.p,{children:e.jsx(r.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-search-results",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Search Results"})})]})}function j(a={}){const{wrapper:r}={...i(),...a.components};return r?e.jsx(r,{...a,children:e.jsx(o,{...a})}):o(a)}function f(a,r){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const y={id:"components-block-search-result",title:"Components - Block/search-result",tags:["autodocs"],args:d,argTypes:V,parameters:{docs:{page:j}}};b([x,g,k]);const t=()=>c`
    <vl-search-result>
