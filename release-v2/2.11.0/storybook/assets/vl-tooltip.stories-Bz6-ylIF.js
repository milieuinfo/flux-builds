...
`,e.jsxs(t.p,{children:["De tooltip-component gebruikt achterliggend ",e.jsx(t.a,{href:"https://floating-ui.com/",rel:"nofollow",children:"floating-ui"}),"."]})]})}function M(o={}){const{wrapper:t}={...b(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(h,{...o})}):h(o)}function B(o,t){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}C([D,I]);const G={id:"components-block-tooltip",title:"Components - Block/tooltip",tags:["autodocs"],args:n,argTypes:P,parameters:{docs:{page:M}}},f=o=>d` <div style="position: relative;min-height: 150px;">${o()}</div>`,x=(o,t,s)=>A(n,({open:j,placement:v,hideArrow:y,distance:T,strategy:k,type:E})=>d`
            ${o}
            <vl-tooltip
                for=${s}
                ?open=${j}
