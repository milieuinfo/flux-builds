...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-modify-actions.html",rel:"nofollow",children:"Legacy Demo - Map Modify Action"})})]})}function b(t={}){const{wrapper:e}={...m(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(c,{...t})}):c(t)}function x(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const L={id:"map-action-layer-action-modify-action",title:"map/action/layer-action/modify-action",tags:["autodocs"],args:i,argTypes:h,parameters:{docs:{page:b}}},r=y(i,({active:t,defaultActive:e})=>d`
        <vl-map lambert2008>
  ...
  return html\`
        ...
        \`;
})`,...n.parameters?.docs?.source}}};const V=["MapModifyActionDefault","MapModifyActionSnapping"];export{r as MapModifyActionDefault,n as MapModifyActionSnapping,V as __namedExportsOrder,L as default};
