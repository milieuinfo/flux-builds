...
`]}),`
`,i.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function $(t={}){const{wrapper:e}={...x(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(h,{...t})}):h(t)}function q(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const R={id:"components-block-next-side-navigation",title:"Components - Block/next/side-navigation",tags:["autodocs"],args:n,argTypes:D,parameters:{docs:{page:$,story:{inline:!1,iframeHeight:500}}}};U([y,S,w,T]);const b=u`
