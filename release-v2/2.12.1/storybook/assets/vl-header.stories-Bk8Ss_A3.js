...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-header.html",rel:"nofollow",children:"Legacy Demo - Header"})})]})}function R(t={}){const{wrapper:n}={...g(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(c,{...t})}):c(t)}function p(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}U([L]);const O={id:"components-compliance-header",title:"Components - Compliance/header",tags:["autodocs"],args:r,argTypes:$,parameters:{docs:{page:R,inlineStories:!1},layout:"fullscreen"}},o=w(r,({authenticatedUserUrl:t,development:n,identifier:d,loginRedirectUrl:s,loginUrl:u,logoutUrl:m,skeleton:h,simple:v,switchCapacityUrl:j,rejectLogout:b,logoutCallback:f,applicationLinks:k,onReady:y})=>D`
        <body>
            <vl-header
