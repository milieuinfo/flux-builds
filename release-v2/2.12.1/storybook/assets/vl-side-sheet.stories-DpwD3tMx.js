...
`;function w(i){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...k(),...i.components},{FluxComponentMetaData:u}=t;return u||B("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"side-sheet",children:"Side sheet"}),`
...
icon in te stellen. `,e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-icon/",rel:"nofollow",children:"Hier"}),` vind je een
...
`,e.jsx(T,{of:r}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld code om side-sheet te openen en te sluiten van buitenaf"}),e.jsx(V,{code:E,language:"ts",dark:!0})]}),`
...
`,e.jsx(t.code,{children:"vl-side-bar"}),"-component (link ",e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/vue-documentation/?path=/story/components-vl-sidebar--sidebar-collapsible",rel:"nofollow",children:"side-bar-component"}),")."]}),`
`,e.jsx(t.h3,{id:"legacy-documentatie",children:"Legacy Documentatie"}),`
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-side-sheet--default",rel:"nofollow",children:"Legacy Storybook - Side Sheet"})}),`
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlSideSheet.html",rel:"nofollow",children:"Legacy Documentatie - Side Sheet"})}),`
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-side-sheet.html",rel:"nofollow",children:"Legacy Demo - Side Sheet"})})]})}function M(i={}){const{wrapper:t}={...k(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(w,{...i})}):w(i)}function B(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const P=()=>{let i;return customElements.whenDefined("vl-side-sheet").then(()=>{i=document.querySelector("#side-sheet-toggle"),document.querySelector("#vl-side-sheet-open-button-with-close-listener")}),{toggleSideSheet:()=>i?.toggle(),openSideSheet:()=>i?.open(),closeSideSheet:()=>i?.close()}},z={id:"components-block-side-sheet",title:"Components - Block/side-sheet",tags:["autodocs"],args:n,argTypes:C,parameters:{docs:{page:M}},decorators:[i=>c` <div style="height: 150px;">${i()}</div>`]},o=x(n,({enableSwipe:i,absolute:t,left:u,top:d,toggleText:m,tooltipText:p,right:h,customIcon:g,hideToggleButton:v,iconPlacement:b,open:f,shadow:S})=>c`
        <vl-side-sheet
            ?enable-swipe=${i}
            ?absolute=${t}
            ?left=${u}
  ...
  top
    ...
    \`)`,...l.parameters?.docs?.source}}};const O=["SideSheetDefault","SideSheetToggle","SideSheetTop"];export{o as SideSheetDefault,r as SideSheetToggle,l as SideSheetTop,O as __namedExportsOrder,z as default};
