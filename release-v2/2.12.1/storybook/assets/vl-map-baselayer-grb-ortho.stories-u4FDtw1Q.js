import{u as m,j as e,C as s,s as p,x as c}from"./iframe-B6HStWZE.js";import"./vl-map-base-layer-DGZE_dim.js";import{m as d,a as h}from"./vl-map-baselayer.stories-arg-wf2YIj4k.js";import"./vl-map-base-layer-grb-ortho-D3mUDd0g.js";import"./preload-helper-D9Z9MdNV.js";function l(r){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...m(),...r.components},{FluxComponentMetaData:t}=a;return t||b("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"map-baselayer-grb-ortho",children:"Map Baselayer GRB Ortho"}),`
...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMapBaseLayerGRBOrtho.html",rel:"nofollow",children:"Legacy Documentatie - Map Base Layer Grb Ortho"})})]})}function i(r={}){const{wrapper:a}={...m(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(l,{...r})}):l(r)}function b(r,a){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const f={id:"map-baselayer-baselayer-grb-ortho",title:"map/baselayer/baselayer-grb-ortho",tags:["autodocs"],args:h,argTypes:d,parameters:{docs:{page:i},controls:{hideNoControlsWarning:!0}}},o=p({},()=>c`
        <vl-map lambert2008>
            <vl-map-baselayer-grb-ortho></vl-map-baselayer-grb-ortho>
        </vl-map>
    `);o.storyName="vl-map-baselayer-grb-ortho - default";const n=p({},()=>c`
        <vl-map lambert2008>
            <vl-map-baselayer-grb-ortho background-layer></vl-map-baselayer-grb-ortho>
        </vl-map>
    `);n.storyName="vl-map-baselayer-grb-ortho - background layer";o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story({}, () => html\`
        <vl-map lambert2008>
            <vl-map-baselayer-grb-ortho></vl-map-baselayer-grb-ortho>
        </vl-map>
    \`)`,...o.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`story({}, () => html\`
        <vl-map lambert2008>
            <vl-map-baselayer-grb-ortho background-layer></vl-map-baselayer-grb-ortho>
        </vl-map>
    \`)`,...n.parameters?.docs?.source}}};const j=["MapBaselayerGrbOrthoDefault","MapBaselayerGrbOrthoBackgroundLayer"];export{n as MapBaselayerGrbOrthoBackgroundLayer,o as MapBaselayerGrbOrthoDefault,j as __namedExportsOrder,f as default};
