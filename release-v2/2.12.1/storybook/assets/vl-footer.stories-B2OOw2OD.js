...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://test.widgets.burgerprofiel.dev-vlaanderen.be/docs/global-footer/modules.html",rel:"nofollow",children:"Global Footer - interfaces"})})]})}function b(a={}){const{wrapper:e}={...m(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(s,{...a})}):s(a)}function p(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}v([h]);const w={id:"components-compliance-next-footer",title:"Components - Compliance/next/footer",tags:["autodocs"],args:i,argTypes:x,parameters:{docs:{page:b,inlineStories:!1},layout:"fullscreen"}},t=g(i,({identifier:a,development:e,onReady:o})=>f`
        <body>
            <vl-footer-next
                ?development=${e}
                identifier=${a}
