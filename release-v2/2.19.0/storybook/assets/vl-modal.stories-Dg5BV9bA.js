...
`]})]})}function B(t={}){const{wrapper:n}={...j(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(f,{...t})}):f(t)}function _(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}L([E,D,V]);const F={id:"components-block-modal",title:"Components - Block/modal",tags:["autodocs"],args:p,argTypes:N,parameters:{docs:{page:B}}},o=T({...p,id:""},({title:t,label:n,open:b,closable:w,notCancellable:$,notAutoClosable:x,allowOverflow:y,size:O,position:z,id:v,focusOnModal:A})=>k`
        <div>
            <vl-button
...
\``,...d.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`story({
  ...
  focusOnModal
    ...
    \`)`,...m.parameters?.docs?.source}}};const I=["modalDefault","modalWithOtherAction","modalMedium","modalLarge","modalFullScreen","modalLeft","modalRight","modalWithFocusOnModal"];export{I as __namedExportsOrder,F as default,o as modalDefault,r as modalFullScreen,s as modalLarge,c as modalLeft,i as modalMedium,u as modalRight,m as modalWithFocusOnModal,d as modalWithOtherAction};
