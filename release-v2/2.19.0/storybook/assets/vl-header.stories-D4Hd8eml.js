import{Z as a,_ as r,u as h,j as e,b8 as D,s as T,x as U,r as I}from"./iframe-CY-ZM549.js";import{h as P,V as A}from"./vl-header.component-s9w2AlYS.js";import"./vl-footer.component-DhbDq3if.js";import"./preload-helper-D9Z9MdNV.js";const{action:S}=__STORYBOOK_MODULE_ACTIONS__,t={...P,onReady:S("ready")},$={authenticatedUserUrl:{name:"authenticated-user-url",description:"De url die wordt opgeroepen om te zien of een gebruiker is ingelogd.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.authenticatedUserUrl}}},development:{name:"development",description:"Geeft aan dat de ontwikkel-servers van Digitaal Vlaanderen gebruikt moeten worden.",table:{type:{summary:r.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(t.development)}}},identifier:{name:"identifier",description:'De identifier die gebruikt wordt om bij Digitaal Vlaanderen de header op te halen. Deze identifier kan aangevraagd worden bij Team Infra van Departement Omgeving of via het stappenplan van Digitaal Vlaanderen. <a href="https://www.vlaanderen.be/digitaal-vlaanderen/onze-diensten-en-platformen/mijn-burgerprofiel/global-header-en-footer#stappenplan-koppeling-met-de-global-header-en-footer" target="_blank" rel="noopener noreferrer" aria-label="Ga naar het stappenplan van Digitaal Vlaanderen (opent in een nieuw venster)">Ga naar het stappenplan van Digitaal Vlaanderen.</a>',table:{type:{summary:r.STRING},category:a.ATTRIBUTES,defaultValue:{summary:t.identifier}}},loginUrl:{name:"login-url",description:"De url die gebruikt wordt bij het aanmelden.<br>Bij het aanpassen van dit attribuut wordt achterliggend de `window.globalHeaderClient.accessMenu.setProfile()` methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.loginUrl}}},logoutUrl:{name:"logout-url",description:"De url die wordt opgeroepen wanneer men zich wil afmelden.<br>Bij het aanpassen van dit attribuut wordt achterliggend de `window.globalHeaderClient.accessMenu.setProfile()` methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.logoutUrl}}},simple:{name:"simple",description:"Indien true wordt het configureren van de sessie overgeslagen.",table:{type:{summary:r.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(t.simple)}}},skeleton:{name:"skeleton",description:"Geeft aan of de header een skeleton moet tonen voordat het rendert.",table:{type:{summary:r.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(t.skeleton)}}},switchCapacityUrl:{name:"switch-capacity-url",description:"De url die wordt opgeroepen wanneer men van organisatie wil wisselen.<br>Bij het aanpassen van dit attribuut wordt achterliggend de `window.globalHeaderClient.accessMenu.setProfile()` methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.switchCapacityUrl}}},skipToContentId:{name:"skip-to-content-id",description:"De id van het content-element waarnaar de skip-link de focus verplaatst (WCAG 2.4.1). Zonder waarde wordt er geen skip-link gerenderd. Gebruik de id van de eerste heading van de pagina-inhoud.",table:{type:{summary:r.STRING},category:a.ATTRIBUTES,defaultValue:{summary:t.skipToContentId}}},applicationLinks:{name:"applicationLinks",description:"De links die getoond worden in de header.<br/>Zie de documentatie pagina voor meer informatie.",table:{type:{summary:"ApplicationLink[]"},category:a.PROPERTIES,defaultValue:{summary:"[]"}}},profileTokenUrl:{name:"profile-token-url",description:"De url die opgeroepen wordt om het PAPI profile token op te halen. Het token wordt achterliggend doorgegeven aan `window.globalHeaderClient.accessMenu.setProfile()` als `idpProfileToken`. Standaard `/sso/papi_token` (endpoint van de Cumuli security lib); zet leeg om geen token op te halen. Het token wordt nooit in de DOM opgenomen (om die reden is er geen `idp-profile-token` attribuut).<br/>Zie de documentatie pagina voor de verwachte response.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.profileTokenUrl}}},idpDataUrl:{name:"idp-data-url",description:"De url die opgeroepen wordt om manueel IdpData op te halen (handig voor mock users via lokale Keycloak). De response wordt doorgegeven aan `window.globalHeaderClient.accessMenu.setProfile()` als `idpData`.",table:{type:{summary:r.URL},category:a.ATTRIBUTES,defaultValue:{summary:t.idpDataUrl}}},idpProfileToken:{name:"idpProfileToken",description:"Het PAPI profile token, te zetten via JavaScript (geen attribuut omdat het token niet in de DOM mag belanden). Heeft voorrang op `profile-token-url`. Wordt enkel meegestuurd wanneer de gebruiker is aangemeld.",table:{type:{summary:r.STRING},category:a.PROPERTIES,defaultValue:{summary:"undefined"}}},idpData:{name:"idpData",description:"Manuele override voor de IdpData. Heeft voorrang op `idp-data-url`. Handig voor mock users via lokale Keycloak.<br/>Zie de documentatie pagina voor het type.",table:{type:{summary:"IDPData"},category:a.PROPERTIES,defaultValue:{summary:"undefined"}}},onReady:{name:"ready",description:"Afgevuurd nadat de widget toegevoegd is aan de DOM.",table:{type:{summary:"-"},category:a.EVENTS}}};function p(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...h(),...i.components},{FluxCanvasIframe:d,FluxComponentMetaData:s}=n;return d||c("FluxCanvasIframe"),s||c("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"digitaal-vlaanderen-header",children:"Digitaal Vlaanderen Header"}),`
...
`,e.jsx(D,{of:o}),`
`,e.jsx(n.h2,{id:"ready-event",children:"Ready event"}),`
`,e.jsxs(n.p,{children:["De component vuurt het ",e.jsx(n.code,{children:"ready"}),` event af zodra de global header widget in de DOM gemount is. Vanaf dat moment is de
widget-inhoud beschikbaar en levert `,e.jsx(n.code,{children:"height"})," de effectieve hoogte van de header op."]}),`
`,e.jsxs(n.p,{children:["Het event wordt afgevuurd ",e.jsxs(n.strong,{children:["op het ",e.jsx(n.code,{children:"<vl-header-next>"})," element zelf"]}),`. Het bubbelt niet en gaat niet door shadow
boundaries, dus registreer de listener op het element:`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`document.querySelector('vl-header-next').addEventListener('ready', () => {
    // de widget staat in de DOM
});
`})}),`
`,e.jsx(n.p,{children:"In een lit-template:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:'html`<vl-header-next identifier="..." @ready=${onReady}></vl-header-next>`;\n'})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://test.widgets.burgerprofiel.dev-vlaanderen.be/docs/global-header/modules.html",rel:"nofollow",children:"Global Header - interfaces"})})]})}function V(i={}){const{wrapper:n}={...h(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(p,{...i})}):p(i)}function c(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}I([A]);const E={id:"components-compliance-next-header",title:"Components - Compliance/next/header",tags:["autodocs"],args:t,argTypes:$,parameters:{docs:{page:V,inlineStories:!1},layout:"fullscreen"}},o=T(t,({authenticatedUserUrl:i,development:n,identifier:d,loginUrl:s,logoutUrl:u,skeleton:g,simple:m,switchCapacityUrl:f,skipToContentId:v,applicationLinks:j,profileTokenUrl:k,idpDataUrl:x,idpProfileToken:b,idpData:y,onReady:w})=>U`
        <body>
            <vl-header-next
                authenticated-user-url=${i}
                ?development=${n}
                identifier=${d}
                login-url=${s}
                logout-url=${u}
