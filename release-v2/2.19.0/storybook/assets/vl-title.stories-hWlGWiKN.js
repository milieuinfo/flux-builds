...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/titles",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Title"})})]})}function N(t={}){const{wrapper:e}={...b(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(f,{...t})}):f(t)}function L(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const D={id:"components-atom-title",title:"Components - Atom/title",tags:["autodocs"],args:i,argTypes:B,parameters:{docs:{page:N}}},s=v(i,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
