...
`,n.jsx(g,{of:t}),`
`,n.jsx(e.h2,{id:"ready-event",children:"Ready event"}),`
`,n.jsxs(e.p,{children:["De component vuurt het ",n.jsx(e.code,{children:"ready"})," event af zodra de global footer widget in de DOM gemount is."]}),`
`,n.jsxs(e.p,{children:["Het event wordt afgevuurd ",n.jsxs(e.strong,{children:["op het ",n.jsx(e.code,{children:"<vl-footer-next>"})," element zelf"]}),`. Het bubbelt niet en gaat niet door shadow
boundaries, dus registreer de listener op het element:`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-js",children:`document.querySelector('vl-footer-next').addEventListener('ready', () => {
    // de widget staat in de DOM
});
`})}),`
`,n.jsx(e.p,{children:"In een lit-template:"}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-js",children:'html`<vl-footer-next identifier="..." @ready=${onReady}></vl-footer-next>`;\n'})}),`
...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://test.widgets.burgerprofiel.dev-vlaanderen.be/docs/global-footer/modules.html",rel:"nofollow",children:"Global Footer - interfaces"})})]})}function j(r={}){const{wrapper:e}={...p(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(s,{...r})}):s(r)}function c(r,e){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}h([v]);const D={id:"components-compliance-next-footer",title:"Components - Compliance/next/footer",tags:["autodocs"],args:i,argTypes:u,parameters:{docs:{page:j,inlineStories:!1},layout:"fullscreen"}},t=m(i,({identifier:r,development:e,onReady:o})=>f`
        <body>
            <vl-footer-next
                ?development=${e}
                identifier=${r}
