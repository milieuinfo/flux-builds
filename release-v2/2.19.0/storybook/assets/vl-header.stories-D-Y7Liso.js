import{Z as a,_ as t,u as g,j as e,b8 as w,s as D,x as T,r as U}from"./iframe-CY-ZM549.js";import{h as $}from"./vl-header.component-CpL6Dy50.js";import"./vl-footer.component-DhbDq3if.js";import{V as R}from"./vl-header.component-s9w2AlYS.js";import"./preload-helper-D9Z9MdNV.js";const{action:V}=__STORYBOOK_MODULE_ACTIONS__,r={...$,onReady:V("ready")},A={authenticatedUserUrl:{name:"authenticated-user-url",description:"De url die wordt opgeroepen om te zien of een gebruiker is ingelogd.",table:{type:{summary:t.URL},category:a.ATTRIBUTES,defaultValue:{summary:r.authenticatedUserUrl}}},development:{name:"development",description:"Geeft aan dat de ontwikkel-servers van Digitaal Vlaanderen gebruikt moeten worden.",table:{type:{summary:t.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(r.development)}}},identifier:{name:"identifier",description:'De identifier die gebruikt wordt om bij Digitaal Vlaanderen de header op te halen. Deze identifier kan aangevraagd worden bij Team Infra van Departement Omgeving of via het stappenplan van Digitaal Vlaanderen. <a href="https://www.vlaanderen.be/digitaal-vlaanderen/onze-diensten-en-platformen/mijn-burgerprofiel/global-header-en-footer#stappenplan-koppeling-met-de-global-header-en-footer" target="_blank" rel="noopener noreferrer" aria-label="Ga naar het stappenplan van Digitaal Vlaanderen (opent in een nieuw venster)">Ga naar het stappenplan van Digitaal Vlaanderen.</a>',table:{type:{summary:t.STRING},category:a.ATTRIBUTES,defaultValue:{summary:r.identifier}}},loginRedirectUrl:{name:"login-redirect-url",description:"De redirect url die gebruikt wordt bij het aanmelden.<br>Bij het aanpassen van dit attribuut wordt achterliggend de session.configure() methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:t.URL},category:a.ATTRIBUTES,defaultValue:{summary:r.loginRedirectUrl}}},loginUrl:{name:"login-url",description:"De url die gebruikt wordt bij het aanmelden.<br>Bij het aanpassen van dit attribuut wordt achterliggend de session.configure() methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:t.URL},category:a.ATTRIBUTES,defaultValue:{summary:r.loginUrl}}},logoutUrl:{name:"logout-url",description:"De url die wordt opgeroepen wanneer men zich wil afmelden.<br>Bij het aanpassen van dit attribuut wordt achterliggend de session.configure() methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:t.URL},category:a.ATTRIBUTES,defaultValue:{summary:r.logoutUrl}}},simple:{name:"simple",description:"Indien true wordt het configureren van de sessie overgeslagen.",table:{type:{summary:t.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(r.simple)}}},skeleton:{name:"skeleton",description:"Geeft aan of de header een skeleton moet tonen voordat het rendert.",table:{type:{summary:t.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(r.skeleton)}}},switchCapacityUrl:{name:"switch-capacity-url",description:"De url die wordt opgeroepen wanneer men van organisatie wil wisselen.<br>Bij het aanpassen van dit attribuut wordt achterliggend de session.configure() methode van Digitaal Vlaanderen opnieuw aangeroepen.",table:{type:{summary:t.URL},category:a.ATTRIBUTES,defaultValue:{summary:r.switchCapacityUrl}}},skipToContentId:{name:"skip-to-content-id",description:"De id van het content-element waarnaar de skip-link de focus verplaatst (WCAG 2.4.1). Zonder waarde wordt er geen skip-link gerenderd. Gebruik de id van de eerste heading van de pagina-inhoud.",table:{type:{summary:t.STRING},category:a.ATTRIBUTES,defaultValue:{summary:r.skipToContentId}}},rejectLogout:{name:"reject-logout",description:"Geeft aan of het logout request moet worden afgewezen.<br/>Een logout request door de gebruiker wordt nooit afgewezen.",table:{type:{summary:t.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(r.rejectLogout)}}},logoutCallback:{name:"logoutCallback",description:"De callback die aangeroepen wordt bij een logout request.<br/>De logout reason wordt meegegeven aan de callback, door een boolean promise terug te geven kan je het logout request accepteren of afwijzen.<br/>De mogelijke reasons zijn: 'inactivity' en 'expired'.<br/>Een logout request door de gebruiker wordt nooit afgewezen.",control:!1,table:{type:{summary:"(reason: string) => Promise<boolean>"},category:a.PROPERTIES,defaultValue:{summary:String(r.logoutCallback)}}},applicationLinks:{name:"applicationLinks",description:"De links die getoond worden in de header.<br/>Zie de documentatie pagina voor meer informatie.",table:{type:{summary:"ApplicationLink[]"},category:a.PROPERTIES,defaultValue:{summary:"[]"}}},onReady:{name:"ready",description:"Afgevuurd nadat de widget toegevoegd is aan de DOM.",table:{type:{summary:"-"},category:a.EVENTS}}};function c(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...g(),...i.components},{FluxCanvasIframe:d,FluxComponentMetaData:s}=n;return d||p("FluxCanvasIframe"),s||p("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"digitaal-vlaanderen-header",children:"Digitaal Vlaanderen Header"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/digitaal-vlaanderen/onze-oplossingen/mijn-burgerprofiel/koppelen-met-mijn-burgerprofiel-als-dienstenleverancier/technische-toolkit-voor-aansluitingen-door-dienstenleveranciers",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Header"})})]})}function C(i={}){const{wrapper:n}={...g(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(c,{...i})}):c(i)}function p(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}U([R]);const B={id:"components-compliance-header",title:"Components - Compliance/header",tags:["autodocs"],args:r,argTypes:A,parameters:{docs:{page:C,inlineStories:!1},layout:"fullscreen"}},o=D(r,({authenticatedUserUrl:i,development:n,identifier:d,loginRedirectUrl:s,loginUrl:u,logoutUrl:m,skeleton:h,simple:v,switchCapacityUrl:f,rejectLogout:j,skipToContentId:b,logoutCallback:k,applicationLinks:y,onReady:x})=>T`
        <body>
            <vl-header
  ...
  onReady
    ...
    \`)`,...l.parameters?.docs?.source}}};const z=["HeaderDefault","HeaderWithApplicationLinks"];export{o as HeaderDefault,l as HeaderWithApplicationLinks,z as __namedExportsOrder,B as default};
