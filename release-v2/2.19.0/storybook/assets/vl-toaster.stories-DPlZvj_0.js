import{Z as m,_ as p,a1 as S,W as E,cC as h,X as A,u as T,j as e,C as c,b8 as O,s as u,x as d,r as q,d as L,cD as C,cE as D}from"./iframe-CY-ZM549.js";import{o as g}from"./unsafe-html-CLNrWVY9.js";import"./preload-helper-D9Z9MdNV.js";const _={TOP_LEFT:"top-left",TOP_RIGHT:"top-right",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right"},i={...A,...h,defaultSlot:""},z={...E,fadeOut:{name:"fade-out",description:`Elke alert verdwijnt automatisch 5 seconden na openen. 
...
component, met de attribuutnaam als key, zoals `,e.jsx(t.code,{children:"multiline"})," om regeleinden (",e.jsx(t.code,{children:"\\n"}),") in de ",e.jsx(t.code,{children:"message"}),` te bewaren of
`,e.jsx(t.code,{children:"alert-role"})," om de rol van de melding te kiezen."]}),`
`,e.jsx(c,{of:l}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/toaster",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Toaster"})})]})}function F(n={}){const{wrapper:t}={...T(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(j,{...n})}):j(n)}function b(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}var x=Object.freeze,M=Object.defineProperty,v=(n,t)=>x(M(n,"raw",{value:x(t||n.slice())})),y,w,k;q([L,C,D]);const R={id:"components-block-toaster",title:"Components - Block/toaster",tags:["autodocs"],args:i,argTypes:z,parameters:{contentPadding:"large",docs:{page:F,story:{inline:!0}},controls:{hideNoControlsWarning:!0}},decorators:[n=>d` <div style="height: 400px;">${n()}</div>`]},o=u(i,({placement:n,fadeOut:t,defaultSlot:r})=>d(y||(y=v([`
        <script>
    ...
    `);a.storyName="vl-toaster - default slot";a.args={placement:"bottom-right",defaultSlot:`<vl-alert
                ...
                </vl-alert>`};const l=u(i,({placement:n,fadeOut:t})=>d(w||(w=v([`
        <script>
