...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[`Een voorbeeld van cross-validatie (validatie afhankelijk van de waarde van een ander veld) vind je op
`,e.jsx(n.a,{href:"/docs/patronen-formulier-cross-validatie--documentatie",children:"Formulier - Cross-Validatie"}),"."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"customError"}),": als je custom validatie instelt, ",e.jsx(n.a,{href:"/docs/patronen-formulier-aangepaste-validatie--documentatie",children:"zie hier"})," hoe je zelf een custom validator schrijft. Voor validatie afhankelijk van een ander veld, ",e.jsx(n.a,{href:"/docs/patronen-formulier-cross-validatie--documentatie",children:"zie cross-validatie"}),"."]}),`
...
`,e.jsxs(n.p,{children:["In onderstaand voorbeeld: druk op ",e.jsx(n.code,{children:"enter"})," zonder iets in te vullen om de foutmelding te zien."]}),`
...
getoond.`]}),`
`,e.jsxs(n.p,{children:["In onderstaand voorbeeld: vul een cijfer of speciaal teken in en druk op ",e.jsx(n.code,{children:"enter"})," om de foutmelding te zien."]}),`
