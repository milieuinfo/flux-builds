import{Z as t,_ as r,u as b,j as e,C as X,b8 as Z,s as Y,x as K,r as J}from"./iframe-CY-ZM549.js";import{u as h,V as ee}from"./vl-upload.component-CRjn2qhr.js";import{f as ne,a as te}from"./form-control.stories-arg-B6yBTQ6J.js";import{M as ae}from"./form-control.public-methods-doc-DkaRTqkF.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-upload-progress.component-DXqNp2pu.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,a={...ne,...h,onVlChange:o("vl-change"),onVlInput:o("vl-input"),onVlValid:o("vl-valid"),onVlAddedFile:o("vl-addedfile"),onVlRemovedFile:o("vl-removedfile"),onVlSuccess:o("vl-success"),onVlError:o("vl-error"),onVlUploadProgress:o("vl-upload-progress"),onVlComplete:o("vl-complete"),onVlQueueComplete:o("vl-queuecomplete"),onVlInitialised:o("vl-initialised")},re={...te,readonly:{name:"readonly",description:"Duidt aan dat het veld enkel leesbaar is.",table:{type:{summary:r.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(a.readonly)}}},acceptedFiles:{name:"accepted-files",description:"Attribuut om te bepalen welke bestanden worden geaccepteerd door de component (extensie en mimetype).<br>Bv. `image/*,application/pdf,.psd`",table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.acceptedFiles}}},autoProcess:{name:"auto-process",description:"Attribuut om te activeren of deactiveren dat het het gedropte bestand direct moet opgeladen worden.",table:{type:{summary:r.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(a.autoProcess)}}},disallowDuplicates:{name:"disallow-duplicates",description:"Bepaalt dat het niet is toegelaten om dezelfde bijlage meerdere keren te uploaden. Niet reactief.",table:{type:{summary:r.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(a.disallowDuplicates)}}},errorMessageAcceptedFiles:{name:"error-message-accepted-files",description:"Attribuut om de message te definiëren wanneer er bestanden zijn toegevoegd die niet voldoen aan hetgevraagde bestandstype.",table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.errorMessageAcceptedFiles}}},errorMessageFilesize:{name:"error-message-filesize",description:"Attribuut om de message te definiëren wanneer er te grote bestanden zijn toegevoegd. <br> Gebruik {{maxSize}} om de maximum grootte weer te geven in MB.",table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.errorMessageFilesize}}},errorMessageMaxFiles:{name:"error-message-maxfiles",description:"Attribuut om de boodschap te bepalen wanneer er te veel bestanden zijn toegevoegd. <br> Gebruik {{maxFiles}} om het maximum aantal bestanden weer te geven.",table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.errorMessageMaxFiles}}},maxFiles:{name:"max-files",description:"Bepaalt aantal upload-bestanden",table:{type:{summary:"number"},category:t.ATTRIBUTES,defaultValue:{summary:String(a.maxFiles)}}},maxSize:{name:"max-size",description:"Bepaalt de maximum grootte per upload-bestand in MB.",table:{type:{summary:"number"},category:t.ATTRIBUTES,defaultValue:{summary:String(a.maxSize)}}},subTitle:{name:"sub-title",description:`De annotatietekst voor de upload knop.
Niet reactief.`,table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.subTitle}}},mainTitle:{name:"main-title",description:`De tekst die op de upload knop komt te staan.
Niet reactief.`,table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.mainTitle}}},parallelUploads:{name:"parallel-uploads",description:"Bepaalt het aantal bestanden dat tegelijkertijd geüpload kan worden.",table:{type:{summary:"number"},category:t.ATTRIBUTES,defaultValue:{summary:String(a.parallelUploads)}}},url:{name:"url",description:`Bepaalt de upload url.
Niet reactief.`,table:{type:{summary:r.STRING},category:t.ATTRIBUTES,defaultValue:{summary:a.url}}},chunking:{name:"chunking",description:"Attribuut om te activeren of deactiveren dat het bestand in stukken wordt geüpload.<br> Dit moet aanstaan om upload progress te verkrijgen.",table:{type:{summary:r.BOOLEAN},category:t.ATTRIBUTES,defaultValue:{summary:String(a.chunking)}}},uploadProgressFn:{name:"uploadProgressFn",description:"Functie die wordt aangeroepen wanneer een bestand wordt geüpload.<br> Deze functie geeft de voortgang van de upload in percentage en de bytes die zijn verzonden.",table:{type:{summary:r.FUNCTION},category:t.PROPERTIES,defaultValue:{summary:String(a.uploadProgressFn)}}},onVlChange:{name:"vl-change",description:"Event dat afgevuurd wordt als bestanden worden toegevoegd of verwijderd (zowel programmatorisch als door een gebruiker).<br>Het detail object van het event bevat de ingegeven waarde.<br>Daarnaast geeft het ook aan welke file werd verwijderd of toegevoegd.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlInput:{name:"vl-input",description:"Event dat alleen afgevuurd wordt als bestanden worden toegevoegd of verwijderd door een gebruiker.<br>Het detail object van het event bevat de ingegeven waarde.<br>Daarnaast geeft het ook aan welke file werd verwijderd of toegevoegd.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlValid:{name:"vl-valid",description:"Event dat afgevuurd wordt als de waarde van het input veld valid is.<br>Het detail object van het event bevat de ingegeven waarde.",table:{type:{summary:"{ value: string }"},category:t.EVENTS}},onVlAddedFile:{name:"vl-addedfile",description:"Event dat afgevuurd wordt als een bestand wordt toegevoegd.<br>Daarnaast geeft het ook de file die werd toegevoegd.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlRemovedFile:{name:"vl-removedfile",description:"Event dat afgevuurd wordt als een bestand wordt verwijderd.<br>Daarnaast geeft het ook de file die werd verwijderd.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlError:{name:"vl-error",description:"Event dat afgevuurd wordt als een bestand niet voldoet aan de validatie.<br>Het detail object van het event bevat de ingegeven waarde.<br>Daarnaast geeft het ook de file met de fout.",table:{type:{summary:"{ value: string, type: string, file: File, errorMessage: string}"},category:t.EVENTS}},onVlUploadProgress:{name:"vl-upload-progress",description:"Event dat afgevuurd wordt als een bestand wordt geüpload.<br>Het detail object van het event bevat de voortgang van de upload in percentage en de bytes die zijn verzonden.<br>Dit werkt alleen als het `chunking` attribuut ingesteld is.",table:{type:{summary:"{ file: File, progress: number, bytesSent: number }"},category:t.EVENTS}},onVlSuccess:{name:"vl-success",description:"Event dat afgevuurd wordt als de upload van een bestand succesvol is.",table:{type:{summary:"{ value: string, type: string, file: File, response: object | string}"},category:t.EVENTS}},onVlComplete:{name:"vl-complete",description:"Event dat afgevuurd wordt als de upload van een bestand compleet is.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlQueueComplete:{name:"vl-queuecomplete",description:"Event dat afgevuurd wordt als de upload van alle bestanden compleet is.",table:{type:{summary:"{ value: string, type: string, file: File}"},category:t.EVENTS}},onVlInitialised:{name:"vl-initialised",description:"Event dat afgevuurd wordt als de upload component geïnitialiseerd is. Hierna kunnen bv. events geregistreerd worden.",table:{type:{summary:"{ type: string}"},category:t.EVENTS}}};function v(l){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...b(),...l.components},{FluxComponentMetaData:d}=n;return d||le("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"upload",children:"Upload"}),`
...
`,e.jsxs(n.p,{children:["Opgelet: je kan pas events registreren nadat de component geïnitialiseerd is met behulp van het ",e.jsx(n.code,{children:"vl-initialised"}),"-event"]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Om deze functionaliteit te bekomen wordt er een ",e.jsx(n.code,{children:"dropzoneValidator"})," gebruikt die overeenkomt met de ",e.jsx(n.code,{children:"customError"}),`
`,e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/ValidityState",rel:"nofollow",children:"ValidityState"}),` key.
...
`,e.jsx(n.h3,{id:"bestandsgrootte-mib-vs-mb",children:"Bestandsgrootte: MiB vs MB"}),`
`,e.jsxs(n.p,{children:["De ",e.jsx(n.code,{children:"max-size"}),"-waarde wordt achterliggend door Dropzone (",e.jsx(n.code,{children:"maxFilesize"}),") binair geïnterpreteerd, dus in ",e.jsx(n.strong,{children:"MiB"}),`
(1024-basis), niet in `,e.jsx(n.strong,{children:"MB"}),` (1000-basis). De UI en de foutmelding spreken bewust over "MB" omdat Windows - de
...
`,e.jsxs(n.p,{children:[`Op macOS of Linux (die bestandsgroottes decimaal in MB tonen) en bij een MB-validerende backend kan dat verschil
verwarren. Een `,e.jsx(n.code,{children:"max-size"})," van bijvoorbeeld ",e.jsx(n.code,{children:"900"}),` laat een bestand tot 900 MiB = 943.718.400 bytes toe, wat decimaal
neerkomt op ~943,7 MB.`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Advies voor afnemers:"}),` valideer de bestandsgrootte ook aan de backend-zijde en reken die in MB (1000-basis),
zet die backend-limiet dan iets hoger dan `,e.jsx(n.code,{children:"max-size"}),`. Zo wordt een bestand dat de gebruiker volgens het upload-veld
mag uploaden, niet alsnog door de backend geweigerd.`]}),`
`]}),`
`,e.jsx(n.h3,{id:"aanbevelingen",children:"Aanbevelingen"}),`
`,e.jsxs(n.p,{children:["Breid de ",e.jsx(n.code,{children:"sub-title"}),`-attribuut uit met een korte uitleg over maximaal aantal bestanden, maximale bestandsgrootte en de
toegestane bestandstypes indien relevant.`]}),`
`,e.jsx(n.p,{children:`De reden hiervoor is dat het belangrijk is om de gebruiker te informeren over de beperkingen van het upload-veld. Het
...
`,e.jsx(n.code,{children:"addFile()"})," methode."]}),`
...
gebruik van inline styles. Deze inline styles worden niet toegelaten in een strikte `,e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP",rel:"nofollow",children:"Content Security Policy"}),`
policy.
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/upload",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Upload"})})]})}function oe(l={}){const{wrapper:n}={...b(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(v,{...l})}):v(l)}function le(l,n){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}J([ee]);const me={id:"components-form-upload",title:"Components - Form/upload",tags:["autodocs"],args:a,argTypes:re,parameters:{docs:{page:oe}}},i=Y(a,({id:l,name:n,label:d,required:f,disabled:y,readonly:x,error:j,success:w,blurValidation:k,url:V,disallowDuplicates:T,maxSize:s,maxFiles:c,chunking:$,parallelUploads:S,autoProcess:z,acceptedFiles:u,subTitle:m,mainTitle:F,errorMessageMaxFiles:E,errorMessageFilesize:D,errorMessageAcceptedFiles:M,onVlChange:A,onVlInput:B,onVlValid:C,onVlError:U,onVlSuccess:I,onVlComplete:N,onVlQueueComplete:R,onVlInitialised:O,onVlRemovedFile:P,onVlAddedFile:q,onVlUploadProgress:G})=>{let p;if(m.toString()==="Symbol(lit-nothing)"){const{maxFiles:H,subTitle:_,maxSize:L}=h,W=u.toString()!=="Symbol(lit-nothing)"?`
 De toegestane bestandstypes zijn: ${u}
`:"",g=typeof c=="number"?c:H,Q=typeof s=="number"?s:L;p=`${_} 
Upload ${g} ${g>1?"bestanden":"bestand"} van maximaal ${Q} MB${W}.`}else p=m;return K`
            <vl-upload
                id=${l}
                name=${n}
                label=${d}
