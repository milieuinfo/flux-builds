...
`;function r(o){const l={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...t(),...o.components},{FluxAlert:n}=l;return n||c("FluxAlert"),e.jsxs(e.Fragment,{children:[e.jsx(a,{of:m}),`
...
`]}),`
`,e.jsxs(l.blockquote,{children:[`
`,e.jsxs(l.p,{children:[`Moet de validatie van een veld afhangen van de waarde van een ander veld? Bekijk dan
`,e.jsx(l.a,{href:"/docs/patronen-formulier-cross-validatie--documentatie",children:"Formulier - Cross-Validatie"}),"."]}),`
`]}),`
`,e.jsxs(l.blockquote,{children:[`
`,e.jsxs(l.p,{children:[`Vormen twee of meer velden samen één waarde, zoals een coördinaat of een getal met eenheid? Bekijk dan
`,e.jsx(l.a,{href:"/docs/patronen-formulier-samengesteld-veld--documentatie",children:"Formulier - Samengesteld veld"}),"."]}),`
`]}),`
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"Code"}),e.jsx(i,{code:v,language:"ts",dark:!0})]})]})}function y(o={}){const{wrapper:l}={...t(),...o.components};return l?e.jsx(l,{...o,children:e.jsx(r,{...o})}):r(o)}function c(o,l){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
