import{r as v,aW as c,g as p,aX as m,aY as g,aZ as h,m as f,aQ as b,a_ as y,a$ as V,E as S,x as e,y as C}from"./iframe-Ds54rb_7.js";import"./vl-accessibility.component-Det_DKYs.js";import"./vl-cookie-consent.component-CFrFj_GM.js";import"./vl-cookie-statement.component-BYpm0qN7.js";import{V as x}from"./vl-footer.component-CcYCrDBU.js";import{V as j}from"./vl-header.component-zEWuM3Mx.js";import"./vl-footer.component-D9ZCAfCJ.js";import"./vl-header.component-DtHfNxj5.js";import"./vl-privacy.component-BVw08l_j.js";var P=Object.getOwnPropertyDescriptor,_=(i,s,d,r)=>{for(var n=r>1?void 0:r?P(s,d):s,l=i.length-1,u;l>=0;l--)(u=i[l])&&(n=u(n)||n);return n};v([c,j,x,p,m,g,h,f]);let o=class extends b{constructor(){super(),y.getInstance().register()}static get styles(){return[V,S]}get isFullWidth(){return this.hasAttribute("full-width")}render(){return e`
            <main>
                <vl-template>
        ...
        `}};o=_([C("vl-page-layout-example")],o);v([o]);const F={title:"Ontwerp/Pagina Layout/Voorbeeld",parameters:{layout:"fullscreen"},decorators:[i=>e` <div style="min-height: calc(100vh - 172px);">${i()}</div>`]},t=()=>e`<vl-page-layout-example></vl-page-layout-example>`,a=()=>e`<vl-page-layout-example full-width></vl-page-layout-example>`;t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => html`<vl-page-layout-example></vl-page-layout-example>`",...t.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => html`<vl-page-layout-example full-width></vl-page-layout-example>`",...a.parameters?.docs?.source}}};const L=["StandaardLayout","VolledigeBreedte"],N=Object.freeze(Object.defineProperty({__proto__:null,StandaardLayout:t,VolledigeBreedte:a,__namedExportsOrder:L,default:F},Symbol.toStringTag,{value:"Module"}));export{N as p};
