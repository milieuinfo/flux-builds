...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMapFeaturesLayer.html",rel:"nofollow",children:"Legacy Documentatie - Map Features Layer"})})]})}function S(t={}){const{wrapper:a}={...i(),...t.components};return a?e.jsx(a,{...t,children:e.jsx(u,{...t})}):u(t)}function M(t,a){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const I={id:"map-layer-vector-layer-features-layer",title:"map/layer/vector-layer/features-layer",tags:["autodocs"],args:r,argTypes:L,parameters:{docs:{page:S}}},n=h(r,({autoExtent:t,autoExtentMaxZoom:a,cluster:l,clusterDistance:m,features:c,hidden:p,maxResolution:d,minResolution:y,name:f,opacity:g,featuresProp:x})=>j`
        <vl-map lambert2008>
