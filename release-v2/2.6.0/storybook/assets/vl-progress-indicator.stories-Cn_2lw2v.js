...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-progress-indicator.html",rel:"nofollow",children:"Legacy Demo - Progress Bar"})})]})}function O(s={}){const{wrapper:n}={...u(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(m,{...s})}):m(s)}function E(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const $={id:"components-block-progress-indicator",title:"Components - Block/progress-indicator",tags:["autodocs"],args:t,argTypes:w,parameters:{docs:{page:O}}},d=x(t,({activeStep:s,showLabels:n,focusOnChange:p,numeric:h,steps:v,onClickStep:f})=>C`
  ...
  onClickStep
    ...
    \`)`,...o.parameters?.docs?.source}}};const I=["ProgressIndicatorDefault","ProgressIndicatorNumeric","ProgressIndicatorFocused"];export{r as ProgressIndicatorDefault,o as ProgressIndicatorFocused,a as ProgressIndicatorNumeric,I as __namedExportsOrder,$ as default};
