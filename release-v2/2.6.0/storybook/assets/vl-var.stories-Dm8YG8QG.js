import{u as d,j as e,M as l,C as t,S as s,c6 as c,c7 as h,c8 as u,c9 as x,x as p}from"./iframe-Ds54rb_7.js";import"./preload-helper-D9Z9MdNV.js";const j=`export const vlMediaScreenExtraSmall = 500;
...
`;function o(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...d(),...r.components},{FluxMetaData:i}=n;return i||v("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Styles/Base (intern)/var"}),`
...
`,e.jsxs("details",{open:!0,children:[e.jsx("summary",{children:"Typography Variables"}),e.jsx(s,{code:x,language:"css",dark:!0})]})]})}function g(r={}){const{wrapper:n}={...d(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}function v(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const k={id:"styles-base-var",title:"Styles/Base (intern)/var",tags:["autodocs"],parameters:{docs:{page:g}}},a=({})=>p` <style>
        .sb-var {
