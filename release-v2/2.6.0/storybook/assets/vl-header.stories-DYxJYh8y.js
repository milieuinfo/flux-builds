import{K as i,L as t,u as g,j as e,bd as b,s as x,x as k}from"./iframe-Ds54rb_7.js";import{h as y}from"./vl-header.component-DtHfNxj5.js";import"./preload-helper-D9Z9MdNV.js";const{action:w}=__STORYBOOK_MODULE_ACTIONS__,r={...y,onReady:w("ready")},D={authenticatedUserUrl:{name:"authenticated-user-url",description:"De url die wordt opgeroepen om te zien of een gebruiker is ingelogd.",table:{type:{summary:t.URL},category:i.ATTRIBUTES,defaultValue:{summary:r.authenticatedUserUrl}}},development:{name:"development",description:"Geeft aan dat de ontwikkel-servers van Digitaal Vlaanderen gebruikt moeten worden.",table:{type:{summary:t.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.development)}}},identifier:{name:"identifier",description:`De identifier die gebruikt wordt om bij Digitaal Vlaanderen de header op te halen.
...
header-en-footer">stappenplan</vl-link> van Digitaal Vlaanderen.`,table:{type:{summary:t.STRING},category:i.ATTRIBUTES,defaultValue:{summary:r.identifier}}},loginUrl:{name:"login-url",description:`De url die gebruikt wordt bij het aanmelden.<br>
...
opnieuw aangeroepen.`,table:{type:{summary:t.URL},category:i.ATTRIBUTES,defaultValue:{summary:r.loginUrl}}},logoutUrl:{name:"logout-url",description:`De url die wordt opgeroepen wanneer men zich wil afmelden.<br>
Bij het aanpassen van dit attribuut wordt achterliggend de
\`window.globalHeaderClient.accessMenu.setProfile()\` methode van Digitaal Vlaanderen
opnieuw aangeroepen.`,table:{type:{summary:t.URL},category:i.ATTRIBUTES,defaultValue:{summary:r.logoutUrl}}},simple:{name:"simple",description:"Indien true wordt het configureren van de sessie overgeslagen.",table:{type:{summary:t.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.simple)}}},skeleton:{name:"skeleton",description:"Geeft aan of de header een skeleton moet tonen voordat het rendert.",table:{type:{summary:t.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.skeleton)}}},switchCapacityUrl:{name:"switch-capacity-url",description:`De url die wordt opgeroepen wanneer men van organisatie wil wisselen.<br>
Bij het aanpassen van dit attribuut wordt achterliggend de
\`window.globalHeaderClient.accessMenu.setProfile()\` methode van Digitaal Vlaanderen
opnieuw aangeroepen.`,table:{type:{summary:t.URL},category:i.ATTRIBUTES,defaultValue:{summary:r.switchCapacityUrl}}},applicationLinks:{name:"applicationLinks",description:"De links die getoond worden in de header.<br/>Zie de documentatie pagina voor meer informatie.",table:{type:{summary:"ApplicationLink[]"},category:i.PROPERTIES,defaultValue:{summary:"[]"}}},onReady:{name:"ready",description:"Afgevuurd nadat de widget toegevoegd is aan de DOM.",table:{type:{summary:"-"},category:i.EVENTS}}};function c(a){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...g(),...a.components},{FluxCanvasIframe:d,FluxMetaData:s}=n;return d||p("FluxCanvasIframe"),s||p("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"digitaal-vlaanderen-header",children:"Digitaal Vlaanderen Header"}),`
`,e.jsx(s,{id:"components-compliance-header-next"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`import { VlHeaderNext } from '@domg-wc/components/compliance';
`})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://test.widgets.burgerprofiel.dev-vlaanderen.be/docs/global-header/modules.html",rel:"nofollow",children:"Global Header - interfaces"})})]})}function U(a={}){const{wrapper:n}={...g(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(c,{...a})}):c(a)}function p(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const V={id:"components-compliance-header-next",title:"Components - Compliance/next/header",tags:["autodocs"],args:r,argTypes:D,parameters:{docs:{page:U,inlineStories:!1},layout:"fullscreen"}},l=x(r,({authenticatedUserUrl:a,development:n,identifier:d,loginUrl:s,logoutUrl:h,skeleton:u,simple:m,switchCapacityUrl:v,applicationLinks:f,onReady:j})=>k`
        <body>
            <vl-header-next
  ...
  onReady
    ...
    \`)`,...o.parameters?.docs?.source}}};const $=["HeaderDefault","HeaderWithApplicationLinks"];export{l as HeaderDefault,o as HeaderWithApplicationLinks,$ as __namedExportsOrder,V as default};
