import{x as s,u as p,j as t,M as g,C as f,S as v,bC as b,b6 as y}from"./iframe-Ds54rb_7.js";import"./preload-helper-D9Z9MdNV.js";const x=["primary","secondary","tertiary","ghost","error","toggle"],$=["default","large","wide","narrow","block"],j=["none","before","after","only"],C=["idle","loading","disabled"],c=(n,e,o,r)=>`${n} ${e} icon-${o} ${r}`,S=(n,e,o,r,l)=>s`<dl style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
