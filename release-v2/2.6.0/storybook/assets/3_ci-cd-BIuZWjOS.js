import{u as r,j as e,M as i}from"./iframe-Ds54rb_7.js";import"./preload-helper-D9Z9MdNV.js";function l(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Beheren/CI - CD"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"e2e-tests-storybook"})," (Stroybook e2e-testen)"]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["In die ",e.jsx(n.strong,{children:"release-and-publish"})," stap gebeurd het volgende:"]}),`
`,e.jsxs(n.ul,{children:[`
