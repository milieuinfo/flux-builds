...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/js-components/vl-ui-popover",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Popover"})})]})}function q(t={}){const{wrapper:o}={...P(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(C,{...t})}):C(t)}function S(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:E}=__STORYBOOK_MODULE_ACTIONS__;H([B,I,N,_]);const F={id:"components-block-popover",title:"Components - Block/popover",tags:["autodocs"],args:r,argTypes:M,parameters:{docs:{page:q}}},V=t=>h` <div style="position: relative;min-height: 150px;">${t()}</div>`,l=u(r,({trigger:t,contentPadding:o,open:i,placement:n,hideArrow:g,hideOnClick:a,distance:j,strategy:y})=>h`
