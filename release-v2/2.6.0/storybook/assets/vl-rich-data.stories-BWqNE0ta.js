import{u as D,j as a,C as k,bd as M,S as v,s as w,x as y,r as V,cF as I,c0 as T}from"./iframe-Ds54rb_7.js";import{V as A}from"./vl-select.component-DYcw1fiu.js";import{r as L,a as p}from"./vl-rich-data.stories-arg-CxuXnTwL.js";import"./preload-helper-D9Z9MdNV.js";const G=`export const richDataMockData = {
    data: [
        {
            id: 0,
            name: 'Project #1',
...
`,W=`import { Pagination } from '../../pager';
...
`;function j(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...D(),...t.components},{FluxMetaData:d}=e;return d||F("FluxMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"rich-data",children:"Rich Data"}),`
`,a.jsx(d,{id:"components-block-rich-data"}),`
...
`,a.jsx(k,{of:f}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"klik hier om een voorbeeld implementatie te zien"}),a.jsx(v,{code:W,language:"ts",dark:!0})]}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"mock data voor voorbeeld kan je hier vinden"}),a.jsx(v,{code:G,language:"ts",dark:!0})]}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data.html",rel:"nofollow",children:"Legacy Demo - Rich Data"})})]})}function O(t={}){const{wrapper:e}={...D(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(j,{...t})}):j(t)}function F(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const K={data:[{id:0,name:"Project #1",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Sander",lastName:"Kleykens"}]},{id:1,name:"Project #2",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:2,name:"Project #3",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:3,name:"Project #4",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:4,name:"Project #5",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:5,name:"Project #6",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:6,name:"Project #7",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:7,name:"Project #8",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:8,name:"Project #9",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:9,name:"Project #10",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:10,name:"Project #11",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:11,name:"Project #12",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:12,name:"Project #13",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:13,name:"Project #14",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:14,name:"Project #15",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:15,name:"Project #16",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:16,name:"Project #17",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:17,name:"Project #18",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:18,name:"Project #19",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:19,name:"Project #20",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:20,name:"Project #21",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:21,name:"Project #22",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:22,name:"Project #23",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:23,name:"Project #24",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:24,name:"Project #25",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]}]},b=()=>{customElements.whenDefined("vl-rich-data").then(()=>{const t=document.querySelector("#rich-data"),e=t?.querySelector('[slot="content"]'),d=t?.querySelector('[slot="sorter"]'),x=t?.querySelector("vl-pager"),g=K;let P;const N=(l,n,i)=>{P=l,e&&(e.innerHTML=""),l?.slice(n,i).forEach(r=>{const s=new Date().toLocaleString(),o=r.manager,m=r.medewerkers[0],h=`
                  ...
                  `;e&&e.insertAdjacentHTML("beforeend",`<vl-search-result>${h}</vl-search-result>`)})},q=(l,n,i)=>i===""?l:l.filter(r=>B(r,n).includes(i)),B=(l,n)=>{const i=n.split(".");let r=l;for(let s=0;s<i.length;s++)if(r[i[s]]!==void 0)r=r[i[s]];else return;return r.toString()};t?.addEventListener("change",l=>{let n=g.data,i=g.data.length,r;const s=l;if(s.detail.formData){r=[];for(const m of s.detail.formData.entries())n=q(n,m[0],m[1]),i=n.length,r.push({name:m[0],value:m[1]})}const o=s.detail.paging;if(o){const m=(o.currentPage-1)*10;N(n,m,m+10)}t&&(t.data={paging:{currentPage:s.detail.paging.currentPage,totalItems:i},filter:r})}),d?.addEventListener("vl-change",l=>{const n=P;l.stopPropagation(),n&&(n.sort((i,r)=>{const s=l.target?.value?.split(".");if(!s)return 0;const o=E=>s.reduce(($,S)=>$[S],E)?.toString()||"",m=o(i),h=o(r);return m.localeCompare(h)}),t&&(t.data={paging:{currentPage:1,totalItems:n.length}}),N(n,0,10))}),t&&(t.data={paging:{currentPage:1,totalItems:25}});const C=Number(x?.getAttribute("items-per-page")??10);N(g.data,0,C)})},Z={id:"components-block-rich-data",title:"Components - Block/rich-data",tags:["autodocs"],args:p,argTypes:L,parameters:{docs:{page:O}}};V([I,T,A]);const c=({filterClosable:t,filterClosed:e})=>y`
    ...
    `;c.storyName="vl-rich-data - default";const R=({filterClosable:t,filterClosed:e,filterMaxWidth:d})=>y`
        <vl-rich-data id="rich-data" ?filter-closable=${t} ?filter-closed=${e} filter-max-width=${d}>
    ...
    `,f=w(p,t=>(b(),R(t)));f.storyName="vl-rich-data - pager";const u=w(p,t=>(b(),R(t)));u.storyName="vl-rich-data - filter-max-width";u.args={filterMaxWidth:"calc(1280px / 3)"};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`({
  filterClosable,
  filterClosed
}: typeof richDataArgs) => {
  return html\`
    ...
    \`;
}`,...c.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`story(richDataArgs, (pagerArgs: typeof richDataArgs) => {
  richDataPaginationImplementation();
  return pagerTemplate(pagerArgs);
})`,...f.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`story(richDataArgs, (pagerArgs: typeof richDataArgs) => {
  richDataPaginationImplementation();
  return pagerTemplate(pagerArgs);
})`,...u.parameters?.docs?.source}}};const J=["RichDataDefault","RichDataPager","RichDataFilterMaxWidth"];export{c as RichDataDefault,u as RichDataFilterMaxWidth,f as RichDataPager,J as __namedExportsOrder,Z as default};
