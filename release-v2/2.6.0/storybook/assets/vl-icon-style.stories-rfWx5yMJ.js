import{u as l,j as n,M as a,C as t,aU as d,x as r}from"./iframe-Ds54rb_7.js";import"./preload-helper-D9Z9MdNV.js";function c(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...l(),...i.components},{FluxMetaData:s}=e;return s||p("FluxMetaData"),n.jsxs(n.Fragment,{children:[n.jsx(a,{title:"Components - Atom/icon-style"}),`
`,n.jsx(e.h1,{id:"icon-style",children:"Icon Style"}),`
`,n.jsx(s,{id:"components-atom-icon-style"}),`
`,n.jsx("br",{}),`
`,n.jsx(e.h2,{id:"inhoudstafel",children:"Inhoudstafel"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#doel",children:"Doel"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#voorbeelden",children:"Voorbeelden"})}),`
`]}),`
...
`,n.jsx(t,{of:o})]})}function v(i={}){const{wrapper:e}={...l(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(c,{...i})}):c(i)}function p(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const b={id:"components-atom-icon-style",title:"Components - Atom/icon-style (intern)",tags:["autodocs"],parameters:{docs:{page:v}}},o=({})=>r`
    <style>
        .sb-icon {
            ${d};
            margin-bottom: 1rem;
...
`;o.storyName="icon-style - default";o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`({}) => html\`
    <style>
        .sb-icon {
            \${vlIconStyles};
            margin-bottom: 1rem;
...
\``,...o.parameters?.docs?.source}}};const g=["IconStyleDefault"];export{o as IconStyleDefault,g as __namedExportsOrder,b as default};
