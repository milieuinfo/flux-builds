import{Z as d,_ as u,W as h,X as v,u as p,j as e,C as n,bc as m,x as i,r as y,c5 as x,c6 as g,c7 as V}from"./iframe-D9dm7PbY.js";import"./preload-helper-D9Z9MdNV.js";const c={...v,defaultSlot:""},j={...h,defaultSlot:{name:"[default]",description:"De inhoud van het zoekresultaat",table:{type:{summary:u.HTML},category:d.SLOTS,defaultValue:{summary:c.defaultSlot}}}};function o(t){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...t.components},{FluxComponentMetaData:s}=r;return s||b("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"search-result",children:"Search Result"}),`
...
`,e.jsx(r.p,{children:e.jsx(r.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-search-results",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Search Results"})})]})}function k(t={}){const{wrapper:r}={...p(),...t.components};return r?e.jsx(r,{...t,children:e.jsx(o,{...t})}):o(t)}function b(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const R={id:"components-block-search-result",title:"Components - Block/search-result",tags:["autodocs"],args:c,argTypes:j,parameters:{docs:{page:k}}};y([x,g,V]);const l=()=>i`
    <vl-search-result>
