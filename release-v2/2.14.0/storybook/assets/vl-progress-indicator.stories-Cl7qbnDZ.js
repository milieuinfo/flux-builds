...
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-progress-bar",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Progress Bar"})})]})}function T(t={}){const{wrapper:s}={...b(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(v,{...t})}):v(t)}function L(t,s){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const N={id:"components-block-progress-indicator",title:"Components - Block/progress-indicator",tags:["autodocs"],args:n,argTypes:I,parameters:{docs:{page:T}}},g=O(n,({activeStep:t,showLabels:s,focusOnChange:m,numeric:S,steps:f,onClickStep:j,staticSteps:k,enableFutureSteps:x})=>E`
  ...
  enableFutureSteps
    ...
    \`)`,...d.parameters?.docs?.source}}};const P=["ProgressIndicatorDefault","ProgressIndicatorNumeric","ProgressIndicatorFocused","ProgressIndicatorLabels","ProgressIndicatorStaticSteps","ProgressIndicatorEnableFutureSteps"];export{r as ProgressIndicatorDefault,d as ProgressIndicatorEnableFutureSteps,c as ProgressIndicatorFocused,p as ProgressIndicatorLabels,i as ProgressIndicatorNumeric,l as ProgressIndicatorStaticSteps,P as __namedExportsOrder,N as default};
