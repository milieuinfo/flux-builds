...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-info-tile",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Info Tile"})})]})}function ce(s={}){const{wrapper:n}={...w(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(V,{...s})}):V(s)}function re(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const fe={id:"components-block-info-tile",title:"Components - Block/info-tile",tags:["autodocs"],args:t,argTypes:se,parameters:{docs:{page:ce}}},o=oe({...t,classes:""},({autoOpen:s,toggleable:n,center:I,clickable:C,clickableLabel:E,contentSlot:N,subtitleSlot:U,titleSlot:R,footerSlot:_,menuSlot:G,badgeSlot:F,size:W,icon:X,iconAsBadge:Z,type:P,fullHeight:Y=!1,classes:q="",headingLevel:J,onVlClickInfoTile:K,highlight:Q,highlightLeft:ee})=>j`
        <vl-info-tile
            ?auto-open=${s}
            ?center=${I}
            ?icon-as-badge=${Z}
