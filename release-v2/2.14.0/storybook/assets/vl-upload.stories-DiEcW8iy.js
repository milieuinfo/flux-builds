...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-upload",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Upload"})})]})}function le(o={}){const{wrapper:n}={...b(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(v,{...o})}):v(o)}function re(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}K([J]);const pe={id:"components-form-upload",title:"Components - Form/upload",tags:["autodocs"],args:a,argTypes:ae,parameters:{docs:{page:le}}},i=Y(a,({id:o,name:n,label:s,required:f,disabled:y,readonly:x,error:j,success:w,url:k,disallowDuplicates:V,maxSize:d,maxFiles:c,chunking:T,parallelUploads:S,autoProcess:$,acceptedFiles:u,subTitle:m,mainTitle:F,errorMessageMaxFiles:E,errorMessageFilesize:z,errorMessageAcceptedFiles:D,onVlChange:M,onVlInput:A,onVlValid:C,onVlError:U,onVlSuccess:I,onVlComplete:N,onVlQueueComplete:R,onVlInitialised:B,onVlRemovedFile:P,onVlAddedFile:O,onVlUploadProgress:G})=>{let p;if(m.toString()==="Symbol(lit-nothing)"){const{maxFiles:H,subTitle:_,maxSize:q}=h,L=u.toString()!=="Symbol(lit-nothing)"?`
 De toegestane bestandstypes zijn: ${u}
`:"",g=typeof c=="number"?c:H,Q=typeof d=="number"?d:q;p=`${_} 
Upload ${g} ${g>1?"bestanden":"bestand"} van maximaal ${Q} MB${L}.`}else p=m;return Z`
            <vl-upload
                id=${o}
                name=${n}
                label=${s}
