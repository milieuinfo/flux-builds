import{Z as v,_ as q,W as h,X as S,u as g,j as t,C as d,bc as j,s as c,x as p,r as D}from"./iframe-D9dm7PbY.js";import"./vl-side-navigation.component-BNg8c-SM.js";import{V as P}from"./vl-side-navigation-layout.component-CNnakMfJ.js";import"./preload-helper-D9Z9MdNV.js";const a={...S,line:!1,timeline:!1,simpleTimeline:!1,lastStepNoLine:!1},T={...h,line:{name:"line",description:"Beeldt een verticale lijn af tussen de stappen.",table:{type:{summary:q.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.line)}}},timeline:{name:"timeline",description:"Beeldt een verticale tijdlijn af tussen de stappen.",table:{type:{summary:q.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.timeline)}}},simpleTimeline:{name:"simple-timeline",description:"Beeldt een simpele verticale tijdlijn af tussen de stappen.",table:{type:{summary:q.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.simpleTimeline)}}},lastStepNoLine:{name:"last-step-no-line",description:"Laat de verticale lijn na de laatste stap weg bij gebruik van de line, timeline of simple-timeline attributen.",table:{type:{summary:q.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.lastStepNoLine)}}}};function b(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...g(),...s.components},{FluxComponentMetaData:o}=e;return o||f("FluxComponentMetaData"),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"steps",children:"Steps"}),`
...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-steps",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Steps"})})]})}function E(s={}){const{wrapper:e}={...g(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(b,{...s})}):b(s)}function f(s,e){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}D([P]);const y={id:"components-block-steps-steps",title:"Components - Block/steps/steps",tags:["autodocs"],args:a,argTypes:T,parameters:{docs:{page:E}}},i=c(a,({line:s,timeline:e,lastStepNoLine:o})=>p`
  ...
  lastStepNoLine
    ...
    \`)`,...m.parameters?.docs?.source}}};const C=["StepsDefault","StepsIcons","StepsLine","StepsTimeline","StepsSimpleTimeline","StepsSideNavigation"];export{i as StepsDefault,r as StepsIcons,n as StepsLine,m as StepsSideNavigation,u as StepsSimpleTimeline,l as StepsTimeline,C as __namedExportsOrder,y as default};
