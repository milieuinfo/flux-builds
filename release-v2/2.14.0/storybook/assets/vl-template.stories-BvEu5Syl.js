import{Z as l,W as s,X as r,x as o,r as i,bb as n,Q as f}from"./iframe-D9dm7PbY.js";import"./preload-helper-D9Z9MdNV.js";const d={...r,center:!1,stretch:!1},m={...s,center:{name:"v-center",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content verticaal gecentreerd wordt.",table:{type:{summary:"boolean"},category:l.ATTRIBUTES,defaultValue:{summary:"false"}}},stretch:{name:"v-stretch",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content 100% zal innemen.",table:{type:{summary:"boolean"},category:l.ATTRIBUTES,defaultValue:{summary:"false"}}}};i([n,f]);const v={id:"components-block-template",title:"Components - Block/template",tags:["autodocs"],args:d,argTypes:m},c="1.2.3",p=o`
    <vl-content-header>
        <img
            slot="image"
