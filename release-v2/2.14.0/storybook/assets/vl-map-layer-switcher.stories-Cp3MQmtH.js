import{Z as h,_ as f,W as T,X as M,u as w,j as a,C as v,bc as F,S as I,x as d,s as g}from"./iframe-D9dm7PbY.js";import"./vl-map-base-layer-DdS66t0g.js";import"./vl-map-base-layer-grb-gray-DlB85uo0.js";import"./vl-map-layer-circle-style-D6lcMikC.js";import"./vl-map-features-layer-CjjaBi1V.js";import"./vl-map-side-sheet-BTYsSRzw.js";import"./vl-map-layer-switcher-D6HmnoI6.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-D9Lz4fnH.js";import"./vl-checkbox.component-CTssVSja.js";import"./vl-datepicker.component-BdyOMgdW.js";import"./cleave-esm-DfUhcNrv.js";import"./vl-fieldset.component-BtuuUfav.js";import"./vl-input-field-masked.component-B41Wbgbh.js";import"./vl-radio.component-BJRVPCas.js";import"./vl-radio-group.component-BOLoNZwp.js";import"./vl-select.component-CVn7Sb7E.js";import"./vl-select-rich.component-BEDJuxRx.js";import"./vl-textarea.component-DoL2u81l.js";import"./vl-textarea-rich.component-CiD6zwd0.js";import"./vl-upload.component-anH3-fcY.js";import"./vl-upload-progress.component-BSxlhh7Y.js";const y={...M,title:"Kaartlagen",layers:null},C={...T,title:{name:"title",description:"De titel bovenaan de layer-switcher.",table:{type:{summary:f.STRING},category:h.ATTRIBUTES,defaultValue:{summary:y.title}}},layers:{name:"layers",description:"Kan gebruikt worden om een subselectie van kaartlagen te tonen.<br>Geef hier de name attributen van de kaartlagen mee.<br>Kaartlagen worden niet langer automatisch toegevoegd of verwijderd in de layer-switcher.",table:{type:{summary:`${f.STRING}[]`},category:h.PROPERTIES,defaultValue:{summary:y.layers}}}},E=`import { VlButtonComponent } from '@domg-wc/components/atom';
...
`,a.jsx(v,{of:i}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"volledig code voorbeeld van bovenstaande implementatie"}),a.jsx(I,{code:E,language:"ts",dark:!0})]})]})}function K(l={}){const{wrapper:e}={...w(),...l.components};return e?a.jsx(e,{...l,children:a.jsx(b,{...l})}):b(l)}function V(l,e){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}const B=()=>d`
    ...
    `,P=(l,e,t,u)=>l.map(r=>d`
        ...
        <vl-map lambert2008>
            ...
            <vl-map-features-layer name="Kaartlaag 2" .features=${$} projection-code="EPSG:31370">
                <vl-map-layer-circle-style color="yellow"></vl-map-layer-circle-style>
            </vl-map-features-layer>
            <vl-map-features-layer name="Kaartlaag 3" .features=${j} projection-code="EPSG:31370">
                <vl-map-layer-circle-style color="red"></vl-map-layer-circle-style>
            </vl-map-features-layer>
            </vl-map-wmts-layer>
            </vl-map-wfs-layer>
        </vl-map>
    `),o=x.bind({});o.storyName="vl-map-layer-switcher - default";const s=x.bind({});s.storyName="vl-map-layer-switcher - subselection";s.args={layers:["Kaartlaag 1","Kaartlaag 2"]};const m=g(y,({title:l,layers:e})=>d`
        <vl-map lambert2008>
            <vl-map-side-sheet>
                <vl-map-layer-switcher title=${l} .layers=${e}></vl-map-layer-switcher>
            </vl-map-side-sheet>
    ...
    `);m.storyName="vl-map-layer-switcher - resolutions";const i=g(y,({title:l,layers:e})=>{const t=["zwart","geel","rood"],{handleAddLayerForId:u,handleToggleLayerForId:r,handleRemoveLayerForId:c}=G();return d`
        ${P(t,u,r,c)}
        ${B()}
        <vl-map
