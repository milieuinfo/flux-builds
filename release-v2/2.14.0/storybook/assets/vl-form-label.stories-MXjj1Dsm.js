import{Z as i,_ as s,c9 as g,X as p,W as v,u as f,j as n,C as c,bc as x,s as u,x as h,r as j,b as y}from"./iframe-D9dm7PbY.js";import"./preload-helper-D9Z9MdNV.js";const o={...p,...g,defaultSlot:""},T={...v,for:{name:"for",description:"Het id van de form control waarvoor het label bedoeld is.",table:{category:i.ATTRIBUTES,type:{summary:s.STRING},defaultValue:{summary:o.for}}},label:{name:"label",description:"De tekst van het label. Overschrijft de waarde van het default slot.",table:{category:i.ATTRIBUTES,type:{summary:s.STRING},defaultValue:{summary:o.label}}},annotation:{name:"annotation",description:"De annotatie tekst die naast het label getoond wordt (bv. een voorbeeld of extra uitleg).",table:{category:i.ATTRIBUTES,type:{summary:s.STRING},defaultValue:{summary:o.annotation}}},block:{name:"block",description:"Duidt aan of het label de volledige breedte van de parent moet innemen.",table:{category:i.ATTRIBUTES,type:{summary:s.BOOLEAN},defaultValue:{summary:String(o.block)}}},light:{name:"light",description:"Duidt aan of het label in light mode moet weergegeven worden.",table:{category:i.ATTRIBUTES,type:{summary:s.BOOLEAN},defaultValue:{summary:String(o.light)}}},defaultSlot:{name:"[default]",description:"De content van het label. Wordt overschreven door de waarde van het label attribuut.",table:{type:{summary:s.HTML},category:i.SLOTS,defaultValue:{summary:o.defaultSlot}}}};function b(a){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...f(),...a.components},{FluxComponentMetaData:r}=e;return r||w("FluxComponentMetaData"),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"form-label",children:"Form Label"}),`
...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-form-message",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Form Message"})})]})}function k(a={}){const{wrapper:e}={...f(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(b,{...a})}):b(a)}function w(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}j([y]);const $={id:"components-form-form-label",title:"Components - Form/form-label",tags:["autodocs"],args:o,argTypes:T,parameters:{docs:{page:k}}},t=u(o,({for:a,label:e,annotation:r,block:m,light:d})=>h`
        <vl-form-label
            for=${a}
            label=${e}
            annotation=${r}
            ...
            ?light=${d}
        ></vl-form-label>
    `);t.storyName="vl-form-label - default";t.args={label:"Naam"};const l=u(o,({for:a,label:e,annotation:r,block:m,light:d})=>h`
        <vl-form-label
            for=${a}
            label=${e}
            annotation=${r}
