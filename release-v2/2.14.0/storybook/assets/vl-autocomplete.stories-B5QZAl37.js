...
`;function k(a){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...w(),...a.components},{FluxComponentMetaData:s}=t;return s||Y("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"autocomplete",children:"Autocomplete"}),`
...
`,e.jsx(t.a,{href:"https://geo.api.vlaanderen.be/geolocation/",rel:"nofollow",children:"Documentatie voor de Geolocation API"})]})]})}function X(a={}){const{wrapper:t}={...w(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(k,{...a})}):k(a)}function Y(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}U([P]);const ee={id:"components-block-autocomplete",title:"Components - Block/autocomplete",tags:["autodocs"],args:n,argTypes:q,parameters:{docs:{page:X}},decorators:[a=>i` <div style="height: 400px;">${a()}</div>`]},l=m(n,({placeholder:a,initialValue:t,label:s,labelSmall:c,minChars:d,maxSuggestions:E,captionFormat:R,groupBy:C,items:J,showClear:$,clearTooltip:B,noMatchesText:G,disableLoading:N})=>i`
            <div class="container">
                <vl-autocomplete
                    placeholder=${a}
                    initial-value=${t}
