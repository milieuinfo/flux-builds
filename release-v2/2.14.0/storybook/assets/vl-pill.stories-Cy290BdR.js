...
je voorbeelden van kleuren die op deze manier getest zijn.`]})]})}function w(i={}){const{wrapper:l}={...u(),...i.components};return l?e.jsx(l,{...i,children:e.jsx(m,{...i})}):m(i)}function A(i,l){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const _={id:"components-block-pill",title:"Components - Block/pill",tags:["autodocs"],args:C,argTypes:T,parameters:{docs:{page:w}}},a=({closable:i,checkable:l,clickable:o,click:h,checked:b,type:s,disabled:d,close:y,check:g})=>r`
    <vl-pill
        ?closable=${i}
        ?checkable=${l}
        ?clickable=${o}
...
\``,...a.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => html\`<div class="vl-stacked vl-stacked-medium">
        ...
        <div class="vl-stacked vl-stacked-medium">
            ...
            <vl-link href="/?path=/docs/styles-kleurenpalet--documentatie"
                >Zie kleurenpalet (met WCAG getestte kleuren)</vl-link
            >
        </div>\``,...n.parameters?.docs?.source}}};const S=["PillDefault","PillAllVariants","PillCustomColors"];export{c as PillAllVariants,n as PillCustomColors,a as PillDefault,S as __namedExportsOrder,_ as default};
