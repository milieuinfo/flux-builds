...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-alert",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Alert"})})]})}function X(o={}){const{wrapper:t}={...N(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(L,{...o})}):L(o)}function w(o,t){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}P([q]);const J={id:"components-block-alert",title:"Components - Block/alert",tags:["autodocs"],args:n,argTypes:K,parameters:{docs:{page:X}}},s=G(n,({closable:o,icon:t,title:T,size:k,type:z,naked:E,multiline:H,message:R,defaultSlot:I,actionsSlot:O,titleSlot:W,alertClosed:V})=>F`
        <vl-alert
            ?closable=${o}
            ?naked=${E}
            ?multiline=${H}
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...$.parameters?.docs?.source}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`story(alertArgs, ({
  closable,
  icon,
  title,
  size,
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...S.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`story(alertArgs, ({
  closable,
  icon,
  title,
  size,
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...f.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`story(alertArgs, ({
  closable,
  icon,
  title,
  size,
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...u.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`story(alertArgs, ({
  closable,
  icon,
  title,
  size,
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...y.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`story(alertArgs, ({
  closable,
  icon,
  title,
  size,
  ...
  alertClosed
        ...
        >
            \${unsafeHTML(titleSlot)}\${unsafeHTML(defaultSlot)}\${unsafeHTML(actionsSlot)}</vl-alert
        >
    \`)`,...v.parameters?.docs?.source}}};const ee=["AlertDefault","AlertError","AlertInfo","AlertSuccess","AlertWarning","AlertWithButton","AlertWithTitleSlot","AlertCloseable","AlertNakedError","AlertNakedWarning","AlertNakedSuccess","AlertMultiline"];export{u as AlertCloseable,d as AlertDefault,m as AlertError,p as AlertInfo,v as AlertMultiline,y as AlertNakedError,b as AlertNakedSuccess,h as AlertNakedWarning,g as AlertSuccess,$ as AlertWarning,S as AlertWithButton,f as AlertWithTitleSlot,ee as __namedExportsOrder,J as default};
