import{Z as m,_ as $,bL as T,X as x,a1 as j,W as S,u as b,j as n,C as v,bc as A,s as y,x as g}from"./iframe-D9dm7PbY.js";import{o as i}from"./unsafe-html-DRRKv-ng.js";import"./preload-helper-D9Z9MdNV.js";const r={...x,...T,defaultSlot:""},B={...S,type:{name:"type",description:"Het type van de titel.",control:{type:j.INLINE_RADIO},options:["h1","h2","h3","h4","h5","h6"],table:{type:{summary:$.STRING},category:m.ATTRIBUTES,defaultValue:{summary:r.type}}},underline:{name:"underline",description:"Voegt een subtiele lijn toe onder de titel.",table:{type:{summary:$.BOOLEAN},category:m.ATTRIBUTES,defaultValue:{summary:String(r.underline)}}},alt:{name:"alt",description:"Zet alle letters om in uppercase en zal altijd een lijn toevoegen onder de titel.",table:{type:{summary:$.BOOLEAN},category:m.ATTRIBUTES,defaultValue:{summary:String(r.alt)}}},noSpaceBottom:{name:"no-space-bottom",description:"Vermindert ruimte onder de titel.",table:{type:{summary:$.BOOLEAN},category:m.ATTRIBUTES,defaultValue:{summary:String(r.noSpaceBottom)}}},appearance:{name:"appearance",description:"Bepaalt de visuele stijl van de titel, onafhankelijk van het semantische type. Handig voor het behouden van semantiek terwijl je een andere stijl wilt toepassen.",control:{type:j.INLINE_RADIO},options:["(none)","h1","h2","h3","h4","h5","h6"],table:{type:{summary:$.STRING},category:m.ATTRIBUTES,defaultValue:{summary:r.appearance||"''"}}},defaultSlot:{name:"[default]",table:{type:{summary:$.HTML},category:m.SLOTS}}};function f(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...b(),...t.components},{FluxComponentMetaData:a}=e;return a||N("FluxComponentMetaData"),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"title",children:"Title"}),`
...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-titles",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Title"})})]})}function L(t={}){const{wrapper:e}={...b(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(f,{...t})}):f(t)}function N(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const D={id:"components-atom-title",title:"Components - Atom/title",tags:["autodocs"],args:r,argTypes:B,parameters:{docs:{page:L}}},s=y(r,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h1"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h1"} - ${i(o)}
        </vl-title>
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h2"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h2"} - ${i(o)}
        </vl-title>
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h3"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h3"} - ${i(o)}
        </vl-title>
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h4"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h4"} - ${i(o)}
        </vl-title>
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h5"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h5"} - ${i(o)}
        </vl-title>
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h6"} underline=${e} no-space-bottom=${a} alt=${h} appearance=${l}>
            ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h6"} - ${i(o)}
        </vl-title>
    `);s.storyName="vl-title - default";s.args={defaultSlot:"Ik ben een titel"};const c=y(r,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h2"} appearance=${["h1","h2","h3","h4","h5","h6"].includes(l)?l:"h3"} underline="${e}" no-space-bottom="${a}" alt="${h}"
            >${i(o)} - ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h2"} met ${["h1","h2","h3","h4","h5","h6"].includes(l)?l:"h3"}-stijl</vl-title
        >
        <vl-title type=${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h3"} appearance=${["h1","h2","h3","h4","h5","h6"].includes(l)?l:"h4"} underline="${e}" no-space-bottom="${a}" alt="${h}"
            >${i(o)} - ${["h1","h2","h3","h4","h5","h6"].includes(t)?t:"h3"} met ${["h1","h2","h3","h4","h5","h6"].includes(l)?l:"h4"}-stijl</vl-title
        >
    `);c.storyName="vl-title - appearance";c.args={defaultSlot:"Ik ben een titel"};const d=y(r,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
        <vl-title
            type="${t}"
            underline=${e}
            no-space-bottom=${a}
            alt=${h}
            appearance=${l}
            >${i(o)} - ${t} met underline</vl-title
        >
    `);d.storyName="vl-title - underline";d.args={...s.args,underline:!0,type:"h2"};const p=y(r,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
        <vl-title
            type="${t}"
            underline=${e}
            no-space-bottom=${a}
            alt=${h}
            appearance=${l}
            >${i(o)} - ${t} met alt</vl-title
        >
    `);p.storyName="vl-title - alt";p.args={...s.args,alt:!0,type:"h2"};const u=y(r,({type:t,underline:e,noSpaceBottom:a,alt:h,defaultSlot:o,appearance:l})=>g`
        <vl-title
            type="${t}"
            underline=${e}
            no-space-bottom=${a}
            alt=${h}
            appearance=${l}
            >${i(o)} - ${t} met no-space-bottom</vl-title
        >
  ...
  appearance
        ...
        >
    \`)`,...c.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story<TitleArgs>(titleArgs, ({
  type,
  underline,
  noSpaceBottom,
  alt,
  ...
  appearance
        ...
        >
    \`)`,...d.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story<TitleArgs>(titleArgs, ({
  type,
  underline,
  noSpaceBottom,
  alt,
  ...
  appearance
        ...
        >
    \`)`,...p.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`story<TitleArgs>(titleArgs, ({
  type,
  underline,
  noSpaceBottom,
  alt,
  ...
  appearance
        ...
        >
    \`)`,...u.parameters?.docs?.source}}};const k=["TitleDefault","TitleAppearance","TitleUnderline","TitleAlt","TitleNoSpaceBottom"];export{p as TitleAlt,c as TitleAppearance,s as TitleDefault,u as TitleNoSpaceBottom,d as TitleUnderline,k as __namedExportsOrder,D as default};
