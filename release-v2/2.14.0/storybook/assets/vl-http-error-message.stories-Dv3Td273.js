import{Z as i,_ as o,W as D,X as G,u as j,j as e,C as H,bc as w,s as V,x as _,r as B,d as P}from"./iframe-D9dm7PbY.js";import{o as b}from"./unsafe-html-DRRKv-ng.js";import"./preload-helper-D9Z9MdNV.js";const a={...G,title:"",image:"",alt:"",errorCode:"",textSlot:"",actionsSlot:""},O={...D,title:{name:"title",type:{name:o.STRING,required:!1},description:"Past de title van de error message aan.",table:{type:{summary:o.STRING},defaultValue:{summary:a.title},category:i.ATTRIBUTES}},image:{name:"image",type:{name:o.STRING,required:!1},description:"De URL voor de afbeelding die weergegeven moet worden.",table:{type:{summary:o.STRING},defaultValue:{summary:a.image},category:i.ATTRIBUTES}},alt:{name:"image-alt",type:{name:o.STRING,required:!1},description:"Past de alternatieve tekst van de afbeelding aan.",table:{type:{summary:o.STRING},defaultValue:{summary:a.alt},category:i.ATTRIBUTES}},errorCode:{name:"error-code",type:{name:o.STRING,required:!1},description:"Geeft de default titel, afbeelding, tekst en actie voor een specifieke error code weer.",table:{type:{summary:o.STRING},defaultValue:{summary:a.errorCode},category:i.ATTRIBUTES}},textSlot:{name:"text",description:"Past de omschrijvende tekst onder de titel aan. Dit slot is niet reactief",table:{type:{summary:o.HTML},category:i.SLOTS,defaultValue:{summary:a.textSlot}}},actionsSlot:{name:"actions",description:"Past de acties aan. Dit slot is niet reactief",table:{type:{summary:o.HTML},category:i.SLOTS,defaultValue:{summary:a.actionsSlot}}}};function N(s){const r={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...j(),...s.components},{FluxComponentMetaData:L}=r;return L||q("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"http-error-message",children:"HTTP Error Message"}),`
`,e.jsx(L,{id:"components-block-http-error-message"}),`
...
`,e.jsx(H,{of:l})]})}function U(s={}){const{wrapper:r}={...j(),...s.components};return r?e.jsx(r,{...s,children:e.jsx(N,{...s})}):N(s)}function q(s,r){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}B([P]);const z={id:"components-block-http-error-message",title:"Components - Block/http-error-message",tags:["autodocs"],args:a,argTypes:O,parameters:{docs:{page:U}}},t=V(a,({title:s,image:r,alt:L,errorCode:R,textSlot:k,actionsSlot:I})=>_`
        <vl-http-error-message title=${s} image=${r} image-alt=${L} error-code=${R}>
            ${b(k)} ${b(I)}
  ...
  actionsSlot
    ...
    \`)`,...f.parameters?.docs?.source}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`story(httpErrorMessageArgs, ({
  title,
  image,
  alt,
  errorCode,
  ...
  actionsSlot
    ...
    \`)`,...y.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`story(httpErrorMessageArgs, ({
  title,
  image,
  alt,
  errorCode,
  ...
  actionsSlot
    ...
    \`)`,...A.parameters?.docs?.source}}};const Y=["httpErrorMessageDefault","httpErrorMessage400","httpErrorMessage401","httpErrorMessage403","httpErrorMessage404","httpErrorMessage405","httpErrorMessage408","httpErrorMessage410","httpErrorMessage411","httpErrorMessage412","httpErrorMessage413","httpErrorMessage414","httpErrorMessage415","httpErrorMessage500","httpErrorMessage501","httpErrorMessage502","httpErrorMessage503","httpErrorMessage504","httpErrorMessage505","httpErrorMessage506"];export{Y as __namedExportsOrder,z as default,l as httpErrorMessage400,g as httpErrorMessage401,m as httpErrorMessage403,p as httpErrorMessage404,c as httpErrorMessage405,d as httpErrorMessage408,h as httpErrorMessage410,u as httpErrorMessage411,M as httpErrorMessage412,S as httpErrorMessage413,$ as httpErrorMessage414,f as httpErrorMessage415,E as httpErrorMessage500,y as httpErrorMessage501,v as httpErrorMessage502,x as httpErrorMessage503,T as httpErrorMessage504,C as httpErrorMessage505,A as httpErrorMessage506,n as httpErrorMessageDefault};
