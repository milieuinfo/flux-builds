import{Z as i,_ as l,a1 as p,W as m,X as d,u as c,j as e,C as u,b8 as g,s as h,x}from"./iframe-DynOw9qF.js";import"./vl-map-base-layer-C-Ui_DPh.js";import"./vl-map-base-layer-grb-gray-C5sP2Bls.js";import{D as y,a as f}from"./vl-map-current-location-DA1zYyn3.js";import"./preload-helper-D9Z9MdNV.js";const r={...d,tooltip:y,zoom:f},v={...m,tooltip:{name:"tooltip",description:"Bepaalt de tekst van de tooltip van de huidige locatie knop.",table:{type:{summary:l.STRING},category:i.ATTRIBUTES,defaultValue:{summary:r.tooltip}}},zoom:{name:"zoom",description:"Bepaalt hoever er ingezoomd wordt bij het klikken op de huidige locatie knop.",control:{type:p.RANGE,min:1,max:13,step:1},table:{type:{summary:l.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(r.zoom)}}}};function s(t){const o={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...c(),...t.components},{FluxComponentMetaData:n}=o;return n||j("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"map-current-location",children:"Map Current Location"}),`
