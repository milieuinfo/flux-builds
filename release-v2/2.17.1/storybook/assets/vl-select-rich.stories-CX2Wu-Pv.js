import{u as x,j as e,C as r,S as s,b8 as W,s as N,x as j,r as E}from"./iframe-DynOw9qF.js";import{s as O,a as $}from"./vl-select-rich.stories-arg-Dfvfk9-t.js";import{V as F}from"./vl-select-rich.component-CaoTbphr.js";import{M as Z}from"./form-control.public-methods-doc-VCr5AkLW.js";import"./preload-helper-D9Z9MdNV.js";import"./form-control.stories-arg-BtJ2It1_.js";function g(l){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...x(),...l.components},{FluxComponentMetaData:m}=n;return m||X("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"select-rich",children:"Select Rich"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/multiselect",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Multiselect"})})]})}function _(l={}){const{wrapper:n}={...x(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(g,{...l})}):g(l)}function X(l,n){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}E([F]);const le={id:"components-form-select-rich",title:"Components - Form/select-rich",tags:["autodocs"],args:$,argTypes:O,parameters:{docs:{page:_}},decorators:[l=>j` <div style="height: 400px;">${l()}</div>`]},t=N($,({id:l,name:n,label:m,required:V,disabled:S,error:k,success:y,blurValidation:f,options:D,placeholder:R,notDeletable:w,multiple:C,search:T,position:z,resultLimit:P,noResultsText:L,noChoicesText:A,searchPlaceholder:q,searchStrategy:H,onVlChange:B,onVlInput:I,onVlSelectSearch:G,onVlReset:K,onVlValid:M})=>j` <vl-select-rich
            id=${l}
            name=${n}
            label=${m}
            ?required=${V}
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...a.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story(selectRichArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...p.parameters?.docs?.source}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`story(selectRichArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...b.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`story(selectRichArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...v.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`story(selectRichArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...o.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story(selectRichArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select-rich
            ...
            @vl-valid=\${onVlValid}
        ></vl-select-rich>\`;
})`,...u.parameters?.docs?.source}}};const te=["SelectRichDefault","SelectRichSearchStrategyDefault","SelectRichSearchStrategyExactAnd","SelectRichSearchStrategyExactOr","SelectRichNotDeletable","SelectRichGroups","SelectRichMultiple","SelectRichSelectedOption","SelectRichDisabledOption","SelectRichReadOnly"];export{a as SelectRichDefault,h as SelectRichDisabledOption,o as SelectRichGroups,d as SelectRichMultiple,i as SelectRichNotDeletable,u as SelectRichReadOnly,p as SelectRichSearchStrategyDefault,b as SelectRichSearchStrategyExactAnd,v as SelectRichSearchStrategyExactOr,c as SelectRichSelectedOption,te as __namedExportsOrder,le as default};
