import{Z as i,_ as c,a1 as D,u as j,j as e,C as z,b8 as M,s as F,x as P}from"./iframe-DynOw9qF.js";import"./vl-map-base-layer-C-Ui_DPh.js";import"./vl-map-base-layer-grb-gray-C5sP2Bls.js";import"./vl-map-features-layer-v5om4n5p.js";import"./vl-map-layer-circle-style-DDKlHhd7.js";import{m as A,a as E}from"./vl-map-layer-style.stories-arg-CXfP94Dp.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-C9gH2IcN.js";const o={...E,borderColor:"rgba(0, 0, 0, 0)",clusterColor:"rgba(2, 85, 204, 1)",clusterTextColor:"#FFF",clusterMultiplier:1,size:5},k={...A,borderColor:{name:"border-color",description:"De kleur van de rand van de kaartlaagstijl.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.borderColor}}},clusterColor:{name:"cluster-color",description:"De kleur bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterColor}}},clusterMultiplier:{name:"cluster-multiplier",description:"Bepaalt de verhouding van de vergroting voor clusters tegenover ingestelde `size`.",control:{type:D.NUMBER,step:.1},table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.clusterMultiplier)}}},clusterTextColor:{name:"cluster-text-color",description:"De kleur van de tekst bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterTextColor}}},size:{name:"size",description:"De grootte van de cirkels.",table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.size)}}}};function S(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...j(),...r.components},{FluxComponentMetaData:s}=t;return s||L("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"map-layer-circle-style",children:"Map Layer Circle Style"}),`
...
`]}),`
`,e.jsxs(t.p,{children:["Het is ook mogelijk te kiezen de verhouding van de coëfficiënt aan te passen door de ",e.jsx(t.code,{children:"cluster-multiplier"}),` in
te stellen.`]}),`
...
`]})]})}function N(r={}){const{wrapper:t}={...j(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(S,{...r})}):S(r)}function L(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const Y={id:"map-layer-style-layer-circle-style",title:"map/layer-style/layer-circle-style",tags:["autodocs"],args:o,argTypes:k,parameters:{docs:{page:N}}},T=F(o,({borderColor:r,borderSize:t,clusterColor:s,clusterTextColor:p,clusterMultiplier:y,color:u,name:d,size:m,textBackgroundColor:x,textBorderColor:b,textBorderSize:f,textColor:g,textFeatureAttributeName:C,textOffsetX:$,textOffsetY:v,textSize:h})=>P` <vl-map lambert2008>
