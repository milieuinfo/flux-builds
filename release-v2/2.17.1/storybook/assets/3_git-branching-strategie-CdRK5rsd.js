import{u as r,j as e,M as o}from"./iframe-DynOw9qF.js";import"./preload-helper-D9Z9MdNV.js";const a=""+new URL("git-branching-strategie-teams-DppHH_r_.png",import.meta.url).href;function i(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Bijdragen/Git Branching Strategie"}),`
...
`,e.jsx(n.strong,{children:"feature-v2/JIRA-123-sleutel-woorden"})," (of ",e.jsx(n.strong,{children:"feature-v1/JIRA-123-sleutel-woorden"}),`). Het versie-suffix geeft aan naar
welke integratie-branch de feature gaat: een `,e.jsx(n.strong,{children:"feature-v2/"}),"-branch target ",e.jsx(n.strong,{children:"develop-v2"}),", een ",e.jsx(n.strong,{children:"feature-v1/"}),`-branch
target `,e.jsx(n.strong,{children:"develop-v1"}),`. Als het Flux team bvb. ticket FLUX-2322 opneemt met als titel 'cdn-assets voorzien met tinyMCE
theming en publiceren op artifactory' en dit voor v2 is, dan gebeurt dat in een branch met bvb. de naam
`,e.jsx(n.strong,{children:"feature-v2/FLUX-2322-tinymce-cdn"}),`. De feature branch is tijdelijk en bij voorkeur / meestal enkel voor eigen
