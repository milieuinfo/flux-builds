...
over de volgorde van de domeinen of het moment waarop de preload gebeurt.`]})]})}function x(a={}){const{wrapper:o}={...d(),...a.components};return o?e.jsx(o,{...a,children:e.jsx(i,{...a})}):i(a)}function j(a,o){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const P={id:"components-block-proza-message-proza-message-preloader",title:"Components - Block/proza-message/proza-message-preloader",tags:["autodocs"],args:r,argTypes:b,parameters:{docs:{page:x},controls:{hideNoControlsWarning:!0},msw:{handlers:z}}},n=g(r,()=>(u.clearCache(),h`
        <div>
