...
`]}),`
`,n.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function A(i={}){const{wrapper:e}={...f(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(x,{...i})}):x(i)}function k(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const B={id:"components-block-next-side-navigation-layout",title:"Components - Block/next/side-navigation-layout",tags:["autodocs"],args:a,argTypes:L,parameters:{docs:{page:A,story:{inline:!1,iframeHeight:500}}}};w([q,I,T,P]);const t=v`
    <vl-paragraph>
...
`,c=h(a,({compact:i,contentBlock:e,navigationTitle:o,excludeSelectors:l,childSpacing:d,multiActive:y})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
                ?multi-active=${y}
        ...
        `);c.storyName="vl-side-navigation-layout-next - default";const u=h(a,({compact:i,contentBlock:e,maxDepth:o,excludeSelectors:l,childSpacing:d,multiActive:y})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
                ?multi-active=${y}
        ...
        `);u.storyName="vl-side-navigation-layout-next - met steps";u.parameters={docs:{story:{inline:!1,iframeHeight:800}}};const p=h(a,({compact:i,contentBlock:e,excludeSelectors:o,childSpacing:l,multiActive:d})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
                ?multi-active=${d}
        ...
        `);p.storyName="vl-side-navigation-layout-next - twee layouts met eigen content";p.parameters={docs:{story:{inline:!1,iframeHeight:900}}};const m=h(a,({compact:i,contentBlock:e,excludeSelectors:o,childSpacing:l,multiActive:d})=>v`
            <vl-side-navigation-layout-next
                ?compact=${i}
                ?content-block=${e}
                ?multi-active=${d}
        ...
        `);m.storyName="vl-side-navigation-layout-next - custom table of contents";c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  navigationTitle,
  excludeSelectors,
  ...
  return html\`
        ...
        \`;
})`,...u.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  excludeSelectors,
  childSpacing,
  ...
  return html\`
        ...
        \`;
})`,...p.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`story(sideNavigationLayoutArgs, ({
  compact,
  contentBlock,
  excludeSelectors,
  childSpacing,
  ...
  return html\`
        ...
        \`;
})`,...m.parameters?.docs?.source}}};const N=["SideNavigationLayoutDefault","SideNavigationLayoutWithSteps","SideNavigationLayoutTwoLayouts","SideNavigationLayoutWithCustomToc"];export{c as SideNavigationLayoutDefault,p as SideNavigationLayoutTwoLayouts,m as SideNavigationLayoutWithCustomToc,u as SideNavigationLayoutWithSteps,N as __namedExportsOrder,B as default};
