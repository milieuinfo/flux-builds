import{u as h,j as e,C as m,bd as S,S as E,J as a,K as l,P as u,O as p,s as O,x as B}from"./iframe-CflcmDUD.js";import{o as $}from"./unsafe-html-Bzfy4gdb.js";import"./vl-accessibility.component-C3RNICEu.js";import"./preload-helper-D9Z9MdNV.js";const r={FULLY_COMPLIANT:"FULLY_COMPLIANT",PARTIALLY_COMPLIANT:"PARTIALLY_COMPLIANT",NOT_COMPLIANT:"NOT_COMPLIANT"},d={EXPERT_EVALUATED:"EXPERT_EVALUATED",SELF_EVALUATED:"SELF_EVALUATED",NOT_EVALUATED:"NOT_EVALUATED"},D=`import { html } from 'lit';
...
export const header = ({ disableBackLink, hideBackLink }: HeaderProps) => html\`
    ...
    ></vl-functional-header>
\`;
`;function k(t){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...h(),...t.components},{FluxMetaData:c}=i;return c||w("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(i.h1,{id:"accessibility",children:"Accessibility"}),`
`,e.jsx(c,{id:"components-compliance-accessibility"}),`
...
`,e.jsx(E,{code:D,language:"ts",dark:!0}),`
...
`,e.jsx(i.p,{children:e.jsx(i.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accessibility.html",rel:"nofollow",children:"Legacy Demo - Accessibility"})})]})}function C(t={}){const{wrapper:i}={...h(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(k,{...t})}):k(t)}function w(t,i){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:I}=__STORYBOOK_MODULE_ACTIONS__,n={application:"deze applicatie",compliance:`${r.PARTIALLY_COMPLIANT}`,date:"20 juli 2021",dateModified:"20 juli 2021",disableBackLink:!1,hideBackLink:!1,evaluation:`${d.NOT_EVALUATED}`,version:"1.0.0",limitations:null,onClickBack:I("vl-click-back"),headerSlot:""},N={application:{name:"application",description:"De applicatie waar de verklaring over gaat.",table:{type:{summary:l.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.application}}},compliance:{name:"compliance",description:"De nalevingsstatus van de verklaring.",control:{type:p.SELECT},options:Object.values(r),table:{type:u(Object.values(r)),category:a.ATTRIBUTES,defaultValue:{summary:n.compliance}}},date:{name:"date",description:"De aanmaakdatum van de verklaring.",table:{type:{summary:l.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.date}}},dateModified:{name:"date-modified",description:"De datum van de laatste wijziging van de verklaring.",table:{type:{summary:l.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.dateModified}}},disableBackLink:{name:"disable-back-link",description:"Zet de terug-link uit.",table:{type:{summary:l.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(n.disableBackLink)}}},hideBackLink:{name:"hide-back-link",description:"Verwijdert de terug-link.",table:{type:{summary:l.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(n.hideBackLink)}}},evaluation:{name:"evaluation",description:"De evaluatiestatus van de verklaring.",control:{type:p.SELECT},options:Object.values(d),table:{type:{summary:u(Object.values(d))},category:a.ATTRIBUTES,defaultValue:{summary:n.evaluation}}},version:{name:"version",description:"De huidige versie van de verklaring.",table:{type:{summary:l.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.version}}},limitations:{name:"limitations",description:"Property om limitaties mee te geven aan de verklaring. Het object bevat 3 optionele properties. De `withTiming` limitaties vallen onder 'Niet-naleving van het bestuursdecreet'. Dit zijn tijdelijke limitaties. `withoutTiming` limitaties vallen onder 'Onevenredige last'. Dit zijn permanente limitaties. De `outsideApplicableLaw` limitaties vallen onder 'De inhoud valt buiten de werkingssfeer van de toepasselijke wetgeving'. Dit zijn limitaties die buiten de werkingssfeer van de toepasselijke wetgeving vallen.",table:{type:{summary:"object"},category:a.PROPERTIES}},onClickBack:{name:"vl-click-back",description:"Afgevuurd na het klikken op de terug-link.",table:{type:{summary:"-"},category:a.EVENTS}},headerSlot:{name:"header",description:"Hiermee kan je de standaard functional header vervangen door een header naar keuze.",table:{type:{summary:l.HTML},category:a.SLOTS,defaultValue:{summary:n.headerSlot}}}},P={id:"components-compliance-accessibility",title:"Components - Compliance/accessibility",tags:["autodocs"],args:n,argTypes:N,parameters:{layout:"fullscreen",docs:{page:C}}},b=O(n,({application:t,compliance:i,date:c,dateModified:v,disableBackLink:y,hideBackLink:T,evaluation:f,version:L,limitations:j,onClickBack:A,headerSlot:x})=>B`
        <vl-accessibility
            application=${t}
            compliance=${i}
            date=${c}
    ...
    `),g={withTiming:["Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."],withoutTiming:["Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."],outsideApplicableLaw:["Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."]},o=b.bind({});o.storyName="vl-accessibility - default";o.args={limitations:g};const s=b.bind({});s.storyName="vl-accessibility - header slot";s.args={limitations:g,headerSlot:`
    <vl-functional-header
        slot="header"
  ...
  headerSlot
    ...
    \`)`,...o.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(accessibilityArgs, ({
  application,
  compliance,
  date,
  dateModified,
  ...
  headerSlot
    ...
    \`)`,...s.parameters?.docs?.source}}};const U=["AccessibilityDefault","AccessibilityHeaderSlot"];export{o as AccessibilityDefault,s as AccessibilityHeaderSlot,U as __namedExportsOrder,P as default};
