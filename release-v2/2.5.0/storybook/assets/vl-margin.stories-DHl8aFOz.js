import{u as h,j as e,M as u,C as d,x as m,n as b,b6 as c}from"./iframe-CflcmDUD.js";import"./preload-helper-D9Z9MdNV.js";const x=""+new URL("margin-en-padding-DsqQ6Ycd.png",import.meta.url).href;function p(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...h(),...r.components},{FluxMetaData:v}=n;return v||y("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Styles/Layout (afnemers)/margin"}),`
`,e.jsx(n.h1,{id:"margin",children:"Margin"}),`
`,e.jsx(v,{id:"styles-layout-afnemers-margin"}),`
`,e.jsx("br",{}),`
...
`,e.jsx(n.a,{href:"/docs/styles-layout-afnemers-section--documentatie",children:"vl-section"}),"."]}),`
`,e.jsx(d,{of:s}),`
...
`,e.jsx(d,{of:l})]})}function j(r={}){const{wrapper:n}={...h(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(p,{...r})}):p(r)}function y(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const k={id:"styles-layout-afnemers-margin",title:"Styles/Layout (afnemers)/margin",tags:["autodocs"],parameters:{docs:{page:j}}},g=b`
    .sb-container {
        width: 300px;
...
`;a.storyName="vl-margin - small";a.parameters=c;const i=({})=>m`
    <style>
        ${g}
    </style>
    <div class="sb-container">
...
`;i.storyName="vl-margin - medium";i.parameters=c;const o=({})=>m`
    <style>
        ${g}
    </style>
    <div class="sb-container">
...
`;o.storyName="vl-margin - no";o.parameters=c;const t=({})=>m`
    <style>
        ${g}
    </style>
    <div class="sb-container">
...
\``,...a.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`({}) => html\`
    <style>
        \${marginCss}
    </style>
    <div class="sb-container">
...
\``,...i.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`({}) => html\`
    <style>
        \${marginCss}
    </style>
    <div class="sb-container">
...
\``,...l.parameters?.docs?.source}}};const w=["MarginDefault","MarginSmall","MarginMedium","MarginNo","MarginNoBottom","MarginNoTop"];export{s as MarginDefault,i as MarginMedium,o as MarginNo,t as MarginNoBottom,l as MarginNoTop,a as MarginSmall,w as __namedExportsOrder,k as default};
