import{u as h,j as e,M as u,C as l,x as c,n as b,b6 as p}from"./iframe-CflcmDUD.js";import"./preload-helper-D9Z9MdNV.js";const x=""+new URL("margin-en-padding-DsqQ6Ycd.png",import.meta.url).href;function v(d){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...h(),...d.components},{FluxMetaData:m}=n;return m||y("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Styles/Layout (afnemers)/padding"}),`
`,e.jsx(n.h1,{id:"padding",children:"Padding"}),`
`,e.jsx(m,{id:"styles-layout-afnemers-padding"}),`
`,e.jsx("br",{}),`
...
`,e.jsx(l,{of:r})]})}function j(d={}){const{wrapper:n}={...h(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(v,{...d})}):v(d)}function y(d,n){throw new Error("Expected component `"+d+"` to be defined: you likely forgot to import, pass, or provide it.")}const k={id:"styles-layout-afnemers-padding",title:"Styles/Layout (afnemers)/padding",tags:["autodocs"],parameters:{docs:{page:j}}},g=b`
    .sb-container {
        width: 300px;
        height: 100px;
...
`;a.storyName="vl-padding - small";a.parameters=p;const i=({})=>c`
    <style>
        ${g}
    </style>
...
`;i.storyName="vl-padding - medium";i.parameters=p;const o=({})=>c`
    <style>
        ${g}
    </style>
...
`;o.storyName="vl-padding - no";o.parameters=p;const t=({})=>c`
    <style>
        ${g}
    </style>
...
\``,...r.parameters?.docs?.source}}};const z=["PaddingDefault","PaddingSmall","PaddingMedium","PaddingNo","PaddingNoBottom","PaddingNoTop"];export{s as PaddingDefault,i as PaddingMedium,o as PaddingNo,t as PaddingNoBottom,r as PaddingNoTop,a as PaddingSmall,z as __namedExportsOrder,k as default};
