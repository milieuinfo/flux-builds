import{x as i,g as d,r as g,cx as m,bb as c,cy as p,cz as h,aW as k,aZ as u,I as b,aX as w,o as f,B as y,aG as j,q as z,by as D,cA as O,cB as V,cs as A}from"./iframe-CflcmDUD.js";const G=()=>i`
...
`,t={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",headerSlot:"",versionSlot:"",contentSlot:"",bottomSlot:""};var H=Object.getOwnPropertyDescriptor,T=(n,e,a,v)=>{for(var r=v>1?void 0:v?H(e,a):e,o=n.length-1,l;o>=0;o--)(l=n[o])&&(r=l(r)||r);return r};let s=class extends y{constructor(){super(),this.date=t.date,this.version=t.version,this.disableBackLink=t.disableBackLink,this.hideBackLink=t.hideBackLink,this.allowCustomCSS=!1}static get styles(){return[j,z,D,O,V,A]}static get properties(){return{date:{type:String,attribute:"date"},disableBackLink:{type:Boolean,attribute:"disable-back-link"},hideBackLink:{type:Boolean,attribute:"hide-back-link"},version:{type:String,attribute:"version"}}}render(){return i`
            <slot name="header"
                >${C({disableBackLink:this.disableBackLink,hideBackLink:this.hideBackLink})}
            </slot>
            <section class="vl-section">
                <slot name="version"> ${P(this.version,this.date)}</slot>
            </section>
        ...
        `}handleContentSlotChanged(n){const e=this.shadowRoot?.querySelector("#content"),a=this.querySelector('[slot="content"]');e&&a&&(e.textContent="",e.appendChild(a))}};g([m,c,p,h,k,u,b,w,...S()]);s=T([f("vl-privacy")],s);export{t as p};
