import{J as l,K as t,u as m,j as e,C as u,bd as f,s as g,x as h}from"./iframe-CflcmDUD.js";import"./vl-map-base-layer-BvMalALX.js";import"./vl-map-base-layer-grb-gray-Cuxf_f6a.js";import"./vl-map-wfs-layer-Bprmt369.js";import{m as v,a as j}from"./vl-map-layer.stories-arg-BZ85ZSrg.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-flPUvAVN.js";const o={...j,layers:"",projectionCode:"",url:""},x={...v,layers:{name:"layers",description:"De layers van de WFS.<br>Dit attribuut is niet reactief.",type:{name:t.STRING,required:!0},table:{type:{summary:t.STRING},category:l.ATTRIBUTES,defaultValue:{summary:o.layers}}},projectionCode:{name:"projection-code",description:`Indien je Lambert 72 coördinaten gebruikt op een Lambert 2008 kaart, moet je de projectie code
            EPSG:31370 meegeven als projection-code. Geef je dit niet mee, dan zal de kaartlaag de projectie code van
            de kaart overnemen.<br>Dit attribuut is niet reactief.`,table:{type:{summary:t.STRING},category:l.ATTRIBUTES,defaultValue:{summary:o.projectionCode}}},url:{name:"url",description:"De WFS url.<br>Dit attribuut is niet reactief.",type:{name:t.STRING,required:!0},table:{type:{summary:t.STRING},category:l.ATTRIBUTES,defaultValue:{summary:o.url}}}};function i(r){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...m(),...r.components},{FluxMetaData:s}=a;return s||w("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"map-wfs-layer",children:"Map WFS Layer"}),`
`,e.jsx(s,{id:"map-layer-vector-layer-wfs-layer"}),`
...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMapWfsLayer.html",rel:"nofollow",children:"Legacy Documentatie - Map Wfs Layer"})})]})}function b(r={}){const{wrapper:a}={...m(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(i,{...r})}):i(r)}function w(r,a){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const $={id:"map-layer-vector-layer-wfs-layer",title:"map/layer/vector-layer/wfs-layer",tags:["autodocs"],args:o,argTypes:x,parameters:{docs:{page:b}}},n=g(o,({hidden:r,layers:a,maxResolution:s,minResolution:p,name:c,opacity:d,url:y})=>h`
            <vl-map lambert2008>
