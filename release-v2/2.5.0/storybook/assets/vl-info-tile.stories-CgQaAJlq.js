...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-info-tile.html",rel:"nofollow",children:"Legacy Demo - Info Tile"})})]})}function Z(s={}){const{wrapper:n}={...j(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(D,{...s})}):D(s)}function J(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const ee={id:"components-block-info-tile",title:"Components - Block/info-tile",tags:["autodocs"],args:t,argTypes:Y,parameters:{docs:{page:Z}}},o=X({...t,classes:""},({autoOpen:s,toggleable:n,center:L,contentSlot:O,subtitleSlot:w,titleSlot:I,footerSlot:k,menuSlot:E,badgeSlot:N,size:U,icon:V,iconAsBadge:C,type:R,fullHeight:_=!1,classes:F=""})=>x`
        <vl-info-tile
            ?auto-open=${s}
            ?center=${L}
            ?icon-as-badge=${C}
