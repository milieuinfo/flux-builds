import{u as r,j as e,M as a,C as s,S as m}from"./iframe-CflcmDUD.js";import{f as i,D as c}from"./form-demo.stories-z85O3i6f.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-form-data.component-Cb6s8v5r.js";import"./vl-checkbox.component-D4zgMdoi.js";import"./vl-datepicker.component-CgELEzZR.js";import"./cleave-esm-DfUhcNrv.js";import"./vl-input-field-masked.component-DfsuPfBk.js";import"./vl-radio.component-Ra8Rh6YT.js";import"./vl-radio-group.component-BGDxo2T5.js";import"./vl-select.component-BMMIEVaD.js";import"./vl-select-rich.component-BsFMqeXH.js";import"./vl-textarea.component-C8hensF9.js";import"./vl-textarea-rich.component-Cwmhv0os.js";import"./vl-upload.component-Blk6WjMY.js";const d=`import { registerWebComponents, webComponent } from '@domg-wc/common';
...
`;function t(o){const l={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...r(),...o.components},{FluxAlert:n}=l;return n||v("FluxAlert"),e.jsxs(e.Fragment,{children:[e.jsx(a,{of:i}),`
`,e.jsx(l.h1,{id:"form---demo",children:"Form - Demo"}),`
`,e.jsxs(l.blockquote,{children:[`
`,e.jsxs(l.p,{children:["Meer info over validatie binnen onze form componenten vind je hier: ",e.jsx(l.a,{href:"/docs/ontwerp-form-validation--documentatie",children:"Form - Validatie"})]}),`
`]}),`
`,e.jsxs(l.blockquote,{children:[`
`,e.jsxs(l.p,{children:["Uitgebreid voorbeeld hoe je form data eenvoudiger kan parsen en instellen vind je op de ",e.jsx(l.a,{href:"/docs/ontwerp-form-form-data--documentatie",children:"Form Data pagina"}),"."]}),`
`]}),`
...
`,e.jsxs(l.p,{children:["Maak voor het opbouwen van de grid structuur gebruik van de ",e.jsx(l.a,{href:"/docs/styles-layout-afnemers-grid--documentatie",children:"vl-grid classes"}),".",e.jsx("br",{}),`
Plaats deze op native HtmlDivElements.`]}),`
`,e.jsx(l.h2,{id:"form-data",children:"Form data"}),`
`,e.jsxs(l.p,{children:["Gebruik de ",e.jsx(l.a,{href:"/docs/ontwerp-form-form-data--documentatie",children:"parseFormData"})," helper functie om de form data te verzamelen.",e.jsx("br",{}),`
...
`,e.jsxs("details",{open:!0,children:[e.jsx("summary",{children:"Code"}),e.jsx(m,{code:d,language:"ts",dark:!0})]})]})}function D(o={}){const{wrapper:l}={...r(),...o.components};return l?e.jsx(l,{...o,children:e.jsx(t,{...o})}):t(o)}function v(o,l){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{D as default};
