...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://nosir.github.io/cleave.js/",rel:"nofollow",children:"Documentatie Cleave.js"})})]})}function se(a={}){const{wrapper:n}={...j(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(b,{...a})}):b(a)}function re(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}K([ee,Y]);const he={id:"components-form-input-field-masked",title:"Components - Form/input-field-masked",tags:["autodocs"],args:p,argTypes:ie,parameters:{controls:{exclude:["pattern","type"]},docs:{page:se}}},s=J(p,({id:a,name:n,label:k,required:f,disabled:y,error:M,success:E,block:w,readonly:I,value:F,placeholder:R,autocomplete:L,minLength:P,maxLength:C,min:q,max:S,minExclusive:A,maxExclusive:D,mask:T,maskPrefix:N,rawValue:O,disableMaskValidation:B,regex:U,onVlChange:z,onVlInput:G,onVlReset:_,onVlValid:X})=>V`
