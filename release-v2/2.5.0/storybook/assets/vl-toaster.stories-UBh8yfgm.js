import{J as m,K as p,O as S,G as E,cp as h,H as O,u as w,j as e,C as c,bd as A,s as u,x as d,r as D,h as q,cq as L,cr as C}from"./iframe-CflcmDUD.js";import{o as g}from"./unsafe-html-Bzfy4gdb.js";import"./preload-helper-D9Z9MdNV.js";const _={TOP_LEFT:"top-left",TOP_RIGHT:"top-right",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right"},i={...O,...h,defaultSlot:""},M={...E,fadeOut:{name:"fade-out",description:`Elke alert verdwijnt automatisch 5 seconden na openen. 
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-toasters",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Toaster"})})]})}function z(r={}){const{wrapper:t}={...w(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(j,{...r})}):j(r)}function b(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}var x=Object.freeze,N=Object.defineProperty,v=(r,t)=>x(N(r,"raw",{value:x(r.slice())})),y,k,T;D([q,L,C]);const G={id:"components-block-toaster",title:"Components - Block/toaster",tags:["autodocs"],args:i,argTypes:M,parameters:{contentPadding:"large",docs:{page:z,story:{inline:!0}},controls:{hideNoControlsWarning:!0}},decorators:[r=>d` <div style="height: 400px;">${r()}</div>`]},o=u(i,({placement:r,fadeOut:t,defaultSlot:n})=>d(y||(y=v([`
    ...
    `);a.storyName="vl-toaster - default slot";a.args={placement:"bottom-right",defaultSlot:`<vl-alert
                ...
                </vl-alert>`};const s=u(i,({placement:r,fadeOut:t})=>d(k||(k=v([`
        <script>
    ...
    `])),t,r));s.storyName="vl-toaster - show alert";s.parameters={controls:{exclude:["defaultSlot"]}};const l=u(i,({placement:r,fadeOut:t,defaultSlot:n})=>d(T||(T=v([`
        <script>
    ...
    `])),r,t,g(n)));l.storyName="vl-toaster - fade out";l.args={fadeOut:!0};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story<ToasterArgs>(toasterArgs, ({
  placement,
  fadeOut,
  defaultSlot
}) => {
  ...
  return html\`
    ...
    \`;
})`,...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story<ToasterArgs>(toasterArgs, ({
  placement,
  fadeOut
}) => {
  return html\`
        ...
        <vl-button id="button-technical-error"> Toon waarschuwing</vl-button>
    \`;
})`,...s.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`story<ToasterArgs>(toasterArgs, ({
  placement,
  fadeOut,
  defaultSlot
}) => {
  return html\`
        ...
        <vl-button id="button-loader"> Toon melding met lader</vl-button>
    \`;
})`,...l.parameters?.docs?.source}}};const R=["ToasterDefault","ToasterDefaultSlot","ToasterShowAlert","ToasterFadeOut"];export{o as ToasterDefault,a as ToasterDefaultSlot,l as ToasterFadeOut,s as ToasterShowAlert,R as __namedExportsOrder,G as default};
