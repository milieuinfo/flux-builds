...
`,n.jsx(s,{of:o})]})}function f(t={}){const{wrapper:i}={...r(),...t.components};return i?n.jsx(i,{...t,children:n.jsx(l,{...t})}):l(t)}function p(t,i){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const g={id:"styles-base-font",title:"Styles/Base (intern)/font",tags:["autodocs"],parameters:{docs:{page:f}}},e=({})=>d`
    <style>
        .sb-font-normal {
