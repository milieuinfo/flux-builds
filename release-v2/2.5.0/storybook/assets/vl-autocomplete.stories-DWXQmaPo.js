...
`;function k(a){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...w(),...a.components},{FluxMetaData:s}=t;return s||J("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"autocomplete",children:"Autocomplete"}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-autocomplete--default",rel:"nofollow",children:"Legacy Storybook - Autocomplete"})})]})}function Y(a={}){const{wrapper:t}={...w(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(k,{...a})}):k(a)}function J(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}U([P]);const ee={id:"components-block-autocomplete",title:"Components - Block/autocomplete",tags:["autodocs"],args:n,argTypes:q,parameters:{docs:{page:Y}},decorators:[a=>i` <div style="height: 400px;">${a()}</div>`]},l=m(n,({placeholder:a,initialValue:t,label:s,labelSmall:c,minChars:d,maxSuggestions:E,captionFormat:R,groupBy:C,items:K,showClear:G,clearTooltip:$,noMatchesText:B,disableLoading:L})=>i`
            <div class="container">
                <vl-autocomplete
                    placeholder=${a}
                    initial-value=${t}
        ...
        `);g.storyName="vl-autocomplete - input and api call";const h=m(n,()=>i`
            <vl-autocomplete
                @search=${a=>z(a.target,a.detail.searchTerm)}
                placeholder="Gemeente, Straat of Project"
                min-chars="2"
                max-suggestions="5"
            ></vl-autocomplete>
