...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-doormat",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Doormat"})})]})}function R(r={}){const{wrapper:t}={...f(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(u,{...r})}):u(r)}function N(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}M([H]);const O={id:"components-block-doormat",title:"Components - Block/doormat",tags:["autodocs"],args:a,argTypes:k,parameters:{docs:{page:R}}},c=B(a,({href:r,external:t,alt:d,imageSrc:x,imageAlt:S,imageHeight:y,imageWidth:v,graphic:b,textSlot:$,titleSlot:T})=>E`
  ...
  titleSlot
        ...
        \`)`,...m.parameters?.docs?.source}}};const C=["DoormatDefault","DoormatAlt","DoormatImage","DoormatGraphic"];export{s as DoormatAlt,n as DoormatDefault,m as DoormatGraphic,l as DoormatImage,C as __namedExportsOrder,O as default};
