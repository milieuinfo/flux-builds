...
`,L=`import richDataFilterData from './vl-rich-data-table-filter.stories-mock';
...
`,Z=`export const richDataFilterData = {
    data: [
        {
            id: 0,
            name: 'Wegen',
...
`,X=`import { VlPagerComponent } from '../../pager';
...
`,a.jsxs("details",{children:[a.jsx("summary",{children:"code voorbeeld hoe sorting toe te passen"}),a.jsx(N,{code:G,language:"ts",dark:!0})]}),`
...
`,a.jsxs("details",{children:[a.jsx("summary",{children:"gebruikte mock data in onderstaande voorbeeld"}),a.jsx(N,{code:Z,language:"ts",dark:!0})]}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"code voorbeeld hoe filtering toe te passen"}),a.jsx(N,{code:L,language:"ts",dark:!0})]}),`
...
`,a.jsxs("details",{children:[a.jsx("summary",{children:"code voorbeeld hoe paginatie toe te passen"}),a.jsx(N,{code:X,language:"ts",dark:!0})]}),`
`,a.jsxs(e.p,{children:["Template voorbeeld vind je hieronder. Klik ",a.jsx(e.code,{children:"Show code"})," de html te zien."]}),`
