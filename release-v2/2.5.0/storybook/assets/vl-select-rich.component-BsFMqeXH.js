...
`,Fi={AUTO:"auto",TOP:"top",BOTTOM:"bottom"},L={...tt,initialOptions:[],options:[],placeholder:"",notDeletable:!1,multiple:!1,search:!1,position:Fi.AUTO,resultLimit:4,noResultsText:"Geen resultaten gevonden",noChoicesText:"Geen resterende opties gevonden",searchPlaceholder:"Zoek item"};var Ri=Object.getOwnPropertyDescriptor,Ki=(i,e,t,s)=>{for(var r=s>1?void 0:s?Ri(e,t):e,n=i.length-1,l;n>=0;n--)(l=i[n])&&(r=l(r)||r);return r};let Re=class extends it{constructor(){super(),this.options=L.options,this.initialOptions=L.initialOptions,this.placeholder=L.placeholder,this.search=L.search,this.searchPlaceholder=L.searchPlaceholder,this.choices=null,this.notDeletable=L.notDeletable,this.multiple=L.multiple,this.position=L.position,this.resultLimit=L.resultLimit,this.noResultsText=L.noResultsText,this.noChoicesText=L.noChoicesText,this.value=null,this.dropdownInitialised=!1,this.isDropdownOpen=!1,this.dispatchInput=!1,this.callbackOnInit=()=>{this.getChoicesElement()?.addEventListener("click",this.onClickChoices),this.internals.labels[0]?.addEventListener("click",this.onClickChoices),this.getChoicesElement()?.addEventListener("showDropdown",()=>{const i=this.getChoicesElement()?.querySelector(".vl-select__list--dropdown");i&&!this.dropdownInitialised&&(i.setAttribute("role","group"),i.setAttribute("id","vl-select__list"),this.dropdownInitialised=!0),this.isDropdownOpen=!0}),this.getChoicesElement()?.addEventListener("hideDropdown",()=>{this.isDropdownOpen=!1}),this.setChoicesInputAttributes()},this.onClickChoices=()=>{this.disabled||this.choices?.showDropdown()},this.onSearchInput=i=>{const e=i?.target?.value;this.dispatchEvent(new CustomEvent("vl-select-search",{bubbles:!0,composed:!0,detail:{value:e}}))},this.submitFormOnEnter=!1}static get styles(){return[st,rt,nt,Pi,ji,lt,Ni]}static get properties(){return{initialOptions:{type:Array,attribute:"initial-options"},options:{type:Array},placeholder:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},multiple:{type:Boolean},search:{type:Boolean},position:{type:String},resultLimit:{type:Number,attribute:"result-limit"},noResultsText:{type:String,attribute:"no-results-text"},noChoicesText:{type:String,attribute:"no-choices-text"},searchPlaceholder:{type:String,attribute:"search-placeholder"},value:{type:FormData,state:!0,hasChanged:(i,e)=>i instanceof FormData&&e instanceof FormData?JSON.stringify([...i.entries()])!==JSON.stringify([...e.entries()]):i!==e}}}firstUpdated(i){super.firstUpdated(i),this.choices=new Fe(this.validationTarget,this.getChoicesConfig()),this.initialOptions=structuredClone(this.options),setTimeout(()=>{this.value||this.setValue(null),this.choices?.input?.element?.addEventListener("input",this.onSearchInput)},0)}updated(i){if(super.updated(i),!!this.choices){if(i.has("options")&&(this.choices.clearStore(),this.choices.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.options)),i.has("value")){const e={value:this.getSelected()};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{bubbles:!0,composed:!0,detail:e})),this.validity.valid&&this.dispatchEventIfValid(e)}i.has("disabled")&&(this.disabled?this.choices.disable():this.choices.enable()),i.has("error")&&this.internals.setValidity({customError:this.error},"custom-error"),i.has("resultLimit")&&(this.choices.config.searchResultLimit=this.resultLimit)}}disconnectedCallback(){super.disconnectedCallback(),this.getChoicesElement()?.removeEventListener("click",this.onClickChoices),this.internals.labels[0]?.removeEventListener("click",this.onClickChoices),this.choices?.input?.element?.removeEventListener("input",this.onSearchInput),this.choices?.destroy()}render(){const i={"vl-select":!this.multiple,"vl-multiselect":this.multiple,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success};return at`
            <select
                id=${this.id||X}
                name=${this.name||X}
                class=${ot(i)}
            ...
            ></select>
        `}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){super.resetFormControl(),this.choices?.clearStore(),this.choices?.setChoices(this.options,"value","label",!0),this.updateSelectedOptions(this.initialOptions),this.onChange()}setOptions(i){!i||!i.length||(this.options=structuredClone(i))}updateSelectedOptions(i){const e=i.filter(s=>s.selected).map(s=>s.value),t=i.filter(s=>!s.selected).map(s=>s.value);this.removeSelectionByValue(t),this.selectByValue(e)}setSelectedValues(i){this.removeAllSelections(),this.selectByValue(i)}getSelected(){return this.multiple?this.getSelectedValues():this.getSelectedValues()[0]||null}selectByValue(i){this.choices&&(Array.isArray(i)?this.choices.setChoiceByValue(i):this.choices.setChoiceByValue([i]),this.setValue(this.collectFormData()))}removeSelectionByValue(i){this.choices&&(Array.isArray(i)?i.forEach(e=>this.choices.removeActiveItemsByValue(e)):this.choices.removeActiveItemsByValue(i),this.setValue(this.collectFormData()))}removeAllSelections(){this.choices&&(this.choices.removeActiveItems(),this.setValue(this.collectFormData()))}onKeydown(i){i.stopPropagation(),super.onKeydown(i)}setChoicesInputAttributes(){if(this.choices?.input?.element){const i=this.choices.input.element;i.setAttribute("type","text"),i.classList.add("vl-input-field","vl-input-field-cloned"),i.setAttribute("autocomplete","off"),i.setAttribute("autocapitalize","off"),i.setAttribute("spellcheck","false"),i.setAttribute("role","textbox"),i.setAttribute("aria-autocomplete","list"),i.setAttribute("aria-label","zoek item")}}getSelectedValues(){const i=this.validationTarget.selectedOptions;return Array.from(i).filter(e=>e.value&&e.hasAttribute("selected")).map(e=>e.value)}collectFormData(){const i=this.name||this.id,e=this.getSelectedValues();return e?.length?e.reduce((t,s,r)=>(r?t.append(i,s):t.set(i,s),t),new FormData):null}getChoicesElement(){return this.shadowRoot?.querySelector(".js-vl-select")}getChoicesConfig(){return{callbackOnInit:this.callbackOnInit,shouldSort:!1,removeItemButton:!this.notDeletable,removeItems:!this.notDeletable,searchEnabled:this.search,placeholder:!!this.placeholder,placeholderValue:this.placeholder,position:this.position,noResultsText:this.noResultsText,searchResultLimit:this.resultLimit,noChoicesText:this.noChoicesText,searchPlaceholderValue:this.searchPlaceholder,classNames:{...Fe.defaults.allOptions.classNames,containerOuter:"js-vl-select",containerInner:"vl-select__inner",input:"vl-input-field",inputCloned:"vl-input-field-cloned",list:"vl-select__list",listItems:"vl-select__list--multiple",listSingle:"vl-select__list--single",listDropdown:["vl-select__list","vl-select__list--dropdown"],item:"vl-select__item",itemSelectable:"vl-select__item--selectable",itemDisabled:"vl-select__item--disabled",itemChoice:"vl-select__item--choice",placeholder:"vl-select__placeholder",group:"vl-select__group",groupHeading:"vl-select__heading",button:"vl-select__button"},callbackOnCreateTemplates:i=>({containerOuter:()=>i(`
                            <div
