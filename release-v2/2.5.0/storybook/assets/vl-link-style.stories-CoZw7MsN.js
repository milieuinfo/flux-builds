import{u as a,j as e,M as t,C as r,aU as d,aT as c,x as k,b6 as m}from"./iframe-CflcmDUD.js";import"./preload-helper-D9Z9MdNV.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...a(),...s.components},{FluxMetaData:i}=n;return i||p("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Components - Atom/link-style"}),`
...
`,e.jsx(r,{of:l})]})}function v(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}function p(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const u={id:"components-atom-link-style",title:"Components - Atom/link-style (intern)",tags:["autodocs"],parameters:{docs:{page:v}}},l=({})=>k`
    <style>
        ${d()};
        .sb-link {
            ${c};
...
`;l.storyName="link-style - default";l.parameters=m;l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`({}) => html\`
    <style>
        \${vlLinkStyles()};
        .sb-link {
            \${vlIconStyles};
...
\``,...l.parameters?.docs?.source}}};const x=["LinkStyleDefault"];export{l as LinkStyleDefault,x as __namedExportsOrder,u as default};
