...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map.html",rel:"nofollow",children:"Legacy Demo - Map"})})]})}function K(t={}){const{wrapper:e}={...L(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(A,{...t})}):A(t)}function I(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const n=t=>C(`${t}-action`),i=t=>C(`${t}-toggle-button`),D=["draw-point","draw-line","draw-polygon","modify","delete"],C=t=>{const e=document.getElementsByClassName(t);return e[e.length-1]},G=({detail:{previous:t,current:e}})=>{D.forEach(o=>{t===n(o)?i(o).on=!1:e===n(o)&&(i(o).on=!0)})},B=({detail:{layer:t,visible:e}})=>{const o=t.getElementsByClassName("action");for(const s of o)D.forEach(d=>{s===n(d)&&(i(d).disabled=!e)})},O=({detail:{value:t}})=>{document.querySelectorAll("vl-map-features-layer")?.forEach(o=>{o.setAttribute("opacity",String(t/100))})};F([H]);const Me={id:"map-map",title:"map/map",tags:["autodocs"],args:r,argTypes:Z,parameters:{docs:{page:K}}},u=k(r,({allowFullscreen:t,disableEscape:e,disableRotation:o,disableMousewheelZoom:s,disableKeyboard:d,noBorder:v,fullHeight:g})=>E`
  ...
  toaster.showAlert({
    ...
    \`)`,...f.parameters?.docs?.source}}};const De=["MapDefault","MapFullHeight","MapPlayground","MapPlaygroundLB72"];export{u as MapDefault,b as MapFullHeight,y as MapPlayground,f as MapPlaygroundLB72,De as __namedExportsOrder,Me as default};
