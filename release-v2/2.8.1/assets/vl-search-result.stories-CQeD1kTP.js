import{K as u,L as h,H as p,I as v,u as i,j as e,C as n,bd as m,x as c,r as b,c3 as x,c4 as g,c5 as V}from"./iframe-C7eocPW2.js";import"./preload-helper-D9Z9MdNV.js";const d={...v,defaultSlot:""},j={...p,defaultSlot:{name:"[default]",description:"De inhoud van het zoekresultaat",table:{type:{summary:h.HTML},category:u.SLOTS,defaultValue:{summary:d.defaultSlot}}}};function o(a){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...a.components},{FluxComponentMetaData:s}=r;return s||f("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"search-result",children:"Search Result"}),`
