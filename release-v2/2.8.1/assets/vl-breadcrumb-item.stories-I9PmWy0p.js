...
`,e.jsx(o,{of:c})]})}function B(t={}){const{wrapper:r}={...p(),...t.components};return r?e.jsx(r,{...t,children:e.jsx(u,{...t})}):u(t)}function w(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const E={id:"components-block-breadcrumb-breadcrumb-item",title:"Components - Block/breadcrumb/breadcrumb-item",tags:["autodocs"],args:d,argTypes:T,parameters:{docs:{page:B}}},m=v(d,({href:t,type:r})=>k`
        <vl-breadcrumb>
  ...
  type
    ...
    \`)`,...c.parameters?.docs?.source}}};const C=["BreadcrumbDefault","BreadcrumbButton","BreadcrumbText"];export{a as BreadcrumbButton,n as BreadcrumbDefault,c as BreadcrumbText,C as __namedExportsOrder,E as default};
