import{u as D,j as a,C as k,bd as M,S as v,s as w,x as y,r as V,cK as I,c3 as T}from"./iframe-C7eocPW2.js";import{V as A}from"./vl-select.component-DbS55rlf.js";import{r as L,a as p}from"./vl-rich-data.stories-arg-ZCJ7WXZC.js";import"./preload-helper-D9Z9MdNV.js";const G=`export const richDataMockData = {
    data: [
        {
            id: 0,
            name: 'Project #1',
...
`;function j(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...D(),...t.components},{FluxComponentMetaData:f}=e;return f||O("FluxComponentMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"rich-data",children:"Rich Data"}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data.html",rel:"nofollow",children:"Legacy Demo - Rich Data"})})]})}function K(t={}){const{wrapper:e}={...D(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(j,{...t})}):j(t)}function O(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const _={data:[{id:0,name:"Project #1",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Sander",lastName:"Kleykens"}]},{id:1,name:"Project #2",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:2,name:"Project #3",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:3,name:"Project #4",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:4,name:"Project #5",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:5,name:"Project #6",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:6,name:"Project #7",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:7,name:"Project #8",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:8,name:"Project #9",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:9,name:"Project #10",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:10,name:"Project #11",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:11,name:"Project #12",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:12,name:"Project #13",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:13,name:"Project #14",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:14,name:"Project #15",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:15,name:"Project #16",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:16,name:"Project #17",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:17,name:"Project #18",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:18,name:"Project #19",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:19,name:"Project #20",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:20,name:"Project #21",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:21,name:"Project #22",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:22,name:"Project #23",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:23,name:"Project #24",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:24,name:"Project #25",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]}]},b=()=>{customElements.whenDefined("vl-rich-data").then(()=>{const t=document.querySelector("#rich-data"),e=t?.querySelector('[slot="content"]'),f=t?.querySelector('[slot="sorter"]'),x=t?.querySelector("vl-pager"),g=_;let P;const N=(l,n,i)=>{P=l,e&&(e.innerHTML=""),l?.slice(n,i).forEach(r=>{const s=new Date().toLocaleString(),o=r.manager,m=r.medewerkers[0],h=`
    ...
    `;c.storyName="vl-rich-data - default";const R=({filterClosable:t,filterClosed:e,filterMaxWidth:f})=>y`
    ...
    `,d=w(p,t=>(b(),R(t)));d.storyName="vl-rich-data - pager";d.args={filterClosable:!0};const u=w(p,t=>(b(),R(t)));u.storyName="vl-rich-data - filter-max-width";u.args={filterMaxWidth:"calc(1280px / 3)",filterClosable:!0};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`({
  filterClosable,
  filterClosed
}: typeof richDataArgs) => {
  return html\`
  ...
  richDataPaginationImplementation();
  return pagerTemplate(pagerArgs);
})`,...u.parameters?.docs?.source}}};const J=["RichDataDefault","RichDataPager","RichDataFilterMaxWidth"];export{c as RichDataDefault,u as RichDataFilterMaxWidth,d as RichDataPager,J as __namedExportsOrder,Z as default};
