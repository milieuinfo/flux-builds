...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-header.html",rel:"nofollow",children:"Legacy Demo - Header"})})]})}function $(t={}){const{wrapper:n}={...g(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(c,{...t})}):c(t)}function p(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const E={id:"components-compliance-header",title:"Components - Compliance/header",tags:["autodocs"],args:r,argTypes:T,parameters:{docs:{page:$,inlineStories:!1},layout:"fullscreen"}},o=w(r,({authenticatedUserUrl:t,development:n,identifier:d,loginRedirectUrl:s,loginUrl:u,logoutUrl:h,skeleton:m,simple:v,switchCapacityUrl:j,rejectLogout:f,logoutCallback:b,applicationLinks:k,onReady:y})=>D`
  ...
  onReady
    ...
    \`)`,...l.parameters?.docs?.source}}};const C=["HeaderDefault","HeaderWithApplicationLinks"];export{o as HeaderDefault,l as HeaderWithApplicationLinks,C as __namedExportsOrder,E as default};
