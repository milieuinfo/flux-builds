import{g as b,x as D,z as j,r as h,J as w,aX as v,y as s,D as f,E as y,cD as A,cE as z,cF as V,m as G,b8 as E,aY as x,aH as P,cH as I,bx as M,cG as H,cS as T}from"./iframe-C7eocPW2.js";const $=()=>[b],B=()=>D`
...
`;var L=Object.getOwnPropertyDescriptor,F=(n,i,o,a)=>{for(var e=a>1?void 0:a?L(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let r=class extends f{constructor({title:n,name:i,purpose:o,domain:a,processor:e,validity:t}={}){const l="<div></div>",O=[...y.map(d=>d.styleSheet),S.styleSheet];super(l,O);const C=()=>{const d=i||this.getAttribute("name");return Array.isArray(d)?`
        ...
        `,i=[P.styleSheet,...y.map(a=>a.styleSheet),S.styleSheet,I.styleSheet,M.styleSheet,H.styleSheet];super(n,i);const o=this.shadowRoot?.querySelector('slot[name="header"]');o&&T(B(),o),this.allowCustomCSS=!1,this._element.insertAdjacentHTML("afterend",`
