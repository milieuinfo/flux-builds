...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/js-components/vl-ui-popover",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Popover"})})]})}function G(t={}){const{wrapper:o}={...V(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(C,{...t})}):C(t)}function S(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:x}=__STORYBOOK_MODULE_ACTIONS__;_([I,N,q,M]);const Y={id:"components-block-popover",title:"Components - Block/popover",tags:["autodocs"],args:r,argTypes:Z,parameters:{docs:{page:G}}},z=t=>h` <div style="position: relative;min-height: 150px;">${t()}</div>`,R=g(r,({trigger:t,contentPadding:o,open:c,placement:n,hideArrow:b,hideOnClick:l,distance:L,strategy:O})=>h`
