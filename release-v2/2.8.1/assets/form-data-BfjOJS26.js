...
`,e.jsxs(n.p,{children:["Echter, deze API is niet altijd even handig in gebruik. Als je ",e.jsx(n.code,{children:"FormData.entries()"}),` gebruikt, dan krijg je een iterator van de waardes.
...
Wanneer je `,e.jsx(n.code,{children:"FormData.getAll()"})," gebruikt, krijg je dan weer altijd een array van waardes terug, ook voor inputs die maar 1 waarde kunnen bevatten."]}),`
...
`]}),`
`,e.jsx(i,{of:s,sourceState:"none"})]})}function y(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(a,{...r})}):a(r)}export{y as default};
