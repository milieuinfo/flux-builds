...
`})}),`
`,e.jsx(o,{of:r}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"options"}),e.jsx(h,{code:`
  [
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-select",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Select"})})]})}function M(l={}){const{wrapper:n}={...C(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(H,{...l})}):H(l)}function W(l,n){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}P([K]);const Y={id:"components-form-select",title:"Components - Form/select",tags:["autodocs"],args:a,argTypes:B,parameters:{docs:{page:M}}},m=I(a,({id:l,name:n,label:b,required:g,disabled:j,error:x,success:$,options:k,placeholder:V,notDeletable:y,autocomplete:w,block:f,onVlChange:S,onVlInput:D,onVlValid:R,onVlReset:E})=>A` <vl-select
            id=${l}
            name=${n}
            label=${b}
            ?required=${g}
        ...
        </vl-select>`),s=_.bind({});s.storyName="vl-select - declarative options";s.args={id:"woonplaats",name:"woonplaats",label:"Kies je woonplaats",placeholder:"Kies je woonplaats"};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(selectArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select
            ...
            @vl-reset=\${onVlReset}
        ></vl-select>\`;
})`,...c.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story(selectArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select
            ...
            @vl-reset=\${onVlReset}
        ></vl-select>\`;
})`,...p.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`story(selectArgs, ({
  id,
  name,
  label,
  required,
  ...
  return html\` <vl-select
            ...
            @vl-reset=\${onVlReset}
        ></vl-select>\`;
})`,...u.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(selectArgs, ({
  id,
  name,
  label,
  required,
...
})`,...s.parameters?.docs?.source}}};const J=["SelectDefault","SelectNotDeletable","SelectGroups","SelectSelectedOption","SelectDisabledOption","SelectReadOnly","SelectDeclarativeStates"];export{s as SelectDeclarativeStates,r as SelectDefault,p as SelectDisabledOption,d as SelectGroups,i as SelectNotDeletable,u as SelectReadOnly,c as SelectSelectedOption,J as __namedExportsOrder,Y as default};
