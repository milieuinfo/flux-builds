import{r as c,bz as p,h as v,aQ as s,x as d,y as u,bA as h,z as f,E as x,bB as w}from"./iframe-C7eocPW2.js";var _=Object.getOwnPropertyDescriptor,q=(i,n,r,a)=>{for(var o=a>1?void 0:a?_(n,r):n,e=i.length-1,l;e>=0;e--)(l=i[e])&&(o=l(o)||o);return o};let m=class extends s{render(){return d`
            <div>
                <vl-button
                    ghost
...
`;let b=class extends s{static get styles(){const i=f`
            .laaginfo {
                display: flex;
            }
        ...
        `;return[x,i]}render(){return d`
            <div class="panel">
                <vl-accordion toggle-text="Stedelijk woongebied" custom-css=${j}>
                    <span class="laaginfo">
                    ...
                    <div class="panel">
                        <div>
                            <vl-accordion toggle-text="$1.1" custom-css=${t}>
                                <span slot="menu">
                                ...
                                <div class="panel">
                                    <div>
                                        <vl-accordion toggle-text="Alle werken" custom-css=${t}>
                                            <span slot="menu">
                                                <vl-button
                                                    id="btn-acties3"
                                                    icon="nav-show-more-vertical"
                        ...
                        <div>
                            <vl-accordion toggle-text="$1.2" custom-css=${t}>
                                <span slot="menu">
                        ...
                        <div>
                            <vl-accordion toggle-text="$1.3" custom-css=${t}>
                                <span slot="menu">
        ...
        `}createRenderRoot(){return this}};c([h,p,v]);b=A([u("vl-popover-menu-accordion")],b);var V=Object.getOwnPropertyDescriptor,$=(i,n,r,a)=>{for(var o=a>1?void 0:a?V(n,r):n,e=i.length-1,l;e>=0;e--)(l=i[e])&&(o=l(o)||o);return o};let g=class extends s{static get styles(){return[x,f``]}render(){return d`
