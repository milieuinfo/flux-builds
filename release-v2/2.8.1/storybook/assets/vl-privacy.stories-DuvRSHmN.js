import{u as p,j as e,C as s,bd as f,S,K as r,L as o,s as j,x}from"./iframe-C7eocPW2.js";import{o as d}from"./unsafe-html-DGst3qpG.js";import{p as L}from"./vl-privacy.component-CUD5fbwN.js";import"./preload-helper-D9Z9MdNV.js";const T=`import { html } from 'lit';
...
export const header = ({ disableBackLink, hideBackLink }: { disableBackLink: boolean; hideBackLink: boolean }) => html\`
    ...
    ></vl-functional-header>
\`;
`;function m(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...a.components},{FluxComponentMetaData:l}=n;return l||$("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"privacy",children:"Privacy"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-privacy.html",rel:"nofollow",children:"Legacy Demo - Privacy"})})]})}function B(a={}){const{wrapper:n}={...p(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(m,{...a})}):m(a)}function $(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:H}=__STORYBOOK_MODULE_ACTIONS__,t={...L,onClickBack:H("vl-click-back")},C={date:{name:"date",description:"De datum waarop de pagina werd uitgegeven.",table:{type:{summary:o.STRING},category:r.ATTRIBUTES,defaultValue:{summary:t.date}}},disableBackLink:{name:"disable-back-link",description:"Zet de terug-link uit.",table:{type:{summary:o.BOOLEAN},category:r.ATTRIBUTES,defaultValue:{summary:String(t.disableBackLink)}}},hideBackLink:{name:"hide-back-link",description:"Verwijdert de terug-link.",table:{type:{summary:o.BOOLEAN},category:r.ATTRIBUTES,defaultValue:{summary:String(t.hideBackLink)}}},version:{name:"version",description:"De pagina versie.",table:{type:{summary:o.STRING},category:r.ATTRIBUTES,defaultValue:{summary:t.version}}},onClickBack:{name:"vl-click-back",description:"Afgevuurd na het klikken op de terug-link.",table:{type:{summary:"-"},category:r.EVENTS}},headerSlot:{name:"header",description:"Hiermee kan je de standaard functional header vervangen door een header naar keuze.",table:{type:{summary:o.HTML},category:r.SLOTS,defaultValue:{summary:t.headerSlot}}},versionSlot:{name:"version",description:"Hiermee kan je de standaard versie sectie vervangen door een sectie naar keuze.",table:{type:{summary:o.HTML},category:r.SLOTS,defaultValue:{summary:t.versionSlot}}},contentSlot:{name:"content",description:"Hiermee kan je de standaard content sectie vervangen door een sectie naar keuze.",table:{type:{summary:o.HTML},category:r.SLOTS,defaultValue:{summary:t.contentSlot}}},bottomSlot:{name:"bottom",description:"Hiermee kan je de standaard footer sectie vervangen door een sectie naar keuze.",table:{type:{summary:o.HTML},category:r.SLOTS,defaultValue:{summary:t.bottomSlot}}}},w={id:"components-compliance-privacy",title:"Components - Compliance/privacy",tags:["autodocs"],args:t,argTypes:C,parameters:{layout:"fullscreen",docs:{page:B}}},u=j(t,({date:a,disableBackLink:n,hideBackLink:l,version:v,onClickBack:h,headerSlot:k,versionSlot:y,contentSlot:b,bottomSlot:g})=>x`
            <vl-privacy
                date=${a}
                ?disable-back-link=${n}
                ?hide-back-link=${l}
...
`};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`story(privacyArgs, ({
  ...
  bottomSlot
        ...
        \`)`,...c.parameters?.docs?.source}}};const A=["PrivacyDefault","PrivacyHeaderSlot"];export{i as PrivacyDefault,c as PrivacyHeaderSlot,A as __namedExportsOrder,w as default};
