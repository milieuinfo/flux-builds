import{u as p,j as l,M as x,S as u,cU as h,C as r,cV as v,cW as a,cX as t,z as f,x as m,r as b,b as j,V as y,h as S}from"./iframe-C7eocPW2.js";import"./vl-checkbox.component-fqljGoIJ.js";import"./vl-datepicker.component-CaI7c1zK.js";import"./vl-input-field-masked.component-CDZX6soo.js";import"./vl-radio.component-Lxgs_PqS.js";import"./vl-radio-group.component-Ch5F_1Yr.js";import"./vl-select.component-DbS55rlf.js";import"./vl-select-rich.component-Ddm3ot_S.js";import"./vl-textarea.component-BZkPAf39.js";import"./vl-textarea-rich.component-D-0h8uGI.js";import"./vl-upload.component-8zPgs-PI.js";import"./preload-helper-D9Z9MdNV.js";import"./cleave-esm-DfUhcNrv.js";import"./vl-upload-progress.component-DQ6fHp6d.js";const w=""+new URL("grid-large-uKz8Dn73.png",import.meta.url).href,k=""+new URL("grid-medium-DzNcUqr3.png",import.meta.url).href,z=""+new URL("grid-small-C8fouyyk.png",import.meta.url).href,M=""+new URL("grid-extra-small-CfB2bL1s.png",import.meta.url).href,C=""+new URL("css-large-BCbHcJ27.png",import.meta.url).href,$=""+new URL("css-medium-B1Gfoyhz.png",import.meta.url).href,L=""+new URL("css-small-DRqYjDPH.png",import.meta.url).href,R=""+new URL("css-extra-small-DJX17tHm.png",import.meta.url).href,G=`import gridRawCss from './vl-grid.raw.css?raw';
...
\`;
`;function g(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...p(),...s.components},{FluxComponentMetaData:d}=n;return d||_("FluxComponentMetaData"),l.jsxs(l.Fragment,{children:[l.jsx(x,{title:"Styles/Layout (afnemers)/grid"}),`
...
`,l.jsx(u,{code:G,language:"ts",dark:!0}),`
...
`,l.jsx("br",{}),`
`,l.jsx("img",{src:R,alt:"css extra small",style:{maxWidth:"600px"}}),`
...
`})}),`
`,l.jsx(r,{of:i})]})}function E(s={}){const{wrapper:n}={...p(),...s.components};return n?l.jsx(n,{...s,children:l.jsx(g,{...s})}):g(s)}function _(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const D=f`
    .vl-grid {
...
`;b([j,y,S]);const P={id:"styles-layout-grid",title:"Styles/Layout (afnemers)/grid",tags:["autodocs"],parameters:{docs:{page:E}}},c=()=>m`
    <style>
...
\``,...i.parameters?.docs?.source}}};const Y=["GridResponsive","GridColumnStart","GridJustifyAlign","GridWithForm"];export{e as GridColumnStart,o as GridJustifyAlign,c as GridResponsive,i as GridWithForm,Y as __namedExportsOrder,P as default};
