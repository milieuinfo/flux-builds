"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[3662],{"../../libs/components/src/compliance/privacy/vl-privacy.component.ts":(e,n,i)=>{var a=i("../../libs/common/src/index.ts"),t=i("../../libs/styles/src/index.ts"),r=i("../../node_modules/lit/index.js"),o=i("../../node_modules/lit/decorators.js"),v=i("../../libs/components/src/atom/index.ts"),l=i("../../libs/components/src/atom/paragraph/index.ts"),d=i("../../libs/components/src/block/contact-card/index.ts"),s=i("../../libs/components/src/block/document/index.ts"),g=i("../../libs/components/src/block/infoblock/index.ts"),m=i("../../libs/components/src/block/properties/index.ts"),c=i("../../libs/components/src/block/side-navigation/index.ts"),p=i("../../libs/components/src/block/typography/index.ts"),k=i("../../node_modules/lit-html/lit-html.js");let h=()=>(0,k.qy)`
...
`;var b=i("../../libs/components/src/block/functional-header/index.ts");let w=()=>[b.a],f=({disableBackLink:e,hideBackLink:n})=>(0,r.qy)`
...
`;var j=i("../../libs/components/src/compliance/privacy/vl-privacy.defaults.ts");class z extends a.jW{static{(0,a.gy)([d.Y,s.F,g.P,p.I,v.IM,c.N8,m.L,l.Q,...w()])}constructor(){super(),this.date=j.z.date,this.version=j.z.version,this.disableBackLink=j.z.disableBackLink,this.hideBackLink=j.z.hideBackLink,this.allowCustomCSS=!1}static get styles(){return[t.qO,t.oi,t.B2,t.DE,t.as,t.Ei]}static get properties(){return{date:{type:String,attribute:"date"},disableBackLink:{type:Boolean,attribute:"disable-back-link"},hideBackLink:{type:Boolean,attribute:"hide-back-link"},version:{type:String,attribute:"version"}}}render(){return(0,r.qy)`
            <slot name="header"
                >${f({disableBackLink:this.disableBackLink,hideBackLink:this.hideBackLink})}
            </slot>
            <section class="vl-section">
                <slot name="version"> ${y(this.version,this.date)}</slot>
            </section>
            <section id="content" class="vl-section">
                <slot name="content" @slotchange=${this.handleContentSlotChanged}> ${u()}</slot>
            </section>
            <section class="vl-section vl-section--overlap">
                <slot name="bottom"> ${h()}</slot>
            </section>
        `}handleContentSlotChanged(e){let n=this.shadowRoot?.querySelector("#content"),i=this.querySelector('[slot="content"]');n&&i&&(n.textContent="",n.appendChild(i))}}z=function(e,n,i,a){var t,r=arguments.length,o=r<3?n:null===a?a=Object.getOwnPropertyDescriptor(n,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,i,a);else for(var v=e.length-1;v>=0;v--)(t=e[v])&&(o=(r<3?t(o):r>3?t(n,i,o):t(n,i))||o);return r>3&&o&&Object.defineProperty(n,i,o),o}([(0,o.EM)("vl-privacy")],z)},"../../libs/components/src/compliance/privacy/vl-privacy.defaults.ts":(e,n,i)=>{i.d(n,{z:()=>a});let a={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",headerSlot:"",versionSlot:"",contentSlot:"",bottomSlot:""}}}]);