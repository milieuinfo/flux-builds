...
</div>`;j.storyName="vl-group - links";j.args={separatorRow:!0};const f=({group:l,collapseL:e,collapseM:n,collapseS:t,collapseXS:a,column:s,justifyStart:i,justifyCenter:c,justifyEnd:p,alignStart:u,alignCenter:d,alignEnd:g,separatorColumn:v,separatorRow:m,spaceBetween:h,stretchChildren:L})=>S` <div
    class=${b({"vl-group":l,"vl-group--collapse-l":e,"vl-group--collapse-m":n,"vl-group--collapse-s":t,"vl-group--collapse-xs":a,"vl-group--column":s,"vl-group--justify-start":i,"vl-group--justify-center":c,"vl-group--justify-end":p,"vl-group--align-start":u,"vl-group--align-center":d,"vl-group--align-end":g,"vl-group--separator-column":v,"vl-group--separator-row":m,"vl-group--space-between":h,"vl-group--stretch-children":L})}
>
