import{H as h,I as y,u as g,j as t,C as b,bc as v,c6 as f,x as r}from"./iframe-CYuKbPIU.js";import"./preload-helper-D9Z9MdNV.js";const x={...y,parameters:'{"key1": "tempus" , "key2": "ipsum" }'},q={...h,parameters:{name:"parameters",description:"De key/value parameters die verwerkt en getoond zullen worden in het content element.",control:{disable:!0},table:{type:{summary:"string"}}}};function m(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...g(),...i.components},{FluxAlert:o,FluxComponentMetaData:d}=e;return o||c("FluxAlert"),d||c("FluxComponentMetaData"),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"typography",children:"Typography"}),`
...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-typography.html",rel:"nofollow",children:"Legacy Demo - Typography"})})]})}function k(i={}){const{wrapper:e}={...g(),...i.components};return e?t.jsx(e,{...i,children:t.jsx(m,{...i})}):m(i)}function c(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const D={id:"components-block-typography",title:"Components - Block/typography",tags:["autodocs"],args:x,argTypes:q,parameters:{docs:{page:k},controls:{hideNoControlsWarning:!0}}},a=()=>r` <vl-typography data-cy="typography">
    <p>
