...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-button",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Button"})})]})}function cn(i={}){const{wrapper:e}={...G(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(L,{...i})}):L(i)}function sn(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}rn([ln]);const $n={id:"components-atom-button",title:"Components - Atom/button",tags:["autodocs"],args:o,argTypes:dn,parameters:{docs:{page:cn}}},l=tn(o,({type:i,disabled:e,error:T,block:E,large:A,wide:C,narrow:O,secondary:N,tertiary:I,ghost:P,loading:R,icon:M,ctaLink:D,iconPlacement:H,toggle:z,on:U,controlled:K,external:_,inputGroup:W,label:F,defaultSlot:V,onVlClick:X,onVlToggle:Y})=>on`
            <vl-button
                type=${i}
                ?disabled=${e}
                ?error=${T}
