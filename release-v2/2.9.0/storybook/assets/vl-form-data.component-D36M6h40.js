import{aG as D,V as v,r as f,b,c as p,h as g,aQ as F,E as h,bw as k,z as y,x as i,y as c,bt as L,cA as H,aX as R,B as q}from"./iframe-CYuKbPIU.js";import{V as G}from"./vl-checkbox.component-C49Iumfs.js";import{V as M}from"./vl-datepicker.component-BP40-iVe.js";import"./vl-fieldset.component-BT-o0TdA.js";import{V as C}from"./vl-input-field-masked.component-BveMZxzc.js";import{V as O}from"./vl-radio.component-hwfXcKxP.js";import{V as E}from"./vl-radio-group.component-C8gC7BmN.js";import{V as I}from"./vl-select.component-6g5kFKgt.js";import{V as w}from"./vl-select-rich.component-DtV_8s-w.js";import{V as _}from"./vl-textarea.component-DuSmPQH1.js";import{V as P}from"./vl-textarea-rich.component-JN7e0g4F.js";import{V as S}from"./vl-upload.component-Dwvrbdbs.js";const u=(e,l)=>{if(!e)return null;const t=new FormData(e),a=Array.from(e.elements).filter(s=>!(s instanceof HTMLInputElement&&s.type==="radio")&&s.hasAttribute("name")).map(s=>s.getAttribute("name")).filter((s,n,j)=>j.indexOf(s)!==n),o=Array.from(e.elements).filter(s=>s.hasAttribute("multiple")).map(s=>s.getAttribute("name")),r=Array.from(new Set([...a,...o]));return Array.from(t.keys()).reduce((s,n)=>({...s,[n]:r.includes(n)?t.getAll(n):t.get(n)}),{})},z=(e,l)=>{e&&Object.entries(l).forEach(([t,a])=>{const o=e.elements.namedItem(t);o&&(o instanceof HTMLInputElement&&o.type==="checkbox"?T(o,a):o instanceof HTMLInputElement&&o.type==="file"?W(o,a):o instanceof HTMLTextAreaElement||o instanceof HTMLSelectElement?o.value=a:o instanceof RadioNodeList?Z(o,a):o instanceof HTMLInputElement?o.value=a:o instanceof D&&B(o,a))})},B=(e,l)=>{if(e.validationTarget instanceof HTMLSelectElement)K(e,l);else if(e.validationTarget instanceof HTMLInputElement&&e.validationTarget.type==="checkbox")T(e,l);else if(e.validationTarget instanceof HTMLInputElement&&e.validationTarget.type==="file"){const t=e;t.removeAllFiles(),Array.isArray(l)?l.forEach(a=>a instanceof File&&t.addFile(a)):l instanceof File&&t.addFile(l)}else e.setAttribute("value",l)},W=(e,l)=>{const t=new DataTransfer;Array.isArray(l)?(l.forEach(a=>{t.items.add(a)}),e.files=t.files):l instanceof File&&(t.items.add(l),e.files=t.files)},Z=(e,l)=>{Array.from(e).forEach(t=>{if(t instanceof HTMLInputElement){const a=Array.isArray(l)?l.includes(t.value):t.value===l;t.type==="radio"&&a?t.checked=!0:t.type==="checkbox"&&((Array.isArray(l)?l.includes(t.value):t.value===l)?t.setAttribute("checked",""):t.removeAttribute("checked"))}else if(t instanceof D&&t.validationTarget instanceof HTMLInputElement){if(t.validationTarget.type==="radio")t.getAttribute("value")===l&&t.setAttribute("checked","");else if(t.validationTarget.type==="checkbox"){const a=t;Array.isArray(l)&&t.validationTarget&&(l.some(o=>d(a,o))?a.setAttribute("checked",""):a.removeAttribute("checked"))}}})},K=(e,l)=>{e instanceof w?e.setSelectedValues(l):e.setAttribute("value",l)},d=(e,l)=>typeof l=="string"&&l&&l===(e.getAttribute("value")||"on"),T=(e,l)=>{Array.isArray(l)?l.some(t=>d(e,t))?e.setAttribute("checked",""):e.removeAttribute("checked"):d(e,l)||typeof l=="boolean"&&l?e.setAttribute("checked",""):typeof l=="boolean"&&!l&&e.removeAttribute("checked")};var Y=Object.getOwnPropertyDescriptor,$=(e,l,t,a)=>{for(var o=a>1?void 0:a?Y(l,t):l,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=s(o)||o);return o};const J={key:"customError",message:"Value does not equal 'foo'",isValid(e,l){return l?l==="foo":!0}};let m=class extends v{};m.formControlValidators=[...v.formControlValidators,J];m=$([c("vl-input-field-with-foo-validator")],m);let V=class extends F{constructor(){super(...arguments),this.success=!1}static get styles(){return[h,k,y`
        ...
        `}onSubmit(e){e.preventDefault();const l=u(e.target);console.log(l)}};f([b,v,C,_,M,w,I,E,O,S,G,p,g,L]);x=Q([c("vl-form-demo")],x);var X=Object.getOwnPropertyDescriptor,N=(e,l,t,a)=>{for(var o=a>1?void 0:a?X(l,t):l,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=s(o)||o);return o};let A=class extends q{constructor(){super(...arguments),this.hobbies=[{label:"Padel",value:"padel"},{label:"Dans",value:"dans"},{label:"Drummen",value:"drummen"},{label:"Zwemmen",value:"zwemmen"},{label:"Boardgames",value:"boardgames"},{label:"Fietsen",value:"fietsen"},{label:"Cocktails",value:"cocktails"}],this.parsedFormData=null}static get properties(){return{parsedFormData:{type:Object,state:!0}}}static get styles(){return[h,k,y`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
