...
`,n.jsxs(e.p,{children:["Een ingevulde ",n.jsx(e.code,{children:"skip-to-content-id"}),` zorgt ervoor dat er een skip-link gerenderd wordt. Dit laat gebruikers toe om meteen te skippen naar de
...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-functional-header.html",rel:"nofollow",children:"Legacy Demo  - Functional Header"})})]})}function oe(a={}){const{wrapper:e}={...w(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(M,{...a})}):M(a)}function C(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:I}=__STORYBOOK_MODULE_ACTIONS__;Z([q,ee,ne,te,ae]);const ge={id:"components-block-functional-header",title:"Components - Block/functional-header",tags:["autodocs"],args:l,argTypes:le,parameters:{docs:{page:oe}}},v=$(l,({back:a,backLink:e,disableBackLink:o,fullWidth:r,hideBackLink:u,hideSubHeader:H,link:R,marginBottom:A,subTitle:F,title:O,actionsSlot:V,backSlot:E,backLinkSlot:W,subHeaderSlot:D,subTitleSlot:z,titleSlot:N,topLeftSlot:U,topRightSlot:_,skipToContentId:K,onClickBack:G})=>L`
