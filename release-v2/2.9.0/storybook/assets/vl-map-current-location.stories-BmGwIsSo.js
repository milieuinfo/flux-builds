import{K as i,L as l,P as p,H as m,I as d,u as s,j as e,C as u,bc as g,s as h,x}from"./iframe-CYuKbPIU.js";import"./vl-map-base-layer-LVSVMNMu.js";import"./vl-map-base-layer-grb-gray-DfQGTfFu.js";import{D as y,a as f}from"./vl-map-current-location-hajA9gzx.js";import"./preload-helper-D9Z9MdNV.js";const n={...d,tooltip:y,zoom:f},v={...m,tooltip:{name:"tooltip",description:"Bepaalt de tekst van de tooltip van de huidige locatie knop.",table:{type:{summary:l.STRING},category:i.ATTRIBUTES,defaultValue:{summary:n.tooltip}}},zoom:{name:"zoom",description:"Bepaalt hoever er ingezoomd wordt bij het klikken op de huidige locatie knop.",control:{type:p.RANGE,min:1,max:13,step:1},table:{type:{summary:l.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(n.zoom)}}}};function c(t){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...t.components},{FluxComponentMetaData:r}=o;return r||j("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"map-current-location",children:"Map Current Location"}),`
