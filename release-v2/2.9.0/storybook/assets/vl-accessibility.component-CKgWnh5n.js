import{r as v,bF as d,x as e,cD as g,cE as b,J as h,aX as p,cn as k,cF as m,g as u,A as f,B as y,aH as w,E as L,v as A,cR as T}from"./iframe-CYuKbPIU.js";v([d]);const o=()=>e`
    <vl-link
...
`,$=({compliance:t,evaluation:a})=>e`
    ...
    </div>`,E=()=>[g,b,h,p,k,m],C=({application:t,compliance:a,date:n,dateModified:i,evaluation:l,limitations:s})=>e` <section id="content" class="vl-section">
