...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accordion.html",rel:"nofollow",children:"Legacy Demo - Accordion"})})]})}function K(a={}){const{wrapper:n}={...S(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(x,{...a})}):x(a)}function F(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}R([B,_]);const Y={id:"components-block-accordion",title:"Components - Block/accordion",tags:["autodocs"],args:o,argTypes:G,parameters:{docs:{page:K}}},s=P(o,({bold:a,closeToggleText:n,contentPadding:T,disabled:$,defaultOpen:j,icon:y,openToggleText:k,toggleText:w,defaultSlot:L,titleSlot:A,subtitleSlot:O,menuSlot:H,headingLevel:M,onToggle:z})=>N`
        <vl-accordion
            ?bold=${a}
            content-padding=${T}
            close-toggle-text=${n}
  ...
  onToggle
    ...
    \`)`,...b.parameters?.docs?.source}}};const Q=["AccordionDefault","AccordionHeading","AccordionDynamicToggle","AccordionIcon","AccordionTitleSlot","AccordionSubtitleSlot","AccordionImageSubtitleSlot","AccordionMenuSlot"];export{d as AccordionDefault,g as AccordionDynamicToggle,r as AccordionHeading,c as AccordionIcon,m as AccordionImageSubtitleSlot,b as AccordionMenuSlot,p as AccordionSubtitleSlot,u as AccordionTitleSlot,Q as __namedExportsOrder,Y as default};
