import{K as o,L as d,H as c,I as p,u as l,j as e,C as m,bc as h,s as u,x as w}from"./iframe-CYuKbPIU.js";import"./preload-helper-D9Z9MdNV.js";const t={...p,isActive:!1,name:""},z={...c,isActive:{name:"isActive",description:"Bepaalt of de pane actief is.",table:{type:{summary:d.STRING},category:o.ATTRIBUTES,defaultValue:{summary:String(t.isActive)}}},name:{name:"name",description:"Stelt de naam van de pane in. De naam is zichtbaar in de tooltip van de stap.",table:{type:{summary:d.STRING},category:o.ATTRIBUTES,defaultValue:{summary:t.name}}}};function s(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...l(),...a.components},{FluxComponentMetaData:i}=n;return i||x("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"wizard-pane",children:"Wizard Pane"}),`
