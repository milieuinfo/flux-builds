import{_ as h,X as y,Y as b,u as g,j as t,C as v,bd as f,c6 as x,x as r}from"./iframe-69xRVzLO.js";import"./preload-helper-D9Z9MdNV.js";const q={...b,parameters:'{"key1": "tempus" , "key2": "ipsum" }'},k={...y,parameters:{name:"parameters",description:"De key/value parameters die verwerkt en getoond zullen worden in het content element.",control:{disable:!0},table:{type:{summary:"string"},category:h.ATTRIBUTES}}};function m(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...g(),...i.components},{FluxAlert:o,FluxComponentMetaData:d}=e;return o||c("FluxAlert"),d||c("FluxComponentMetaData"),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"typography",children:"Typography"}),`
...
`})}),`
`,t.jsx(x,{title:"Varianten",includePrimary:!1}),`
...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-typography.html",rel:"nofollow",children:"Legacy Demo - Typography"})})]})}function j(i={}){const{wrapper:e}={...g(),...i.components};return e?t.jsx(e,{...i,children:t.jsx(m,{...i})}):m(i)}function c(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const T={id:"components-block-typography",title:"Components - Block/typography",tags:["autodocs"],args:q,argTypes:k,parameters:{docs:{page:j},controls:{hideNoControlsWarning:!0}}},a=()=>r` <vl-typography data-cy="typography">
    <p>
...
}`,...n.parameters?.docs?.source}}};const w=["TypographyDefault","TypographyTitles","TypographyLists","TypographyMarkup","TypographyTable","TypographyParameters"];export{a as TypographyDefault,s as TypographyLists,u as TypographyMarkup,n as TypographyParameters,p as TypographyTable,l as TypographyTitles,w as __namedExportsOrder,T as default};
