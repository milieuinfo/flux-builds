...
`,e.jsx(r.p,{children:e.jsx(r.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-http-error-message--default",rel:"nofollow",children:"Legacy Storybook - Http Error Message"})})]})}function U(s={}){const{wrapper:r}={...j(),...s.components};return r?e.jsx(r,{...s,children:e.jsx(N,{...s})}):N(s)}function q(s,r){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}B([P]);const z={id:"components-block-http-error-message",title:"Components - Block/http-error-message",tags:["autodocs"],args:a,argTypes:O,parameters:{docs:{page:U}}},t=V(a,({title:s,image:r,alt:b,errorCode:k,textSlot:R,actionsSlot:D})=>_`
