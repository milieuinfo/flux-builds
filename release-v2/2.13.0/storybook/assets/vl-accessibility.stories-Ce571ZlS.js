...
`,e.jsx(i.p,{children:e.jsx(i.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accessibility.html",rel:"nofollow",children:"Legacy Demo - Accessibility"})})]})}function I(t={}){const{wrapper:i}={...y(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(g,{...t})}):g(t)}function w(t,i){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const Y={id:"components-compliance-accessibility",title:"Components - Compliance/accessibility",tags:["autodocs"],args:n,argTypes:M,parameters:{layout:"fullscreen",docs:{page:I}}},u=O(n,({application:t,compliance:i,date:p,dateModified:T,disableBackLink:f,hideBackLink:L,evaluation:A,version:j,limitations:E,onClickBack:S,headerSlot:$})=>C`
        <vl-accessibility
            application=${t}
            compliance=${i}
            date=${p}
  ...
  headerSlot
    ...
    \`)`,...s.parameters?.docs?.source}}};const q=["AccessibilityDefault","AccessibilitySelfEvaluated","AccessibilityExpertEvaluated","AccessibilityHeaderSlot"];export{o as AccessibilityDefault,r as AccessibilityExpertEvaluated,s as AccessibilityHeaderSlot,c as AccessibilitySelfEvaluated,q as __namedExportsOrder,Y as default};
