import{Y as f,_ as d,$ as s,X as j,u as x,j as i,bd as L,C as p,s as v,x as u,r as U,R as y,bF as S,d as w,cd as T}from"./iframe-69xRVzLO.js";import{t as g}from"./vl-side-navigation.component-BikInihD.js";import"./preload-helper-D9Z9MdNV.js";import"./property-DzMVtqAE.js";const C={closed:!1,compact:!1,headingRootSelector:"",maxDepth:void 0,navigationTitle:"Op deze pagina",childSpacing:"small"},o={...f,...C,defaultSlot:""},$={...j,closed:{name:"closed",description:"Wanneer aanwezig wordt de inhoudstafel standaard verborgen. Heeft enkel effect wanneer het attribuut `compact` is gezet of bij mobiele weergave (viewport < 768px). Op desktop zonder compact wordt de navigatie altijd getoond.",table:{type:{summary:s.BOOLEAN},category:d.ATTRIBUTES,defaultValue:{summary:String(o.closed)}}},compact:{name:"compact",description:"Forceert de compacte weergave (toggle knop, verborgen navigatie standaard) ongeacht de viewport grootte.",table:{type:{summary:s.BOOLEAN},category:d.ATTRIBUTES,defaultValue:{summary:String(o.compact)}}},headingRootSelector:{name:"heading-root-selector",description:'CSS selector om het root container element te vinden waarbinnen naar headings gezocht wordt. Indien niet opgegeven, wordt het volledige document/shadow root doorzocht. Voorbeeld: "#section-1" om enkel headings binnen die sectie te scannen.',table:{type:{summary:s.STRING},category:d.ATTRIBUTES,defaultValue:{summary:o.headingRootSelector}}},maxDepth:{name:"max-depth",description:"Optionele maximum diepte voor shadow DOM traversal (bij scannen van headings én bij zoeken van scroll-target). Biedt fijnmazige controle over performantie vs compatibiliteit. 0 = enkel light DOM, 1 = light DOM + eerste niveau shadow DOM, undefined = onbeperkt (standaard).",table:{type:{summary:s.NUMBER},category:d.ATTRIBUTES,defaultValue:{summary:o.maxDepth!==void 0?String(o.maxDepth):"undefined"}}},navigationTitle:{name:"navigation-title",description:"Tekst die getoond wordt als titel boven de inhoudstafel.",table:{type:{summary:s.STRING},category:d.ATTRIBUTES,defaultValue:{summary:o.navigationTitle}}},defaultSlot:{name:"[default]",description:'Custom inhoudsopgave. Wanneer je hier content plaatst (bijv. een ul/li-structuur met vl-link elementen met href="#..."), wordt die gebruikt in plaats van de automatisch gegenereerde inhoudsopgave. De links moeten verwijzen naar heading-ids in de content.',table:{type:{summary:s.HTML},category:d.SLOTS,defaultValue:{summary:String(o.defaultSlot)}}},childSpacing:{name:"child-spacing",description:"Bepaalt de verticale ruimte tussen child-links. `medium` geeft extra ruimte (1.3rem marge boven en onder), vergelijkbaar met de stijl van de klassieke vl-side-navigation. `small` is de standaard compacte weergave.",options:["medium","small"],control:{type:"select"},table:{type:{summary:s.STRING},category:d.ATTRIBUTES,defaultValue:{summary:o.childSpacing}}}};function h(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...x(),...t.components},{FluxAlert:n,FluxComponentMetaData:a}=e;return n||q("FluxAlert"),a||q("FluxComponentMetaData"),i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"side-navigation-next",children:"Side Navigation Next"}),`
...
`]}),`
`,i.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function D(t={}){const{wrapper:e}={...x(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(h,{...t})}):h(t)}function q(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const V={id:"components-block-next-side-navigation",title:"Components - Block/next/side-navigation",tags:["autodocs"],args:o,argTypes:$,parameters:{docs:{page:D,story:{inline:!1,iframeHeight:500}}}};U([y,S,w,T]);const b=u`
...
`,l=v(o,({closed:t,compact:e,headingRootSelector:n,maxDepth:a,navigationTitle:c,childSpacing:k})=>u`
        ...
        `);l.storyName="vl-side-navigation-next - default";l.args={headingRootSelector:"#story-content-container"};const r=v(o,({closed:t,headingRootSelector:e,maxDepth:n,navigationTitle:a,childSpacing:c})=>u`
            <div class="vl-grid vl-content-block">
                <vl-side-navigation-next
        ...
        `);r.storyName="vl-side-navigation-next - compact";r.args={compact:!0,headingRootSelector:"#story-content-container"};const m=v(o,({closed:t,compact:e,maxDepth:n,childSpacing:a})=>u`
        <div class="vl-grid vl-content-block">
            <vl-side-navigation-next
                class="vl-column vl-column--3 vl-column--start-10 vl-column--m-3  vl-column--s-12  vl-side-navigation--order-1"
                ?closed=${t}
  ...
  return html\`
    ...
    \`;
})`,...m.parameters?.docs?.source}}};const O=["SideNavigationDefault","SideNavigationCompact","SideNavigationWithCustomToc"];export{r as SideNavigationCompact,l as SideNavigationDefault,m as SideNavigationWithCustomToc,O as __namedExportsOrder,V as default};
