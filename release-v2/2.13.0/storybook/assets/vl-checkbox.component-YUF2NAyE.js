import{bv as n,i as k,a0 as d,bt as x,bu as _,x as b,F as v,T as t,w as u}from"./iframe-69xRVzLO.js";const g=`:host {
...
`,l={...d,block:!1,value:null,checked:!1,isSwitch:!1,indeterminate:!1};var w=Object.getOwnPropertyDescriptor,m=(e,o,c,h)=>{for(var r=h>1?void 0:h?w(o,c):o,i=e.length-1,s;i>=0;i--)(s=e[i])&&(r=s(r)||r);return r};let a=class extends x{constructor(){super(...arguments),this.block=l.block,this.value=l.value,this.checked=l.checked,this.isSwitch=l.isSwitch,this.indeterminate=l.indeterminate,this.initialValue=null,this.initialCheckedValue=!1,this.dispatchInput=!1}static get styles(){return[_,f]}static get properties(){return{block:{type:Boolean},value:{type:String},checked:{type:Boolean,reflect:!0},indeterminate:{type:Boolean,reflect:!0},isSwitch:{type:Boolean,attribute:"switch"}}}get validationTarget(){return this.shadowRoot?.querySelector("input")}connectedCallback(){super.connectedCallback(),this.id||(this.id=`vl-checkbox-${++a.instanceCounter}`),this.initialValue||(this.initialValue=this.value,this.initialCheckedValue=this.checked)}updated(e){if(super.updated(e),e.has("checked")||e.has("value")){const o=this.checked?this.value||"on":null,c={checked:this.checked,currentTarget:this};this.checked&&(c.value=o),this.setValue(o),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:c})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:c})),this.dispatchInput=!1),this.dispatchEventIfValid(c)}}render(){return b` ${this.isSwitch?this.renderCheckboxSwitch():this.renderCheckboxDefault()} `}resetFormControl(){super.resetFormControl(),this.checked=this.initialCheckedValue,this.value=this.initialValue}renderCheckboxDefault(){const e={"vl-checkbox":!0,"vl-checkbox--disabled":this.disabled,"vl-checkbox--error":this.isInvalid||this.error,"vl-checkbox--success":this.success,"vl-checkbox--block":this.block};return b`
        ...
        `}toggle(){this.checked=!this.checked,this.dispatchInput=!0}};a.instanceCounter=0;a=m([u("vl-checkbox")],a);export{a as V,l as c};
