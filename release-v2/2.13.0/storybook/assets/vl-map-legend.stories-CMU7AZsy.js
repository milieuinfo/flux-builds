...
</svg>`),U=()=>{document.addEventListener("DOMContentLoaded",async()=>{await document.getElementById("map")?.ready,document.querySelector("#pattern-diagonal").appliesTo=e=>e.get("styleId")==="pattern-diagonal",document.querySelector("#pattern-dotted").appliesTo=e=>e.get("styleId")==="pattern-dotted",document.querySelector("#no-pattern").appliesTo=e=>e.get("styleId")==="no-pattern"})},K=m(o,({bottom:r,left:e,placement:a,right:l,top:s,layoutVertical:n})=>{const c={type:"FeatureCollection",features:[{type:"Feature",geometry:{type:"Polygon",coordinates:[[[135e3,205e3],[145e3,205e3],[145e3,195e3],[135e3,195e3],[135e3,205e3]]]},properties:{styleId:"pattern-diagonal"}},{type:"Feature",geometry:{type:"Polygon",coordinates:[[[147e3,205e3],[157e3,205e3],[157e3,195e3],[147e3,195e3],[147e3,205e3]]]},properties:{styleId:"pattern-dotted"}},{type:"Feature",geometry:{type:"Polygon",coordinates:[[[159e3,205e3],[169e3,205e3],[169e3,195e3],[159e3,195e3],[159e3,205e3]]]},properties:{styleId:"no-pattern"}}]};return U(),i` <vl-map id="map">
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
...
`;function $(r){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...w(),...r.components},{FluxComponentMetaData:a}=e;return a||Y("FluxComponentMetaData"),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"map-legend",children:"Map Legend"}),`
