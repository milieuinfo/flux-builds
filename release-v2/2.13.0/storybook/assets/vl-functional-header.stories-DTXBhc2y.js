...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-functional-header.html",rel:"nofollow",children:"Legacy Demo  - Functional Header"})})]})}function le(a={}){const{wrapper:e}={...C(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(B,{...a})}):B(a)}function M(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:oe}=__STORYBOOK_MODULE_ACTIONS__;Z([q,Q,ee,te,ne]);const Ie={id:"components-block-functional-header",title:"Components - Block/functional-header",tags:["autodocs"],args:l,argTypes:ie,parameters:{docs:{page:le}}},v=$(l,({back:a,backLink:e,disableBackLink:o,fullWidth:r,hideBackLink:u,hideSubHeader:w,link:I,marginBottom:R,subTitle:A,title:F,actionsSlot:O,backSlot:V,backLinkSlot:W,subHeaderSlot:E,subTitleSlot:z,titleSlot:D,topLeftSlot:N,topRightSlot:U,skipToContentId:_,onClickBack:K})=>L`
