...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-info-tile.html",rel:"nofollow",children:"Legacy Demo - Info Tile"})})]})}function ce(s={}){const{wrapper:n}={...V(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(w,{...s})}):w(s)}function re(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const fe={id:"components-block-info-tile",title:"Components - Block/info-tile",tags:["autodocs"],args:t,argTypes:se,parameters:{docs:{page:ce}}},o=oe({...t,classes:""},({autoOpen:s,toggleable:n,center:B,clickable:C,clickableLabel:E,contentSlot:N,subtitleSlot:U,titleSlot:R,footerSlot:_,menuSlot:G,badgeSlot:F,size:W,icon:P,iconAsBadge:X,type:Y,fullHeight:q=!1,classes:Z="",headingLevel:J,onVlClickInfoTile:K,highlight:Q,highlightLeft:ee})=>j`
        <vl-info-tile
            ?auto-open=${s}
            ?center=${B}
            ?icon-as-badge=${X}
    ...
    `];const S=o.bind({});S.storyName="vl-info-tile - heading level";S.args={titleSlot:'<span slot="title">Broos Deprez</span>',subtitleSlot:'<span slot="subtitle">Uw zoon (19.05.2005)</span>',contentSlot:'<div slot="content">De studietoelage voor Broos Deprez werd toegekend.</div>',headingLevel:"6"};const m=o.bind({});m.storyName="vl-info-tile - centered";m.args={toggleable:!1,titleSlot:'<span slot="title">Broos Deprez</span>',subtitleSlot:'<span slot="subtitle">Uw zoon (19.05.2005)</span>',contentSlot:'<div slot="content">De studietoelage voor Broos Deprez werd toegekend.</div>',center:!0};const v=o.bind({});v.storyName="vl-info-tile - toggleable";v.args={toggleable:!0,titleSlot:'<span slot="title">Broos Deprez</span>',contentSlot:'<div slot="content">De studietoelage voor Broos Deprez werd toegekend.</div>'};const T=o.bind({});T.storyName="vl-info-tile - menu slot";T.args={titleSlot:'<span slot="title">Broos Deprez</span>',subtitleSlot:'<span slot="subtitle">Uw zoon (19.05.2005)</span>',contentSlot:'<div slot="content">De studietoelage voor Broos Deprez werd toegekend.</div>',menuSlot:`<span slot="menu">
        ...
        <vl-popover for="btn-acties" placement="bottom-end">
            ...
            font-weight: 500;
        ">BD</div>`};const I=o.bind({});I.storyName="vl-info-tile - footer slot";I.args={titleSlot:'<span slot="title">Broos Deprez</span>',subtitleSlot:'<span slot="subtitle">Uw zoon (19.05.2005)</span>',contentSlot:'<div slot="content">De studietoelage voor Broos Deprez werd toegekend.</div>',footerSlot:`<div slot="footer">
  ...
  highlightLeft
    ...
    \`)`,...m.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`story({
  ...infoTileArgs,
  classes: ''
}, ({
  autoOpen,
  ...
  highlightLeft
    ...
    \`)`,...v.parameters?.docs?.source}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`story({
  ...infoTileArgs,
  classes: ''
}, ({
  autoOpen,
  ...
  highlightLeft
    ...
    \`)`,...z.parameters?.docs?.source}}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`story({
  ...infoTileArgs,
  classes: ''
}, ({
  autoOpen,
  ...
  highlightLeft
    ...
    \`)`,...I.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`story({
  ...infoTileArgs,
  classes: ''
}, ({
  autoOpen,
