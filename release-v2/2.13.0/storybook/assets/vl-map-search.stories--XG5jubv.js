...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-search.html",rel:"nofollow",children:"Legacy Demo - Map Search"})})]})}function j(r={}){const{wrapper:e}={...u(),...r.components};return e?a.jsx(e,{...r,children:a.jsx(h,{...r})}):h(r)}function S(r,e){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}var i=Object.freeze,w=Object.defineProperty,k=(r,e)=>i(w(r,"raw",{value:i(r.slice())})),d;const X={id:"map-search",title:"map/search",tags:["autodocs"],args:t,argTypes:T,parameters:{docs:{page:j}}},s=y(t,({placeholder:r,searchEmptyText:e,searchNoResultsText:n,searchPlaceholder:p,withOffset:g})=>f`
            <vl-map lambert2008>
                <vl-map-search
                    placeholder=${r}
                    search-empty-text=${e}
  ...
  searchPlaceholder
        ...
        <script>
            document.querySelector('vl-map-search').bindMap(document.querySelector('vl-map'));
        <\/script>
    \`)`,...o.parameters?.docs?.source}}};const F=["MapSearchDefault","MapSearchOutsideMap"];export{s as MapSearchDefault,o as MapSearchOutsideMap,F as __namedExportsOrder,X as default};
