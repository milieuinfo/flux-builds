...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMapWmtsLayer.html",rel:"nofollow",children:"Legacy Documentatie - Map Wmts Layer"})})]})}function j(r={}){const{wrapper:e}={...c(),...r.components};return e?a.jsx(e,{...r,children:a.jsx(y,{...r})}):y(r)}function $(r,e){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const C={id:"map-layer-wmts-layer",title:"map/layer/wmts-layer",tags:["autodocs"],args:s,argTypes:T,parameters:{docs:{page:j}}},n=d(s,({hidden:r,layer:e,maxResolution:m,minResolution:o,name:p,opacity:g,url:b,fromCapabilities:f})=>u`
            <vl-map lambert2008>
