import{u as j,j as a,C as v,bd as V,S as k,cj as I,s as D,x as w,r as T,cK as A,c3 as L}from"./iframe-69xRVzLO.js";import{V as G}from"./vl-select.component-DjcSeoM9.js";import{r as O,a as h}from"./vl-rich-data.stories-arg-IK9ZcVs-.js";import"./preload-helper-D9Z9MdNV.js";const W=`export const richDataMockData = {
    data: [
        {
            id: 0,
            name: 'Project #1',
...
`;function y(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...j(),...t.components},{FluxComponentMetaData:p}=e;return p||F("FluxComponentMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"rich-data",children:"Rich Data"}),`
`,a.jsx(p,{id:"components-block-rich-data"}),`
...
`,a.jsx(v,{of:d}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"klik hier om een voorbeeld implementatie te zien"}),a.jsx(k,{code:K,language:"ts",dark:!0})]}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"mock data voor voorbeeld kan je hier vinden"}),a.jsx(k,{code:W,language:"ts",dark:!0})]}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data.html",rel:"nofollow",children:"Legacy Demo - Rich Data"})})]})}function _(t={}){const{wrapper:e}={...j(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(y,{...t})}):y(t)}function F(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const H={data:[{id:0,name:"Project #1",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Sander",lastName:"Kleykens"}]},{id:1,name:"Project #2",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:2,name:"Project #3",manager:{firstName:"Tom",lastName:"Coemans"},medewerkers:[{firstName:"Guy",lastName:"Wauters"}]},{id:3,name:"Project #4",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:4,name:"Project #5",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:5,name:"Project #6",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:6,name:"Project #7",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:7,name:"Project #8",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:8,name:"Project #9",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:9,name:"Project #10",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:10,name:"Project #11",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:11,name:"Project #12",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:12,name:"Project #13",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:13,name:"Project #14",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:14,name:"Project #15",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:15,name:"Project #16",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:16,name:"Project #17",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:17,name:"Project #18",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:18,name:"Project #19",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:19,name:"Project #20",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:20,name:"Project #21",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:21,name:"Project #22",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:22,name:"Project #23",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:23,name:"Project #24",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]},{id:24,name:"Project #25",manager:{firstName:"Pascal",lastName:"Riquier"},medewerkers:[{firstName:"Pieter",lastName:"Beckers"}]}]},R=()=>{customElements.whenDefined("vl-rich-data").then(()=>{const t=document.querySelector("#rich-data"),e=t?.querySelector('[slot="content"]'),p=t?.querySelector('[slot="sorter"]'),x=t?.querySelector("vl-pager"),u=H;let P;const g=(l,n,i)=>{P=l,e&&(e.innerHTML=""),l?.slice(n,i).forEach(r=>{const s=new Date().toLocaleString(),m=r.manager,o=r.medewerkers[0],N=`
                        ...
                        <vl-search-result-properties>
                            ...
                            <vl-property-data>
                                <span>${r.name} o.l.v. <strong>${m.firstName} ${m.lastName}</strong></span>
                            </vl-property-data>
                        </vl-search-result-properties>
                  `;e&&e.insertAdjacentHTML("beforeend",`<vl-search-result>${N}</vl-search-result>`)})},q=(l,n,i)=>i===""?l:l.filter(r=>B(r,n).includes(i)),B=(l,n)=>{const i=n.split(".");let r=l;for(let s=0;s<i.length;s++)if(r[i[s]]!==void 0)r=r[i[s]];else return;return r.toString()},C=I(([l])=>{let n=u.data,i=u.data.length,r;const s=l;if(s.detail.formData){r=[];for(const o of s.detail.formData.entries())n=q(n,o[0],o[1]),i=n.length,r.push({name:o[0],value:o[1]})}const m=s.detail.paging;if(m){const o=(m.currentPage-1)*10;g(n,o,o+10)}t&&(t.data={paging:{currentPage:s.detail.paging.currentPage,totalItems:i},filter:r})},500);t?.addEventListener("change",C),p?.addEventListener("vl-change",l=>{const n=P;l.stopPropagation(),n&&(n.sort((i,r)=>{const s=l.target?.value?.split(".");if(!s)return 0;const m=$=>s.reduce((S,M)=>S[M],$)?.toString()||"",o=m(i),N=m(r);return o.localeCompare(N)}),t&&(t.data={paging:{currentPage:1,totalItems:n.length}}),g(n,0,10))}),t&&(t.data={paging:{currentPage:1,totalItems:25}});const E=Number(x?.getAttribute("items-per-page")??10);g(u.data,0,E)})},Q={id:"components-block-rich-data",title:"Components - Block/rich-data",tags:["autodocs"],args:h,argTypes:O,parameters:{docs:{page:_}}};T([A,L,G]);const c=({filterClosable:t,filterClosed:e})=>w`
    ...
    `;c.storyName="vl-rich-data - default";const b=({filterClosable:t,filterClosed:e,filterMaxWidth:p})=>w`
        <vl-rich-data id="rich-data" ?filter-closable=${t} ?filter-closed=${e} filter-max-width=${p}>
    ...
    `,d=D(h,t=>(R(),b(t)));d.storyName="vl-rich-data - pager";d.args={filterClosable:!0};const f=D(h,t=>(R(),b(t)));f.storyName="vl-rich-data - filter-max-width";f.args={filterMaxWidth:"calc(1280px / 3)",filterClosable:!0};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`({
  filterClosable,
  filterClosed
}: typeof richDataArgs) => {
  return html\`
