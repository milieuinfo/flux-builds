import{_ as v,$ as b,X as h,Y as S,u as g,j as t,C as d,bd as j,s as c,x as p,r as D}from"./iframe-69xRVzLO.js";import"./vl-side-navigation.component-BikInihD.js";import{V as P}from"./vl-side-navigation-layout.component-CAo-KB7k.js";import"./preload-helper-D9Z9MdNV.js";import"./property-DzMVtqAE.js";const a={...S,line:!1,timeline:!1,simpleTimeline:!1,lastStepNoLine:!1},T={...h,line:{name:"line",description:"Beeldt een verticale lijn af tussen de stappen.",table:{type:{summary:b.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.line)}}},timeline:{name:"timeline",description:"Beeldt een verticale tijdlijn af tussen de stappen.",table:{type:{summary:b.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.timeline)}}},simpleTimeline:{name:"simple-timeline",description:"Beeldt een simpele verticale tijdlijn af tussen de stappen.",table:{type:{summary:b.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.simpleTimeline)}}},lastStepNoLine:{name:"last-step-no-line",description:"Laat de verticale lijn na de laatste stap weg bij gebruik van de line, timeline of simple-timeline attributen.",table:{type:{summary:b.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(a.lastStepNoLine)}}}};function q(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...g(),...s.components},{FluxComponentMetaData:o}=e;return o||x("FluxComponentMetaData"),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"steps",children:"Steps"}),`
...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-steps.html",rel:"nofollow",children:"Legacy Demo - Steps"})})]})}function f(s={}){const{wrapper:e}={...g(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(q,{...s})}):q(s)}function x(s,e){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}D([P]);const w={id:"components-block-steps-steps",title:"Components - Block/steps/steps",tags:["autodocs"],args:a,argTypes:T,parameters:{docs:{page:f}}},i=c(a,({line:s,timeline:e,lastStepNoLine:o})=>p`
    ...
    `);u.storyName="vl-steps - simple timeline";u.args={simpleTimeline:!0};const m=c(a,()=>p`
  ...
  lastStepNoLine
    ...
    \`)`,...u.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`story(stepsArgs, () => html\`
        <section class="vl-section" id="steps-side-navigation-example">
            <vl-side-navigation-layout-next>
                <div slot="content">
                    <vl-steps>
    ...
    \`)`,...m.parameters?.docs?.source}}};const C=["StepsDefault","StepsIcons","StepsLine","StepsTimeline","StepsSimpleTimeline","StepsSideNavigation"];export{i as StepsDefault,r as StepsIcons,n as StepsLine,m as StepsSideNavigation,u as StepsSimpleTimeline,l as StepsTimeline,C as __namedExportsOrder,w as default};
