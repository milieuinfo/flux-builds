...
`]}),`
`,n.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function L(i={}){const{wrapper:e}={...k(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(x,{...i})}):x(i)}function b(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const B={id:"components-block-next-side-navigation-layout",title:"Components - Block/next/side-navigation-layout",tags:["autodocs"],args:a,argTypes:C,parameters:{docs:{page:L,story:{inline:!1,iframeHeight:500}}}};S([w,q,I,T]);const t=m`
    <vl-paragraph>
