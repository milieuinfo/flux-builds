...
`})}),`
`,e.jsx(b,{of:o})]})}function M(n={}){const{wrapper:t}={...m(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(c,{...n})}):c(n)}function N(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const q={id:"components-block-next-tabs",title:"Components - Block/next/tabs",tags:["autodocs"],args:i,argTypes:L,parameters:{docs:{page:M}}};f([S,w,C,V,y]);const a=T(i,({defaultSlot:n,panelSlot:t,horizontalNavigation:s,label:v,onVlTabClick:x,onVlTabLinkClick:g})=>j`
        <vl-tabs-next
            label="${v}"
  ...
  onVlTabLinkClick
        ...
        <vl-tabs-next
            ...
            >\${unsafeHTML(defaultSlot)}\${unsafeHTML(panelSlot)}</vl-tabs-next
        >
    \`)`,...o.parameters?.docs?.source}}};const J=["TabsDefault","TabsHorizontalNavigation"];export{a as TabsDefault,o as TabsHorizontalNavigation,J as __namedExportsOrder,q as default};
