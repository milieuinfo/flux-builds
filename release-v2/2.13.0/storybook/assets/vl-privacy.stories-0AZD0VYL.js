...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-privacy.html",rel:"nofollow",children:"Legacy Demo - Privacy"})})]})}function H(a={}){const{wrapper:n}={...p(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(m,{...a})}):m(a)}function C(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const V={id:"components-compliance-privacy",title:"Components - Compliance/privacy",tags:["autodocs"],args:t,argTypes:B,parameters:{layout:"fullscreen",docs:{page:H}}},u=j(t,({date:a,disableBackLink:n,hideBackLink:l,version:v,onClickBack:h,headerSlot:k,versionSlot:y,contentSlot:b,bottomSlot:g})=>x`
            <vl-privacy
                date=${a}
                ?disable-back-link=${n}
                ?hide-back-link=${l}
...
`};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`story(privacyArgs, ({
  ...
  bottomSlot
        ...
        \`)`,...c.parameters?.docs?.source}}};const _=["PrivacyDefault","PrivacyHeaderSlot"];export{i as PrivacyDefault,c as PrivacyHeaderSlot,_ as __namedExportsOrder,V as default};
