...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-upload",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Upload"})})]})}function le(o={}){const{wrapper:n}={...b(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(v,{...o})}):v(o)}function re(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}Z([J]);const pe={id:"components-form-upload",title:"Components - Form/upload",tags:["autodocs"],args:a,argTypes:ae,parameters:{docs:{page:le}}},i=Y(a,({id:o,name:n,label:d,required:f,disabled:y,readonly:x,error:j,success:w,url:k,disallowDuplicates:V,maxSize:s,maxFiles:u,chunking:T,parallelUploads:$,autoProcess:S,acceptedFiles:c,subTitle:m,mainTitle:F,errorMessageMaxFiles:E,errorMessageFilesize:z,errorMessageAcceptedFiles:D,onVlChange:M,onVlInput:A,onVlValid:C,onVlError:U,onVlSuccess:I,onVlComplete:N,onVlQueueComplete:R,onVlInitialised:B,onVlRemovedFile:P,onVlAddedFile:O,onVlUploadProgress:G})=>{let p;if(m.toString()==="Symbol(lit-nothing)"){const{maxFiles:H,subTitle:_,maxSize:q}=h,L=c.toString()!=="Symbol(lit-nothing)"?`
 De toegestane bestandstypes zijn: ${c}
`:"",g=typeof u=="number"?u:H,Q=typeof s=="number"?s:q;p=`${_} 
Upload ${g} ${g>1?"bestanden":"bestand"} van maximaal ${Q} MB${L}.`}else p=m;return K`
            <vl-upload
                id=${o}
                name=${n}
                label=${d}
