...
`,e.jsxs(n.li,{children:["Het ",e.jsx(n.code,{children:"anchor-positioning"}),` attribuut: indien aanwezig rendert de kalender in de browser top-layer,
zodat ancestor `,e.jsx(n.code,{children:"transform"}),", ",e.jsx(n.code,{children:"overflow"})," of ",e.jsx(n.code,{children:"sticky"})," de positionering niet kan breken."]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<vl-datepicker anchor-positioning></vl-datepicker>
`})}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["⚠️ ",e.jsx(n.code,{children:"anchor-positioning"}),` wijzigt het render-model (top-layer ipv shadow DOM). Test grondig als
...
`,e.jsxs(n.li,{children:["Het ",e.jsx(n.code,{children:"anchor-positioning"})," attribuut vereist Popover API + CSS Anchor Positioning (Chrome/Edge 125+, Safari 26+). Op andere browsers (oudere Safari, Firefox) valt de datepicker stil terug op de default positionering."]}),`
`]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/datepicker",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Datepicker"})})]})}function ve(t={}){const{wrapper:n}={...A(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(E,{...t})}):E(t)}function ge(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const T=(t,n,l="d.m.Y",x="")=>{if(t&&n){const h=new Date(t),b=new Date(t);h.setDate(h.getDate()-n),b.setDate(b.getDate()+n);const $=[S.formatDate(h,l),S.formatDate(b,l)];return x?$.join(x):$}else return""};te([de,ie,re,oe]);const Se={id:"components-form-datepicker",title:"Components - Form/datepicker",tags:["autodocs"],args:i,argTypes:ue,parameters:{docs:{page:ve,story:{inline:!1,iframeHeight:440}}},decorators:[t=>j` <div style="height: 400px">${t()}</div> `]},u=ae(i,({id:t,type:n,format:l,minDate:x,maxDate:h,minTime:b,maxTime:$,amPm:I,success:M,blurValidation:R,block:P,disabled:C,error:O,readonly:N,required:Y,disableMaskValidation:q,value:U,placeholder:W,autocomplete:B,label:V,pattern:z,regex:H,name:_,onVlChange:G,onVlInput:F,onVlReset:L,onVlValid:K,position:J,isStatic:X,anchorPositioning:Z,helperText:D})=>j`
        ...
        `),o=u.bind({});o.storyName="vl-datepicker - default";o.args={id:"datepicker-default",name:"datepicker-default",placeholder:"dd.mm.YYYY",label:"Datum",helperText:"Typ of selecteer een datum"};const f="d.m.Y",[he,be]=T(new Date,2,f),d=u.bind({});d.storyName="vl-datepicker - min-date en max-date";d.args={id:"datepicker-min-max-date",name:"datepicker-min-max-date",minDate:he,maxDate:be,value:new Date().toISOString(),format:f,placeholder:"dd.mm.YYYY",label:"Datum",helperText:"Typ of selecteer een datum tussen de minimum en maximum data"};const s=u.bind({});s.storyName="vl-datepicker - static";s.args={id:"datepicker-static",name:"datepicker-static",isStatic:!0,placeholder:"dd.mm.YYYY",label:"Datum",helperText:"Typ of selecteer een datum"};const[fe,xe]=T(new Date,10,f),$e=T(new Date,4,"Y-m-d","/"),m=u.bind({});m.storyName="vl-datepicker - range";m.args={id:"datepicker-range",name:"datepicker-range",type:"range",minDate:fe,maxDate:xe,format:f,value:$e,label:"Start- en einddatum",placeholder:"dd.mm.YYYY tot en met dd.mm.YYYY",helperText:"Kies een start- en einddatum"};const c=u.bind({});c.storyName="vl-datepicker - time";c.args={id:"datepicker-time",name:"datepicker-time",type:"time",format:"H:i",label:"Tijd",placeholder:"hh:mm",helperText:"Kies een tijd"};const g=u.bind({});g.storyName="vl-datepicker - min-time en max-time";g.args={id:"datepicker-min-max-time",name:"datepicker-min-max-time",minTime:"10:00",maxTime:"11:00",type:"time",format:"H:i",label:"Tijd",placeholder:"hh:mm",helperText:"Kies een tijd tussen een minimum en maximum"};const p=u.bind({});p.storyName="vl-datepicker - date-time";p.args={id:"datepicker-datetime",name:"datepicker-datetime",type:"date-time",format:`${f} H:i`,label:"Datum en tijd",placeholder:"dd.mm.YYYY hh:mm",helperText:"Kies een datum en tijd"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(datepickerArgs, ({
  id,
  type,
  format,
  minDate,
  ...
  return html\`
        ...
        \`;
})`,...p.parameters?.docs?.source}}};const we=["DatepickerDefault","DatepickerMinDateAndMaxDate","DatepickerStatic","DatepickerRange","DatepickerTime","DatepickerMinTimeAndMaxTime","DatepickerDateTime"];export{p as DatepickerDateTime,o as DatepickerDefault,d as DatepickerMinDateAndMaxDate,g as DatepickerMinTimeAndMaxTime,m as DatepickerRange,s as DatepickerStatic,c as DatepickerTime,we as __namedExportsOrder,Se as default};
