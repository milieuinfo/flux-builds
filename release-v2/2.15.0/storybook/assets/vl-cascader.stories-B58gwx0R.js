...
`,A=`import { ItemListFn, CascaderItem } from '../vl-cascader.model';
...
`,e.jsxs("details",{children:[e.jsx("summary",{children:"voorbeeld itemListFn opzet"}),e.jsx(h,{code:A,language:"ts",dark:!0,format:!0})]}),`
