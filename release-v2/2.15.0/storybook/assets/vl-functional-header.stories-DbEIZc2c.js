...
`,e.jsxs(n.li,{children:["Vermijd het gebruik van ",e.jsx(n.code,{children:"history.back()"}),". De gebruiker kan op verschillende manieren op je pagina belandt zijn."]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/application-header",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Functional Header"})})]})}function re(i={}){const{wrapper:n}={...C(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(M,{...i})}):M(i)}function w(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:se}=__STORYBOOK_MODULE_ACTIONS__;Q([ee,ne,te,ie,ae]);const Re={id:"components-block-functional-header",title:"Components - Block/functional-header",tags:["autodocs"],args:l,argTypes:oe,parameters:{docs:{page:re}}},v=L(l,({back:i,backLink:n,disableBackLink:o,fullWidth:r,hideBackLink:b,hideSubHeader:I,link:R,marginBottom:A,subTitle:O,title:V,titleLabel:W,actionsSlot:F,backSlot:E,backLinkSlot:z,subHeaderSlot:D,subTitleSlot:N,titleSlot:U,topLeftSlot:_,topRightSlot:G,skipToContentId:K,onClickBack:J})=>$`
    ...
    `),H="Voor lager, middelbaar en hoger onderwijs",s="School- en studietoelagen",y="Terug",de=`<div slot="actions">
        <a href="#">Actie 1</a>
        <a href="#">Actie 2</a>
    </div>`,ce=`<span slot="back">${y}</span>`,be=`<a slot="back-link" href="#">${y}</a>`,ue='<span slot="sub-header">Sub header content</span>',j=`<span slot="sub-title">${H}</span>`,ke=`<span slot="title">${s}</span>`,me='<span slot="top-left">Linkerbovenhoek content</span>',he='<span slot="top-right">Rechterbovenhoek content</span>',c=v.bind({});c.storyName="vl-functional-header - default";c.args={subTitle:H,titleLabel:s};const u=v.bind({});u.storyName="vl-functional-header - actions";u.args={subTitle:H,titleLabel:s,actionsSlot:de};const k=v.bind({});k.storyName="vl-functional-header - slots";k.args={backSlot:ce,backLinkSlot:be,subHeaderSlot:ue,subTitleSlot:j,titleSlot:ke,topLeftSlot:me,topRightSlot:he};const m=L(l,({fullWidth:i,marginBottom:n,titleLabel:o,link:r,skipToContentId:b})=>$`
        <vl-functional-header
            ?full-width=${i}
            link=${r}
            margin-bottom=${n}
