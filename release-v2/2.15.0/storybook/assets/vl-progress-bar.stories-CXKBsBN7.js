...
uitgeschakeld. In het geval van "indeterminate" blijft er enkel een fade-in/fade-out animatie zichtbaar.`})]})}function A(n={}){const{wrapper:r}={...h(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(p,{...n})}):p(n)}function w(n,r){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}D([E]);const O={id:"components-block-progress-bar",title:"Components - Block/progress-bar",tags:["autodocs"],args:a,argTypes:S,parameters:{docs:{page:A}}},m=$(a,({value:n,indeterminate:r,label:c,labelledby:v,error:y,success:f})=>k`
        <vl-progress-bar
            value="${n}"
            label=${b(c)}
            labelledby=${b(v)}
