import{Z as i,_ as s,W as d,X as x,u as l,j as e,C as c,bc as p,s as m,x as w}from"./iframe-CsDE-vVI.js";import"./preload-helper-D9Z9MdNV.js";const a={...x,image:"",contextLink:"",titleLink:""},h={...d,image:{name:"image (slot)",description:"",table:{type:{summary:s.HTML},category:i.SLOTS}},contextLink:{name:"context-link (slot)",description:"Link voor de context.",table:{type:{summary:s.STRING},category:i.ATTRIBUTES,defaultValue:{summary:a.contextLink}}},titleLink:{name:"title-link (slot)",description:"Link voor de titel",table:{type:{summary:s.STRING},category:i.ATTRIBUTES,defaultValue:{summary:a.titleLink}}}};function f(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...l(),...n.components},{FluxComponentMetaData:r}=t;return r||u("FluxComponentMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"content-header",children:"Content Header"}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/content-header",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Content Header"})})]})}function b(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(f,{...n})}):f(n)}function u(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const D={id:"components-block-content-header",title:"Components - Block/content-header",tags:["autodocs"],args:a,argTypes:h,parameters:{docs:{page:b}}},H=m(a,({contextLink:n,titleLink:t})=>w`
        <vl-content-header>
            <img
                slot="image"
                sizes="100vw"
