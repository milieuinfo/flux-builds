import{bx as n,i as k,$ as d,br as x,bs as _,aV as u,x as h,F as b,T as t,w as g}from"./iframe-B0laZkYe.js";const w=`:host {
    /* Font sizing (62.5% = 10px base for rem calculations) */
    font-size: 62.5%;

    /* Box */
    --vl-checkbox--box-size: 1.8rem;

    /* Icon */
    --vl-checkbox--icon-size: 0.8rem;

    /* Switch variant */
    --vl-checkbox--switch-width: 4rem;
    --vl-checkbox--switch-height: 2.2rem;
    --vl-checkbox--switch-knob-size: 1.8rem;
    --vl-checkbox--switch-knob-size-checked: 2rem;
}
`,f=k`
    ${n(w)}
...
`,l={...d,block:!1,value:null,checked:!1,isSwitch:!1,indeterminate:!1};var m=Object.getOwnPropertyDescriptor,p=(e,o,c,s)=>{for(var r=s>1?void 0:s?m(o,c):o,i=e.length-1,v;i>=0;i--)(v=e[i])&&(r=v(r)||r);return r};let a=class extends x{constructor(){super(...arguments),this.block=l.block,this.value=l.value,this.checked=l.checked,this.isSwitch=l.isSwitch,this.indeterminate=l.indeterminate,this.initialValue=null,this.initialCheckedValue=!1,this.dispatchInput=!1}static get styles(){return[_,u,f]}static get properties(){return{block:{type:Boolean},value:{type:String},checked:{type:Boolean,reflect:!0},indeterminate:{type:Boolean,reflect:!0},isSwitch:{type:Boolean,attribute:"switch"}}}get validationTarget(){return this.shadowRoot?.querySelector("input")}connectedCallback(){super.connectedCallback(),this.id||(this.id=`vl-checkbox-${++a.instanceCounter}`),this.initialValue||(this.initialValue=this.value,this.initialCheckedValue=this.checked)}updated(e){if(super.updated(e),e.has("checked")||e.has("value")){const o=this.checked?this.value||"on":null,c={checked:this.checked,currentTarget:this};this.checked&&(c.value=o),this.setValue(o),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:c})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:c})),this.dispatchInput=!1),this.dispatchEventIfValid(c)}}render(){return h` ${this.isSwitch?this.renderCheckboxSwitch():this.renderCheckboxDefault()} `}resetFormControl(){super.resetFormControl(),this.checked=this.initialCheckedValue,this.value=this.initialValue}renderCheckboxDefault(){const e={"vl-checkbox":!0,"vl-checkbox--disabled":this.disabled,"vl-checkbox--error":this.isInvalid||this.error,"vl-checkbox--success":this.success,"vl-checkbox--block":this.block};return h`
            <label class=${b(e)}>
                <input
                    id=${this.id}
                    name=${this.name||t}
                ...
                <div class="vl-checkbox__label">
                    <i
                        class=${b({"vl-checkbox__box":!0,"vl-icon":!0,"vl-icon--check":this.checked,"vl-icon--minus":this.indeterminate&&!this.checked})}
                        aria-hidden="true"
                    ></i>
                    <span>
                        <slot></slot>
        ...
        `}renderCheckboxSwitch(){const e={"vl-checkbox--switch__wrapper":!0,"vl-checkbox--disabled":this.disabled,"vl-checkbox--error":this.isInvalid||this.error,"vl-checkbox--success":this.success,"vl-checkbox--block":this.block};return h`
            <div class=${b(e)}>
                <input
                    id=${this.id}
                    name=${this.name||t}
        ...
        `}toggle(){this.checked=!this.checked,this.dispatchInput=!0}};a.instanceCounter=0;a=p([g("vl-checkbox")],a);export{a as V,l as c};
