import{Z as l,_ as d,X as j,W as L,u as b,j as i,b8 as U,C as v,s as g,x as c,r as y,Q as w,bH as S,d as T,bt as C}from"./iframe-B0laZkYe.js";import{t as h}from"./vl-side-navigation.component-BoIdkX-M.js";import"./preload-helper-D9Z9MdNV.js";const $={closed:!1,compact:!1,headingRootSelector:"",maxDepth:void 0,navigationTitle:"Op deze pagina",childSpacing:"small",multiActive:!1},n={...j,...$,defaultSlot:""},D={...L,closed:{name:"closed",description:"Wanneer aanwezig wordt de inhoudstafel standaard verborgen. Heeft enkel effect wanneer het attribuut `compact` is gezet of bij mobiele weergave (viewport < 768px). Op desktop zonder compact wordt de navigatie altijd getoond.",table:{type:{summary:d.BOOLEAN},category:l.ATTRIBUTES,defaultValue:{summary:String(n.closed)}}},compact:{name:"compact",description:"Forceert de compacte weergave (toggle knop, verborgen navigatie standaard) ongeacht de viewport grootte.",table:{type:{summary:d.BOOLEAN},category:l.ATTRIBUTES,defaultValue:{summary:String(n.compact)}}},headingRootSelector:{name:"heading-root-selector",description:'CSS selector om het root container element te vinden waarbinnen naar headings gezocht wordt. Indien niet opgegeven, wordt het volledige document/shadow root doorzocht. Voorbeeld: "#section-1" om enkel headings binnen die sectie te scannen.',table:{type:{summary:d.STRING},category:l.ATTRIBUTES,defaultValue:{summary:n.headingRootSelector}}},maxDepth:{name:"max-depth",description:"Optionele maximum diepte voor shadow DOM traversal (bij scannen van headings én bij zoeken van scroll-target). Biedt fijnmazige controle over performantie vs compatibiliteit. 0 = enkel light DOM, 1 = light DOM + eerste niveau shadow DOM, undefined = onbeperkt (standaard).",table:{type:{summary:d.NUMBER},category:l.ATTRIBUTES,defaultValue:{summary:n.maxDepth!==void 0?String(n.maxDepth):"undefined"}}},navigationTitle:{name:"navigation-title",description:"Tekst die getoond wordt als titel boven de inhoudstafel.",table:{type:{summary:d.STRING},category:l.ATTRIBUTES,defaultValue:{summary:n.navigationTitle}}},defaultSlot:{name:"[default]",description:'Custom inhoudsopgave. Wanneer je hier content plaatst (bijv. een ul/li-structuur met vl-link elementen met href="#..."), wordt die gebruikt in plaats van de automatisch gegenereerde inhoudsopgave. De links moeten verwijzen naar heading-ids in de content.',table:{type:{summary:d.HTML},category:l.SLOTS,defaultValue:{summary:String(n.defaultSlot)}}},childSpacing:{name:"child-spacing",description:"Bepaalt de verticale ruimte tussen child-links. `medium` geeft extra ruimte (1.3rem marge boven en onder), vergelijkbaar met de stijl van de klassieke vl-side-navigation. `small` is de standaard compacte weergave.",options:["medium","small"],control:{type:"select"},table:{type:{summary:d.STRING},category:l.ATTRIBUTES,defaultValue:{summary:n.childSpacing}}},multiActive:{name:"multi-active",description:"Wanneer aanwezig worden alle items waarvan content zichtbaar is als actief gemarkeerd, in plaats van enkel het bovenste. De actieve items worden aangeduid met een doorlopende lijn uiterst links. Zonder dit attribuut kan het zijn dat de onderste items onderaan nooit aangeduid worden.<br>Dit attribuut is niet reactief.",table:{type:{summary:d.BOOLEAN},category:l.ATTRIBUTES,defaultValue:{summary:String(n.multiActive)}}}};function q(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...b(),...t.components},{FluxAlert:o,FluxComponentMetaData:a}=e;return o||x("FluxAlert"),a||x("FluxComponentMetaData"),i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"side-navigation-next",children:"Side Navigation Next"}),`
...
`,i.jsx(v,{of:s,inline:!1}),`
`,i.jsxs("details",{children:[i.jsx("summary",{children:"Compact (navigatie standaard gesloten)"}),i.jsxs(e.p,{children:["Met het attribuut ",i.jsx(e.code,{children:"compact"})," wordt de compacte weergave geforceerd: de navigatie staat standaard gesloten en kan via de toggle knop worden opengeklapt."]}),i.jsx(v,{of:r,inline:!1})]}),`
...
`]}),`
`,i.jsx("vl-side-navigation-next",{compact:!0,"exclude-selectors":"iframe, #storybook-root",closed:!0})]})}function A(t={}){const{wrapper:e}={...b(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(q,{...t})}):q(t)}function x(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const O={id:"components-block-next-side-navigation",title:"Components - Block/next/side-navigation",tags:["autodocs"],args:n,argTypes:D,parameters:{docs:{page:A,story:{inline:!1,iframeHeight:500}}}};y([w,S,T,C]);const k=c`
...
`,s=g(n,({closed:t,compact:e,headingRootSelector:o,maxDepth:a,navigationTitle:u,childSpacing:p,multiActive:f})=>c`
            <div class="vl-grid vl-content-block">
                ...
                <div class="vl-column vl-column--8 vl-column--m-9 vl-column--s-12 ">${k}</div>
            </div>
        `);s.storyName="vl-side-navigation-next - default";s.args={headingRootSelector:"#story-content-container"};const r=g(n,({closed:t,headingRootSelector:e,maxDepth:o,navigationTitle:a,childSpacing:u,multiActive:p})=>c`
            <div class="vl-grid vl-content-block">
                <vl-side-navigation-next
                ...
                <div class="vl-column vl-column--12">${k}</div>
            </div>
        `);r.storyName="vl-side-navigation-next - compact";r.args={compact:!0,headingRootSelector:"#story-content-container"};const m=g(n,({closed:t,compact:e,maxDepth:o,childSpacing:a,multiActive:u})=>c`
            <div class="vl-grid vl-content-block">
                <vl-side-navigation-next
                    class="vl-column vl-column--3 vl-column--start-10 vl-column--m-3  vl-column--s-12  vl-side-navigation--order-1"
                    ?closed=${t}
        ...
        `);m.storyName="vl-side-navigation-next - custom table of contents";s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(sideNavigationArgs, ({
  closed,
  compact,
  headingRootSelector,
  maxDepth,
  ...
  return html\`
        ...
        \`;
})`,...s.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(sideNavigationArgs, ({
  closed,
  headingRootSelector,
  maxDepth,
  navigationTitle,
  ...
  return html\`
        ...
        \`;
})`,...m.parameters?.docs?.source}}};const V=["SideNavigationDefault","SideNavigationCompact","SideNavigationWithCustomToc"];export{r as SideNavigationCompact,s as SideNavigationDefault,m as SideNavigationWithCustomToc,V as __namedExportsOrder,O as default};
