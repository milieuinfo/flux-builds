import{Z as v,_ as h,W as g,co as b,X as x,u as y,j as r,C as i,bc as j,s as c,x as m,r as f,Y as w,bu as P}from"./iframe-nqJ0ju39.js";import"./preload-helper-D9Z9MdNV.js";const n={...x,...b},k={...g,labelWidth:{name:"label-width",description:"De breedte van de labels, in %. Heeft geen impact als de properties 'stacked' worden.",table:{type:{summary:h.NUMBER},category:v.ATTRIBUTES,defaultValue:{summary:String(n.labelWidth)}}},noClone:{name:"no-clone",description:"Default wordt de inhoud van label en data ge-cloned: van de Light DOM naar de shadow DOM, met no-clone actief wordt de inhoud verplaatst.",table:{type:{summary:h.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(n.noClone)}}},props:{name:"props",description:"De props in JSON formaat.",table:{type:{summary:h.ARRAY},category:v.PROPERTIES,defaultValue:{summary:String(n.props)}}},noPaddingBottom:{name:"no-padding-bottom",description:"Haalt de witruimte onder het laatste item weg. Gebruik dit indien er via stacking al witruimte aanwezig is.",table:{type:{summary:h.BOOLEAN},category:v.ATTRIBUTES,defaultValue:{summary:String(n.noPaddingBottom)}}}};function u(o){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...y(),...o.components},{FluxComponentMetaData:t}=e;return t||$("FluxComponentMetaData"),r.jsxs(r.Fragment,{children:[r.jsx(e.h1,{id:"properties",children:"Properties"}),`
...
component van Digitaal Vlaanderen.`]})]})}function B(o={}){const{wrapper:e}={...y(),...o.components};return e?r.jsx(e,{...o,children:r.jsx(u,{...o})}):u(o)}function $(o,e){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}const S=[{class:"column",items:[{labels:["Straat"],data:["Appelstraat","Perenstraat"]}]}],W=[{class:"column",items:[{labels:["Gemeente"],data:["Antwerpen","Berchem"]}]}];f([w,P]);const T={id:"components-block-properties",title:"Components - Block/properties",tags:["autodocs"],args:n,argTypes:k,parameters:{docs:{page:B}}},C=c(n,({labelWidth:o,props:e,noPaddingBottom:t})=>m`
    ...
    `),D=c(n,({labelWidth:o,props:e,noPaddingBottom:t})=>m`
        <vl-properties label-width=${o} .props=${e} ?no-padding-bottom=${t}></vl-properties>
    `),a=C.bind({});a.storyName="vl-properties - default";const s=D.bind({});s.storyName="vl-properties - with props";s.args={props:[...S,...W]};const p=c(n,({labelWidth:o,props:e,noPaddingBottom:t})=>m`
        <vl-properties label-width=${o} .props=${e} ?no-padding-bottom=${t}>
            <vl-property>
    ...
    `);d.storyName="vl-properties - columns";a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`story(propertiesArgs, ({
  labelWidth,
  props,
  noPaddingBottom
}) => html\`
    ...
    \`)`,...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(propertiesArgs, ({
  labelWidth,
  props,
  noPaddingBottom
}) => html\`
        <vl-properties label-width=\${labelWidth} .props=\${props} ?no-padding-bottom=\${noPaddingBottom}></vl-properties>
    \`)`,...s.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story(propertiesArgs, ({
  labelWidth,
  props,
  noPaddingBottom
}) => html\`
  ...
  noPaddingBottom
    ...
    \`)`,...d.parameters?.docs?.source}}};const M=["PropertiesDefault","PropertiesWithProps","PropertiesHtmlEnriched","PropertiesStacked","PropertiesColumns"];export{d as PropertiesColumns,a as PropertiesDefault,p as PropertiesHtmlEnriched,l as PropertiesStacked,s as PropertiesWithProps,M as __namedExportsOrder,T as default};
