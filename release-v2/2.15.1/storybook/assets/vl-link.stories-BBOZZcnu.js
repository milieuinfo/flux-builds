...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://www.vlaanderen.be/vlaanderen-design-system/componenten/link",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Link"})})]})}function U(r={}){const{wrapper:n}={...$(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(x,{...r})}):x(r)}function W(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}M([G]);const Z={id:"components-atom-link",title:"Components - Atom/link",tags:["autodocs"],args:l,argTypes:H,parameters:{docs:{page:U}}},o=P(l,({href:r,bold:n,small:g,large:j,error:y,external:S,buttonAsLink:L,type:w,icon:A,iconPlacement:T,defaultSlot:V,label:E,onVlClick:C})=>R`
        <vl-link
            href=${r}
            ?bold=${n}
            ?small=${g}
