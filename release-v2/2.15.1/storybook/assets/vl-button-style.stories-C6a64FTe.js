import{x as s,u as p,j as n,M as v,C as h,S as f,bE as b,b6 as y}from"./iframe-nqJ0ju39.js";import"./preload-helper-D9Z9MdNV.js";const $=["primary","secondary","tertiary","ghost","error","toggle"],x=["default","large","wide","narrow","block"],j=["none","before","after","only"],C=["idle","loading","disabled"],c=(t,e,o,r)=>`${t} ${e} icon-${o} ${r}`,S=(t,e,o,r,l)=>s`<dl style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
