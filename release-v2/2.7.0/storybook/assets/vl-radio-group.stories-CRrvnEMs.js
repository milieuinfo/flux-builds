import{K as a,L as l,u as c,j as e,C as y,bd as V,s as k,x as $,r as C}from"./iframe-BRJWU34U.js";import{a as w,f as E}from"./form-control.stories-arg-CUD096Q9.js";import{r as R,V as D}from"./vl-radio-group.component-B-OVdapL.js";import{V as T}from"./vl-radio.component-OOpp9DdI.js";import{M as G}from"./form-control.public-methods-doc-BO7BByku.js";import"./preload-helper-D9Z9MdNV.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,i={...E,...R,onVlChange:t("vl-change"),onVlInput:t("vl-input"),onVlValid:t("vl-valid")},S={...w,readonly:{name:"readonly",description:"Duidt aan dat het veld enkel leesbaar is.",table:{type:{summary:l.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(i.readonly)}}},value:{name:"value",description:"De value van de radio.",table:{type:{summary:l.STRING},category:a.ATTRIBUTES,defaultValue:{summary:String(i.value)}}},onVlChange:{name:"vl-change",description:"Event dat afgevuurd wordt als een radio aangevinkt of uitgevinkt wordt (zowel programmatorisch als door een gebruiker).<br>Het detail object van het event bevat de checked state en de waarde van de radio.",table:{type:{summary:"{ checked: boolean, value?: string }"},category:a.EVENTS}},onVlInput:{name:"vl-input",description:"Event dat alleen afgevuurd wordt als een gebruiker een radio aanvinkt.<br>Het detail object van het event bevat de checked state en de waarde van de radio.",table:{type:{summary:"{ checked: boolean, value?: string }"},category:a.EVENTS}},onVlValid:{name:"vl-valid",description:"Event dat afgevuurd wordt als een radio aangevinkt wordt.<br>Het detail object van het event bevat de checked state en de waarde van de radio.",table:{type:{summary:"{ checked: boolean, value?: string }"},category:a.EVENTS}}};function s(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...c(),...o.components},{FluxMetaData:d}=n;return d||A("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"radio-group",children:"Radio Group"}),`
