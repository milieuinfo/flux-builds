import{u as d,j as e,C as o,bd as L,s as A,x as _,r as z,V as N}from"./iframe-BRJWU34U.js";import{i as R,a as s}from"./vl-input-field.stories-arg-Bei8RL8s.js";import{M as T}from"./form-control.public-methods-doc-BO7BByku.js";import"./preload-helper-D9Z9MdNV.js";import"./form-control.stories-arg-CUD096Q9.js";function a(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...d(),...i.components},{FluxMetaData:t}=n;return t||H("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"input-field",children:"Input Field"}),`
`,e.jsx(t,{id:"components-form-input-field"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-input-field",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Input field"})})]})}function Z(i={}){const{wrapper:n}={...d(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}function H(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}z([N]);const O={id:"components-form-input-field",title:"Components - Form/input-field",tags:["autodocs"],args:s,argTypes:R,parameters:{docs:{page:Z}}},c=A(s,({id:i,name:n,label:t,required:p,disabled:u,error:m,success:h,block:x,readonly:v,type:j,value:g,placeholder:$,autocomplete:b,minLength:f,maxLength:k,min:y,max:V,minExclusive:F,maxExclusive:I,pattern:w,inputGroup:C,regex:D,onVlInput:E,onVlReset:M,onVlChange:q,onVlValid:G})=>_` <vl-input-field
            id=${i}
            name=${n}
            label=${t}
            ?required=${p}
