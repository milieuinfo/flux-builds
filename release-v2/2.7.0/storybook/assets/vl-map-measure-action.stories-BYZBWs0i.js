import{u as v,j as a,C as m,bd as d,s as p,x as i}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-measure-control-Cc4FvdRn.js";import"./vl-map-action-controls-MTkIn2Lt.js";import"./vl-map-features-layer-B_ClZkbk.js";import"./vl-map-wfs-layer-DkWiFLJM.js";import{m as y,a as o}from"./vl-map-draw-action.stories-arg-C721WnLP.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-draw-action-DKMqKN8Y.js";import"./vl-map-layer-action-2JAAiOGD.js";import"./composite-vector-layer-BuQYujkN.js";import"./vl-map-vector-layer-BFohRpWd.js";import"./vl-map-control.mixin-BVplJShe.js";import"./vl-map-action.stories-arg-CeHGMlwy.js";function c(r){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...v(),...r.components},{FluxMetaData:s}=e;return s||f("FluxMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"map-measure-action",children:"Map Measure Action"}),`
`,a.jsx(s,{id:"map-action-draw-action-measure-action"}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-map-vl-map-measure-action--default",rel:"nofollow",children:"Legacy Storybook - Map Measure Action"})})]})}function g(r={}){const{wrapper:e}={...v(),...r.components};return e?a.jsx(e,{...r,children:a.jsx(c,{...r})}):c(r)}function f(r,e){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const V={id:"map-action-draw-action-measure-action",title:"map/action/draw-action/measure-action",tags:["autodocs"],args:o,argTypes:y,parameters:{docs:{page:g}}},n=p(o,({active:r,defaultActive:e})=>i`
        <vl-map lambert2008>
  ...
  defaultActive
        ...
        \`)`,...l.parameters?.docs?.source}}};const N=["MapMeasureActionDefault","MapMeasureActionSnapping","MapMeasureActionControl"];export{l as MapMeasureActionControl,n as MapMeasureActionDefault,t as MapMeasureActionSnapping,N as __namedExportsOrder,V as default};
