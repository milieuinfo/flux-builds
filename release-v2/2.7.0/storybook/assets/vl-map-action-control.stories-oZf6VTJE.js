import{K as m,L as p,H as f,I as h,u,j as a,C as d,bd as A,s as y,x as g}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-draw-polygon-action-uHPrsMc9.js";import"./vl-map-delete-action-CzPS5WCd.js";import"./vl-map-modify-action-ZHcO0FOc.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-features-layer-B_ClZkbk.js";import"./vl-map-action-controls-MTkIn2Lt.js";import"./vl-map-action-control-BpFx6JYW.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-draw-action-DKMqKN8Y.js";import"./vl-map-layer-action-2JAAiOGD.js";import"./composite-vector-layer-BuQYujkN.js";import"./vl-map-vector-layer-BFohRpWd.js";import"./select-action-BvgTSUoJ.js";import"./vl-map-control.mixin-BVplJShe.js";const r={...h,actionId:"",icon:"",label:"",defaultActive:!1},x={...f,actionId:{name:"action-id",description:"Het id van de actie die gelinkt is aan deze map-action-control.<br>Houd dit in sync met het id attribuut dat je op de actie plaatst.",table:{type:{summary:p.STRING},category:m.ATTRIBUTES,defaultValue:{summary:r.actionId}}},icon:{name:"icon",description:"Het icoon van de toggle-button.",table:{type:{summary:p.STRING},category:m.ATTRIBUTES,defaultValue:{summary:r.icon}}},label:{name:"label",description:"Het label van de toggle-button.",table:{type:{summary:p.STRING},category:m.ATTRIBUTES,defaultValue:{summary:r.label}}},defaultActive:{name:"default-active",description:"Voeg `default-active` toe om de control default te activeren bij het renderen.",table:{type:{summary:p.BOOLEAN},category:m.ATTRIBUTES,defaultValue:{summary:String(r.defaultActive)}}}};function v(t){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...u(),...t.components},{FluxMetaData:c}=o;return c||w("FluxMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(o.h1,{id:"map-action-control",children:"Map Action Control"}),`
`,a.jsx(c,{id:"map-controls-action-control"}),`
...
`,a.jsx(d,{of:i})]})}function j(t={}){const{wrapper:o}={...u(),...t.components};return o?a.jsx(o,{...t,children:a.jsx(v,{...t})}):v(t)}function w(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const O={id:"map-controls-action-control",title:"map/controls/action-control",tags:["autodocs"],args:r,argTypes:x,parameters:{docs:{page:j},controls:{hideNoControlsWarning:!0}}},s=y(r,({actionId:t,icon:o,label:c,defaultActive:b})=>g`
        <vl-map lambert2008>
    ...
    `);i.storyName="vl-map-action-control - multiple";n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`story(mapActionControlArgs, ({
  actionId,
  icon,
  label,
  defaultActive
    ...
    \`)`,...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`story(mapActionControlArgs, ({
  actionId,
  icon,
  label,
  defaultActive
  ...
  defaultActive
    ...
    \`)`,...i.parameters?.docs?.source}}};const U=["MapActionControlDefault","MapActionControlDefaultActive","MapActionControlIcon","MapActionControlMultiple"];export{n as MapActionControlDefault,e as MapActionControlDefaultActive,l as MapActionControlIcon,i as MapActionControlMultiple,U as __namedExportsOrder,O as default};
