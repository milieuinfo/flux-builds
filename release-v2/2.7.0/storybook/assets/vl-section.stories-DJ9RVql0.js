import{u as v,j as e,M as p,C as b,S as u,x as c,z as h,b6 as i}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const m=""+new URL("section-overlap-BFjLB5_G.png",import.meta.url).href;function a(n){const s={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...v(),...n.components},{FluxMetaData:d}=s;return d||x("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"Styles/Layout (afnemers)/section"}),`
`,e.jsx(s.h1,{id:"section",children:"Section"}),`
`,e.jsx(d,{id:"styles-layout-afnemers-section"}),`
`,e.jsx("br",{}),`
...
`,e.jsx("br",{}),`
`,e.jsx("br",{}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"section overlap - code"}),e.jsx(u,{code:o.toString(),language:"html",dark:!0,format:!0})]})]})}function g(n={}){const{wrapper:s}={...v(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(a,{...n})}):a(n)}function x(n,s){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const f={id:"styles-layout-afnemers-section",title:"Styles/Layout (afnemers)/section",tags:["autodocs"],parameters:{docs:{page:g}}},r=h`
    .vl-section {
        p {
            display: flex;
