...
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-progress-indicator.html",rel:"nofollow",children:"Legacy Demo - Progress Bar"})})]})}function A(t={}){const{wrapper:s}={...b(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(v,{...t})}):v(t)}function T(t,s){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const P={id:"components-block-progress-indicator",title:"Components - Block/progress-indicator",tags:["autodocs"],args:n,argTypes:I,parameters:{docs:{page:A}}},g=O(n,({activeStep:t,showLabels:s,focusOnChange:m,numeric:S,steps:f,onClickStep:j,staticSteps:k,enableFutureSteps:x})=>L`
