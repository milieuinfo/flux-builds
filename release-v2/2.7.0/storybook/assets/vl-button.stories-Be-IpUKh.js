...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-button",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Button"})})]})}function cn(i={}){const{wrapper:e}={...G(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(L,{...i})}):L(i)}function sn(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}rn([ln]);const $n={id:"components-atom-button",title:"Components - Atom/button",tags:["autodocs"],args:o,argTypes:dn,parameters:{docs:{page:cn}}},l=tn(o,({type:i,disabled:e,error:T,block:E,large:A,wide:C,narrow:O,secondary:N,tertiary:P,ghost:I,loading:R,icon:M,ctaLink:D,iconPlacement:H,toggle:U,on:z,controlled:K,external:_,inputGroup:W,label:F,defaultSlot:V,onVlClick:X,onVlToggle:Y})=>on`
            <vl-button
                type=${i}
                ?disabled=${e}
                ?error=${T}
        ...
        `),d=l.bind({});d.storyName="vl-button - primary";d.args={defaultSlot:"Klik op mij"};const c=l.bind({});c.storyName="vl-button - secondary";c.args={defaultSlot:"Klik op mij",secondary:!0};const s=l.bind({});s.storyName="vl-button - tertiary";s.args={defaultSlot:"Klik op mij",tertiary:!0};const u=l.bind({});u.storyName="vl-button - ghost";u.args={defaultSlot:"Klik op mij",ghost:!0};const g=l.bind({});g.storyName="vl-button - disabled";g.args={defaultSlot:"Klik op mij",disabled:!0};const b=l.bind({});b.storyName="vl-button - error";b.args={defaultSlot:"Klik op mij",error:!0};const $=l.bind({});$.storyName="vl-button - block";$.args={defaultSlot:"Klik op mij",block:!0};const p=l.bind({});p.storyName="vl-button - large";p.args={defaultSlot:"Klik op mij",large:!0};const m=l.bind({});m.storyName="vl-button - wide";m.args={defaultSlot:"Klik op mij",wide:!0};const y=l.bind({});y.storyName="vl-button - narrow";y.args={defaultSlot:"Klik op mij",narrow:!0};const k=l.bind({});k.storyName="vl-button - loading";k.args={defaultSlot:"Klik op mij",loading:!0};const h=l.bind({});h.storyName="vl-button - icon";h.args={defaultSlot:"Klik op mij",icon:"location",iconPlacement:"before"};const f=l.bind({});f.storyName="vl-button - icon only";f.args={icon:"location",label:"Locatie"};const v=l.bind({});v.storyName="vl-button - icon only - ghost";v.args={icon:"trash",label:"Verwijder",ghost:!0};const x=l.bind({});x.storyName="vl-button - toggle";x.args={defaultSlot:"Klik op mij",toggle:!0};const w=l.bind({});w.storyName="vl-button - cta-link";w.args={icon:"add",defaultSlot:"Voeg nieuw object toe.",ctaLink:"https://www.vlaanderen.be"};const j=l.bind({});j.storyName="vl-button - input-group";j.args={defaultSlot:"Klik op mij",inputGroup:!0};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`story(buttonArgs, ({
  type,
  disabled,
  error,
  block,
  ...
  onVlToggle
        ...
        \`)`,...x.parameters?.docs?.source}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`story(buttonArgs, ({
  type,
  disabled,
  error,
  block,
  ...
  onVlToggle
        ...
        \`)`,...j.parameters?.docs?.source}}};const pn=["ButtonPrimary","ButtonSecondary","ButtonTertiary","ButtonGhost","ButtonDisabled","ButtonError","ButtonBlock","ButtonLarge","ButtonWide","ButtonNarrow","ButtonLoading","ButtonIcon","ButtonIconOnly","ButtonIconOnlyGhost","ButtonToggle","ButtonCtaLink","ButtonInputGroup"];export{$ as ButtonBlock,w as ButtonCtaLink,g as ButtonDisabled,b as ButtonError,u as ButtonGhost,h as ButtonIcon,f as ButtonIconOnly,v as ButtonIconOnlyGhost,j as ButtonInputGroup,p as ButtonLarge,k as ButtonLoading,y as ButtonNarrow,d as ButtonPrimary,c as ButtonSecondary,s as ButtonTertiary,x as ButtonToggle,m as ButtonWide,pn as __namedExportsOrder,$n as default};
