import{K as a,L as o,Q as b,P as v,u as y,j as e,C as h,bd as x,S as B,s as O,x as C}from"./iframe-BRJWU34U.js";import{o as D}from"./unsafe-html-HT10cyGK.js";import"./vl-accessibility.component-rbYJhn8X.js";import"./preload-helper-D9Z9MdNV.js";const m={FULLY_COMPLIANT:"FULLY_COMPLIANT",PARTIALLY_COMPLIANT:"PARTIALLY_COMPLIANT",NOT_COMPLIANT:"NOT_COMPLIANT"},d={EXPERT_EVALUATED:"EXPERT_EVALUATED",SELF_EVALUATED:"SELF_EVALUATED",NOT_EVALUATED:"NOT_EVALUATED"},{action:N}=__STORYBOOK_MODULE_ACTIONS__,n={application:"deze applicatie",compliance:`${m.PARTIALLY_COMPLIANT}`,date:"20 juli 2021",dateModified:"20 juli 2021",disableBackLink:!1,hideBackLink:!1,evaluation:`${d.NOT_EVALUATED}`,version:"1.0.0",limitations:null,onClickBack:N("vl-click-back"),headerSlot:""},M={application:{name:"application",description:"De applicatie waar de verklaring over gaat.",table:{type:{summary:o.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.application}}},compliance:{name:"compliance",description:"De nalevingsstatus van de verklaring.",control:{type:v.SELECT},options:Object.values(m),table:{type:b(Object.values(m)),category:a.ATTRIBUTES,defaultValue:{summary:n.compliance}}},date:{name:"date",description:"De aanmaakdatum van de verklaring.",table:{type:{summary:o.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.date}}},dateModified:{name:"date-modified",description:"De datum van de laatste wijziging van de verklaring.",table:{type:{summary:o.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.dateModified}}},disableBackLink:{name:"disable-back-link",description:"Zet de terug-link uit.",table:{type:{summary:o.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(n.disableBackLink)}}},hideBackLink:{name:"hide-back-link",description:"Verwijdert de terug-link.",table:{type:{summary:o.BOOLEAN},category:a.ATTRIBUTES,defaultValue:{summary:String(n.hideBackLink)}}},evaluation:{name:"evaluation",description:"De evaluatiestatus van de verklaring.",control:{type:v.SELECT},options:Object.values(d),table:{type:{summary:b(Object.values(d))},category:a.ATTRIBUTES,defaultValue:{summary:n.evaluation}}},version:{name:"version",description:"De huidige versie van de verklaring.",table:{type:{summary:o.STRING},category:a.ATTRIBUTES,defaultValue:{summary:n.version}}},limitations:{name:"limitations",description:"Property om limitaties mee te geven aan de verklaring. Het object bevat 3 optionele properties. De `withTiming` limitaties vallen onder 'Niet-naleving van het bestuursdecreet'. Dit zijn tijdelijke limitaties. `withoutTiming` limitaties vallen onder 'Onevenredige last'. Dit zijn permanente limitaties. De `outsideApplicableLaw` limitaties vallen onder 'De inhoud valt buiten de werkingssfeer van de toepasselijke wetgeving'. Dit zijn limitaties die buiten de werkingssfeer van de toepasselijke wetgeving vallen.",table:{type:{summary:"object"},category:a.PROPERTIES}},onClickBack:{name:"vl-click-back",description:"Afgevuurd na het klikken op de terug-link.",table:{type:{summary:"-"},category:a.EVENTS}},headerSlot:{name:"header",description:"Hiermee kan je de standaard functional header vervangen door een header naar keuze.",table:{type:{summary:o.HTML},category:a.SLOTS,defaultValue:{summary:n.headerSlot}}}},_=`import { html } from 'lit';
...
export const header = ({ disableBackLink, hideBackLink }: HeaderProps) => html\`
    ...
    ></vl-functional-header>
\`;
`;function g(t){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...y(),...t.components},{FluxMetaData:p}=i;return p||w("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(i.h1,{id:"accessibility",children:"Accessibility"}),`
...
`,e.jsx(i.p,{children:e.jsx(i.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accessibility.html",rel:"nofollow",children:"Legacy Demo - Accessibility"})})]})}function I(t={}){const{wrapper:i}={...y(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(g,{...t})}):g(t)}function w(t,i){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const H={id:"components-compliance-accessibility",title:"Components - Compliance/accessibility",tags:["autodocs"],args:n,argTypes:M,parameters:{layout:"fullscreen",docs:{page:I}}},u=O(n,({application:t,compliance:i,date:p,dateModified:T,disableBackLink:f,hideBackLink:L,evaluation:A,version:j,limitations:E,onClickBack:S,headerSlot:$})=>C`
        <vl-accessibility
            application=${t}
            compliance=${i}
            date=${p}
    ...
    <vl-functional-header
        ...
        link="https://omgeving.vlaanderen.be"
        back="Start"
    ></vl-functional-header>`};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`story(accessibilityArgs, ({
  application,
  compliance,
  date,
  dateModified,
  ...
  headerSlot
    ...
    \`)`,...l.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`story(accessibilityArgs, ({
  application,
  compliance,
  date,
  dateModified,
  ...
  headerSlot
    ...
    \`)`,...s.parameters?.docs?.source}}};const z=["AccessibilityDefault","AccessibilitySelfEvaluated","AccessibilityExpertEvaluated","AccessibilityHeaderSlot"];export{l as AccessibilityDefault,r as AccessibilityExpertEvaluated,s as AccessibilityHeaderSlot,c as AccessibilitySelfEvaluated,z as __namedExportsOrder,H as default};
