import{K as s,L as l,H as u,I as h,u as m,j as e,C as d,bd as b,s as v,bZ as p,x as g}from"./iframe-BRJWU34U.js";import{p as z,a as k}from"./vl-proza-message.stories-msw-BzSRmsUw.js";import"./preload-helper-D9Z9MdNV.js";const o={...h,baseUrl:"",block:!1,code:"",domain:"",parameters:""},y={...u,baseUrl:{name:"base-url",description:"Optionele baseUrl waarvan het Proza bericht opgehaald wordt.<br>Indien deze baseUrl niet meegegeven wordt, wordt het Proza bericht opgehaald relatief tov de huidige url op het pad 'proza/domein/{domain}/{code}'.<br>Dit attribuut is niet reactief.",control:!1,table:{type:{summary:l.URL},category:s.ATTRIBUTES,defaultValue:{summary:o.baseUrl}}},block:{name:"block",description:"Duidt aan dat de inhoud van het Proza bericht een block element is.",control:!1,table:{type:{summary:l.BOOLEAN},category:s.ATTRIBUTES,defaultValue:{summary:String(o.block)}}},code:{name:"code",description:"De code die het Proza bericht identificeert.",type:{name:l.STRING,required:!0},control:!1,table:{type:{summary:l.STRING},category:s.ATTRIBUTES,defaultValue:{summary:o.code}}},domain:{name:"domain",description:"Het Proza domein waarin het Proza bericht zit.",type:{name:l.STRING,required:!0},control:!1,table:{type:{summary:l.STRING},category:s.ATTRIBUTES,defaultValue:{summary:o.domain}}},parameters:{name:"parameters",description:"De key/value parameters die verwerkt en getoond zullen worden in het content element.",control:!1,table:{type:{summary:l.STRING},category:s.ATTRIBUTES,defaultValue:{summary:o.parameters}}}};function c(n){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...m(),...n.components},{FluxMetaData:i}=a;return i||f("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"proza-message",children:"Proza Message"}),`
`,e.jsx(i,{id:"components-block-proza-message"}),`
...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/legacy-vl-proza-message--non-editable",rel:"nofollow",children:"Legacy Storybook - Proza Message"})}),`
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlProzaMessage.html",rel:"nofollow",children:"Legacy Documentatie - Proza Message"})}),`
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-proza-message.html",rel:"nofollow",children:"Legacy Demo - Proza Message"})})]})}function x(n={}){const{wrapper:a}={...m(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(c,{...n})}):c(n)}function f(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const M={id:"components-block-proza-message",title:"Components - Block/proza-message",tags:["autodocs"],args:o,argTypes:y,parameters:{docs:{page:x},controls:{hideNoControlsWarning:!0},msw:{handlers:[...z,...k]}}},t=v(o,()=>(p.clearCache(),g`
    ...
    `));t.storyName="vl-proza-message - default";const r=v(o,()=>(p.clearCache(),g`
        <div class="vl-grid vl-stacked-small">
            <div class="vl-column vl-column--12">
                <vl-title type="h6">Als een inline element:</vl-title>
    ...
    `));r.storyName="vl-proza-message - editable";t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`story(prozaMessageArgs, () => {
  ...
  return html\`
    ...
    \`;
})`,...t.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(prozaMessageArgs, () => {
  VlProzaMessage.clearCache();
  return html\`
        <div class="vl-grid vl-stacked-small">
            <div class="vl-column vl-column--12">
    ...
    \`;
})`,...r.parameters?.docs?.source}}};const T=["ProzaMessageDefault","ProzaMessageEditable"];export{t as ProzaMessageDefault,r as ProzaMessageEditable,T as __namedExportsOrder,M as default};
