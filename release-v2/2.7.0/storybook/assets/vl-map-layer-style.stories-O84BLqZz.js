import{u as S,j as e,C as b,bd as z,s as C,x as j}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-features-layer-B_ClZkbk.js";import{m as L,a as g}from"./vl-map-layer-style.stories-arg-Dn5UhR2K.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-BFohRpWd.js";function h(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...S(),...r.components},{FluxMetaData:l}=t;return l||F("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"map-layer-style",children:"Map Layer Style"}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-layer-style.html",rel:"nofollow",children:"Legacy Demo - Map Layer Style"})})]})}function B(r={}){const{wrapper:t}={...S(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(h,{...r})}):h(r)}function F(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const X={id:"map-layer-style",title:"map/layer-style",tags:["autodocs"],args:g,argTypes:L,parameters:{docs:{page:B}}},v=C(g,({borderColor:r,borderSize:t,color:l,name:d,invalid:y,textBackgroundColor:i,textBorderColor:m,textBorderSize:p,textColor:c,textFeatureAttributeName:x,textOffsetX:u,textOffsetY:f,textSize:$})=>j` <vl-map lambert2008>
...
})`,...n.parameters?.docs?.source}}};const D=["MapLayerStyleDefault","MapLayerStyleText","MapLayerStyleInvalid","MapLayerStyleLegend"];export{a as MapLayerStyleDefault,s as MapLayerStyleInvalid,n as MapLayerStyleLegend,o as MapLayerStyleText,D as __namedExportsOrder,X as default};
