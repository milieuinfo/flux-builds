...
`,t.jsxs(e.p,{children:["Deze component is de nieuwe versie van het ",t.jsx(e.a,{href:"/docs/elements-title-h1--documentatie",children:"vl-title"})," element, we raden aan om op termijn deze versie te gebruiken."]}),`
...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-titles",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Title"})})]})}function x(n={}){const{wrapper:e}={...m(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(c,{...n})}):c(n)}function b(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const E={id:"components-atom-title",title:"Components - Atom/title",tags:["autodocs"],args:r,argTypes:j,parameters:{docs:{page:x}}},o=y(r,({underline:n,noSpaceBottom:e,alt:l,defaultSlot:i})=>f`
