...
export const header = () => html\`
    ...
    ></vl-functional-header>
\`;
`;function d(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...m(),...t.components},{FluxMetaData:c}=n;return c||B("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"cookie-statement",children:"Cookie Statement"}),`
...
`};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(cookieStatementArgs, ({
  ...
  headerSlot
    ...
    \`)`,...i.parameters?.docs?.source}}};const V=["CookieStatementDefault","CookieStatementHeaderSlot"];export{o as CookieStatementDefault,i as CookieStatementHeaderSlot,V as __namedExportsOrder,D as default};
