import{u as t,j as e,M as o,C as r,b0 as l,b1 as g,b2 as c,b3 as h,b4 as v,b5 as m,x as b,b6 as p}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";function s(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...i.components},{FluxMetaData:a}=n;return a||H("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Components - Atom/heading-style"}),`
...
`,e.jsx(r,{of:d})]})}function x(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function H(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const f={id:"components-atom-heading-style",title:"Components - Atom/heading-style (intern)",tags:["autodocs"],parameters:{docs:{page:x}}},d=({})=>b`
    <style>
        .sb-heading-1 {
            ${l}
        }
...
`;d.storyName="heading-style - default";d.parameters=p;d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`({}) => html\`
    ...
    <div class="sb-heading-5">Heading van grootte 5</div>
    <div class="sb-heading-6">Heading van grootte 6</div>
\``,...d.parameters?.docs?.source}}};const y=["HeadingStyleDefault"];export{d as HeadingStyleDefault,y as __namedExportsOrder,f as default};
