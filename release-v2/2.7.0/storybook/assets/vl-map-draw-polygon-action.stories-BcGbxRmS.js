import{u as s,j as a,C as i,bd as g,s as c,x as m}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-features-layer-B_ClZkbk.js";import"./vl-map-wfs-layer-DkWiFLJM.js";import{m as y,a as t}from"./vl-map-draw-action.stories-arg-C721WnLP.js";import"./vl-map-draw-polygon-action-uHPrsMc9.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-BFohRpWd.js";import"./vl-map-action.stories-arg-CeHGMlwy.js";import"./vl-map-draw-action-DKMqKN8Y.js";import"./vl-map-layer-action-2JAAiOGD.js";import"./composite-vector-layer-BuQYujkN.js";function p(n){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components},{FluxMetaData:l}=e;return l||u("FluxMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"map-draw-polygon-action",children:"Map Draw Polygon Action"}),`
`,a.jsx(l,{id:"map-action-draw-action-draw-polygon-action"}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-draw-actions.html",rel:"nofollow",children:"Legacy Demo - Map Draw Polygon Action"})})]})}function v(n={}){const{wrapper:e}={...s(),...n.components};return e?a.jsx(e,{...n,children:a.jsx(p,{...n})}):p(n)}function u(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const S={id:"map-action-draw-action-draw-polygon-action",title:"map/action/draw-action/draw-polygon-action",tags:["autodocs"],args:t,argTypes:y,parameters:{docs:{page:v}}},r=c(t,({active:n,defaultActive:e})=>m`
  ...
  snappingPixelTolerance
    ...
    \`)`,...o.parameters?.docs?.source}}};const _=["MapDrawPolygonActionDefault","MapDrawPolygonActionSnapping"];export{r as MapDrawPolygonActionDefault,o as MapDrawPolygonActionSnapping,_ as __namedExportsOrder,S as default};
