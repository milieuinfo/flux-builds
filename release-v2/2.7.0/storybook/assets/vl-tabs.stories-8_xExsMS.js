...
`;function k(a){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...x(),...a.components},{FluxAlert:s,FluxMetaData:i}=t;return s||j("FluxAlert"),i||j("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"tabs",children:"Tabs"}),`
...
`,e.jsx(y,{of:r}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:"TypeScript code"}),e.jsx(C,{code:M,language:"ts",dark:!0})]}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-tabs.html",rel:"nofollow",children:"Legacy Demo - Tabs"})})]})}function N(a={}){const{wrapper:t}={...x(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(k,{...a})}):k(a)}function j(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}let b=0;const I=()=>{const a=document.createElement("div");a.innerHTML='<vl-tabs-pane id="fiets-'+b+'" title="Fiets '+b+'">TEST '+b+"</vl-tabs-pane>",a.firstElementChild&&(document.querySelector("vl-tabs#tabs")?.appendChild(a.firstElementChild),b++)},F={id:"components-block-tabs-tabs",title:"Components - Block/tabs/tabs",tags:["autodocs"],args:n,argTypes:P,parameters:{docs:{page:N}}};q([$,w]);const l=g(n,({activeTab:a,alt:t,disableLinks:s,responsiveLabel:i,onChangeActiveTab:c,onClickActiveTab:u,displayStyle:p})=>h`
        <vl-tabs
            active-tab=${a}
            display-style=${p}
            ?alt=${t}
    ...
    `);d.storyName="vl-tabs - without active tab";d.args={responsiveLabel:"Navigatie/menu"};const r=g(n,({activeTab:a,alt:t,disableLinks:s,responsiveLabel:i,onChangeActiveTab:c,displayStyle:u})=>h`
        <div>
            <vl-button id="add-pane-button" @click=${I}>Pane toevoegen</vl-button>
            <vl-tabs
                id="tabs"
                active-tab=${a}
                display-style=${u}
  ...
  displayStyle
    ...
    \`)`,...r.parameters?.docs?.source}}};const R=["TabsDefault","TabsWithoutActiveTab","TabsDynamic"];export{l as TabsDefault,r as TabsDynamic,d as TabsWithoutActiveTab,R as __namedExportsOrder,F as default};
