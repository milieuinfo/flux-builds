import{u as r,j as e,M as i,C as p,S as l}from"./iframe-BRJWU34U.js";import{p as c,M as s}from"./popover-menu.stories-u6YrBzdo.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-popover-menu-info-tile.component-B1cBYBM8.js";const a=`import { registerWebComponents, webComponent } from '@domg-wc/common';
...
`;function t(o){const n={h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:c}),`
...
`,e.jsx(p,{of:s,sourceState:"none"}),`
`,e.jsxs("details",{open:!0,children:[e.jsx("summary",{children:"Code"}),e.jsx(l,{code:a,language:"ts",dark:!0})]})]})}function h(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{h as default};
