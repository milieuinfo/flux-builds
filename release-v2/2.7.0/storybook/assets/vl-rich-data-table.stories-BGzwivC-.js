...
`,X=`import richDataFilterData from './vl-rich-data-table-filter.stories-mock';
...
`,G=`export const richDataFilterData = {
    data: [
        {
            id: 0,
            name: 'Wegen',
...
`,a.jsxs("details",{children:[a.jsx("summary",{children:"gebruikte mock data in onderstaande voorbeeld"}),a.jsx(N,{code:G,language:"ts",dark:!0})]}),`
`,a.jsxs("details",{children:[a.jsx("summary",{children:"code voorbeeld hoe filtering toe te passen"}),a.jsx(N,{code:X,language:"ts",dark:!0})]}),`
...
`,a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-rich-data-table.html",rel:"nofollow",children:"Legacy Demo - Rich Data Table"})]})]})}function _(n={}){const{wrapper:e}={...T(),...n.components};return e?a.jsx(e,{...n,children:a.jsx(D,{...n})}):D(n)}function U(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}B([$,V,M,E,q,z,I]);const ie={id:"components-block-rich-data-table",title:"Components - Block/rich-data-table",tags:["autodocs"],args:f,argTypes:W,parameters:{docs:{page:_}}},Y=j(f,({collapsedM:n,collapsedS:e,collapsedXS:d,zebra:i,fluxZebra:l})=>P`
        <vl-rich-data-table
