import{u as y,j as e,C as p,bd as b,s as k,x as h}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import{m as x,a as d}from"./vl-map-baselayer.stories-arg-BZIBM8wX.js";import"./preload-helper-D9Z9MdNV.js";function c(r){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...y(),...r.components},{FluxMetaData:o}=a;return o||$("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"map-baselayer",children:"Map Baselayer"}),`
`,e.jsx(o,{id:"map-baselayer"}),`
...
`,e.jsx(a.p,{children:e.jsx(a.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMapBaseLayer.html",rel:"nofollow",children:"Legacy Documentatie - Map Base Layer"})})]})}function v(r={}){const{wrapper:a}={...y(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(c,{...r})}):c(r)}function $(r,a){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const M={id:"map-baselayer",title:"map/baselayer",tags:["autodocs"],args:d,argTypes:x,parameters:{docs:{page:v}}},l=k(d,({backgroundLayer:r,backgroundType:a,backgroundOptions:o,layer:i,title:m,type:u,url:g})=>h`
        <vl-map lambert2008>
            <vl-map-baselayer
                ?background-layer=${r}
                background-type=${a}
