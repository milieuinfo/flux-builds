import{K as i,L as l,P as p,H as m,I as d,u as s,j as e,C as u,bd as g,s as h,x as y}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import{D as x,a as f}from"./vl-map-current-location-ordnqffI.js";import"./preload-helper-D9Z9MdNV.js";const r={...d,tooltip:x,zoom:f},v={...m,tooltip:{name:"tooltip",description:"Bepaalt de tekst van de tooltip van de huidige locatie knop.",table:{type:{summary:l.STRING},category:i.ATTRIBUTES,defaultValue:{summary:r.tooltip}}},zoom:{name:"zoom",description:"Bepaalt hoever er ingezoomd wordt bij het klikken op de huidige locatie knop.",control:{type:p.RANGE,min:1,max:13,step:1},table:{type:{summary:l.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(r.zoom)}}}};function c(t){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...t.components},{FluxMetaData:n}=o;return n||j("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"map-current-location",children:"Map Current Location"}),`
`,e.jsx(n,{id:"map-current-location"}),`
