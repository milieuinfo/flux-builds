import{H as l,I as s,x as o,r as i,bc as r,aX as n}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const f={...s,center:!1,stretch:!1},d={...l,center:{name:"v-center",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content verticaal gecentreerd wordt.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},stretch:{name:"v-stretch",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content 100% zal innemen.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}}};i([r,n]);const u={id:"components-block-template",title:"Components - Block/template",tags:["autodocs"],args:f,argTypes:d},m="1.2.3",c=o`
    <vl-content-header>
        <img
            slot="image"
