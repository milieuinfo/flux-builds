...
`,o.jsx(e.p,{children:o.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-cookie-consent.html",rel:"nofollow",children:"Legacy Demo - Cookie Consent"})})]})}function v(n={}){const{wrapper:e}={...l(),...n.components};return e?o.jsx(e,{...n,children:o.jsx(c,{...n})}):c(n)}function w(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const N={id:"components-compliance-cookie-consent",title:"Components - Compliance/cookie-consent",tags:["autodocs"],args:t,argTypes:f,parameters:{layout:"fullscreen",docs:{page:v}}},r=b(t,({analytics:n,autoOptInFunctionalDisabled:e,owner:s,link:m,matomoId:d,matomoUrl:u,onClose:p})=>y`
            <div>
                <vl-cookie-consent
                    id="cookie-consent"
                    analytics=${n}
  ...
  onClose
        ...
        \`)`,...r.parameters?.docs?.source}}};const _=["CookieConsentDefault"];export{r as CookieConsentDefault,_ as __namedExportsOrder,N as default};
