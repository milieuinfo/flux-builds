...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-alert.html",rel:"nofollow",children:"Legacy Demo - Alert"})})]})}function K(o={}){const{wrapper:t}={...C(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(x,{...o})}):x(o)}function q(o,t){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}G([_]);const Q={id:"components-block-alert",title:"Components - Block/alert",tags:["autodocs"],args:n,argTypes:P,parameters:{docs:{page:K}}},s=D(n,({closable:o,icon:t,title:v,size:M,type:N,naked:w,message:z,defaultSlot:E,actionsSlot:H,titleSlot:R,alertClosed:I})=>U`
        <vl-alert
            ?closable=${o}
            ?naked=${w}
            icon=${t}
  ...
  alertClosed
    ...
    \`)`,...b.parameters?.docs?.source}}};const Z=["AlertDefault","AlertError","AlertInfo","AlertSuccess","AlertWarning","AlertWithButton","AlertWithTitleSlot","AlertCloseable","AlertNakedError","AlertNakedWarning","AlertNakedSuccess"];export{d as AlertCloseable,c as AlertDefault,m as AlertError,p as AlertInfo,h as AlertNakedError,b as AlertNakedSuccess,$ as AlertNakedWarning,g as AlertSuccess,f as AlertWarning,y as AlertWithButton,S as AlertWithTitleSlot,Z as __namedExportsOrder,Q as default};
