import{I as T,H as P,cf as H,K as i,Q as E,P as k,L as d,cg as w,bJ as $,u as V,j as e,C as j,bd as B,S as A,s as g,x as h,r as _,bz as I,ch as N,ci as q,h as M}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const f={...T,selected:!1};({...P,selected:String(f.selected)});const r={...T,...H},Z={...P,for:{name:"for",description:"HTML id van het element die de popover zal triggeren en waar tegenover de popover zich zal oriënteren.",type:{name:d.STRING,required:!0},table:{type:{summary:d.STRING},category:i.PROPERTIES,defaultValue:{summary:r.for}}},open:{name:"open",description:"Bepaalt of de popover open is.",table:{type:{summary:d.BOOLEAN},category:i.PROPERTIES,defaultValue:{summary:String(r.open)}}},hideArrow:{name:"hide-arrow",description:"Verbergt de pijl die wijst naar het element die de popover triggert.",table:{type:{summary:d.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.hideArrow)}}},hideOnClick:{name:"hide-on-click",description:"Verbergt popover wanneer op de content wordt geklikt. Niet reactief.",table:{type:{summary:d.BOOLEAN},category:i.ATTRIBUTES,defaultValue:{summary:String(r.hideOnClick)}}},distance:{name:"distance",description:"Afstand van de popover tegenover het trigger element.",control:{type:k.RANGE,min:0,max:100,step:1},table:{type:{summary:d.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(r.distance)}}},contentPadding:{name:"content-padding",description:"De grootte van de padding van de content.<br>Deze padding wordt toegepast op zowel desktop als mobile.",control:{type:k.SELECT},options:[...Object.keys($)],table:{type:{summary:E(Object.keys($))},category:i.ATTRIBUTES,defaultValue:{summary:r.contentPadding}}},placement:{name:"placement",description:"Voorkeursoriëntatie van de popover als de ruimte het toelaat. Je kan ook `-start` of `-end` suffix toevoegen zodat oriëntatie start of eindigt aan respectievelijk begin of einde van het trigger element.<br />[Raadpleeg de placement documentatie van floating-ui](https://floating-ui.com/docs/tutorial#placements).",table:{type:{summary:"top | right | bottom | left"},category:i.ATTRIBUTES,defaultValue:{summary:r.placement}}},trigger:{name:"trigger",description:"Gebruiker interacties die popover zal triggeren. Je kan verschillende combineren door ze met een spatie naast mekaar te zetten. Bv. met `focus hover` zal de popover zowel verschijnen bij focus als bij hover.",table:{type:{summary:"click | focus | hover"},category:i.ATTRIBUTES,defaultValue:{summary:r.trigger}}},strategy:{name:"strategy",description:"Positioneringsstrategie van de popover.<br />[Raadpleeg de strategy documentatie van floating-ui](https://floating-ui.com/docs/computePosition#strategy).",control:{type:k.SELECT},options:Object.values(w),table:{type:{summary:E(Object.values(w))},category:i.ATTRIBUTES,defaultValue:{summary:r.strategy}}}};function C(t){const o={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...V(),...t.components},{FluxAlert:c,FluxMetaData:n}=o;return c||S("FluxAlert"),n||S("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(o.h1,{id:"popover",children:"Popover"}),`
...
Het doel van de popover is het bouwen van context- of submenu's. Je kan deze menu's opbouwen adhv de `,e.jsx(o.code,{children:"vl-popover-action-list"})," en ",e.jsx(o.code,{children:"vl-popover-action"})," componenten. De popover kan ook andere interactieve HTML-elementen bevatten."]}),`
...
`,e.jsx(o.p,{children:e.jsx(o.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/js-components/vl-ui-popover",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Popover"})})]})}function G(t={}){const{wrapper:o}={...V(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(C,{...t})}):C(t)}function S(t,o){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const{action:y}=__STORYBOOK_MODULE_ACTIONS__;_([I,N,q,M]);const Y={id:"components-block-popover",title:"Components - Block/popover",tags:["autodocs"],args:r,argTypes:Z,parameters:{docs:{page:G}}},z=t=>h` <div style="position: relative;min-height: 150px;">${t()}</div>`,R=g(r,({trigger:t,contentPadding:o,open:c,placement:n,hideArrow:b,hideOnClick:l,distance:L,strategy:O})=>h`
            ...
            <vl-popover
                ...
                content-padding=${o}
            >
                <vl-popover-action-list @click=${D=>{const u=D.target;y("click")("vl-popover-action clicked > "+u.action),Array.from(u.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(x=>{x!==u&&x.removeAttribute("selected")}),u.setAttribute("selected","")}}>
        ...
        `),a=R.bind({});a.storyName="vl-popover - default";a.decorators=[z];a.args={placement:"bottom-start"};const p=R.bind({});p.storyName="vl-popover - hover";p.decorators=[z];p.args={trigger:"focus hover"};const s=g(f,({selected:t})=>h`
        <vl-popover-action-list @click=${c=>{const n=c.target;y("click")("vl-popover-action clicked > "+n.action,n),Array.from(n.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(l=>{l!==n&&l.removeAttribute("selected")}),n.setAttribute("selected","")}}>
    ...
    `);s.storyName="vl-popover - actions";s.parameters={controls:{include:["selected"]}};const v=g(f,({selected:t})=>h`
        <vl-popover-action-list @click=${c=>{const n=c.target;y("click")("vl-popover-action clicked > "+n.action),Array.from(n.parentElement?.querySelectorAll("vl-popover-action")||[]).forEach(l=>{l!==n&&l.removeAttribute("selected")}),n.setAttribute("selected","")}}>
            <vl-popover-action ?selected=${t} icon="search" action="zoeken">Zoeken</vl-popover-action>
            <vl-popover-action icon="bell" action="rapporten-tonen">Rapportenoverzicht</vl-popover-action>
            <vl-popover-action icon="pin" action="locatie-vinden">Vind locatie</vl-popover-action>
            <hr class="vl-separator" />
    ...
    `);v.storyName="vl-popover - actions divider";v.parameters={controls:{include:["selected"]}};const m=g(f,({selected:t})=>h`
        <vl-popover-action-list>
            <vl-popover-action
                ?selected=${t}
                icon="search"
  ...
  return html\`
        ...
        \`;
})`,...a.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`story(popoverDefaultArgs, ({
  trigger,
  contentPadding,
  open,
  placement,
  ...
  return html\`
        ...
        \`;
})`,...p.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(popoverActionArgs, ({
  selected
}) => {
  const actionListClickHandler = (event: CustomEvent) => {
    const actionElement = event.target as VlPopoverActionComponent;
  ...
  return html\`
    ...
    \`;
})`,...v.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`story(popoverActionArgs, ({
  selected
}) => {
  return html\`
        <vl-popover-action-list>
    ...
    \`;
})`,...m.parameters?.docs?.source}}};const K=["PopoverDefault","PopoverHover","PopoverActions","PopoverActionsDivider","PopoverActionsLinks"];export{s as PopoverActions,v as PopoverActionsDivider,m as PopoverActionsLinks,a as PopoverDefault,p as PopoverHover,K as __namedExportsOrder,Y as default};
