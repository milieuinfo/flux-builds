import{K as i,L as c,P as B,u as S,j as e,C as j,bd as D,s as F,x as P}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-features-layer-B_ClZkbk.js";import"./vl-map-layer-circle-style-BYHuRewh.js";import{m as A,a as k}from"./vl-map-layer-style.stories-arg-Dn5UhR2K.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-BFohRpWd.js";const o={...k,borderColor:"rgba(0, 0, 0, 0)",clusterColor:"rgba(2, 85, 204, 1)",clusterTextColor:"#FFF",clusterMultiplier:1,size:5},L={...A,borderColor:{name:"border-color",description:"De kleur van de rand van de kaartlaagstijl.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.borderColor}}},clusterColor:{name:"cluster-color",description:"De kleur bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterColor}}},clusterMultiplier:{name:"cluster-multiplier",description:"Bepaalt de verhouding van de vergroting voor clusters tegenover ingestelde `size`.",control:{type:B.NUMBER,step:.1},table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.clusterMultiplier)}}},clusterTextColor:{name:"cluster-text-color",description:"De kleur van de tekst bij het clusteren van features.",table:{type:{summary:c.STRING},category:i.ATTRIBUTES,defaultValue:{summary:o.clusterTextColor}}},size:{name:"size",description:"De grootte van de cirkels.",table:{type:{summary:c.NUMBER},category:i.ATTRIBUTES,defaultValue:{summary:String(o.size)}}}};function z(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...S(),...r.components},{FluxMetaData:s}=t;return s||N("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"map-layer-circle-style",children:"Map Layer Circle Style"}),`
`,e.jsx(s,{id:"map-layer-style-layer-circle-style"}),`
...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-circle-style.html",rel:"nofollow",children:"Legacy Demo - Map Layer Circle Style"})})]})}function E(r={}){const{wrapper:t}={...S(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(z,{...r})}):z(r)}function N(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const Y={id:"map-layer-style-layer-circle-style",title:"map/layer-style/layer-circle-style",tags:["autodocs"],args:o,argTypes:L,parameters:{docs:{page:E}}},T=F(o,({borderColor:r,borderSize:t,clusterColor:s,clusterTextColor:p,clusterMultiplier:y,color:u,name:d,size:m,textBackgroundColor:x,textBorderColor:b,textBorderSize:f,textColor:g,textFeatureAttributeName:C,textOffsetX:v,textOffsetY:h,textSize:$})=>P` <vl-map lambert2008>
