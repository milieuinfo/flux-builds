import{K as d,L as h,H as p,I as v,u as i,j as e,C as n,bd as m,x as c,r as b,c0 as x,c1 as g,c2 as V}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const u={...v,defaultSlot:""},k={...p,defaultSlot:{name:"[default]",description:"De inhoud van het zoekresultaat",table:{type:{summary:h.HTML},category:d.SLOTS,defaultValue:{summary:u.defaultSlot}}}};function o(a){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...a.components},{FluxMetaData:s}=r;return s||f("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(r.h1,{id:"search-result",children:"Search Result"}),`
...
`,e.jsx(r.a,{href:"/docs/styles-layout-afnemers-group--documentatie",children:"Group"})," layout."]}),`
`,e.jsx(n,{of:l}),`
`,e.jsx(r.h2,{id:"referenties",children:"Referenties"}),`
`,e.jsx(r.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),`
`,e.jsx(r.p,{children:e.jsx(r.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-search-results",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Search Results"})})]})}function j(a={}){const{wrapper:r}={...i(),...a.components};return r?e.jsx(r,{...a,children:e.jsx(o,{...a})}):o(a)}function f(a,r){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const y={id:"components-block-search-result",title:"Components - Block/search-result",tags:["autodocs"],args:u,argTypes:k,parameters:{docs:{page:j}}};b([x,g,V]);const t=()=>c`
    <vl-search-result>
...
\``,...l.parameters?.docs?.source}}};const M=["SearchResultDefault","SearchResultGroup"];export{t as SearchResultDefault,l as SearchResultGroup,M as __namedExportsOrder,y as default};
