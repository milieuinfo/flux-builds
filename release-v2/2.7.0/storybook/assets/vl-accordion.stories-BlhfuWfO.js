...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-accordion.html",rel:"nofollow",children:"Legacy Demo - Accordion"})})]})}function U(a={}){const{wrapper:n}={...S(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(f,{...a})}):f(a)}function G(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}P([N,R]);const W={id:"components-block-accordion",title:"Components - Block/accordion",tags:["autodocs"],args:t,argTypes:_,parameters:{docs:{page:U}}},m=D(t,({bold:a,closeToggleText:n,contentPadding:b,disabled:x,defaultOpen:h,icon:$,openToggleText:j,toggleText:y,defaultSlot:k,titleSlot:w,subtitleSlot:L,menuSlot:A,onToggle:O})=>V`
        <vl-accordion
            ?bold=${a}
            content-padding=${b}
            close-toggle-text=${n}
