import{u as s,j as a,C as l,bd as v,s as c,x as m}from"./iframe-BRJWU34U.js";import"./vl-map-base-layer-mxB9Jgb1.js";import"./vl-map-base-layer-grb-gray-Di19ej0R.js";import"./vl-map-layer-circle-style-BYHuRewh.js";import"./vl-map-features-layer-B_ClZkbk.js";import"./vl-map-wfs-layer-DkWiFLJM.js";import{m as y,a as i}from"./vl-map-draw-action.stories-arg-C721WnLP.js";import"./vl-map-draw-point-action-C4gpWcG4.js";import"./preload-helper-D9Z9MdNV.js";import"./vl-map-vector-layer-BFohRpWd.js";import"./vl-map-action.stories-arg-CeHGMlwy.js";import"./vl-map-draw-action-DKMqKN8Y.js";import"./vl-map-layer-action-2JAAiOGD.js";import"./composite-vector-layer-BuQYujkN.js";function p(n){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components},{FluxMetaData:o}=e;return o||u("FluxMetaData"),a.jsxs(a.Fragment,{children:[a.jsx(e.h1,{id:"map-draw-point-action",children:"Map Draw Point Action"}),`
`,a.jsx(o,{id:"map-action-draw-action-draw-point-action"}),`
...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map-draw-actions.html",rel:"nofollow",children:"Legacy Demo - Map Draw Point Action"})})]})}function g(n={}){const{wrapper:e}={...s(),...n.components};return e?a.jsx(e,{...n,children:a.jsx(p,{...n})}):p(n)}function u(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const V={id:"map-action-draw-action-draw-point-action",title:"map/action/draw-action/draw-point-action",tags:["autodocs"],args:i,argTypes:y,parameters:{docs:{page:g}}},r=c(i,({active:n,defaultActive:e})=>m`
        <vl-map lambert2008>
  ...
  snappingPixelTolerance
    ...
    \`)`,...t.parameters?.docs?.source}}};const z=["MapDrawPointActionDefault","MapDrawPointActionSnapping"];export{r as MapDrawPointActionDefault,t as MapDrawPointActionSnapping,z as __namedExportsOrder,V as default};
