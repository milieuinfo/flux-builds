import{u as p,j as l,M as x,S as u,cT as h,C as r,cU as v,cV as a,cW as t,z as f,x as m,r as b,b as j,V as y,h as S}from"./iframe-BRJWU34U.js";import"./vl-checkbox.component-hEBJWAHV.js";import"./vl-datepicker.component-BaFRo2zZ.js";import"./vl-input-field-masked.component-BxETAt31.js";import"./vl-radio.component-OOpp9DdI.js";import"./vl-radio-group.component-B-OVdapL.js";import"./vl-select.component-CH2R68DQ.js";import"./vl-select-rich.component-BMxQbxL4.js";import"./vl-textarea.component-s96ZCi9E.js";import"./vl-textarea-rich.component-DNWjl1dl.js";import"./vl-upload.component-DzlL03XT.js";import"./preload-helper-D9Z9MdNV.js";import"./cleave-esm-DfUhcNrv.js";const w=""+new URL("grid-large-uKz8Dn73.png",import.meta.url).href,k=""+new URL("grid-medium-DzNcUqr3.png",import.meta.url).href,z=""+new URL("grid-small-C8fouyyk.png",import.meta.url).href,M=""+new URL("grid-extra-small-CfB2bL1s.png",import.meta.url).href,C=""+new URL("css-large-BCbHcJ27.png",import.meta.url).href,$=""+new URL("css-medium-B1Gfoyhz.png",import.meta.url).href,L=""+new URL("css-small-DRqYjDPH.png",import.meta.url).href,G=""+new URL("css-extra-small-DJX17tHm.png",import.meta.url).href,E=`import gridRawCss from './vl-grid.raw.css?raw';
...
\`;
`;function g(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...p(),...s.components},{FluxMetaData:d}=n;return d||_("FluxMetaData"),l.jsxs(l.Fragment,{children:[l.jsx(x,{title:"Styles/Layout (afnemers)/grid"}),`
`,l.jsx(n.h1,{id:"grid",children:"Grid"}),`
`,l.jsx(d,{id:"styles-layout-afnemers-grid"}),`
`,l.jsx("br",{}),`
...
`,l.jsx("img",{src:w,alt:"grid large",style:{maxWidth:"600px"}}),`
`,l.jsx("br",{}),`
`,l.jsx("img",{src:C,alt:"css large",style:{maxWidth:"600px"}}),`
`,l.jsx(n.h3,{id:"medium-1023",children:"Medium (<1023)"}),`
`,l.jsx("img",{src:k,alt:"grid medium",style:{maxWidth:"500px"}}),`
`,l.jsx("br",{}),`
...
`,l.jsx("br",{}),`
`,l.jsx("img",{src:G,alt:"css extra small",style:{maxWidth:"600px"}}),`
...
`})}),`
`,l.jsx(r,{of:i})]})}function R(s={}){const{wrapper:n}={...p(),...s.components};return n?l.jsx(n,{...s,children:l.jsx(g,{...s})}):g(s)}function _(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const D=f`
    .vl-grid {
...
`;b([j,y,S]);const K={id:"styles-layout-afnemers-grid",title:"Styles/Layout (afnemers)/grid",tags:["autodocs"],parameters:{docs:{page:R}}},c=()=>m`
    <style>
...
`;c.storyName="vl-grid - responsive";const e=()=>m`
    <style>
...
`;e.storyName="vl-grid - column start";const o=()=>m`
    <style>
        .vl-grid {
...
`;o.storyName="vl-grid - justify / align";const i=()=>m`
    <style>
...
\``,...c.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => html\`
    <style>
        #story--styles-layout-afnemers-grid--grid-column-start-inner {
            .vl-grid {
                --vl-column-min-height: 20px;
...
\``,...i.parameters?.docs?.source}}};const P=["GridResponsive","GridColumnStart","GridJustifyAlign","GridWithForm"];export{e as GridColumnStart,o as GridJustifyAlign,c as GridResponsive,i as GridWithForm,P as __namedExportsOrder,K as default};
