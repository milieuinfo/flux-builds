import{u as c,j as e,M as d,C as l,x as p,r as g,h as v,V as h}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";function a(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...c(),...t.components},{FluxMetaData:s}=n;return s||b("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Form/input-group"}),`
`,e.jsx(n.h1,{id:"input-group",children:"Input Group"}),`
`,e.jsx(s,{id:"components-form-input-group"}),`
`,e.jsxs(n.p,{children:["De ",e.jsx(n.code,{children:"Input Group [next]"})," combineert een ",e.jsx(n.code,{children:"Input Field [next]"})," met een ",e.jsx(n.code,{children:"Button [next]"}),`. Deze combinatie kan eender waar
gebruikt worden, het moet niet persé in een formulier! `,e.jsx(n.code,{children:"Input Group [next]"}),` is geen aparte component:
`,e.jsx(n.a,{href:"/docs/styles-layout-afnemers-group--documentatie",children:"Group [next]"}),", ",e.jsx(n.a,{href:"/docs/components-atom-button--documentatie",children:"Button [next]"}),`
en `,e.jsx(n.a,{href:"/docs/components-form-input-field--documentatie",children:"Input Field [next]"}),` kunnen in de juiste toestand gebracht worden om
...
`,e.jsx(l,{of:u})]})}function m(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}function b(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}g([v,h]);const j={id:"components-form-input-group",title:"Components - Form/input-group",tags:["autodocs"],parameters:{docs:{page:m}}},o=()=>p`
...
\``,...u.parameters?.docs?.source}}};const k=["InputGroupButtonLeft","InputGroupButtonRight","InputGroupIconLeft","InputGroupIconRight"];export{o as InputGroupButtonLeft,i as InputGroupButtonRight,r as InputGroupIconLeft,u as InputGroupIconRight,k as __namedExportsOrder,j as default};
