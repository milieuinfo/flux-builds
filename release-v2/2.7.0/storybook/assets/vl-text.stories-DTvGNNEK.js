...
`,n.jsx(s,{of:$})]})}function H(t={}){const{wrapper:e}={...b(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(S,{...t})}):S(t)}function C(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}O([M]);const _={id:"components-atom-text",title:"Components - Atom/text",tags:["autodocs"],args:T,argTypes:V,parameters:{docs:{page:H}}},l=B(T,({bold:t,success:e,warning:f,error:y,italic:h,underline:w,annotation:j,small:v,defaultSlot:A})=>N`
        <vl-text
            ?bold=${t}
            ?success=${e}
            ?warning=${f}
