import{K as h,L as u,H as g,cj as x,I as j,u as v,j as r,C as p,bd as f,s as d,x as c,r as w,J as y,ca as P}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const s={...j,...x},k={...g,labelWidth:{name:"label-width",description:"De breedte van de labels, in %. Heeft geen impact als de properties 'collapsed' worden.",table:{type:{summary:u.NUMBER},category:h.ATTRIBUTES,defaultValue:{summary:String(s.labelWidth)}}},props:{name:"props",description:"De props in JSON formaat.",table:{type:{summary:u.ARRAY},category:h.PROPERTIES,defaultValue:{summary:String(s.props)}}}};function b(n){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...v(),...n.components},{FluxMetaData:m}=e;return m||C("FluxMetaData"),r.jsxs(r.Fragment,{children:[r.jsx(e.h1,{id:"properties",children:"Properties"}),`
...
component van Digitaal Vlaanderen.`]})]})}function W(n={}){const{wrapper:e}={...v(),...n.components};return e?r.jsx(e,{...n,children:r.jsx(b,{...n})}):b(n)}function C(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const S=[{class:"column",items:[{labels:["Straat"],data:["Appelstraat","Perenstraat"]}]}],$=[{class:"column",items:[{labels:["Gemeente"],data:["Antwerpen","Berchem"]}]}];w([y,P]);const M={id:"components-block-properties",title:"Components - Block/properties",tags:["autodocs"],args:s,argTypes:k,parameters:{docs:{page:W}}},A=d(s,({labelWidth:n,props:e})=>c`
    ...
    `),D=d(s,({labelWidth:n,props:e})=>c` <vl-properties label-width=${n} .props=${e}></vl-properties> `),a=A.bind({});a.storyName="vl-properties - default";const o=D.bind({});o.storyName="vl-properties - with props";o.args={props:[...S,...$]};const l=d(s,({labelWidth:n,props:e})=>c`
        <vl-properties label-width=${n} .props=${e}>
            <label>
    ...
    `);l.storyName="vl-properties - html enriched";const t=d(s,({labelWidth:n,props:e})=>c`
        <vl-properties label-width=${n} .props=${e}>
            <div class="collapsed">
                <label>Woonplaats</label>
                <data>Brussel</data>
    ...
    `);t.storyName="vl-properties - collapsed";const i=d(s,({labelWidth:n,props:e})=>c`
        <vl-properties label-width=${n} .props=${e}>
            <div class="column">
                <label>Woonplaats</label>
                <data>Brussel</data>
  ...
  props
    ...
    \`)`,...i.parameters?.docs?.source}}};const N=["PropertiesDefault","PropertiesWithProps","PropertiesHtmlEnriched","PropertiesCollapsed","PropertiesColumns"];export{t as PropertiesCollapsed,i as PropertiesColumns,a as PropertiesDefault,l as PropertiesHtmlEnriched,o as PropertiesWithProps,N as __namedExportsOrder,M as default};
