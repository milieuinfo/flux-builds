import{g as b,x as D,z as j,r as h,J as w,aX as v,y as s,D as f,E as y,cC as A,cD as z,cE as V,m as G,b8 as E,aY as x,aH as P,cG as I,bx as M,cF as H,cR as T}from"./iframe-BRJWU34U.js";const $=()=>[b],B=()=>D`
...
`;var L=Object.getOwnPropertyDescriptor,F=(n,i,o,a)=>{for(var e=a>1?void 0:a?L(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let r=class extends f{constructor({title:n,name:i,purpose:o,domain:a,processor:e,validity:t}={}){const l="<div></div>",S=[...y.map(d=>d.styleSheet),O.styleSheet];super(l,S);const C=()=>{const d=i||this.getAttribute("name");return Array.isArray(d)?`
                    <vl-typography>
                        <ul>
                ...
                <vl-title type="h3">${n||this.getAttribute("title")}</vl-title>
                <vl-properties slot="properties">
                    ...
                    <data>${t||this.getAttribute("validity")}</data>
                </vl-properties>
            `)}};h([w,v]);r=F([s("vl-cookie")],r);var N=Object.getOwnPropertyDescriptor,Y=(n,i,o,a)=>{for(var e=a>1?void 0:a?N(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let c=class extends r{constructor(){super({title:"Departement Omgeving toegangsbeheer cookies",name:["KEYCLOAK_SESSION","KEYCLOAK_SESSION_LEGACY"],purpose:"Sessiegebaseerde cookies die het mogelijk maken om gebruikers te herkennen op een webpagina van Departement Omgeving.",domain:window.location.hostname,processor:"Departement Omgeving",validity:"10 uur"})}};c=Y([s("vl-authentication-cookie")],c);var K=Object.getOwnPropertyDescriptor,U=(n,i,o,a)=>{for(var e=a>1?void 0:a?K(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let p=class extends r{constructor(){super({title:"Vlaams toegangsbeheer cookies",name:["AMWEBJCT!%2Fsps!JSESSIONID","https%3A%2F%2Fauthenticatie.vlaanderen.be%2Fsps%2Fvidp%2Fsaml20FIMSAML20","PD_STATEFUL_5bb64e42-0d53-11e2-a712-52540052f0ed","PD-H-SESSION-ID","tbsession"],purpose:"Sessiegebaseerde cookies die het mogelijk maken om gebruikers te herkennen op een webpagina van het Vlaams toegangsbeheer.",domain:"authenticatie.vlaanderen.be",processor:"Vlaamse overheid",validity:"Sessie"})}};p=U([s("vl-header-authentication-cookie")],p);var W=Object.getOwnPropertyDescriptor,J=(n,i,o,a)=>{for(var e=a>1?void 0:a?W(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let k=class extends r{constructor(){super({title:"Vlaanderen header cookie",name:"VOGANONUSER",purpose:"De Reverse Proxy van de Vlaamse overheid plaats dit cookie in kader van de Vlaanderen header op Vlaanderen.be om de goede uitvoering van de verzending van communicatie over een elektronisch communicatienetwerk van de Vlaamse overheid te verzekeren.",domain:"vlaanderen.be",processor:"Vlaamse overheid",validity:"Permanente cookies met een geldigheid van maximaal 24 uur"})}};k=J([s("vl-header-cookie")],k);var R=Object.getOwnPropertyDescriptor,q=(n,i,o,a)=>{for(var e=a>1?void 0:a?R(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let m=class extends r{constructor(){super({title:"Sessie cookie voor betere gebruikerservaring",name:["JSESSIONID","KEYCLOAK_IDENTITY","KEYCLOAK_IDENTITY_LEGACY"],purpose:"De cookie wordt gebruikt om een sessie tussen de applicatieserver en een gebruiker in stand te houden. Dankzij deze cookie kan een gebruiker door de server op een uniek manier geïdentificeerd worden.",domain:window.location.hostname,processor:"Departement Omgeving",validity:"Beperkt tot de duur van de sessie"})}};m=q([s("vl-jsessionid-cookie")],m);var X=Object.getOwnPropertyDescriptor,Q=(n,i,o,a)=>{for(var e=a>1?void 0:a?X(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let u=class extends r{constructor(){super({title:"Persistentie sessie cookie voor betere gebruikerservaring",name:['BIGipServerPool-AUTO-* (vb. "BIGipServerPOOL-AUTO-app=2016879114.37407.0000")','BIGipServerPool-sso-pr-* (vb. "BIGipServerPOOL-sso-pr-app=2016879114.37407.0000")'],purpose:'Dankzij de cookie kan er verzekerd worden dat verzoeken van een gebruiker voor de duur van een sessie worden gedistribueerd naar de server waarop ze zijn gestart. De cookies worden daarom vaak beschreven als "sticky sessions". Hierdoor kan een betere gebruikerservaring gerealiseerd worden. Bovendien kan de infrastructuur optimaal gebruikt worden.',domain:window.location.hostname,processor:"Departement Omgeving",validity:"Beperkt tot de duur van de sessie"})}};u=Q([s("vl-sticky-session-cookie")],u);var Z=Object.getOwnPropertyDescriptor,ee=(n,i,o,a)=>{for(var e=a>1?void 0:a?Z(i,o):i,t=n.length-1,l;t>=0;t--)(l=n[t])&&(e=l(e)||e);return e};let g=class extends f{constructor(){const n=`
            <slot name="header"></slot>
        `,i=[P.styleSheet,...y.map(a=>a.styleSheet),O.styleSheet,I.styleSheet,M.styleSheet,H.styleSheet];super(n,i);const o=this.shadowRoot?.querySelector('slot[name="header"]');o&&T(B(),o),this.allowCustomCSS=!1,this._element.insertAdjacentHTML("afterend",`
            ...
            `)}static get _observedAttributes(){return["date","disable-back-link","hide-back-link","version"]}_versionChangedCallback(n,i){const o=this._shadow?.getElementById("introduction-version");o.innerText=i}_dateChangedCallback(n,i){const o=this._shadow?.getElementById("introduction-date");o.innerText=i}_disableBackLinkChangedCallback(){const n=this._shadow?.querySelector("vl-functional-header");this.hasAttribute("disable-back-link")?n?.setAttribute("disable-back-link",""):n?.removeAttribute("disable-back-link")}_hideBackLinkChangedCallback(){const n=this._shadow?.querySelector("vl-functional-header");this.hasAttribute("hide-back-link")?n?.setAttribute("hide-back-link",""):n?.removeAttribute("hide-back-link")}};h([A,z,w,V,G,v,E,x,b,v,...$()]);g=ee([s("vl-cookie-statement")],g);
