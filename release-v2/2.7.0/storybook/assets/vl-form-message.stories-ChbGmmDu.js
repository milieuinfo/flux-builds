import{K as a,L as d,H as g,c5 as u,I as f,u as l,j as e,C as h,bd as p,s as v,x as j,r as x,c as b}from"./iframe-BRJWU34U.js";import"./preload-helper-D9Z9MdNV.js";const r={...f,...u,defaultSlot:""},y={...g,for:{name:"for",description:"De id van het input element waarvoor de message getoond moet worden.",table:{category:a.ATTRIBUTES,type:{summary:d.STRING},defaultValue:{summary:String(r.for)}}},state:{name:"state",description:"De state van het input element waarvoor de message getoond moet worden.",table:{category:a.ATTRIBUTES,type:{summary:"ValidityState"},defaultValue:{summary:String(r.state)}}},show:{name:"show",description:"Duidt aan of de message getoond moet worden.<br>Dit kan gebruikt worden om de message manueel te tonen of te verbergen.",table:{category:a.ATTRIBUTES,type:{summary:d.BOOLEAN},defaultValue:{summary:String(r.show)}}},preLine:{name:"preLine",description:"Duidt aan of de nieuwe lijnen (`\n`) in de message behouden worden.",table:{category:a.ATTRIBUTES,type:{summary:d.BOOLEAN},defaultValue:{summary:String(r.preLine)}}},defaultSlot:{name:"[default]",description:"De inhoud van de message.",table:{type:{summary:d.HTML},category:a.SLOTS,defaultValue:{summary:r.defaultSlot}}}};function i(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...l(),...o.components},{FluxMetaData:t}=n;return t||D("FluxMetaData"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"form-message",children:"Form Message"}),`
`,e.jsx(t,{id:"components-form-form-message"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/forms/vl-ui-form-message",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Form Message"})})]})}function w(o={}){const{wrapper:n}={...l(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}function D(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}x([b]);const T={id:"components-form-form-message",title:"Components - Form/form-message",tags:["autodocs"],args:r,argTypes:y,parameters:{docs:{page:w}}},s=v(r,({for:o,state:n,show:t,preLine:m,defaultSlot:c})=>j`
        <vl-form-message
            for=${o}
            state=${n}
            ?show=${t}
        ...
        ></vl-form-message>
    `);s.storyName="vl-form-message - default";s.args={show:!0,defaultSlot:"Dit is een form message."};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`story(formMessageArgs, ({
  for: forValue,
  state,
  show,
  preLine,
  ...
  return html\`
        ...
        ></vl-form-message>
    \`;
})`,...s.parameters?.docs?.source}}};const k=["FormMessageDefault"];export{s as FormMessageDefault,k as __namedExportsOrder,T as default};
