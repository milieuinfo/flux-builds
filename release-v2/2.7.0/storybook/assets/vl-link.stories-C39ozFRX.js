...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-link",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Link"})})]})}function H(r={}){const{wrapper:n}={...x(),...r.components};return n?e.jsx(n,{...r,children:e.jsx($,{...r})}):$(r)}function U(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}R([C]);const W={id:"components-atom-link",title:"Components - Atom/link",tags:["autodocs"],args:l,argTypes:D,parameters:{docs:{page:H}}},o=I(l,({href:r,bold:n,small:h,large:v,error:y,external:S,buttonAsLink:L,icon:A,iconPlacement:j,defaultSlot:T,label:w})=>M`
            <vl-link
                href=${r}
                ?bold=${n}
                ?small=${h}
