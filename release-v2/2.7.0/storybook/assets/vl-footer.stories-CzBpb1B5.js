...
`,n.jsx(e.p,{children:n.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-footer.html",rel:"nofollow",children:"Legacy Demo - Footer"})})]})}function j(a={}){const{wrapper:e}={...c(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(s,{...a})}):s(a)}function p(a,e){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}h([v]);const D={id:"components-compliance-footer",title:"Components - Compliance/footer",tags:["autodocs"],args:i,argTypes:b,parameters:{docs:{page:j,inlineStories:!1},layout:"fullscreen"}},o=g(i,({identifier:a,development:e,onReady:t})=>f`
        <body>
            <vl-footer
                ?development=${e}
                identifier=${a}
    ...
    `);o.storyName="vl-footer - default";o.args={development:!0,identifier:"0337f8dc-3266-4e7a-8f4a-95fd65189e5b"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`story(footerArgs, ({
  identifier,
  development,
  onReady
}) => html\`
