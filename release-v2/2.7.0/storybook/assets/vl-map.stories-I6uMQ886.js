...
`,a.jsx(e.p,{children:a.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map.html",rel:"nofollow",children:"Legacy Demo - Map"})})]})}function K(t={}){const{wrapper:e}={...L(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(A,{...t})}):A(t)}function I(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const n=t=>G(`${t}-action`),i=t=>G(`${t}-toggle-button`),D=["draw-point","draw-line","draw-polygon","modify","delete"],G=t=>{const e=document.getElementsByClassName(t);return e[e.length-1]},B=({detail:{previous:t,current:e}})=>{D.forEach(o=>{t===n(o)?i(o).on=!1:e===n(o)&&(i(o).on=!0)})},C=({detail:{layer:t,visible:e}})=>{const o=t.getElementsByClassName("action");for(const s of o)D.forEach(d=>{s===n(d)&&(i(d).disabled=!e)})},O=({detail:{value:t}})=>{document.querySelectorAll("vl-map-features-layer")?.forEach(o=>{o.setAttribute("opacity",String(t/100))})};F([H]);const Le={id:"map-map",title:"map/map",tags:["autodocs"],args:r,argTypes:Z,parameters:{docs:{page:K}}},u=k(r,({allowFullscreen:t,disableEscape:e,disableRotation:o,disableMousewheelZoom:s,disableKeyboard:d,noBorder:v,fullHeight:g})=>E`
    ...
    `);b.storyName="vl-map - full height";b.args={noBorder:!0,fullHeight:!0};const p="rgba(102, 51, 153, 0.6)",V="width: 100%;",h="display: flex; gap: 1rem; align-items: center; margin-bottom: 1rem;",N={type:"FeatureCollection",features:[{type:"Feature",id:1,geometry:{type:"Point",coordinates:[21e4,19e4]}},{type:"Feature",id:2,geometry:{type:"LineString",coordinates:[[17e4,17e4],[15e4,206e3]]}},{type:"Feature",id:3,geometry:{type:"Polygon",coordinates:[[[44e3,171e3],[1e5,171e3],[1e5,205e3],[44e3,205e3],[44e3,171e3]]]}}]},y=k(r,({allowFullscreen:t,allowInvalidGeometry:e,disableEscape:o,disableRotation:s,disableMousewheelZoom:d,disableKeyboard:v,noBorder:g,fullHeight:j,activeActionChange:w,layerVisibleChange:x})=>E`
        <vl-map
            ...
            @vl-layer-visible-changed=${l=>{x(l.detail),C(l)}}
        >
  ...
  toaster.showAlert({
    ...
    \`)`,...f.parameters?.docs?.source}}};const Me=["MapDefault","MapFullHeight","MapPlayground","MapPlaygroundLB72"];export{u as MapDefault,b as MapFullHeight,y as MapPlayground,f as MapPlaygroundLB72,Me as __namedExportsOrder,Le as default};
