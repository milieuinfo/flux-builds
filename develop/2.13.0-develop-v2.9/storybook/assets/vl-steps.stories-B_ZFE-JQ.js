...
`,t.jsx(e.p,{children:t.jsx(e.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-steps.html",rel:"nofollow",children:"Legacy Demo - Steps"})})]})}function f(s={}){const{wrapper:e}={...g(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(q,{...s})}):q(s)}function x(s,e){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}D([P]);const A={id:"components-block-steps-steps",title:"Components - Block/steps/steps",tags:["autodocs"],args:a,argTypes:T,parameters:{docs:{page:f}}},i=c(a,({line:s,timeline:e,lastStepNoLine:o})=>p`
  ...
  lastStepNoLine
    ...
    \`)`,...m.parameters?.docs?.source}}};const w=["StepsDefault","StepsIcons","StepsLine","StepsTimeline","StepsSimpleTimeline","StepsSideNavigation"];export{i as StepsDefault,r as StepsIcons,n as StepsLine,m as StepsSideNavigation,u as StepsSimpleTimeline,l as StepsTimeline,w as __namedExportsOrder,A as default};
