...
`,e.jsx(t.p,{children:e.jsx(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-doormat",rel:"nofollow",children:"Documentatie Digitaal Vlaanderen - Doormat"})})]})}function I(a={}){const{wrapper:t}={...x(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(v,{...a})}):v(a)}function W(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}N([R]);const z={id:"components-block-doormat",title:"Components - Block/doormat",tags:["autodocs"],args:n,argTypes:V,parameters:{docs:{page:I}}},h=b(n,({href:a,linkLabel:t,external:p,alt:y,imageSrc:$,imageAlt:w,imageHeight:k,imageWidth:j,graphic:T,fullHeight:A,textSlot:H,titleSlot:D})=>S`
    ...
    `),g=C.bind({});g.storyName="vl-doormat - full height";g.args={fullHeight:!0};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`story(doormatArgs, ({
  href,
  linkLabel,
  external,
  alt,
  ...
  fullHeight
    ...
    \`)`,...g.parameters?.docs?.source}}};const F=["DoormatDefault","DoormatExternal","DoormatAlt","DoormatImage","DoormatGraphic","DoormatFullHeight"];export{s as DoormatAlt,r as DoormatDefault,o as DoormatExternal,g as DoormatFullHeight,d as DoormatGraphic,m as DoormatImage,F as __namedExportsOrder,z as default};
